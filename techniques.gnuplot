...
#plot '/tmp/data_gnuplot' using 3 t "$\\subsetneq$" fs solid 0.3 ls 1, '' using 4 t "$\\supsetneq$" fs pattern 3 ls 2, '' using 5:xtic(1) t "uncomparable"  fs pattern 13 ls 3
plot '/tmp/data_gnuplot' using 3 t "$\\subsetneq$" fs solid 0.3 ls 1, '' using 4 t "$\\supsetneq$" fs solid 0.7 ls 2, '' using 5:xtic(1) t "uncomparable"  fs solid 0.7 ls 3
