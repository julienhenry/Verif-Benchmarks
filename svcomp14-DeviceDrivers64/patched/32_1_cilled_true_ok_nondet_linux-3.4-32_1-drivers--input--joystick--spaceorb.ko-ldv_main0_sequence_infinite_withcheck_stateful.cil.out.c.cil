  ...
  if (0) {
    ...
    *((int *)__cil_tmp139) = __cil_tmp148 | __cil_tmp143;
    ...
    while (1) {
      ...
      __cil_tmp149 = (unsigned long )i * 4UL;
    ...
    while (1) {
      ...
      __cil_tmp160 = (unsigned long )i * 4UL;
    ...
    while (1) {
      ...
      __cil_tmp172 = (unsigned long )i * 4UL;
    ...
    while (1) {
      ...
      if (__cil_tmp187 & __cil_tmp184) {
        __cil_tmp188 = (unsigned long )i * 8UL;
...
{ struct spaceorb *spaceorb ;
  ...
  *((struct input_dev **)spaceorb) = input_dev;
  __cil_tmp8 = 0UL;
  __cil_tmp9 = 76UL + __cil_tmp8;
  __cil_tmp10 = (unsigned long )spaceorb;
  __cil_tmp11 = __cil_tmp10 + __cil_tmp9;
  __cil_tmp12 = (char *)__cil_tmp11;
  __cil_tmp13 = 0UL;
  __cil_tmp14 = 40UL + __cil_tmp13;
  ...
  *((unsigned long *)__cil_tmp43) = __cil_tmp45 | __cil_tmp44;
  ...
  while (1) {
    ...
    __cil_tmp56 = (unsigned long )i * 4UL;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp61);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& spaceorb_drv, & __this_module, "spaceorb");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_spaceorb_drv_serio_driver == 0) {
          ...
          ldv_s_spaceorb_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
