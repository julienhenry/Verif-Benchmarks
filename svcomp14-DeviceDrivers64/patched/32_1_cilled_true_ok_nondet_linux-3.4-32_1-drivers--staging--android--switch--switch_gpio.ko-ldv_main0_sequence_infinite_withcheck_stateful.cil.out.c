...
extern void switch_dev_unregister(struct switch_dev *sdev ) ;
 static int switch_get_state(struct switch_dev *sdev )  __attribute__((__no_instrument_function__)) ;
 static int switch_get_state(struct switch_dev *sdev )  __attribute__((__no_instrument_function__)) ;
 static int switch_get_state(struct switch_dev *sdev ) 
{ unsigned long __cil_tmp2 ;
  unsigned long __cil_tmp3 ;

  {
  __cil_tmp2 = (unsigned long )sdev;
  __cil_tmp3 = __cil_tmp2 + 20UL;
...
{ struct gpio_switch_platform_data *pdata ;
  ...
  *((int *)__cil_tmp55) = gpio_to_irq(__cil_tmp58);
  ...
  tmp___0 = (int )request_irq(__cil_tmp67, & gpio_irq_handler, 8UL, __cil_tmp68, __cil_tmp69);
  ret = tmp___0;
  if (ret < 0) {
    goto err_request_irq;
  }
