...
{ __u16 tmp ;
 ...
 static __be16 __cpu_to_be16p(__u16 const   *p ) 
{ __u16 tmp ;
...
static void dlfb_compress_hline(uint16_t const   **pixel_start_ptr , uint16_t const   *pixel_end ,
...
{ uint16_t const   *pixel ;
  ...
  *tmp___3 = (unsigned char )dev_addr;
  ...
  cmd_pixel_end = pixel + (unsigned long )tmp___10;
  ...
  *cmd_pixels_count_byte = (uint8_t )(((long )pixel - (long )cmd_pixel_start) / 2L);
  ...
  ldv_30509: ;
  if ((unsigned long )pixel_end > (unsigned long )pixel && (unsigned long )(cmd_buffer_end + 0xfffffffffffffff5UL) > (unsigned long )((unsigned char const   *)cmd)) {
    goto ldv_30508;
  }
  if ((unsigned long )((unsigned char const   *)cmd + 11U) >= (unsigned long )cmd_buffer_end) {
    if ((unsigned long )cmd_buffer_end > (unsigned long )((unsigned char const   *)cmd)) {
