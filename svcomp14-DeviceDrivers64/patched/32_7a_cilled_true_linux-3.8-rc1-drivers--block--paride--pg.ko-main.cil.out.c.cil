...
{ int tmp ;
 ...
 static int ldv_register_chrdev_10(unsigned int major___0 , char const   *name___0 ,
                                           struct file_operations  const  *fops ) ;
...
{ 
 ...
 static void ldv_unregister_chrdev_11(unsigned int major___0 , char const   *name___0 ) ;
...
{ int unit ;
 ...
 static int status_reg(struct pg *dev ) 
{ int tmp ;
 ...
 static int read_reg(struct pg *dev , int reg ) 
{ int tmp ;
 ...
 static void write_reg(struct pg *dev , int reg , int val ) 
{ 
