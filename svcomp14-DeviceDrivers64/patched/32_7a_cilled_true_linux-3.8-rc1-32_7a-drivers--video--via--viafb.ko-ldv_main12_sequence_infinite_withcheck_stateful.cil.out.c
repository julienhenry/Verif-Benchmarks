...
void viafb_pm_register(struct viafb_pm_hooks *hooks ) ;
 static u8 via_read_reg(u16 port , u8 index ) 
{ unsigned char tmp ;
 ...
 static void via_write_reg_mask(u16 port , u8 index , u8 data , u8 mask ) 
{ u8 old ;
...
struct i2c_adapter *viafb_find_i2c_adapter(enum viafb_i2c_adap which ) ;
 static int machine_is_olpc(void) 
{ 
...
extern struct proc_dir_entry *proc_mkdir(char const   * , struct proc_dir_entry * ) ;
 static struct proc_dir_entry *proc_create(char const   *name___8 , umode_t mode ,
                                                   struct proc_dir_entry *parent ,
                                                   struct file_operations  const  *proc_fops ) 
...
{ 
 ...
 static int get_var_refresh(struct fb_var_screeninfo *var ) 
{ u32 htotal ;
  u32 vtotal ;
...
{ union __anonunion_u_182 u ;
  ...
  if (viafb_SAMM_ON == 1) {
    ...
    if (viafb_dual_fb != 0) {
      u.viamode.virtual_xres_sec = viafbinfo1->var.xres_virtual;
    } else {
      u.viamode.virtual_xres_sec = viafbinfo->var.xres_virtual;
    }
    if (viafb_dual_fb != 0) {
      u.viamode.virtual_yres_sec = viafbinfo1->var.yres_virtual;
    } else {
      u.viamode.virtual_yres_sec = viafbinfo->var.yres_virtual;
    }
...
{ struct inode *var_group1 ;
  ...
  if (ldv_s_viafb_dvp0_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_dvp0_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 1: ;
  ...
  if (ldv_s_viafb_dvp1_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_dvp1_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 3: ;
  ...
  if (ldv_s_viafb_dfph_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_dfph_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 5: ;
  ...
  if (ldv_s_viafb_dfpl_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_dfpl_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 7: ;
  ...
  if (ldv_s_viafb_vt1636_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_vt1636_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 9: ;
  ...
  if (ldv_s_viafb_iga1_odev_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_iga1_odev_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 12: ;
  ...
  if (ldv_s_viafb_iga2_odev_proc_fops_file_operations == 0) {
    ...
    ldv_s_viafb_iga2_odev_proc_fops_file_operations ++;
  }
  goto ldv_34002;
  case 14: ;
...
void ldv_mutex_lock_28(struct mutex *ldv_func_arg1 ) ;
 static void via_write_reg(u16 port , u8 index , u8 data ) 
{ 
 ...
 static void via_write_misc_reg_mask(u8 data , u8 mask ) 
{ u8 old ;
  unsigned char tmp ;
...
int viafb_DeviceStatus ;
 static u32 get_pll_internal_frequency(u32 ref_freq , struct via_pll_config pll ) 
{ 
 ...
 static u32 get_pll_output_frequency(u32 ref_freq , struct via_pll_config pll ) 
{ u32 tmp ;
...
{ u8 value ;
 ...
 static void set_ldvp0_source(u8 iga ) 
{ 
 ...
 static void set_ldvp1_source(u8 iga ) 
{ 
 ...
 static void set_dvp0_source(u8 iga ) 
{ 
 ...
 static void set_dvp1_source(u8 iga ) 
{ 
 ...
 static void set_lvds1_source(u8 iga ) 
{ 
 ...
 static void set_lvds2_source(u8 iga ) 
{ 
...
{ struct display_timing crt_reg ;
  ...
  {
  if ((unsigned int )cyres == 0U) {
    tmp___0 = (u16 )var->yres;
  } else {
    tmp___0 = cyres;
  }
  if ((unsigned int )cxres == 0U) {
    tmp___1 = (u16 )var->xres;
  } else {
    tmp___1 = cxres;
  }
  tmp = var_to_timing(var, tmp___1, tmp___0);
  crt_reg = tmp;
  if (iga == 1) {
...
{ int j ;
  ...
  if (viafb_dual_fb != 0) {
    tmp___4 = viafbinfo1->fix.line_length;
  } else {
    tmp___4 = viafbinfo->fix.line_length;
  }
  via_set_secondary_pitch(tmp___4);
  via_set_primary_color_depth((int )viaparinfo->depth);
  if (viafb_dual_fb != 0) {
    tmp___5 = viaparinfo1->depth;
  } else {
    tmp___5 = viaparinfo->depth;
  }
  via_set_secondary_color_depth(tmp___5);
...
{ struct platform_device *var_group1 ;
  ...
  if (ldv_s_via_i2c_driver_platform_driver == 0) {
    ...
    ldv_s_via_i2c_driver_platform_driver ++;
  }
  goto ldv_24879;
  case 1: ;
...
static int viafb_dvi_query_EDID(void) ;
 static bool check_tmds_chip(int device_id_subaddr , int device_id ) 
{ int tmp ;
...
static struct _lcd_scaling_factor lcd_scaling_factor  =    {{3, {{159U, 0U, 1U}, {119U, 0U, 7U}, {121U, 4U, 5U}}}, {3, {{121U, 3U, 3U}, {120U,
                                                                                 ...
                                                                                 7U},
                                                                {121U, 6U, 7U}}}};
static struct _lcd_scaling_factor lcd_scaling_factor_CLE  =    {{2,
     {{119U, 0U, 7U}, {121U, 4U, 5U}, {(unsigned char)0, (unsigned char)0, (unsigned char)0}}},
    {2, {{120U, 0U, 7U}, {121U, 6U, 7U}, {(unsigned char)0, (unsigned char)0, (unsigned char)0}}}};
...
static void check_diport_of_integrated_lvds(struct lvds_chip_information *plvds_chip_info ,
                                            struct lvds_setting_information *plvds_setting_info ) ;
 static bool check_lvds_chip(int device_id_subaddr , int device_id ) 
{ int tmp ;
...
{ int set_iga ;
  ...
  if ((unsigned int )cxres != 0U) {
    ...
    set_hres = (int )var->xres;
  }
  if ((unsigned int )cyres != 0U) {
    set_vres = (int )cyres;
  } else {
    set_vres = (int )var->yres;
  }
...
{ u32 ge_cmd ;
  ...
  if ((unsigned int )op != 3U) {
    ...
    if ((tmp___0 & src_x) != 0U || (src_y & 4294963200U) != 0U) {
  ...
  if ((unsigned int )op != 2U) {
    tmp___1 = (u32 )((int )dst_bpp >> 3);
  } else {
    tmp___1 = 1U;
  }
  tmp = ((width * height) * tmp___1 + 3U) >> 2;
  i = 0U;
  goto ldv_32192;
  ldv_32191: 
...
{ struct viafb_par *viapar ;
  ...
  ldv_32242: 
  viapar->fbmem_free -= 8192U;
  (viapar->shared)->cursor_vram_addr = viapar->fbmem_free;
  viapar->fbmem_used += 8192U;
  viapar->fbmem_free -= 262144U;
  (viapar->shared)->vq_vram_addr = viapar->fbmem_free;
  viapar->fbmem_used += 262144U;
  ((viapar->shared)->vdev)->camera_fbmem_size = 1843200L;
  viapar->fbmem_free -= (u32 )((viapar->shared)->vdev)->camera_fbmem_size;
  viapar->fbmem_used += (u32 )((viapar->shared)->vdev)->camera_fbmem_size;
...
{ void *engine ;
  ...
  case 12U: ;
  case 13U: 
  vq_start_low |= 536870912U;
  vq_end_low |= 536870912U;
  vq_high |= 536870912U;
  vq_len |= 536870912U;
  writel(1048576U, (void volatile   *)engine + 1052U);
...
static struct viafb_dev global_dev  ;
 static void viafb_mmio_write(int reg , u32 v ) 
{ 
 ...
 static int viafb_mmio_read(int reg ) 
{ unsigned int tmp ;
...
static struct mutex viafb_dma_lock  =    {{1},
    {{{{{0U}}, 3735899821U, 4294967295U, 0xffffffffffffffffUL, {0, {0, 0}, "viafb_dma_lock.wait_lock",
...
{ int ret ;
  ...
  if ((vdev->pdev)->resource[1].start != 0ULL || (vdev->pdev)->resource[1].end != (vdev->pdev)->resource[1].start) {
    vdev->engine_len = (unsigned long )(((vdev->pdev)->resource[1].end - (vdev->pdev)->resource[1].start) + 1ULL);
  } else {
    vdev->engine_len = 0UL;
  }
...
{ struct gpio_chip *var_group1 ;
  ...
  if (ldv_s_via_gpio_driver_platform_driver == 0) {
    ...
    ldv_s_via_gpio_driver_platform_driver ++;
  }
  goto ldv_19745;
  case 7: ;
...
char const   *via_slap  =    "Please slap VIA Technologies to motivate them releasing full documentation for your platform!\n";
 static u32 cle266_encode_pll(struct via_pll_config pll ) 
{ 
 ...
 static u32 k800_encode_pll(struct via_pll_config pll ) 
{ 
 ...
 static u32 vx855_encode_pll(struct via_pll_config pll ) 
{ 
 ...
 static void cle266_set_primary_pll_encoded(u32 data ) 
{ 
 ...
 static void k800_set_primary_pll_encoded(u32 data ) 
{ 
 ...
 static void cle266_set_secondary_pll_encoded(u32 data ) 
{ 
 ...
 static void k800_set_secondary_pll_encoded(u32 data ) 
{ 
 ...
 static void set_engine_pll_encoded(u32 data ) 
{ 
...
{ u8 value ;
 ...
 static u8 set_clock_source_common(enum via_clksrc source , bool use_pll ) 
{ u8 data ;
...
{ struct via_aux_drv *data ;
 ...
 static bool via_aux_read(struct via_aux_drv *drv , u8 start , u8 *buf , u8 len ) 
