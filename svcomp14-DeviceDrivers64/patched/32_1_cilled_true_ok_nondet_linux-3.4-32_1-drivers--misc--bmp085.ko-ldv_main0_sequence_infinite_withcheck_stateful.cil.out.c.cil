...
{ u32 tmp___7 ;
  ...
  *__cil_tmp5 = (u32 )0;
  ...
  __cil_tmp45 = __cil_tmp44 + 108UL;
  *((u32 *)__cil_tmp45) = tmp___8;
  __cil_tmp46 = (unsigned long )data;
  __cil_tmp47 = __cil_tmp46 + 108UL;
...
{ struct i2c_client *client ;
  ...
  tmp = (int )kstrtoul(buf, 10U, & oversampling);
  tmp___8 = tmp;
  success = tmp___8;
  if (success == 0) {
...
static struct attribute_group  const  bmp085_attr_group  =    {(char const   *)0,
    (umode_t (*)(struct kobject * , struct attribute * , int  ))0, bmp085_attributes};
...
{ struct bmp085_data *data ;
  ...
  *((unsigned char *)__cil_tmp7) = (unsigned char)0;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp12, & bmp085_attr_group);
  err = tmp;
  if (err) {
    goto exit_free;
  }
...
static int bmp085_driver_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
