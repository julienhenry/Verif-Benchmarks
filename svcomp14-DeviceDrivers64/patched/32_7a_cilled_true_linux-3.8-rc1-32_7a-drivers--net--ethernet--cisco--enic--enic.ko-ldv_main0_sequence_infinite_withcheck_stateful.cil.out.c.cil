...
{ unsigned char *tmp ;
 ...
 static void cq_desc_dec(struct cq_desc  const  *desc_arg , u8 *type , u8 *color ,
...
{ unsigned int tmp ;
 ...
 static void vnic_intr_return_credits(struct vnic_intr *intr , unsigned int credits ,
...
{ u32 int_credit_return ;
  ...
  int_credit_return = ((credits & 65535U) | tmp) | tmp___0;
...
{ unsigned int credits ;
 ...
 static u32 vnic_intr_legacy_pba(u32 *legacy_pba ) 
{ unsigned int tmp ;
...
void vnic_intr_clean(struct vnic_intr *intr ) ;
 static void wq_enet_desc_enc(struct wq_enet_desc *desc , u64 address , u16 length ,
...
{ 
 ...
 static void rq_enet_desc_enc(struct rq_enet_desc *desc , u64 address , u8 type ,
                                      u16 length ) 
{ 
 ...
 static unsigned int vnic_cq_service(struct vnic_cq *cq , unsigned int work_to_do ,
...
{ 
 ...
 static void vnic_wq_post(struct vnic_wq *wq , void *os_buf , dma_addr_t dma_addr ,
...
{ struct vnic_wq_buf *buf ;
 ...
 static void vnic_wq_service(struct vnic_wq *wq , struct cq_desc *cq_desc ,
...
{ 
 ...
 static void vnic_rq_post(struct vnic_rq *rq , void *os_buf , unsigned int os_buf_index ,
...
{ struct vnic_rq_buf *buf ;
 ...
 static void vnic_rq_service(struct vnic_rq *rq , struct cq_desc *cq_desc ,
...
{ struct vnic_rq_buf *buf ;
 ...
 static int vnic_rq_fill(struct vnic_rq *rq , int (*buf_fill)(struct vnic_rq * ) ) 
{ int err ;
  unsigned int tmp ;
...
void vnic_rq_clean(struct vnic_rq *rq , void (*buf_clean)(struct vnic_rq * , struct vnic_rq_buf * ) ) ;
 static void enic_queue_wq_desc_ex(struct vnic_wq *wq , void *os_buf , dma_addr_t dma_addr ,
...
{ struct wq_enet_desc *desc ;
 ...
 static void enic_queue_wq_desc_cont(struct vnic_wq *wq , void *os_buf , dma_addr_t dma_addr ,
...
{ 
 ...
 static void enic_queue_wq_desc(struct vnic_wq *wq , void *os_buf , dma_addr_t dma_addr ,
...
{ 
 ...
 static void enic_queue_wq_desc_csum_l4(struct vnic_wq *wq , void *os_buf ,
                                                dma_addr_t dma_addr , unsigned int len ,
...
{ 
 ...
 static void enic_queue_wq_desc_tso(struct vnic_wq *wq , void *os_buf , dma_addr_t dma_addr ,
...
{ 
 ...
 static void enic_queue_rq_desc(struct vnic_rq *rq , void *os_buf , unsigned int os_buf_index ,
                                        dma_addr_t dma_addr , unsigned int len ) 
...
static struct enic_stat  const  enic_tx_stats[11U]  = 
  {      {{'t', 'x', '_', 'f', 'r', 'a', 'm', 'e', 's', '_', 'o', 'k', '\000'}, 0U}, 
       ...
       'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 1U}, 
        {{'t', 'x', '_', 'm', 'u', 'l', 't', 'i', 'c', 'a', 's', 't', '_', 'f', 'r',
       'a', 'm', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 2U}, 
       ...
       's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 5U}, 
        {{'t', 'x', '_', 'm', 'u', 'l', 't', 'i', 'c', 'a', 's', 't', '_', 'b', 'y',
       't', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 6U}, 
        {{'t', 'x', '_', 'b', 'r', 'o', 'a', 'd', 'c', 'a', 's', 't', '_', 'b', 'y',
       't', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 7U}, 
...
static struct enic_stat  const  enic_rx_stats[21U]  = 
  {      {{'r', 'x', '_', 'f', 'r', 'a', 'm', 'e', 's', '_', 'o', 'k', '\000'}, 0U}, 
       ...
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 1U}, 
        {{'r',
       'x', '_', 'u', 'n', 'i', 'c', 'a', 's', 't', '_', 'f', 'r', 'a', 'm', 'e',
       's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 2U}, 
       ...
       'a', 'm', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 4U}, 
        {{'r', 'x', '_', 'b', 'y', 't', 'e', 's', '_', 'o', 'k', '\000'}, 5U}, 
        {{'r', 'x', '_', 'u', 'n', 'i', 'c', 'a', 's', 't', '_', 'b', 'y', 't', 'e',
       's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 6U}, 
        {{'r', 'x', '_', 'm', 'u', 'l', 't', 'i', 'c', 'a', 's', 't', '_', 'b', 'y',
       't', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 7U}, 
        {{'r', 'x', '_', 'b', 'r', 'o', 'a', 'd', 'c', 'a', 's', 't', '_', 'b', 'y',
       't', 'e', 's', '_', 'o', 'k', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 8U}, 
       ...
       '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 20U}};
...
{ 
 ...
 static unsigned int enic_msix_rq_intr(struct enic *enic , unsigned int rq ) 
{ unsigned int tmp ;
 ...
 static unsigned int enic_msix_wq_intr(struct enic *enic , unsigned int wq ) 
{ unsigned int tmp ;
...
{ struct enic *enic ;
 ...
 static void enic_queue_wq_skb_cont(struct enic *enic , struct vnic_wq *wq ,
...
{ skb_frag_t const   *frag ;
 ...
 static void enic_queue_wq_skb_vlan(struct enic *enic , struct vnic_wq *wq ,
...
{ unsigned int head_len ;
 ...
 static void enic_queue_wq_skb_csum_l4(struct enic *enic , struct vnic_wq *wq ,
                                               struct sk_buff *skb , int vlan_tag_insert ,
                                               unsigned int vlan_tag , int loopback ) 
{ unsigned int head_len ;
  unsigned int tmp ;
 ...
 static void enic_queue_wq_skb_tso(struct enic *enic , struct vnic_wq *wq ,
...
{ unsigned int frag_len_left ;
 ...
 static void enic_queue_wq_skb(struct enic *enic , struct vnic_wq *wq , struct sk_buff *skb ) 
{ unsigned int mss ;
  unsigned char *tmp ;
...
{ struct enic *enic ;
  ...
  flags = (netdev->flags | tmp___0) | tmp___1;
  if (enic->flags != flags) {
    enic->flags = flags;
...
{ struct device *dev ;
  ...
  if (pdev->resource[i].start != 0ULL || pdev->resource[i].end != pdev->resource[i].start) {
    enic->bar[i].len = (unsigned long )((pdev->resource[i].end - pdev->resource[i].start) + 1ULL);
  } else {
    enic->bar[i].len = 0UL;
  }
  ...
  if ((enic->config.flags & 2048U) != 0U) {
    netdev->features &= 0xffffffffffffff7fULL;
    enic->loop_enable = 1U;
  ...
  if ((int )enic->config.flags & 1) {
    netdev->hw_features |= 1638400ULL;
  }
  if ((enic->config.flags & 4U) != 0U) {
    netdev->hw_features |= 536870912ULL;
  }
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_enic_netdev_dynamic_ops_net_device_ops == 0) {
    ...
    ldv_s_enic_netdev_dynamic_ops_net_device_ops ++;
  }
  goto ldv_47193;
  case 10: ;
  ...
  if (ldv_s_enic_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_enic_netdev_ops_net_device_ops ++;
  }
  goto ldv_47193;
  case 21: ;
...
{ u64 paddr ;
  ...
  tmp = wq->bufs[fetch_index / tmp___0] + (unsigned long )(fetch_index % tmp___1);
  wq->to_clean = tmp;
  wq->to_use = tmp;
  return;
}
...
void vnic_rq_init(struct vnic_rq *rq , unsigned int cq_index , unsigned int error_interrupt_enable ,
                  unsigned int error_interrupt_offset ) ;
 static void vnic_set_nic_cfg(u32 *nic_cfg , u8 rss_default_cpu , u8 rss_hash_type ,
                                      u8 rss_hash_bits , u8 rss_base_cpu , u8 rss_enable ,
...
{ struct vnic_enet_config *c ;
  ...
  if (__min1 < __min2) {
    c->wq_desc_count = __min1;
  } else {
    c->wq_desc_count = __min2;
  }
  ...
  if (__max1___0 > __max2___0) {
    __min2___0 = __max1___0;
  } else {
    __min2___0 = __max2___0;
  }
  if (__min1___0 < __min2___0) {
    c->rq_desc_count = __min1___0;
  } else {
    c->rq_desc_count = __min2___0;
  }
  ...
  if (__min1___2 < __min2___2) {
    c->intr_timer_usec = __min1___2;
  } else {
    c->intr_timer_usec = __min2___2;
  }
  ...
  _dev_info((struct device  const  *)tmp___10, "vNIC csum tx/rx %s/%s tso/lro %s/%s rss %s intr mode %s type %s timer %d usec loopback tag 0x%04x\n",
            tmp___22, tmp___21, tmp___20, tmp___19, tmp___18, tmp___17, tmp___14,
...
{ enum vnic_dev_intr_mode intr_mode ;
  ...
  if ((unsigned int )intr_mode != 1U) {
    ...
    tmp___4 = (char *)"legacy PCI INTx";
  }
  _dev_info((struct device  const  *)tmp, "vNIC resources used:  wq %d rq %d cq %d intr %d intr mode %s\n",
            enic->wq_count, enic->rq_count, enic->cq_count, enic->intr_count, tmp___4);
  i = 0U;
  goto ldv_39800;
  ldv_39799: 
...
struct vic_provinfo *vic_provinfo_alloc(gfp_t flags , u8 const   *oui , u8 type ) ;
...
{ u64 a0 ;
  ...
  a0 = (u64 )(((((directed != 0) | tmp) | tmp___0) | tmp___1) | tmp___2);
...
{ u64 a0 ;
  ...
  if (r == 0) {
    vdev->notify_sz = (unsigned int )a1;
  } else {
    vdev->notify_sz = 0U;
  }
  return (r);
...
{ u64 paddr ;
  ...
  tmp = rq->bufs[fetch_index / tmp___0] + (unsigned long )(fetch_index % tmp___1);
  rq->to_clean = tmp;
  rq->to_use = tmp;
  return;
}
...
{ struct vnic_rq_buf *buf ;
  ...
  tmp___1 = rq->bufs[fetch_index / tmp___2] + (unsigned long )(fetch_index % tmp___3);
  rq->to_clean = tmp___1;
  rq->to_use = tmp___1;
