...
static struct iio_dev_attr iio_dev_attr_poke_ev1  =    {{{"poke_ev1",
      (umode_t )128}, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                   char *buf ))((void *)0), & iio_evgen_poke}, (u64 )1,
...
{ int ret ;
  ...
  tmp___1 = (int )device_add(& iio_evgen_dev);
  tmp___0 = tmp___1;
  return (tmp___0);
}
}
