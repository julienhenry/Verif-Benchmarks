...
{ enum tm6000_mux mux ;
  ...
  if ((unsigned int )dev->dev_type == 2U) {
    ...
    printk("\016ERROR: __VERIFIER_error(); TM5600 and TM6000 don\'t has SIF audio inputs. Please check the %s configuration.\n",
           (char *)(& dev->name));
    return (-22);
  }
  goto ldv_29696;
...
{ unsigned int i ;
 ...
 static void get_next_buf(struct tm6000_dmaqueue *dma_q , struct tm6000_buffer **buf ) 
{ struct tm6000_core *dev ;
 ...
 static void buffer_filled(struct tm6000_core *dev , struct tm6000_dmaqueue *dma_q ,
                                   struct tm6000_buffer *buf ) 
{ 
...
{ struct tm6000_dmaqueue *dma_q ;
  ...
  if ((unsigned int )dev->isoc_ctl.cmd == 0U) {
    if (dev->isoc_ctl.tmp_buf_len > 0) {
      ...
      if (4 - dev->isoc_ctl.tmp_buf_len > 0) {
        ...
        ptr += (unsigned long )(4 - dev->isoc_ctl.tmp_buf_len);
      }
  ...
  if ((unsigned long )(ptr + (unsigned long )pktsize) > (unsigned long )endp) {
    ...
    ptr += (unsigned long )((long )endp - (long )ptr);
  } else {
    dev->isoc_ctl.cmd = 0U;
    ptr += (unsigned long )pktsize;
  }
  ldv_32923: ;
...
{ struct tm6000_dmaqueue *dma_q ;
  ...
  __ret = __builtin_memcpy((void *)outp + (unsigned long )pos, (void const   *)ptr,
                           __len);
  pos += cpysize;
  ptr += (unsigned long )cpysize;
  len -= (unsigned long )cpysize;
 ...
 static void print_err_status(struct tm6000_core *dev , int packet , int status ) 
{ char *errmsg ;
 ...
 static int tm6000_isoc_copy(struct urb *urb ) 
{ struct tm6000_dmaqueue *dma_q ;
  struct tm6000_core *dev ;
  struct tm6000_dmaqueue  const  *__mptr ;
  int i ;
