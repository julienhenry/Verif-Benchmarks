...
extern void gameport_set_phys(struct gameport *gameport , char const   *fmt  , ...) ;
...
{ int i ;
  ...
  while (1) {
    ...
    __cil_tmp40 = (unsigned long )i * 4UL;
...
{ struct l4 *l4 ;
  ...
  while (1) {
    ...
    idx = __cil_tmp7 + i;
    __cil_tmp8 = (unsigned long )idx * 16UL;
...
{ int cal[4] ;
  ...
  *((int *)__cil_tmp22) = 255;
  ...
  while (1) {
    ...
    __cil_tmp32 = (unsigned long )__cil_tmp31 * 16UL;
