...
static struct device_attribute dev_attr_state  =    {{"state",
     (umode_t )420}, & reg_show_state, & reg_set_state};
...
{ struct regulator_userspace_consumer_data *pdata ;
  ...
  *((struct regulator_bulk_data **)__cil_tmp18) = *((struct regulator_bulk_data **)__cil_tmp20);
  ...
  tmp___0 = (int )sysfs_create_group(__cil_tmp40, & attr_group);
  ret = tmp___0;
  if (ret != 0) {
