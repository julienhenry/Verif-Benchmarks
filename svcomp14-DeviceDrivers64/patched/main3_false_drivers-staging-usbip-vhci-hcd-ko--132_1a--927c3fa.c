...
void rh_port_connect(int rhport , enum usb_device_speed speed ) ;
 static struct vhci_device *port_to_vdev(__u32 port ) 
{ 
...
{ char *s ;
  ...
  if ((unsigned int )vdev->ud.status == 6U) {
    ...
    out += (unsigned long )tmp___7;
  } else {
    tmp___8 = sprintf(out, "000 000 000 0000000000000000 0-0");
    out += (unsigned long )tmp___8;
  }
  tmp___9 = sprintf(out, "\n");
  out += (unsigned long )tmp___9;
...
void vhci_rx_loop(struct usbip_task *ut ) ;
 static struct usb_hcd *vhci_to_hcd(struct vhci_hcd *vhci ) 
...
void rh_port_disconnect(int rhport ) ;
 static struct vhci_hcd *hcd_to_vhci(struct usb_hcd *hcd ) 
{ 
 ...
 static struct device *vhci_dev(struct vhci_hcd *vhci ) 
{ struct usb_hcd *tmp ;
...
{ unsigned long flags ;
  ...
  the_controller->port_status[rhport] |= 65537U;
  switch ((unsigned int )speed) {
  case 3U: 
  the_controller->port_status[rhport] |= 1024U;
  goto ldv_37507;
  case 1U: 
  the_controller->port_status[rhport] |= 512U;
  goto ldv_37507;
  default: ;
  goto ldv_37507;
  }
...
{ unsigned long flags ;
  ...
  tmp___3 = spinlock_check(& the_controller->lock);
  flags = _raw_spin_lock_irqsave(tmp___3);
  the_controller->port_status[rhport] &= 4294967294U;
  the_controller->port_status[rhport] |= 65536U;
  spin_unlock_irqrestore(& the_controller->lock, flags);
  tmp___4 = vhci_to_hcd(the_controller);
  usb_hcd_poll_rh_status(tmp___4);
  return;
...
{ struct vhci_hcd *vhci ;
  ...
  *event_bits = 0UL;
  ...
  if ((vhci->port_status[rhport] & 2031616U) != 0U) {
    ...
    *event_bits |= (unsigned long )(1 << (rhport + 1));
    changed = 1;
  }
  rhport ++;
  ldv_37534: ;
...
{ struct vhci_hcd *dum ;
  ...
  case 3U: 
  dum->port_status[rhport] |= 1024U;
  goto ldv_37568;
  case 1U: 
  dum->port_status[rhport] |= 512U;
  goto ldv_37568;
  default: ;
  goto ldv_37568;
  }
  ...
  dum->port_status[rhport] &= (u32 )(~ (1 << (int )wValue));
  }
  ldv_37564: ;
  goto ldv_37561;
  case 40966: ;
  ...
  *((__le32 *)buf) = 0U;
  ...
  if ((unsigned int )*((unsigned char *)dum + 104UL) != 0U && (long )dum->re_timeout - (long )jiffies < 0L) {
    printk("<3>%s: not yet\n", "vhci_hub_control");
    dum->port_status[rhport] |= 262144U;
    dum->port_status[rhport] &= 4294967291U;
    dum->resuming = 0U;
    dum->re_timeout = 0UL;
  }
  if ((dum->port_status[rhport] & 16U) != 0U && (long )dum->re_timeout - (long )jiffies < 0L) {
    dum->port_status[rhport] |= 1048576U;
    dum->port_status[rhport] &= 4294967279U;
    dum->re_timeout = 0UL;
  ...
  *((u16 *)buf + 1UL) = (unsigned short )(dum->port_status[rhport] >> 16);
  ...
  if ((dum->port_status[rhport] & 2U) != 0U) {
    dum->port_status[rhport] &= 4294965757U;
  }
...
{ struct usb_hcd *var_group1 ;
  ...
  if (ldv_s_vhci_driver_platform_driver == 0) {
    ...
    ldv_s_vhci_driver_platform_driver ++;
  }
  goto ldv_37827;
  case 10: ;
