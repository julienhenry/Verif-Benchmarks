...
{ struct spi_message msg ;
  ...
  *((void const   **)__cil_tmp8) = (void const   *)0;
  __cil_tmp9 = (unsigned long )(& index_xfer) + 8UL;
  *((void **)__cil_tmp9) = (void *)0;
  __cil_tmp10 = (unsigned long )(& index_xfer) + 16UL;
  *((unsigned int *)__cil_tmp10) = 3U;
  __cil_tmp11 = (unsigned long )(& index_xfer) + 24UL;
  *((dma_addr_t *)__cil_tmp11) = 0ULL;
  __cil_tmp12 = (unsigned long )(& index_xfer) + 32UL;
  *((dma_addr_t *)__cil_tmp12) = 0ULL;
  __cil_tmp13 = (unsigned long )(& index_xfer) + 40UL;
  *((unsigned int *)__cil_tmp13) = 1U;
  __cil_tmp14 = (unsigned long )(& index_xfer) + 41UL;
  *((u8 *)__cil_tmp14) = (unsigned char)0;
  __cil_tmp15 = (unsigned long )(& index_xfer) + 42UL;
  *((u16 *)__cil_tmp15) = (unsigned short)0;
  __cil_tmp16 = (unsigned long )(& index_xfer) + 44UL;
  *((u32 *)__cil_tmp16) = 0U;
  __cil_tmp17 = (unsigned long )(& index_xfer) + 48UL;
  ...
  *((void const   **)__cil_tmp20) = (void const   *)0;
  __cil_tmp21 = (unsigned long )(& value_xfer) + 8UL;
  *((void **)__cil_tmp21) = (void *)0;
  __cil_tmp22 = (unsigned long )(& value_xfer) + 16UL;
  *((unsigned int *)__cil_tmp22) = 3U;
  __cil_tmp23 = (unsigned long )(& value_xfer) + 24UL;
  *((dma_addr_t *)__cil_tmp23) = 0ULL;
  __cil_tmp24 = (unsigned long )(& value_xfer) + 32UL;
  *((dma_addr_t *)__cil_tmp24) = 0ULL;
  __cil_tmp25 = (unsigned long )(& value_xfer) + 40UL;
  *((unsigned int *)__cil_tmp25) = 0U;
  __cil_tmp26 = (unsigned long )(& value_xfer) + 41UL;
  *((u8 *)__cil_tmp26) = (unsigned char)0;
  __cil_tmp27 = (unsigned long )(& value_xfer) + 42UL;
  *((u16 *)__cil_tmp27) = (unsigned short)0;
  __cil_tmp28 = (unsigned long )(& value_xfer) + 44UL;
  *((u32 *)__cil_tmp28) = 0U;
  __cil_tmp29 = (unsigned long )(& value_xfer) + 48UL;
...
{ struct ltv350qv *lcd ;
  ...
  *((u8 **)__cil_tmp13) = (u8 *)tmp___8;
  ...
  tmp = (long )IS_ERR(__cil_tmp19);
  tmp___10 = tmp;
  if (tmp___10) {
    __cil_tmp20 = (void const   *)ld;
    tmp___11 = (long )PTR_ERR(__cil_tmp20);
    tmp___9 = tmp___11;
    ret = (int )tmp___9;
...
static int ltv350qv_driver_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
