...
{ int rc ;
  ...
  __cil_tmp16 = __cil_tmp15 - __cil_tmp14;
  ld = (struct lcd_device *)__cil_tmp16;
  tmp = (int )kstrtoul(buf, 0U, & contrast);
  rc = tmp;
  if (rc) {
    return ((ssize_t )rc);
  }
...
{ struct lcd_device *new_ld ;
  ...
  *((void (**)(struct device *dev ))__cil_tmp31) = & lcd_device_release;
  ...
  tmp___12 = (int )device_register(__cil_tmp40);
  rc = tmp___12;
  if (rc) {
    __cil_tmp41 = (void const   *)new_ld;
    kfree(__cil_tmp41);
    __cil_tmp42 = (long )rc;
    tmp___13 = (void *)ERR_PTR(__cil_tmp42);
    tmp___10 = tmp___13;
  ...
  if (rc) {
    ...
    __cil_tmp46 = (long )rc;
    tmp___14 = (void *)ERR_PTR(__cil_tmp46);
    tmp___11 = tmp___14;
...
{ struct class *tmp___7 ;
  ...
  {
  tmp = (struct class *)__class_create(& __this_module, "lcd", & __key___6);
  tmp___7 = tmp;
  lcd_class = tmp___7;
  __cil_tmp5 = (void const   *)lcd_class;
  tmp___11 = (long )IS_ERR(__cil_tmp5);
  tmp___10 = tmp___11;
  if (tmp___10) {
    __cil_tmp6 = (void const   *)lcd_class;
    tmp___12 = (long )PTR_ERR(__cil_tmp6);
    tmp___8 = tmp___12;
    printk("<4>Unable to create backlight class; errno = %ld\n", tmp___8);
    __cil_tmp7 = (void const   *)lcd_class;
    tmp___13 = (long )PTR_ERR(__cil_tmp7);
    tmp___9 = tmp___13;
    return ((int )tmp___9);
  }
