...
{ struct sbi_instrument ins ;
  ...
  case 3230421250U: 
  if (devc->nr_voice != 12) {
    devc->fm_info.nr_voices = devc->nr_voice;
  } else {
    devc->fm_info.nr_voices = 6;
  }
...
{ unsigned char data ;
  ...
  if (voice_mode == 4) {
    if ((int )map->ioaddr == devc->left_io) {
      voice_shift = 0;
    } else {
      voice_shift = 3;
    }
...
static int opl3_init(int ioaddr ,
                     struct module *owner ) 
{ int i ;
  int me___0 ;
  int tmp ;
...
{ int var_opl3_open_12_p0 ;
  ...
  if (ldv_s_opl3_operations_synth_operations == 0) {
    ...
    ldv_s_opl3_operations_synth_operations ++;
  }
  goto ldv_26704;
  case 1: ;
