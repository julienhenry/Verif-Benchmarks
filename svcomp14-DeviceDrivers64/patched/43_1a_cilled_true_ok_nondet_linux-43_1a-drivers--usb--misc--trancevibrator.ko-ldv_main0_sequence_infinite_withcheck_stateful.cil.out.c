  ...
  *((unsigned char *)__cil_tmp30) = (unsigned char)1;
  ...
  if (retval != 0) {
    ...
    *((char const   **)__cil_tmp59) = "trancevibrator";
    __cil_tmp60 = (unsigned long )(& descriptor___0) + 8UL;
    *((char const   **)__cil_tmp60) = "set_speed";
    __cil_tmp61 = (unsigned long )(& descriptor___0) + 16UL;
