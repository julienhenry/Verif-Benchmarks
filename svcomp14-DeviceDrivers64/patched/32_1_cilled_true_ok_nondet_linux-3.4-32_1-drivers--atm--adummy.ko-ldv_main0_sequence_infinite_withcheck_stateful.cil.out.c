...
{ short vpi ;
  ...
  __cil_tmp5 = __cil_tmp4 + 840UL;
  vpi = *((short *)__cil_tmp5);
  __cil_tmp6 = (unsigned long )vcc;
  __cil_tmp7 = __cil_tmp6 + 844UL;
  vci = *((int *)__cil_tmp7);
  if (vci == -2) {
    return (0);
  } else {
...
{ struct atm_dev *atm_dev ;
  ...
  *((void **)__cil_tmp13) = (void *)adummy_dev;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp17, __cil_tmp18);
  tmp___8 = tmp;
  if (tmp___8) {
