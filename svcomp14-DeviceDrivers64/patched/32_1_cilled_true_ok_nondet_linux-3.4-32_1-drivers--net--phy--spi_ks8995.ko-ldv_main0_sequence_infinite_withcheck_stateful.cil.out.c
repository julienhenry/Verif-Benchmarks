...
{ struct ks8995_switch *ks ;
  ...
  *((u8 *)__cil_tmp25) = (u8 )8;
  ...
  tmp = (int )sysfs_create_bin_file(__cil_tmp46, __cil_tmp47);
  err = tmp;
  if (err) {
...
static int ks8995_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
