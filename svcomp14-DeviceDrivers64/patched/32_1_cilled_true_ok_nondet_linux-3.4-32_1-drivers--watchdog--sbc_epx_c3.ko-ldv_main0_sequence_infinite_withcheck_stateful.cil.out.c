...
{ int options ;
  ...
  if ((unsigned long )((int )cmd) == (__cil_tmp23 | __cil_tmp18)) {
    goto case_exp;
  } else
  if ((unsigned long )((int )cmd) == (__cil_tmp30 | __cil_tmp24)) {
    goto case_exp___0;
  } else
  if ((unsigned long )((int )cmd) == (__cil_tmp37 | __cil_tmp31)) {
    goto case_exp___0;
  } else
  if ((unsigned long )((int )cmd) == (__cil_tmp44 | __cil_tmp38)) {
    goto case_exp___2;
  } else
  if ((unsigned long )((int )cmd) == (__cil_tmp51 | __cil_tmp45)) {
    goto case_exp___3;
  } else
  if ((unsigned long )((int )cmd) == (__cil_tmp58 | __cil_tmp52)) {
    goto case_exp___4;
  } else {
    ...
    if (0) {
      ...
      __cil_tmp17 = 40U;
      tmp___0 = (int )copy_to_user(__cil_tmp15, __cil_tmp16, __cil_tmp17);
      tmp = tmp___0;
      if (tmp) {
        return (-14L);
      }
