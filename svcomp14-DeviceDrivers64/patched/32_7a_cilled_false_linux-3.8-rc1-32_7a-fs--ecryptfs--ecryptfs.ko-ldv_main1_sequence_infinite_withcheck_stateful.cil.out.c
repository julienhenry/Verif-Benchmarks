...
extern void kmem_cache_free(struct kmem_cache * , void * ) ;
 static struct ecryptfs_inode_info *ecryptfs_inode_to_private(struct inode *inode ) 
{ struct inode  const  *__mptr ;
 ...
 static struct inode *ecryptfs_inode_to_lower(struct inode *inode ) 
{ struct ecryptfs_inode_info *tmp ;
 ...
 static struct ecryptfs_dentry_info *ecryptfs_dentry_to_private(struct dentry *dentry ) 
{ 
 ...
 static struct dentry *ecryptfs_dentry_to_lower(struct dentry *dentry ) 
{ 
 ...
 static struct vfsmount *ecryptfs_dentry_to_lower_mnt(struct dentry *dentry ) 
{ 
...
extern ssize_t wait_on_sync_kiocb(struct kiocb * ) ;
 static void fsstack_copy_attr_atime(struct inode *dest , struct inode  const  *src ) 
{ 
 ...
 static struct ecryptfs_file_info *ecryptfs_file_to_private(struct file *file ) 
{ 
 ...
 static void ecryptfs_set_file_private(struct file *file , struct ecryptfs_file_info *file_info ) 
{ 
 ...
 static struct file *ecryptfs_file_to_lower(struct file *file ) 
{ 
 ...
 static void ecryptfs_set_file_lower(struct file *file , struct file *lower_file ) 
{ 
 ...
 static struct ecryptfs_sb_info *ecryptfs_superblock_to_private(struct super_block *sb ) 
{ 
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_ecryptfs_dir_fops_file_operations == 0) {
    ...
    ldv_s_ecryptfs_dir_fops_file_operations ++;
  }
  goto ldv_29203;
  case 1: ;
  ...
  if (ldv_s_ecryptfs_main_fops_file_operations == 0) {
    ...
    ldv_s_ecryptfs_main_fops_file_operations ++;
  }
  goto ldv_29203;
  case 9: ;
...
{ 
 ...
 static char *nd_get_link(struct nameidata *nd ) 
{ 
...
extern void fsstack_copy_inode_size(struct inode * , struct inode * ) ;
 static void fsstack_copy_attr_times(struct inode *dest , struct inode  const  *src ) 
{ 
...
extern int vfs_setxattr(struct dentry * , char const   * , void const   * , size_t  ,
                        int  ) ;
 static size_t ecryptfs_lower_header_size(struct ecryptfs_crypt_stat *crypt_stat ) 
{ 
 ...
 static void ecryptfs_set_inode_lower(struct inode *inode , struct inode *lower_inode ) 
{ struct ecryptfs_inode_info *tmp ;
 ...
 static struct super_block *ecryptfs_superblock_to_lower(struct super_block *sb ) 
{ 
 ...
 static void ecryptfs_set_dentry_private(struct dentry *dentry , struct ecryptfs_dentry_info *dentry_info ) 
{ 
 ...
 static void ecryptfs_set_dentry_lower(struct dentry *dentry , struct dentry *lower_dentry ) 
{ 
 ...
 static void ecryptfs_set_dentry_lower_mnt(struct dentry *dentry , struct vfsmount *lower_mnt ) 
{ 
...
struct mutex key_tfm_list_mutex  ;
 static void ecryptfs_set_superblock_private(struct super_block *sb , struct ecryptfs_sb_info *sb_info ) 
{ 
 ...
 static void ecryptfs_set_superblock_lower(struct super_block *sb , struct super_block *lower_sb ) 
{ 
...
{ struct ecryptfs_global_auth_tok *global_auth_tok ;
  ...
  if (rc != 0) {
    ...
    global_auth_tok->flags |= 1U;
    goto out;
  } else {
    global_auth_tok->flags &= 4294967294U;
...
{ char *p ;
  ...
  *(cipher_name_dst + 32UL) = 0;
  ...
  goto ldv_32046;
  case 5: 
  mount_crypt_stat->flags |= 1U;
  goto ldv_32046;
  case 6: 
  mount_crypt_stat->flags |= 2U;
  goto ldv_32046;
  case 7: 
  mount_crypt_stat->flags |= 2U;
  mount_crypt_stat->flags |= 4U;
  goto ldv_32046;
  case 8: 
  ...
  goto ldv_32046;
  case 11: 
  mount_crypt_stat->flags |= 8192U;
  goto ldv_32046;
  case 12: 
  mount_crypt_stat->flags |= 128U;
  goto ldv_32046;
  case 13: 
  *check_ruid = 1U;
  goto ldv_32046;
...
{ struct super_block *s ;
  ...
  s->s_flags |= ((path.dentry)->d_sb)->s_flags & 65537UL;
...
{ 
 ...
 static void zero_user_segments(struct page *page , unsigned int start1 ,
...
{ void *kaddr ;
 ...
 static void zero_user_segment(struct page *page , unsigned int start , unsigned int end ) 
{ 
 ...
 static void zero_user(struct page *page , unsigned int start , unsigned int size ) 
{ 
...
extern struct page *read_cache_page(struct address_space * , unsigned long  , filler_t * ,
                                    void * ) ;
 static struct page *read_mapping_page(struct address_space *mapping , unsigned long index ,
                                               void *data ) 
{ filler_t *filler ;
  struct page *tmp ;
...
{ 
 ...
 static void pagefault_disable___0(void) 
{ struct thread_info *tmp ;
 ...
 static void pagefault_enable___0(void) 
{ struct thread_info *tmp ;
...
{ 
 ...
 static void *kmap_atomic___0(struct page *page ) 
{ void *tmp ;
 ...
 static void __kunmap_atomic___0(void *addr ) 
{ 
 ...
 static int sigismember(sigset_t *set , int _sig ) 
{ unsigned long sig ;
...
{ int tmp ;
 ...
 static int __fatal_signal_pending(struct task_struct *p ) 
{ int tmp ;
  long tmp___0 ;
 ...
 static int fatal_signal_pending(struct task_struct *p ) 
{ int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
{ __u32 tmp ;
 ...
 static __u64 __swab64p(__u64 const   *p ) 
{ __u64 tmp ;
 ...
 static __u64 __be64_to_cpup(__be64 const   *p ) 
{ __u64 tmp ;
...
{ 
 ...
 static unsigned int crypto_tfm_alg_blocksize(struct crypto_tfm *tfm ) 
{ 
 ...
 static void crypto_tfm_set_flags(struct crypto_tfm *tfm , u32 flags ) 
{ 
...
{ struct crypto_tfm *tmp ;
 ...
 static struct blkcipher_alg *crypto_blkcipher_alg(struct crypto_blkcipher *tfm ) 
{ struct crypto_tfm *tmp ;
 ...
 static unsigned int crypto_blkcipher_blocksize(struct crypto_blkcipher *tfm ) 
{ struct crypto_tfm *tmp ;
 ...
 static void crypto_blkcipher_set_flags(struct crypto_blkcipher *tfm , u32 flags ) 
{ struct crypto_tfm *tmp ;
...
{ struct blkcipher_tfm *tmp ;
 ...
 static int crypto_blkcipher_encrypt_iv(struct blkcipher_desc *desc , struct scatterlist *dst ,
...
{ struct blkcipher_tfm *tmp ;
 ...
 static int crypto_blkcipher_decrypt_iv(struct blkcipher_desc *desc , struct scatterlist *dst ,
                                                struct scatterlist *src , unsigned int nbytes ) 
{ struct blkcipher_tfm *tmp ;
  int tmp___0 ;
...
{ __u32 tmp ;
 ...
 static u64 get_unaligned_be64(void const   *p ) 
{ __u64 tmp ;
...
{ int i ;
  ...
  if (size >= remainder_of_page) {
    ...
    addr += (unsigned long )remainder_of_page;
...
{ 
  ...
  if ((mount_crypt_stat->flags & 4U) != 0U) {
    crypt_stat->flags |= 256U;
  }
  if ((mount_crypt_stat->flags & 16U) != 0U) {
    crypt_stat->flags |= 1024U;
    if ((mount_crypt_stat->flags & 32U) != 0U) {
      crypt_stat->flags |= 2048U;
    } else
    if ((mount_crypt_stat->flags & 64U) != 0U) {
      crypt_stat->flags |= 4096U;
    }
  }
  return;
}
...
static struct ecryptfs_cipher_code_str_map_elem ecryptfs_cipher_code_str_map[8U]  = 
  {      {{'a', 'e', 's', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 7U}, 
        {{'b', 'l', 'o', 'w', 'f', 'i', 's', 'h', '\000', (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0}, 4U}, 
        {{'d', 'e', 's', '3', '_', 'e', 'd', 'e', '\000', (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0}, 2U}, 
        {{'c', 'a', 's', 't', '5', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 3U}, 
        {{'t', 'w', 'o', 'f', 'i', 's', 'h', '\000', (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0}, 10U}, 
        {{'c', 'a', 's', 't', '6', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0}, 11U}, 
        {{'a', 'e', 's', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 8U}, 
        {{'a', 'e', 's', '\000', (char)0, (char)0, (char)0, (char)0, (char)0, (char)0,
       (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}, 9U}};
u8 ecryptfs_code_for_cipher_string(char *cipher_name , size_t key_bytes ) 
{ int i ;
  u8 code ;
...
extern void down_write(struct rw_semaphore * ) ;
 static struct key *key_get(struct key *key ) 
{ 
...
void ecryptfs_dump_auth_tok(struct ecryptfs_auth_tok *auth_tok ) ;
 static struct ecryptfs_auth_tok *ecryptfs_get_encrypted_key_payload_data(struct key *key ) 
{ 
...
{ struct key *tmp ;
 ...
 static struct ecryptfs_auth_tok *ecryptfs_get_key_payload_data(struct key *key ) 
{ struct ecryptfs_auth_tok *auth_tok ;
...
{ struct ecryptfs_write_tag_70_packet_silly_stack *s ;
  ...
  *packet_size = 0UL;
  ...
  if (s->block_aligned_filename_size % s->block_size != 0UL) {
    s->num_rand_bytes += s->block_size - s->block_aligned_filename_size % s->block_size;
    s->block_aligned_filename_size = s->num_rand_bytes + filename_size;
  }
...
{ size_t body_size ;
  ...
  *packet_size += (size_t )(*new_auth_tok)->session_key.encrypted_key_size;
  (*new_auth_tok)->session_key.flags &= 4294967291U;
  (*new_auth_tok)->session_key.flags |= 8U;
  (*new_auth_tok)->token_type = 1U;
  (*new_auth_tok)->flags = 0U;
  (*new_auth_tok)->session_key.flags &= 4294967294U;
  (*new_auth_tok)->session_key.flags &= 4294967293U;
...
{ size_t body_size ;
  ...
  *tag_11_contents_size = body_size - 14UL;
  tmp___0 = ldv__builtin_expect((*packet_size + body_size) + 1UL > max_packet_size,
                                0L);
  if (tmp___0 != 0L) {
    printk("\vPacket size exceeds max\n");
    rc = -22;
...
{ struct inode *var_group1 ;
  ...
  if (ldv_s_ecryptfs_miscdev_fops_file_operations == 0) {
    ...
    ldv_s_ecryptfs_miscdev_fops_file_operations ++;
  }
  goto ldv_26034;
  case 1: ;
...
{ struct ecryptfs_open_req req ;
  ...
  if ((int )((lower_dentry->d_inode)->i_sb)->s_flags & 1) {
    tmp___3 = 0;
  } else {
    tmp___3 = 2;
  }
