...
{ int tmp ;
 ...
 static int ldv_mutex_is_locked_25(struct mutex *lock ) ;
...
{ int retval ;
 ...
 static int tv2int(struct timeval  const  *a , struct timeval  const  *b ) 
{ int usecs ;
  int sec ;
...
{ int len ;
  ...
  if (kc == 374U && ! ictx->release_code) {
    ...
    if (! nomouse) {
      ...
      descriptor.flags = 0U;
      descriptor.enabled = (char)0;
      tmp___2 = ldv__builtin_expect((int )((signed char )descriptor.enabled) != 0,
                                    0L);
      if (tmp___2 != 0L) {
        if ((int )ictx->pad_mouse) {
          tmp___8 = (char *)"mouse";
        } else {
          tmp___8 = (char *)"keyboard";
        }
