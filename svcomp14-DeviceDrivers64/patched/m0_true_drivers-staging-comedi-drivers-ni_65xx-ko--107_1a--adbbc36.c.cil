...
{ 
 ...
 static unsigned int mite_device_id(struct mite_struct *mite ) 
{ 
...
static unsigned int const   ni_65xx_port_offset  =    16U;
 static unsigned int Port_Data(unsigned int port ) 
{ 
 ...
 static unsigned int Port_Select(unsigned int port ) 
{ 
 ...
 static unsigned int Rising_Edge_Detection_Enable(unsigned int port ) 
{ 
 ...
 static unsigned int Falling_Edge_Detection_Enable(unsigned int port ) 
{ 
 ...
 static unsigned int Filter_Enable(unsigned int port ) 
{ 
...
static struct ni_65xx_board  const  ni_65xx_boards[22U]  = 
 ...
 static struct ni_65xx_board  const  *board(struct comedi_device *dev ) 
{ 
 ...
 static unsigned int ni_65xx_port_by_channel(unsigned int channel ) 
{ 
 ...
 static unsigned int ni_65xx_total_num_ports(struct ni_65xx_board  const  *board___0 ) 
{ 
...
struct pci_device_id  const  __mod_pci_device_table  ;
 static struct ni_65xx_private *private(struct comedi_device *dev ) 
{ 
 ...
 static struct ni_65xx_subdevice_private *sprivate(struct comedi_subdevice *subdev ) 
{ 
