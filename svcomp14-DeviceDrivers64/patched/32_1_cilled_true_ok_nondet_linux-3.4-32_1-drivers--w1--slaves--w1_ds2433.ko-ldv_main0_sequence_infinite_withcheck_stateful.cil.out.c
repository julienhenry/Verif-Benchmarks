...
{ int err ;
  ...
  *((void **)__cil_tmp6) = (void *)data;
  ...
  tmp___0 = (int )sysfs_create_bin_file(__cil_tmp10, __cil_tmp11);
  err = tmp___0;
  if (err) {
