...
{ 
 ...
 static int usb_endpoint_is_bulk_in(struct usb_endpoint_descriptor  const  *epd ) 
{ int tmp ;
  int tmp___0 ;
  int tmp___1 ;
 ...
 static int usb_endpoint_is_bulk_out(struct usb_endpoint_descriptor  const  *epd ) 
{ int tmp ;
  int tmp___0 ;
  int tmp___1 ;
...
static struct workqueue_struct *deadworkqueue  ;
 static int interface_to_InterfaceNumber(struct usb_interface *interface ) 
{ 
...
{ struct mmc_command *cmd ;
  ...
  if (cmd->opcode == 53U) {
    ...
    if ((data->flags & 512U) != 0U) {
      ...
      vub300->cmnd.head.command_type = 128U;
    }
...
{ u8 register_count ;
  ...
  if ((int )interrupt_size < size) {
    ...
    if ((unsigned long )xfer_buffer != (unsigned long )((u8 *)0)) {
      ...
      size -= (int )interrupt_size;
      data += (unsigned long )interrupt_size;
...
{ int linear_length ;
  ...
  if ((int )vub300->large_usb_packets) {
    padded_length = (linear_length + 511) & -512;
  } else {
...
{ long respretval ;
  ...
  if (! (cmd->error != 0U)) {
    if ((vub300->command_out_urb)->status != 0) {
      ...
      if ((vub300->command_out_urb)->status != -71) {
        cmd->error = (unsigned int )(vub300->command_out_urb)->status;
      } else {
    ...
    if ((vub300->command_res_urb)->status != 0) {
      ...
      if ((vub300->command_res_urb)->status != -71) {
        cmd->error = (unsigned int )(vub300->command_res_urb)->status;
      } else {
        cmd->error = 4294967188U;
      }
    } else
...
{ u8 cmd0 ;
  ...
  if ((((int )rf->command_byte[0] == (int )cmd0 && (int )rf->command_byte[1] == (int )cmd1) && (int )rf->command_byte[2] == (int )cmd2) && (int )rf->command_byte[3] == (int )cmd3) {
    ...
    (vub300->fn[(int )Function].offload_point) ++;
    ...
    if ((((int )r->command_byte[0] == (int )cmd0 && (int )r->command_byte[1] == (int )cmd1) && (int )r->command_byte[2] == (int )cmd2) && (int )r->command_byte[3] == (int )cmd3) {
      ...
      vub300->fn[(int )Function].offload_point += (u32 )delta;
...
{ struct vub300_mmc_host *vub300 ;
  ...
  mmc->ocr_avail |= 4096U;
  mmc->ocr_avail |= 8192U;
  mmc->ocr_avail |= 16384U;
  mmc->ocr_avail |= 32768U;
  mmc->ocr_avail |= 65536U;
  mmc->ocr_avail |= 131072U;
  mmc->ocr_avail |= 262144U;
  mmc->ocr_avail |= 524288U;
  mmc->ocr_avail |= 1048576U;
  mmc->ocr_avail |= 2097152U;
  mmc->ocr_avail |= 4194304U;
  mmc->ocr_avail |= 8388608U;
  ...
  if (tmp___6 == 0) {
    ...
    if (tmp___4 != 0) {
      tmp___5 = (char *)"BULK OUT";
    } else {
      tmp___5 = (char *)"UNKNOWN";
    }
  } else {
  ...
  if ((((unsigned int )vub300->cmnd_res_ep != 0U && (unsigned int )vub300->cmnd_out_ep != 0U) && (unsigned int )vub300->data_inp_ep != 0U) && (unsigned int )vub300->data_out_ep != 0U) {
    ...
    _dev_info((struct device  const  *)(& (vub300->udev)->dev), "vub300 %s packets using EndPoints %02X %02X %02X %02X\n",
              tmp___14, (int )vub300->cmnd_out_ep, (int )vub300->cmnd_res_ep, (int )vub300->data_out_ep,
  ...
  if ((int )pad_input_to_usb_pkt) {
    tmp___16 = (char *)"padding input data to";
  } else {
    tmp___16 = (char *)"with";
  }
  if ((int )mmc->caps & 1) {
  ...
  _dev_info((struct device  const  *)(& (vub300->udev)->dev), "operating_mode = %s %s %d MHz %s %d byte USB packets\n",
            tmp___18, tmp___17, mmc->f_max / 1000000U, tmp___16, tmp___15);
...
{ struct mmc_host *var_group1 ;
  ...
  if (ldv_s_vub300_driver_usb_driver == 0) {
    ...
    ldv_s_vub300_driver_usb_driver ++;
  }
  goto ldv_29699;
  case 6: ;
