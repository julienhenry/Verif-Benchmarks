...
{ unsigned long __cil_tmp2 ;
 ...
 static bool pm_runtime_enabled(struct device *dev )  __attribute__((__no_instrument_function__)) ;
 static bool pm_runtime_enabled(struct device *dev )  __attribute__((__no_instrument_function__)) ;
...
static int wl1271_probe(struct sdio_func *func ,
                        struct sdio_device_id  const  *id )  __attribute__((__section__(".devinit.text"),
...
{ struct sdio_func *func ;
  ...
  while (1) {
    ...
    while (1) {
      ...
      if (tmp___9) {
        ...
        __cil_tmp34 = __cil_tmp33 + 2428UL;
  ...
  __cil_tmp38 = __cil_tmp37 + 2428UL;
  if (*((bool *)__cil_tmp38)) {
...
static int wl1271_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
