...
static int xc2028_get_reg(struct xc2028_data *priv ,
                          u16 reg , u16 *val ) 
...
{ struct xc2028_data *priv ;
 ...
 static int do_tuner_callback(struct dvb_frontend *fe , int cmd , int arg ) 
{ struct xc2028_data *priv ;
  int tmp ;
  int tmp___0 ;
  void *tmp___1 ;
  ...
  if ((unsigned long )fe->callback != (unsigned long )((int (*)(void * , int  , int  ,
                                                                int  ))0)) {
    if ((unsigned long )fe->dvb != (unsigned long )((struct dvb_adapter *)0) && (unsigned long )(fe->dvb)->priv != (unsigned long )((void *)0)) {
      tmp___1 = (fe->dvb)->priv;
    } else {
      tmp___1 = (priv->i2c_props.adap)->algo_data;
    }
    tmp = (*(fe->callback))(tmp___1, 0, cmd, arg);
    tmp___0 = tmp;
  } else {
    tmp___0 = -22;
  }
...
{ struct xc2028_data *priv ;
  ...
  *(buf + 0) = *p;
  ...
  goto ldv_25018;
  ldv_25017: 
  if ((int )size < priv->ctrl.max_len + -1) {
    len = (int )size;
  } else {
    len = priv->ctrl.max_len + -1;
  }
  __len = (size_t )len;
...
{ struct dtv_frontend_properties *c ;
  ...
  if (bw <= 7000000U) {
    ...
    if ((unsigned int )*((unsigned char *)priv + 108UL) != 0U && (unsigned int )*((unsigned char *)priv + 108UL) != 0U) {
      tmp___2 = 256U;
    } else {
      tmp___2 = 128U;
    }
...
{ struct dvb_frontend *fe ;
  ...
  if (debug != 0) {
    ...
    printk("\017%s %d-%04x: request_firmware_nowait(): %s\n", priv->i2c_props.name,
           tmp___0, (int )priv->i2c_props.addr, tmp___3);
  }
  if ((unsigned long )fw == (unsigned long )((struct firmware  const  *)0)) {
    if ((unsigned long )priv->i2c_props.adap != (unsigned long )((struct i2c_adapter *)0)) {
      tmp___1 = i2c_adapter_id(priv->i2c_props.adap);
