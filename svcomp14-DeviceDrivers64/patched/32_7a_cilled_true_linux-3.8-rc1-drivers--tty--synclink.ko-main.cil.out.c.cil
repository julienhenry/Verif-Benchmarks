...
{ int tmp ;
 ...
 static int irq_canonicalize(int irq___0 ) 
{ int tmp ;
...
{ 
 ...
 static int mgsl_paranoia_check(struct mgsl_struct *info , char *name , char const   *routine ) 
{ 
...
{ struct mgsl_struct *info ;
 ...
 static void line_info(struct seq_file *m , struct mgsl_struct *info ) 
{ char stat_buf[30U] ;
  unsigned long flags ;
  raw_spinlock_t *tmp ;
  raw_spinlock_t *tmp___0 ;
...
{ unsigned int i ;
  ...
  info->tx_buffer_list += (unsigned long )info->rx_buffer_count;
  i = 0U;
  goto ldv_42298;
  ldv_42297: 
  ...
  if (info->rx_buffer_count - 1U > i) {
    (info->rx_buffer_list + (unsigned long )i)->link += (i + 1U) * 40U;
  }
  i ++;
  ldv_42298: ;
  ...
  if (info->tx_buffer_count - 1U > i) {
    (info->tx_buffer_list + (unsigned long )i)->link += (i + 1U) * 40U;
  }
  i ++;
  ldv_42301: ;
...
{ unsigned short Copycount ;
  ...
  Buffer += (unsigned long )Copycount;
