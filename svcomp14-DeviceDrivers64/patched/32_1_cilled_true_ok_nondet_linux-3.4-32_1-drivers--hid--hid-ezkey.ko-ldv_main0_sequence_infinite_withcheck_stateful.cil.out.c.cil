...
static int ez_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__hid_register_driver(& ez_driver, & __this_module, "hid_ezkey");
  tmp = tmp___0;
  return (tmp);
}
}
