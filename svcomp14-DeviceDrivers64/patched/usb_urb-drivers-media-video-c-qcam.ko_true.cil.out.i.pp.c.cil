...
{ int tmp___7 ;
  ...
  {
  tmp___8 = (int )__video_register_device(vdev, type, nr, 1, (struct module *)(vdev->fops)->owner);
  tmp = tmp___8;
  tmp___7 = tmp;
  return (tmp___7);
}
...
{ unsigned int idata ;
  ...
  idata |= (unsigned int )((int )tmp___10 >> 4);
  return ((int )idata);
}
}
...
{ struct v4l2_device *v4l2_dev ;
  ...
  while (1) {
    ...
    if (outptr < len) {
      ...
      tmp___24 = (int )__copy_to_user((void *)(buf + outptr), (void const   *)(tmpbuf),
                                      (unsigned int )sz);
      tmp = tmp___24;
      tmp___17 = tmp;
      if (tmp___17) {
...
{ struct qcam *qcam ;
  ...
  tmp___11 = (int )v4l2_device_register((struct device *)((void *)0), v4l2_dev);
  tmp = tmp___11;
  tmp___8 = tmp;
  if (tmp___8 < 0) {
...
{ struct qcam *qcam ;
  ...
  qc_setup(qcam);
  parport_release(qcam->pdev);
  tmp___11 = (int )video_register_device(& qcam->vdev, 0, video_nr);
  tmp = tmp___11;
  tmp___8 = tmp;
  if (tmp___8 < 0) {
...
static int cqcam_init(void)  __attribute__((__section__(".init.text"),
