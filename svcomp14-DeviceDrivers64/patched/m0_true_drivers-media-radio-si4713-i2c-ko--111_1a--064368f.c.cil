...
{ int sz ;
 ...
 static unsigned long ldv_copy_from_user_7(void *to , void const   *from ,
                                                   unsigned long n ) ;
...
{ void *tmp ;
 ...
 static int gpio_is_valid(int number ) 
{ 
...
static int si4713_send_command(struct si4713_device *sdev , u8 command , u8 const   *args ,
                               int argn , u8 *response , int respn , int usecs ) 
...
static int si4713_wait_stc(struct si4713_device *sdev , int usecs ) 
{ int err ;
  u8 resp[1U] ;
  unsigned long tmp ;
  unsigned long tmp___0 ;
...
static struct i2c_device_id  const  si4713_id[2U]  = {      {{'s', 'i', '4', '7', '1', '3', '\000', (char)0, (char)0, (char)0, (char)0, (char)0,
