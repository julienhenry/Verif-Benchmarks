...
static struct device_attribute mISDN_dev_attrs[8U]  = 
  {      {{"id", 292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0},
      ...
      (ssize_t (*)(struct device * , struct device_attribute * , char * ))0, (ssize_t (*)(struct device * ,
                                                                                          ...
                                                                                          char const   * ,
                                                                                          size_t  ))0}};
static int mISDN_uevent(struct device *dev ,
...
{ struct mISDN_sock *msk ;
  ...
  msk = (struct mISDN_sock *)__mptr + 1152921504606845704UL;
  if ((*debug___0 & 4U) != 0U) {
...
{ struct sock *sk ;
  ...
  if (optname == 1) {
    ...
    if (0) {
      ...
      if (opt != 0) {
        ((struct mISDN_sock *)sk)->cmask |= 1U;
      } else {
        ((struct mISDN_sock *)sk)->cmask &= 4294967294U;
      }
      goto ldv_38559;
      switch_default___0: 
      err = -92;
...
{ struct sockaddr_mISDN *maddr ;
  ...
  if ((unsigned int )sk->sk_protocol <= 31U) {
    ...
    if ((unsigned long )node != (unsigned long )((struct hlist_node *)0)) {
      ...
      csk = (struct sock *)__mptr + 1152921504606846920UL;
      goto ldv_38608;
    }
    ldv_38610: 
    _raw_read_unlock_bh(& data_sockets.lock);
...
static struct proto_ops  const  base_sock_ops  = 
    ...
    & sock_no_recvmsg, & sock_no_mmap, (ssize_t (*)(struct socket * , struct page * ,
                                                    int  , size_t  , int  ))0, (ssize_t (*)(struct socket * ,
                                                                                            ...
                                                                                            size_t  ,
                                                                                            unsigned int  ))0};
static int base_sock_create(struct net *net ,
...
{ struct dchannel *dch ;
  ...
  dch = (struct dchannel *)__mptr + 1152921504606845720UL;
...
{ struct bchannel *bch ;
  ...
  {
  __mptr = (struct work_struct  const  *)ws;
  bch = (struct bchannel *)__mptr + 1152921504606846880UL;
...
{ struct hlist_node *node ;
  ...
  if ((unsigned long )node != (unsigned long )((struct hlist_node *)0)) {
    __mptr = (struct hlist_node  const  *)node;
    sk = (struct sock *)__mptr + 1152921504606846920UL;
    goto ldv_38447;
  }
  ldv_38446: 
...
{ struct layer2 *l2 ;
  ...
  {
  __mptr = (struct mISDNchannel  const  *)ch;
  l2 = (struct layer2 *)__mptr + 1152921504606846960UL;
  hh = (struct mISDNhead *)(& skb->cb);
  ret = -22;
  if ((*debug___4 & 524288U) != 0U) {
...
static struct Fsm teifsmu  =    {(FSMFNPTR (**)(struct FsmInst * ,
                   int  , void * ))0, 0, 0, (char **)0, (char **)0};
...
static void da_debug(struct FsmInst *fi ,
                     char *fmt  , ...) 
{ struct manager *mgr ;
  struct va_format vaf ;
  va_list va ;
...
{ struct manager *mgr ;
  ...
  {
  __mptr = (struct mISDNchannel  const  *)ch;
  mgr = (struct manager *)__mptr + 1152921504606846896UL;
  hh = (struct mISDNhead *)(& skb->cb);
  cskb = (struct sk_buff *)0;
  flags = _raw_read_lock_irqsave(& mgr->lock);
  __mptr___0 = (struct list_head  const  *)mgr->layer2.next;
  ...
  if (tmp == 5) {
    ...
    if (0) {
      ...
      if (ldv_s_mISDN_fops_file_operations == 0) {
        ...
        ldv_s_mISDN_fops_file_operations ++;
      }
      goto ldv_38586;
      case_1: ;
