...
{ int result ;
  ...
  if (tmp___8) {
    ...
    tmp___11 = (long )PTR_ERR(__cil_tmp28);
    tmp___7 = tmp___11;
    result = (int )tmp___7;
    goto end;
  }
  ...
  *((void **)__cil_tmp41) = (void *)cdev;
  ...
  tmp___12 = (int )sysfs_create_link(__cil_tmp45, __cil_tmp49, "thermal_cooling");
  result = tmp___12;
  if (result) {
    __cil_tmp50 = (unsigned long )device;
    __cil_tmp51 = __cil_tmp50 + 944UL;
  ...
  tmp___13 = (int )sysfs_create_link(__cil_tmp57, __cil_tmp61, "device");
  result = tmp___13;
  if (result) {
    __cil_tmp62 = (unsigned long )device;
    __cil_tmp63 = __cil_tmp62 + 944UL;
