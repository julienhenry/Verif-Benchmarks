...
static struct device_attribute dev_attr_in0_input  =    {{"in0_input", (umode_t )292}, & show_in0_input, (ssize_t (*)(struct device *dev ,
                                                                 ...
                                                                 char const   *buf ,
                                                                 size_t count ))((void *)0)};
static ssize_t show_in1_input(struct device *dev ,
...
static struct device_attribute dev_attr_in1_input  =    {{"in1_input", (umode_t )292}, & show_in1_input, (ssize_t (*)(struct device *dev ,
                                                                 ...
                                                                 char const   *buf ,
                                                                 size_t count ))((void *)0)};
static ssize_t show_in2_input(struct device *dev ,
                              struct device_attribute *attr , char *buf ) 
{ int tmp___7 ;
  int tmp___8 ;
...
static struct device_attribute dev_attr_in2_input  =    {{"in2_input", (umode_t )292}, & show_in2_input, (ssize_t (*)(struct device *dev ,
                                                                 ...
                                                                 char const   *buf ,
                                                                 size_t count ))((void *)0)};
static ssize_t show_in3_input(struct device *dev ,
                              struct device_attribute *attr , char *buf ) 
{ int tmp___7 ;
  int tmp___8 ;
...
{ struct pcf8591_data *data ;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp15, & pcf8591_attr_group);
  err = tmp;
  if (err) {
    goto exit_kfree;
  }
  ...
  *((struct device **)data) = hwmon_device_register(__cil_tmp30);
  ...
  if (tmp___9) {
    ...
    tmp___11 = (long )PTR_ERR(__cil_tmp34);
    tmp___8 = tmp___11;
    err = (int )tmp___8;
    goto exit_sysfs_remove;
  }
    ...
    if (tmp___8 == 1) {
      ...
      if (0) {
        ...
        if (ldv_s_pcf8591_driver_i2c_driver == 0) {
          ...
          ldv_s_pcf8591_driver_i2c_driver ++;
        }
        goto switch_break;
        case_1: 
