...
enum xp_retval (*xp_remote_memcpy)(unsigned long  , unsigned long  , size_t  )  ;
...
{ enum xp_retval ret ;
  ...
  goto ldv_15344;
  ldv_15343: 
  __cil_tmp5 = (unsigned long )ch_number * 200UL;
...
{ int tmp ;
  ...
  enum xp_retval (**__cil_tmp10)(unsigned long  , unsigned long  , size_t  ) ;
  int (**__cil_tmp11)(int  ) ;
