...
{ struct ata_port_info info ;
  ...
  *((unsigned long *)__cil_tmp8) = 1UL;
  __cil_tmp9 = (unsigned long )(& info) + 8UL;
  *((unsigned long *)__cil_tmp9) = 0UL;
  __cil_tmp10 = (unsigned long )(& info) + 16UL;
  *((unsigned long *)__cil_tmp10) = 31UL;
  __cil_tmp11 = (unsigned long )(& info) + 24UL;
  *((unsigned long *)__cil_tmp11) = 7UL;
  __cil_tmp12 = (unsigned long )(& info) + 32UL;
  *((unsigned long *)__cil_tmp12) = 63UL;
  __cil_tmp13 = (unsigned long )(& info) + 40UL;
  *((struct ata_port_operations **)__cil_tmp13) = & marvell_ops;
  __cil_tmp14 = (unsigned long )(& info) + 48UL;
  *((void **)__cil_tmp14) = (void *)0;
  __cil_tmp15 = & info_sata;
  *((unsigned long *)__cil_tmp15) = 1UL;
  __cil_tmp16 = (unsigned long )(& info_sata) + 8UL;
  *((unsigned long *)__cil_tmp16) = 0UL;
  __cil_tmp17 = (unsigned long )(& info_sata) + 16UL;
  *((unsigned long *)__cil_tmp17) = 31UL;
  __cil_tmp18 = (unsigned long )(& info_sata) + 24UL;
  *((unsigned long *)__cil_tmp18) = 7UL;
  __cil_tmp19 = (unsigned long )(& info_sata) + 32UL;
  *((unsigned long *)__cil_tmp19) = 127UL;
  __cil_tmp20 = (unsigned long )(& info_sata) + 40UL;
  *((struct ata_port_operations **)__cil_tmp20) = & marvell_ops;
  __cil_tmp21 = (unsigned long )(& info_sata) + 48UL;
