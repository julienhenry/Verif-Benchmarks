...
static u8 scale_in_add[10U]  = 
  {      0U,      0U,      0U,      0U, 
        0U,      0U,      0U,      150U, 
        150U,      0U};
 static unsigned long FAN_FROM_REG(u16 val ) 
{ 
...
{ long __val ;
 ...
 static unsigned long TIME_FROM_REG(u8 reg ) 
{ 
 ...
 static u8 TIME_TO_REG(unsigned long val ) 
{ unsigned long __val ;
  unsigned long __min ;
  unsigned long __max ;
  unsigned long tmp ;
 ...
 static long TEMP_FROM_REG(s8 reg ) 
{ 
 ...
 static s8 TEMP_TO_REG(long val , s8 min , s8 max ) 
{ long __val ;
  long __min ;
  long __max ;
  long tmp ;
...
{ struct i2c_client *client ;
  ...
  if (nr == 3) {
    ...
    tmp___1 = w83793_read_value(client, (int )(tmp___4 + (unsigned int )((u16 )index)));
    ...
    w83793_write_value(client, (int )(tmp___6 + (unsigned int )((u16 )index)), (int )data->pwm[index][nr]);
  }
...
{ struct w83793_data *data ;
  ...
  if (index <= 3) {
    ...
    shift = (unsigned int )((u8 )index) + 252U;
  }
  index = index > 3;
...
{ struct sensor_device_attribute_2 *sensor_attr ;
  ...
  if (nr == 0) {
    ...
    data->pwm_default = (u8 )((int )((signed char )data->pwm_default) | (int )((signed char )(tmp___3 >> 2)));
...
{ struct sensor_device_attribute_2 *sensor_attr ;
  ...
  if (nr == 2) {
    ...
    val = (u32 )((int )data->tolerance[index >> 1] >> tmp___3);
...
{ struct sensor_device_attribute_2 *sensor_attr ;
  ...
  if (index > 2) {
    if (nr == 1 || nr == 2) {
      val -= (unsigned long )((int )scale_in_add[index] / (int )scale_in[index]);
    }
    __val = val;
    __min = 0UL;
    __max = 255UL;
...
static struct sensor_device_attribute_2 sda_single_files[6U]  = {      {{{"intrusion0_alarm",
        420U, (_Bool)0, 0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0}, {(char)0},
                             {(char)0}, {(char)0}, {(char)0}}}}, & show_alarm_beep,
...
{ struct watchdog_info ident ;
  ...
  goto ldv_24075;
  case 2147768065U: 
  if (data->watchdog_caused_reboot != 0U) {
    val = 32;
  } else {
    val = 0;
  }
...
{ struct device *dev ;
  ...
  snprintf((char *)(& data->watchdog_name), 10UL, "watchdog%c", tmp___11);
...
{ struct i2c_client *var_group1 ;
  ...
  if (ldv_s_w83793_driver_i2c_driver == 0) {
    ...
    ldv_s_w83793_driver_i2c_driver ++;
  }
  goto ldv_24485;
  case 1: ;
