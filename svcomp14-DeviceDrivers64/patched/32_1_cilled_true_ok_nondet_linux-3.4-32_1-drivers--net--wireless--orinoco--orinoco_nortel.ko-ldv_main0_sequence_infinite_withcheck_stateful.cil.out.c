...
{ struct orinoco_private *priv ;
  ...
  tmp___8 = (int )request_irq(__cil_tmp15, & orinoco_interrupt, 128UL, __cil_tmp21,
                              __cil_tmp22);
  err = tmp___8;
  if (err) {
    __cil_tmp23 = 0UL;
...
{ int err ;
  ...
  tmp___0 = (int )pci_request_regions(pdev, "orinoco_nortel");
  err = tmp___0;
  if (err) {
  ...
  *((void **)__cil_tmp17) = attr_io;
  ...
  tmp___1 = (int )request_irq(__cil_tmp23, & orinoco_interrupt, 128UL, "orinoco_nortel",
                              __cil_tmp24);
  err = tmp___1;
  if (err) {
    __cil_tmp25 = (unsigned long )pdev;
    __cil_tmp26 = __cil_tmp25 + 916UL;
...
{ int tmp___7 ;
  ...
  printk("<7>%s\n", __cil_tmp4);
  tmp = (int )__pci_register_driver(& orinoco_nortel_driver, & __this_module, "orinoco_nortel");
  tmp___7 = tmp;
  return (tmp___7);
}
}
