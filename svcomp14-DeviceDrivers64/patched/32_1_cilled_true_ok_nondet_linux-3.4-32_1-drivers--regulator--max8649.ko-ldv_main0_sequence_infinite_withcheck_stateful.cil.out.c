...
extern int regmap_update_bits(struct regmap *map , unsigned int reg , unsigned int mask ,
                              unsigned int val ) ;
 static int check_range(int min_uV , int max_uV )  __attribute__((__no_instrument_function__)) ;
 static int check_range(int min_uV , int max_uV )  __attribute__((__no_instrument_function__)) ;
...
{ struct max8649_platform_data *pdata ;
  ...
  *((struct regmap **)__cil_tmp23) = regmap_init_i2c(client, __cil_tmp24);
  ...
  if (tmp___9) {
    ...
    tmp___12 = (long )PTR_ERR(__cil_tmp32);
    tmp___8 = tmp___12;
    ret = (int )tmp___8;
  ...
  *((struct regulator_dev **)info) = regulator_register(& dcdc_desc, __cil_tmp115,
  ...
  tmp___13 = (long )IS_ERR(__cil_tmp122);
  tmp___11 = tmp___13;
  if (tmp___11) {
    ...
    tmp___14 = (long )PTR_ERR(__cil_tmp130);
    tmp___10 = tmp___14;
    ret = (int )tmp___10;
    goto out;
  }
