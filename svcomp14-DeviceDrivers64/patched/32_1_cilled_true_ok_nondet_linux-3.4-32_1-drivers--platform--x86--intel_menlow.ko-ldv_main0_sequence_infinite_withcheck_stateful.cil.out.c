...
{ struct acpi_device *device ;
  ...
  *((u32 *)__cil_tmp14) = (u32 )1;
  __cil_tmp15 = (unsigned long )(& arg_list) + 8UL;
...
{ struct acpi_device *device ;
  ...
  *((u32 *)__cil_tmp18) = (u32 )1;
  __cil_tmp19 = (unsigned long )(& arg_list) + 8UL;
...
{ int result ;
  ...
  *((void **)__cil_tmp22) = (void *)cdev;
  ...
  tmp___10 = (int )sysfs_create_link(__cil_tmp26, __cil_tmp30, "thermal_cooling");
  result = tmp___10;
  if (result) {
    goto unregister;
  }
  ...
  tmp___11 = (int )sysfs_create_link(__cil_tmp34, __cil_tmp38, "device");
  result = tmp___11;
  if (result) {
    __cil_tmp39 = 960;
...
static int sensor_get_auxtrip(acpi_handle handle ,
                              int index , unsigned long long *value ) 
{ acpi_status status ;
  char const   *tmp___7 ;
...
{ acpi_status status ;
  ...
  *((u32 *)__cil_tmp11) = (u32 )1;
  __cil_tmp12 = (unsigned long )(& args) + 8UL;
