...
static int tdo24m_writes(struct tdo24m *lcd ,
                         uint32_t *array ) 
...
{ struct tdo24m *lcd ;
  ...
  __cil_tmp17 = __cil_tmp16 + 782UL;
  *((u8 *)__cil_tmp17) = (u8 )8;
  __cil_tmp18 = (unsigned long )spi;
  __cil_tmp19 = __cil_tmp18 + 781UL;
  *((u8 *)__cil_tmp19) = (u8 )3;
  err = spi_setup(spi);
  if (err) {
    return (err);
  ...
  *((struct lcd_device **)__cil_tmp55) = lcd_device_register("tdo24m", __cil_tmp56,
  ...
  if (tmp___10) {
    ...
    tmp___11 = (long )PTR_ERR(__cil_tmp65);
    tmp___9 = tmp___11;
    err = (int )tmp___9;
    goto out_free;
  }
...
static int tdo24m_driver_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
