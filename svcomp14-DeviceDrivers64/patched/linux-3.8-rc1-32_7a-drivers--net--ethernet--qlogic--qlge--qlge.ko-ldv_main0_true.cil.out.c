...
{ int i ;
  ...
  if (tmp___0 != 0) {
    ...
    status = request_irq(pdev->irq, & qlge_isr, tmp___1, (char const   *)(& intr_context->name),
                         (void *)(& qdev->rx_ring));
    if (status != 0) {
      goto err_irq;
    }
...
{ u32 value ;
  ...
  end_jiffies = tmp___1 + (unsigned long )jiffies;
...
{ struct ql_adapter *qdev ;
  ...
  if (pdev->resource[1].start != 0ULL || pdev->resource[1].end != pdev->resource[1].start) {
    tmp___3 = (unsigned long )((pdev->resource[1].end - pdev->resource[1].start) + 1ULL);
  } else {
    tmp___3 = 0UL;
  }
  qdev->reg_base = ioremap_nocache(pdev->resource[1].start, tmp___3);
  if ((unsigned long )qdev->reg_base == (unsigned long )((void *)0)) {
  ...
  if (pdev->resource[3].start != 0ULL || pdev->resource[3].end != pdev->resource[3].start) {
    tmp___4 = (unsigned long )((pdev->resource[3].end - pdev->resource[3].start) + 1ULL);
  } else {
    tmp___4 = 0UL;
  }
  qdev->doorbell_area = ioremap_nocache(pdev->resource[3].start, tmp___4);
  if ((unsigned long )qdev->doorbell_area == (unsigned long )((void *)0)) {
...
{ struct net_device *ndev ;
  ...
  ndev = alloc_etherdev_mqs(19744, (unsigned int )tmp___4, (unsigned int )tmp___3);
...
{ struct ql_adapter *var_group1 ;
  ...
  if (ldv_s_qlge_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_qlge_netdev_ops_net_device_ops ++;
  }
  goto ldv_49906;
  case 5: ;
