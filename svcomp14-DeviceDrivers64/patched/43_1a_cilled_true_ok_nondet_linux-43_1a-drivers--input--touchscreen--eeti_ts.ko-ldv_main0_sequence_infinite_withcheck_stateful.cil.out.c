...
{ struct eeti_ts_platform_data *pdata ;
  ...
  *((struct input_dev **)__cil_tmp51) = input;
  ...
  __cil_tmp53 = __cil_tmp52 + 264UL;
  __cil_tmp54 = (unsigned long )client;
  __cil_tmp55 = __cil_tmp54 + 1192UL;
