...
{ struct sensor_device_attribute *sensor_attr ;
  ...
  data->beep_mask &= (u32 )(~ (255 << bytenr * 8));
  tmp___0 = w83791d_read(client, (int )W83791D_REG_BEEP_CTRL[bytenr]);
  data->beep_mask |= (u32 )(tmp___0 << bytenr * 8);
  data->beep_mask &= (u32 )(~ (1 << bitnr));
  data->beep_mask |= (u32 )(val << bitnr);
...
{ struct i2c_client *client ;
  ...
  data->beep_mask |= (u32 )((int )data->beep_enable << 15);
