...
{ struct tsc_ser *ptsc ;
  ...
  *((unsigned long *)__cil_tmp44) = __cil_tmp46 | __cil_tmp45;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp57);
  error = tmp___0;
  if (error) {
    goto fail3;
  }
...
static int tsc_ser_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& tsc_drv, & __this_module, "tsc40");
  tmp = tmp___0;
  return (tmp);
}
}
