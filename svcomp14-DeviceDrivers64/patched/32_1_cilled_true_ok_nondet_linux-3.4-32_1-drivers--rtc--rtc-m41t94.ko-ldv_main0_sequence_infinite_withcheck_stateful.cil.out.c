...
static int m41t94_set_time(struct device *dev ,
                           struct rtc_time *tm ) 
{ struct spi_device *spi ;
  struct spi_device *tmp___7 ;
  u8 buf[8] ;
...
__section__("__verbose")))  =    {"rtc_m41t94", "m41t94_read_time", "/home/zakharov/launch/work/current--X--drivers/--X--defaultlinux-3.4--X--32_1--X--cpachecker/linux-3.4/csd_deg_dscv/6240/dscv_tempdir/dscv/ri/32_1/drivers/rtc/rtc-m41t94.c.common.c",
    "%s secs=%d, mins=%d, hours=%d, mday=%d, mon=%d, year=%d, wday=%d\n", 101U, 1U};
static int m41t94_read_time(struct device *dev ,
                            struct rtc_time *tm ) 
{ struct spi_device *spi ;
  struct spi_device *tmp___7 ;
  u8 buf[2] ;
  ...
  while (1) {
    ...
    while (1) {
      ...
      if (tmp___24) {
        ...
        __cil_tmp103 = __cil_tmp102 + 12UL;
...
{ struct rtc_device *rtc ;
  ...
  *((u8 *)__cil_tmp8) = (u8 )8;
  ...
  if (tmp___9) {
    ...
    tmp___10 = (long )PTR_ERR(__cil_tmp16);
    tmp___8 = tmp___10;
    return ((int )tmp___8);
  }
