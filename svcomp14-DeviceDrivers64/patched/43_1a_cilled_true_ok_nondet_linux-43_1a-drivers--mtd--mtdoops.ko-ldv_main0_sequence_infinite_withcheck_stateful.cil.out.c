...
{ struct mtd_info *mtd ;
  ...
  *((unsigned int *)__cil_tmp42) = 0U;
  __cil_tmp43 = (unsigned long )(& wait) + 8UL;
  *((void **)__cil_tmp43) = (void *)tmp___0;
  __cil_tmp44 = (unsigned long )(& wait) + 16UL;
  *((int (**)(wait_queue_t * , unsigned int  , int  , void * ))__cil_tmp44) = & default_wake_function;
  __cil_tmp45 = (unsigned long )(& wait) + 24UL;
  ...
  *((struct mtd_info **)__cil_tmp48) = mtd;
  __cil_tmp49 = (unsigned long )(& erase) + 56UL;
  *((void (**)(struct erase_info * ))__cil_tmp49) = & mtdoops_erase_callback;
  __cil_tmp50 = (unsigned long )(& erase) + 8UL;
  *((uint64_t *)__cil_tmp50) = (uint64_t )offset;
  __cil_tmp51 = (unsigned long )(& erase) + 16UL;
  ...
  *((uint64_t *)__cil_tmp51) = (uint64_t )__cil_tmp54;
  __cil_tmp55 = (unsigned long )(& erase) + 64UL;
  *((u_long *)__cil_tmp55) = (unsigned long )(& wait_q);
  ...
  if (ret != 0) {
    ...
    __cil_tmp56 = (unsigned long )(& erase) + 8UL;
    __cil_tmp57 = *((uint64_t *)__cil_tmp56);
    __cil_tmp58 = (unsigned long )(& erase) + 16UL;
...
{ struct mtdoops_context *cxt ;
  ...
  *((int *)__cil_tmp68) = (int )__cil_tmp81;
  ...
  if (ret >= 0) {
    ...
    __cil_tmp114 = __cil_tmp113 + 212UL;
  ...
  if (ret == -5) {
    ...
    __cil_tmp122 = __cil_tmp121 + 212UL;
