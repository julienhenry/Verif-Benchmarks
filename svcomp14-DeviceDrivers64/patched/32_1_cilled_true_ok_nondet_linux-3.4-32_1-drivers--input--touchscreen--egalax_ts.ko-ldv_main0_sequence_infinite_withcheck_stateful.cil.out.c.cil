...
{ struct egalax_ts *ts ;
  ...
  *((struct device **)__cil_tmp25) = (struct device *)__cil_tmp27;
  ...
  __cil_tmp48 = __cil_tmp47 + 808UL;
  __cil_tmp49 = *((int *)__cil_tmp48);
  __cil_tmp50 = (unsigned int )__cil_tmp49;
  __cil_tmp51 = (void *)0;
  __cil_tmp52 = (irqreturn_t (*)(int  , void * ))__cil_tmp51;
  __cil_tmp53 = (void *)ts;
  tmp = (int )request_threaded_irq(__cil_tmp50, __cil_tmp52, & egalax_ts_interrupt,
  ...
  tmp___8 = (int )input_register_device(__cil_tmp60);
  error = tmp___8;
  if (error) {
    goto err_free_irq;
  }
