...
static struct file_operations  const  display_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file *file ,
                                                                        ...
                                                                        loff_t offset ,
                                                                        loff_t len ))0};
static struct usb_device_id imon_usb_id_table[4]  = {      {(__u16 )3,
      (__u16 )2728, (__u16 )32769, (unsigned short)0, (unsigned short)0, (unsigned char)0,
...
{ int i ;
  ...
  tmp___12 = (long )IS_ERR((void const   *)data_buf);
  tmp = tmp___12;
  tmp___9 = tmp;
  if (tmp___9) {
    tmp___13 = (long )PTR_ERR((void const   *)data_buf);
    tmp___11 = tmp___13;
    tmp___8 = tmp___11;
    retval = (int )tmp___8;
    goto exit;
