...
{ unsigned long volatile   *amdpar ;
  ...
  *((void **)__cil_tmp22) = ioremap_nocache(__cil_tmp23, maxsize);
  ...
  iounmap(__cil_tmp47);
  __cil_tmp48 = (unsigned long )(& nettel_amd_map) + 24UL;
...
{ void volatile   *__cil_tmp1 ;
  ...
  __cil_tmp2 = (unsigned long )(& nettel_amd_map) + 24UL;
  if (*((void **)__cil_tmp2)) {
    __cil_tmp3 = (unsigned long )(& nettel_amd_map) + 24UL;
    __cil_tmp4 = *((void **)__cil_tmp3);
    __cil_tmp5 = (void volatile   *)__cil_tmp4;
    iounmap(__cil_tmp5);
    __cil_tmp6 = (unsigned long )(& nettel_amd_map) + 24UL;
