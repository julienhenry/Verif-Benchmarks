...
{ int mfr ;
  ...
  while (1) {
    ...
    __cil_tmp49 = (unsigned long )i * 48UL;
...
{ int floor ;
  ...
  *((char *)__cil_tmp18) = (char)0;
  ...
  while (1) {
    ...
    __cil_tmp51 = (unsigned long )floor * 4UL;
    ...
    *((int *)__cil_tmp52) = 0;
    ...
    while (1) {
      ...
      if (ret) {
        __cil_tmp53 = (unsigned long )floor * 4UL;
        __cil_tmp54 = (unsigned long )(numchips) + __cil_tmp53;
        __cil_tmp55 = (unsigned long )floor * 4UL;
  ...
  *((struct Nand **)__cil_tmp72) = (struct Nand *)tmp___10;
  ...
  while (1) {
    ...
    chip = 0;
    while (1) {
      __cil_tmp76 = (unsigned long )floor * 4UL;
