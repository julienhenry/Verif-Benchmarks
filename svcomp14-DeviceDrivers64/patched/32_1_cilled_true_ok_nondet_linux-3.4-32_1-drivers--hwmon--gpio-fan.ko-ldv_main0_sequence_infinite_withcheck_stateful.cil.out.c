...
{ int err ;
  ...
  *((struct gpio_fan_alarm **)__cil_tmp8) = alarm;
  ...
  tmp = (int )request_irq(__cil_tmp29, & fan_alarm_irq_handler, 128UL, "GPIO fan alarm",
                          __cil_tmp30);
  err = tmp;
  if (err) {
    goto err_free_sysfs;
...
{ struct gpio_fan_data *fan_data ;
  ...
  fan_data = (struct gpio_fan_data *)tmp;
  ret = (int )count;
  tmp___1 = (int )kstrtoul(buf, 10U, & pwm);
  tmp___0 = tmp___1;
  if (tmp___0) {
    return ((ssize_t )-22);
  } else {
...
{ struct gpio_fan_data *fan_data ;
  ...
  fan_data = (struct gpio_fan_data *)tmp;
  tmp___1 = (int )kstrtoul(buf, 10U, & val);
  tmp___0 = tmp___1;
  if (tmp___0) {
    return ((ssize_t )-22);
  } else {
...
{ struct gpio_fan_data *fan_data ;
  ...
  fan_data = (struct gpio_fan_data *)tmp;
  ret = (int )count;
  tmp___2 = (int )kstrtoul(buf, 10U, & rpm);
  tmp___0 = tmp___2;
  if (tmp___0) {
    return ((ssize_t )-22);
  }
...
static struct device_attribute dev_attr_pwm1_mode  =    {{"pwm1_mode", (umode_t )292}, & show_pwm_mode, (ssize_t (*)(struct device *dev ,
                                                                ...
                                                                char const   *buf ,
                                                                size_t count ))((void *)0)};
static struct device_attribute dev_attr_fan1_min  =    {{"fan1_min",
     (umode_t )292}, & show_rpm_min, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                                  char const   *buf , size_t count ))((void *)0)};
static struct device_attribute dev_attr_fan1_max  =    {{"fan1_max",
     (umode_t )292}, & show_rpm_max, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                                  char const   *buf , size_t count ))((void *)0)};
static struct device_attribute dev_attr_fan1_input  =    {{"fan1_input",
     (umode_t )292}, & show_rpm, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                              char const   *buf , size_t count ))((void *)0)};
static struct device_attribute dev_attr_fan1_target  =    {{"fan1_target",
     (umode_t )420}, & show_rpm, & set_rpm};
...
{ struct platform_device *pdev ;
  ...
  *((int *)__cil_tmp34) = get_fan_speed_index(fan_data);
  ...
  tmp___0 = (int )sysfs_create_group(__cil_tmp41, & gpio_fan_ctrl_group);
  err = tmp___0;
  if (err) {
    goto err_free_gpio;
  }
...
{ int err ;
  ...
  *((struct device **)__cil_tmp35) = hwmon_device_register(__cil_tmp38);
  ...
  tmp___2 = (long )IS_ERR(__cil_tmp42);
  tmp___1 = tmp___2;
  if (tmp___1) {
    ...
    tmp___3 = (long )PTR_ERR(__cil_tmp46);
    tmp___0 = tmp___3;
    err = (int )tmp___0;
...
static int gpio_fan_driver_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
    ...
    if (tmp == 3) {
      ...
      if (0) {
        ...
        if (ldv_s_gpio_fan_driver_platform_driver == 0) {
          ...
          ldv_s_gpio_fan_driver_platform_driver ++;
        }
        goto switch_break;
        case_1: 
