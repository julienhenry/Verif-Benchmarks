...
{ struct da9052_rtc *rtc ;
  ...
  *((int *)__cil_tmp19) = platform_get_irq_byname(pdev, "ALM");
  ...
  tmp___3 = (int )request_threaded_irq(__cil_tmp23, __cil_tmp25, & da9052_rtc_irq,
                                       8200UL, "ALM", __cil_tmp26);
  ret = tmp___3;
  if (ret != 0) {
