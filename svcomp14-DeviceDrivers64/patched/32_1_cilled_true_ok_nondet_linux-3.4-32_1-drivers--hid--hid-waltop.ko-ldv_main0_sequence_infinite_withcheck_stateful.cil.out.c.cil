...
{ int ret ;
  ...
  *((u8 *)__cil_tmp14) = (u8 )0;
  ...
  if (ret) {
    ...
    __cil_tmp21 = __cil_tmp20 + 6328UL;
...
static int waltop_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__hid_register_driver(& waltop_driver, & __this_module, "hid_waltop");
  tmp = tmp___0;
  return (tmp);
}
}
