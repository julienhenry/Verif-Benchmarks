...
{ int tmp ;
  ...
  tmp___1 = (int )kstrtoll(s, base, __cil_tmp6);
  tmp = tmp___1;
  return (tmp);
}
}
...
{ struct virtual_consumer_data *data ;
  ...
  data = (struct virtual_consumer_data *)tmp;
  tmp___1 = (int )kstrtol(buf, 10U, & val);
  tmp___0 = tmp___1;
  if (tmp___0 != 0) {
...
{ char *reg_id ;
  ...
  tmp___2 = (struct regulator *)regulator_get(__cil_tmp20, __cil_tmp21);
  *((struct regulator **)__cil_tmp17) = tmp___2;
  ...
  tmp___3 = (long )IS_ERR(__cil_tmp25);
  tmp___1 = tmp___3;
  if (tmp___1) {
    ...
    tmp___4 = (long )PTR_ERR(__cil_tmp29);
    tmp___0 = tmp___4;
    ret = (int )tmp___0;
  ...
  tmp___5 = (int )sysfs_create_group(__cil_tmp37, & regulator_virtual_attr_group);
  ret = tmp___5;
  if (ret != 0) {
