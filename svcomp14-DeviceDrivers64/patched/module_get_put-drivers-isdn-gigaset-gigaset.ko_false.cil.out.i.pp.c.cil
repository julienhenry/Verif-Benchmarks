...
{ unsigned long flags ;
  ...
  if ((cs->bcs + (unsigned long )i)->use_count == 0) {
    ((cs->bcs + (unsigned long )i)->use_count) ++;
...
{ struct tty_struct *var_group1 ;
  ...
  drivers.prev = tmp___1;
  tmp___2 = __VERIFIER_nondet_pointer();
  drivers.next = tmp___2;
...
{ int cid ;
  ...
  {
  if ((int )((signed char )*(s + 1152921504606846975UL)) != 59) {
    return (0);
  }
...
{ unsigned char *argv[11U] ;
  ...
  if (cs->at_state.getstring != 0) {
    ...
    goto ldv_34653;
    ldv_34652: 
    *(argv[j] + 1152921504606846975UL) = (unsigned char)0;
    j ++;
    ldv_34653: ;
    if (j < params) {
      goto ldv_34652;
...
{ unsigned long flags ;
  ...
  if (cs->cidmode == 0U) {
    cs->at_state.pending_commands |= 1024U;
...
{ int i ;
  ...
  {
  cs->at_state.pending_commands &= 4294967291U;
  cs->mode = mode;
  cs->mstate = 0;
  ...
  if ((at_state->pending_commands & 128U) != 0U) {
    at_state->pending_commands &= 4294967167U;
    at_state->pending_commands |= 256U;
    cs->commands_pending = 1;
  }
  i ++;
  ldv_34718: ;
...
{ long tmp ;
  ...
  cs->at_state.pending_commands |= 4U;
  tmp___0 = __builtin_expect((long )(((unsigned int )gigaset_debuglevel & 512U) != 0U),
                             0L);
  if (tmp___0 != 0L) {
...
{ struct bc_state *bcs ;
  ...
  ldv_34777: 
  at_state->pending_commands |= 128U;
  tmp___0 = __builtin_expect((long )(((unsigned int )gigaset_debuglevel & 512U) != 0U),
                             0L);
  if (tmp___0 != 0L) {
...
{ long tmp ;
  ...
  if (cs->mstate == 5) {
    cs->mstate = 3;
    cs->at_state.pending_commands |= 32U;
    tmp = __builtin_expect((long )(((unsigned int )gigaset_debuglevel & 512U) != 0U),
                           0L);
    if (tmp != 0L) {
...
{ int i ;
  ...
  if (channel < 0) {
    ...
    (cs->bcs + (unsigned long )channel)->at_state.pending_commands |= 128U;
  }
  schedule_init(cs, 1);
  return (1);
}
...
{ struct at_state_t *at_state ;
  ...
  if (action == 50) {
    ...
    if (0) {
      ...
      spin_unlock_irqrestore(& cs->lock, flags);
      cs->at_state.pending_commands |= 512U;
      tmp___0 = __builtin_expect((long )(((unsigned int )gigaset_debuglevel & 512U) != 0U),
                                 0L);
      if (tmp___0 != 0L) {
      ...
      (cs->bcs + (unsigned long )channel)->at_state.pending_commands |= 2U;
      cs->commands_pending = 1;
      goto ldv_34883;
      case_12: 
      cs->cur_at_seq = 0;
      ...
      if (ev->parameter > 0) {
        if (ev->parameter <= 65535) {
          ...
          (cs->bcs + (unsigned long )channel)->at_state.pending_commands |= 1U;
          cs->commands_pending = 1;
          goto ldv_34883;
        }
      }
...
{ struct at_state_t *at_state ;
  ...
  if ((cs->at_state.pending_commands & 32U) != 0U) {
    cs->at_state.pending_commands &= 4294966783U;
    i = 0;
    goto ldv_35006;
    ldv_35005: 
    bcs = cs->bcs + (unsigned long )i;
    at_state = & bcs->at_state;
    at_state->pending_commands &= 4294967214U;
    if (at_state->cid > 0) {
      at_state->pending_commands |= 2U;
    }
    if ((at_state->pending_commands & 128U) != 0U) {
  ...
  spin_unlock_irqrestore(& cs->lock, flags);
  cs->at_state.pending_commands &= 4294966271U;
  if (sequence != 0) {
  ...
  if ((bcs->at_state.pending_commands & 2U) != 0U) {
    bcs->at_state.pending_commands &= 4294967293U;
    if ((bcs->at_state.pending_commands & 128U) != 0U) {
      bcs->at_state.pending_commands |= 256U;
      bcs->at_state.pending_commands &= 4294967167U;
    } else {
  ...
  if ((bcs->at_state.pending_commands & 256U) != 0U) {
    bcs->at_state.pending_commands &= 4294967039U;
    cs->curchannel = bcs->channel;
    schedule_sequence(cs, & cs->at_state, 350);
    return;
  } else
  if ((bcs->at_state.pending_commands & 8U) != 0U) {
    bcs->at_state.pending_commands &= 4294967287U;
    cs->curchannel = bcs->channel;
  ...
  if ((at_state->pending_commands & 2U) != 0U) {
    at_state->pending_commands &= 4294967293U;
  ...
  if ((cs->at_state.pending_commands & 32U) != 0U) {
    cs->at_state.pending_commands &= 4294967263U;
...
{ char *dbgline ;
  ...
  *(dbgline + ((unsigned long )(i * 3) + 2UL)) = (char)32;
  ...
  ldv_35252: 
  *(dbgline + ((unsigned long )(l * 3) + 1152921504606846975UL)) = (char)0;
  ...
  if ((unsigned int )*(data + 4UL) == 134U) {
    ...
    if ((unsigned int )*(data + 5UL) == 130U) {
      ...
      data += (unsigned long )((int )*data | ((int )*(data + 1UL) << 8));
      i = 0;
      goto ldv_35254;
      ldv_35253: 
...
{ struct cardstate *cs ;
  ...
  consume_skb(bcs->rx_skb);
  gigaset_new_rx_skb(bcs);
  cmsg->adr.adrPLCI |= (__u32 )((bcs->channel + 1) << 8);
  tmp___0 = kzalloc(56UL, 208U);
  ...
  *(commands + 1UL) = (char *)tmp___2;
  ...
  if (lbc != 0) {
    ...
    *(commands + 3UL) = (char *)tmp___7;
    ...
    strcpy(*(commands + 3UL) + ((unsigned long )l + 1152921504606846974UL), "\r");
  } else
  if (lhlc != 0) {
...
{ struct cardstate *cs ;
  ...
  bcs = cs->bcs + ((unsigned long )channel + 1152921504606846975UL);
  ...
  if ((int )cmsg->Reject == 1) {
    ...
    if (0) {
      ...
      tmp___1 = gigaset_add_event(cs, & (cs->bcs + ((unsigned long )channel + 1152921504606846975UL))->at_state,
                                  -114, (void *)0, 0, (void *)0);
      if ((unsigned long )tmp___1 == (unsigned long )((struct event_t *)0)) {
        return;
      }
      ...
      _dev_info((struct device  const  *)cs->dev, "%s: Reject=%x\n", (char *)"CONNECT_RESP",
                (int )cmsg->Reject);
      tmp___5 = gigaset_add_event(cs, & (cs->bcs + ((unsigned long )channel + 1152921504606846975UL))->at_state,
                                  -116, (void *)0, 0, (void *)0);
...
static struct __anonstruct_capi_send_handler_table_202 capi_send_handler_table[24U]  = 
 ...
 static capi_send_handler_t lookup_capi_send_handler(u16 cmd ) 
{ size_t i ;
  ...
  goto ldv_35724;
  ldv_35723: ;
  if ((int )capi_send_handler_table[i].cmd == (int )cmd) {
