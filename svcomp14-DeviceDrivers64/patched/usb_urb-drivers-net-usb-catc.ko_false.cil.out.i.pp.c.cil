...
{ 
  ...
  {
  return ((void *)((char *)dev + ((sizeof(struct net_device ) + 31UL) & 1152921504606846944UL)));
}
}
    ...
    if (tmp___8 == 9) {
      ...
      if (0) {
        ...
        if (ldv_s_catc_netdev_ops_net_device_ops == 0) {
          ...
          ldv_s_catc_netdev_ops_net_device_ops ++;
        }
        goto switch_break;
        case_3: 
