...
{ struct ihex_binrec  const  *rec ;
  ...
  while (1) {
    ...
    ofs += ((sizeof(*rec) + (unsigned long )((int )tmp___8)) + 3UL) & 1152921504606846972UL;
  }
...
{ struct usb_serial_port *port ;
  ...
  if ((int )cmd == 21534) {
    ...
    if (0) {
      ...
      tmp___8 = (int )copy_to_user(user_arg, (void const   *)(& serstruct), (unsigned int )sizeof(serstruct));
      tmp = tmp___8;
      tmp___7 = tmp;
      if (tmp___7) {
        return (-14);
    ...
    if (tmp___8 == 17) {
      ...
      if (0) {
        ...
        if (ldv_s_whiteheat_device_usb_serial_driver == 0) {
          ...
          ldv_s_whiteheat_device_usb_serial_driver ++;
        }
        goto switch_break;
        case_3: 
