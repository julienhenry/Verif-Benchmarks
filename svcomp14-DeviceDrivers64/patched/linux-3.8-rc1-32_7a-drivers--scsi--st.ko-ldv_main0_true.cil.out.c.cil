...
{ int tmp ;
 ...
 static void SetPageDirty(struct page *page ) 
{ 
...
extern void blk_put_queue(struct request_queue * ) ;
 static unsigned short queue_max_segments(struct request_queue *q ) 
{ 
 ...
 static int queue_dma_alignment(struct request_queue *q ) 
{ int tmp ;

  {
  if ((unsigned long )q != (unsigned long )((struct request_queue *)0)) {
    tmp = (int )q->dma_alignment;
  } else {
    tmp = 511;
  }
  return (tmp);
...
extern void idr_remove(struct idr * , int  ) ;
 static void idr_preload_end(void) 
{ struct thread_info *tmp ;
 ...
 static void *idr_find(struct idr *idr , int id ) 
{ struct idr_layer *hint ;
...
static int sgl_map_user_pages(struct st_buffer *STbp , unsigned int max_pages , unsigned long uaddr ,
                              size_t count , int rw ) ;
static int sgl_unmap_user_pages(struct st_buffer *STbp , unsigned int nr_pages , int dirtied ) ;
...
{ struct st_reject_data *rp ;
 ...
 static char *tape_name(struct scsi_tape *tape ) 
{ 
...
{ u8 const   *ucp ;
  ...
  if (s->have_sense != 0) {
    ...
    if ((unsigned long )ucp != (unsigned long )((u8 const   *)0)) {
      s->flags = (unsigned int )((u8 )*(ucp + 3UL)) & 224U;
    } else {
      s->flags = 0U;
    }
    goto ldv_32469;
...
{ int i ;
  ...
  if ((unsigned int )STbp->do_dio == 0U) {
    if (STp->block_size != 0) {
      if (st_fixed_buffer_size > STp->block_size) {
        bufsize = st_fixed_buffer_size;
      } else {
        bufsize = STp->block_size;
      }
    } else {
      bufsize = (int )count;
...
{ ssize_t total ;
  ...
  count -= (unsigned long )do_count;
  b_point += (unsigned long )do_count;
  ...
  if (STbp->syscall_result != 0) {
    ...
    if (cmdstatp->have_sense != 0 && ((int )cmdstatp->flags & 64) != 0) {
      ...
      if ((ssize_t )undone <= do_count) {
        ...
        b_point += - ((unsigned long )undone);
        do_count -= (ssize_t )undone;
        if (STp->block_size != 0) {
...
{ ssize_t total ;
  ...
  if (STbp->buffer_bytes > 0) {
    if ((unsigned long )STbp->buffer_bytes < count - (unsigned long )total) {
      tmp___8 = (unsigned long )STbp->buffer_bytes;
    } else {
      tmp___8 = count - (unsigned long )total;
    }
    transfer = (ssize_t )tmp___8;
    if (do_dio == 0) {
    ...
    if (code == 1610612736L) {
      ...
      if (code == 1612709888L) {
        if (value == 1048575) {
          ...
          if ((value & 255) != 255) {
            if (value & 1) {
              STm->default_compression = 2U;
            } else {
              STm->default_compression = 1U;
            }
            if ((unsigned int )STp->ready == 0U) {
              STp->compression_changed = 0U;
...
{ int i ;
  ...
  if (cmd_type == 109 && cmd_nr == 1) {
    ...
    if ((int )mtc.mt_op == 30) {
      ...
      retval = do_load_unload(STp, file, tmp___10);
      goto out;
    }
  ...
  if (cmd_type == 109 && cmd_nr == 2) {
    ...
    if (STp->block_size != 0) {
      ...
      if ((unsigned int )STps->rw == 1U) {
        mt_status.mt_blkno -= (((STp->buffer)->buffer_bytes + STp->block_size) + -1) / STp->block_size;
      }
    }
    mt_status.mt_gstat = 0L;
    if ((unsigned int )STp->drv_write_prot != 0U) {
      mt_status.mt_gstat |= 67108864L;
    }
    if (mt_status.mt_blkno == 0) {
      if (mt_status.mt_fileno == 0) {
        mt_status.mt_gstat |= 1073741824L;
      } else {
        mt_status.mt_gstat |= 2147483648L;
      }
    }
    ...
    if ((unsigned int )STps->eof == 3U || (unsigned int )STps->eof == 4U) {
      mt_status.mt_gstat |= 536870912L;
    } else
    if ((unsigned int )STps->eof > 2U) {
      mt_status.mt_gstat |= 134217728L;
    }
    if ((unsigned int )STp->density == 1U) {
      mt_status.mt_gstat |= 2097152L;
    } else
    if ((unsigned int )STp->density == 2U) {
      mt_status.mt_gstat |= 4194304L;
    } else
    if ((unsigned int )STp->density == 3U) {
      mt_status.mt_gstat |= 8388608L;
    }
    if ((unsigned int )STp->ready == 0U) {
      mt_status.mt_gstat |= 16777216L;
    }
    if ((unsigned int )STp->ready == 2U) {
      mt_status.mt_gstat |= 262144L;
    }
    if ((unsigned int )STps->at_sm != 0U) {
      mt_status.mt_gstat |= 268435456L;
    }
    if (((unsigned int )STm->do_async_writes != 0U || ((unsigned int )STm->do_buffer_writes != 0U && STp->block_size != 0)) || (unsigned int )STp->drv_buffer != 0U) {
      mt_status.mt_gstat |= 65536L;
    }
    if ((unsigned int )STp->cleaning_req != 0U) {
      mt_status.mt_gstat |= 32768L;
    }
...
{ int i ;
  ...
  cdev_devno = (dev_t )((((((dev_num & -32) << 3) | (dev_num & 31)) | (mode << 5)) | tmp___1) | 9437184);
  cdev = cdev_alloc();
  ...
  snprintf((char *)(& name), 10UL, "%s%s%s", tmp___3, (char *)(& (tape->disk)->disk_name),
           st_formats[i]);
...
{ struct st_modedef *STm ;
  ...
  options = tmp___1 | options;
  if ((unsigned int )STm->do_read_ahead != 0U) {
    tmp___2 = 4;
  } else {
    tmp___2 = 0;
  }
  options = tmp___2 | options;
  if ((unsigned int )STp->two_fm != 0U) {
    tmp___3 = 16;
  } else {
    tmp___3 = 0;
  }
  options = tmp___3 | options;
  if ((unsigned int )STp->fast_mteom != 0U) {
    tmp___4 = 32;
  } else {
    tmp___4 = 0;
  }
  options = tmp___4 | options;
  if ((unsigned int )STm->defaults_for_writes != 0U) {
    tmp___5 = 128;
  } else {
    tmp___5 = 0;
  }
  options = tmp___5 | options;
  if ((unsigned int )STp->can_bsr != 0U) {
    tmp___6 = 256;
  } else {
    tmp___6 = 0;
  }
  options = tmp___6 | options;
  if ((unsigned int )STp->omit_blklims != 0U) {
    tmp___7 = 512;
  } else {
    tmp___7 = 0;
  }
  options = tmp___7 | options;
  if ((unsigned int )STp->can_partitions != 0U) {
    tmp___8 = 1024;
  } else {
    tmp___8 = 0;
  }
  options = tmp___8 | options;
  if ((unsigned int )STp->scsi2_logical != 0U) {
    tmp___9 = 2048;
  } else {
    tmp___9 = 0;
  }
  options = tmp___9 | options;
  if ((unsigned int )STm->sysv != 0U) {
    tmp___10 = 4096;
  } else {
    tmp___10 = 0;
  }
  options = tmp___10 | options;
  if ((unsigned int )STp->immediate != 0U) {
    tmp___11 = 8192;
  } else {
    tmp___11 = 0;
  }
  options = tmp___11 | options;
  if ((unsigned int )STp->immediate_filemark != 0U) {
    tmp___12 = 32768;
  } else {
    tmp___12 = 0;
  }
  options = tmp___12 | options;
  if ((unsigned int )STp->sili != 0U) {
    tmp___13 = 16384;
  } else {
    tmp___13 = 0;
  }
  options = tmp___13 | options;
...
{ unsigned long end ;
  ...
  if ((unsigned int )nr_pages > max_pages) {
    return (-12);
  }
  if (count == 0UL) {
    return (0);
