...
{ u8 zero[6U] ;
  ...
  __ar->ldv_39847.cmd_buf[__nreg * 2 + 1] = reg + 4U;
...
{ int err ;
  ...
  if ((int )band5ghz) {
    __ar->ldv_39847.cmd_buf[(__nreg + 1) * 2] = carl9170_rf_initval[i]._5ghz;
  } else {
    __ar->ldv_39847.cmd_buf[(__nreg + 1) * 2] = carl9170_rf_initval[i]._2ghz;
  }
  __nreg ++;
  if (__nreg > 6) {
    if ((unsigned int )__ar->state > 1U) {
...
{ struct carl9170_rsp *cmd ;
  ...
  tmp___1 = ldv__builtin_expect((u32 )cmd->hdr.ldv_39068.ldv_39066.len != len - 4U,
                                0L);
  if (tmp___1 != 0L) {
    tmp___0 = net_ratelimit();
    if (tmp___0 != 0) {
