...
extern void *memset(void *s , int c , size_t n ) ;
 static unsigned long arch_local_save_flags(void)  __attribute__((__no_instrument_function__)) ;
 static unsigned long arch_local_save_flags(void)  __attribute__((__no_instrument_function__)) ;
...
{ unsigned long __ret ;
 ...
 static void arch_local_irq_restore(unsigned long f )  __attribute__((__no_instrument_function__)) ;
 static void arch_local_irq_restore(unsigned long f )  __attribute__((__no_instrument_function__)) ;
...
{ unsigned long __edi ;
 ...
 static unsigned long arch_local_irq_save(void)  __attribute__((__no_instrument_function__)) ;
 static unsigned long arch_local_irq_save(void)  __attribute__((__no_instrument_function__)) ;
...
{ int tmp___7 ;
  ...
  {
  tmp___8 = (int )request_threaded_irq(irq, handler, (irqreturn_t (*)(int  , void * ))((void *)0),
                                       flags, name, dev);
  tmp = tmp___8;
  tmp___7 = tmp;
  return (tmp___7);
...
{ struct dma_map_ops *ops ;
  ...
  addr = (*(ops->map_page))(dev, (struct page *)1152897315351035904UL + (tmp___11 >> 12),
                            (unsigned long )ptr & ~ (~ ((1UL << 12) - 1UL)), size,
                            dir, attrs);
  tmp___12 = __phys_addr((unsigned long )ptr);
  debug_dma_map_page(dev, (struct page *)1152897315351035904UL + (tmp___12 >> 12),
...
{ struct dma_map_ops *ops ;
 ...
 static void dma_sync_sg_for_cpu(struct device *dev , struct scatterlist *sg ,
...
{ struct device *tmp___7 ;
 ...
 static void pci_dma_sync_sg_for_cpu(struct pci_dev *hwdev , struct scatterlist *sg ,
                                             int nelems , int direction ) 
{ struct device *tmp___7 ;
...
static u8 start_scsi(struct AdapterCtlBlk *acb , struct DeviceCtlBlk *dcb , struct ScsiReqBlk *srb ) ;
 static void enable_msgout_abort(struct AdapterCtlBlk *acb , struct ScsiReqBlk *srb ) ;
...
{ 
  ...
  if ((int )srb->tag_number < 255) {
    dcb->tag_mask &= (unsigned int )(~ (1 << (int )srb->tag_number));
    srb->tag_number = (u8 )255;
  }
  return;
}
}
 static struct ScsiReqBlk *find_cmd(struct scsi_cmnd *cmd , struct list_head *head ) 
{ struct ScsiReqBlk *i ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
{ int nseg ;
  ...
  if (! nseg) {
    ...
    while (1) {
      ...
      (sgp + i)->length = seglen;
      srb->total_xfer_length += (size_t )seglen;
      i ++;
      sg = sg_next(sg);
    }

    while_break___5: 
    sgp += (int )srb->sg_count - 1;
...
{ u16 pstat ;
 ...
 static void clear_fifo(struct AdapterCtlBlk *acb , char *txt ) 
{ 
...
{ 
 ...
 static u8 msgin_completed(u8 *msgbuf , u32 len ) 
{ 
 ...
 static void msgin_reject(struct AdapterCtlBlk *acb , struct ScsiReqBlk *srb ) 
{ 
...
{ struct ScsiReqBlk *srb ;
 ...
 static void reprogram_regs(struct AdapterCtlBlk *acb , struct DeviceCtlBlk *dcb ) 
{ 
...
{ struct DeviceCtlBlk *dcb ;
 ...
 static void msgin_set_nowide(struct AdapterCtlBlk *acb , struct ScsiReqBlk *srb ) 
{ struct DeviceCtlBlk *dcb ;
...
{ struct DeviceCtlBlk *dcb ;
 ...
 static u8 tagq_blacklist(char *name ) 
{ 
...
{ u8 tempcnt ;
  ...
  if (status) {
    ...
    if ((int )status == 255) {
      ...
      cmd->result |= 7 << 16;
      cmd->result &= -65281;
      cmd->result |= (int )srb->end_message << 8;
      cmd->result &= -256;
      cmd->result |= (int )status;
    }
  } else {
...
{ struct resource *tmp___7 ;
  ...
  tmp___10 = (int )request_irq(irq, & dc395x_interrupt, 128UL, "dc395x", (void *)acb);
  tmp = tmp___10;
  tmp___8 = tmp;
  if (tmp___8) {
...
{ struct Scsi_Host *scsi_host ;
  ...
  io_port_base = (unsigned long )(dev->resource[0].start & 1152921504606846972ULL);
  ...
  pci_set_master(dev);
  tmp___12 = (int )scsi_add_host(scsi_host, & dev->dev);
  tmp___10 = tmp___12;
  tmp___9 = tmp___10;
  if (tmp___9) {
    ...
    {(char const   *)0, (struct bus_type *)0, (struct module *)0, (char const   *)0,
     ...
     (struct driver_private *)0}, {{{{{0U}, 0U, 0U, (void *)0, {(struct lock_class_key *)0,
                                                                ...
                                                                0, 0UL}}}}, {(struct list_head *)0,
                                                                             (struct list_head *)0}}};
static int dc395x_module_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
