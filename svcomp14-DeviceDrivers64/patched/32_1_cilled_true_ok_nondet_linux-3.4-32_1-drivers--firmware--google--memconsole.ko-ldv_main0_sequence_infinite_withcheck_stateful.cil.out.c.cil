...
{ int ret ;
  ...
  __cil_tmp8 = (unsigned long )(& memconsole_bin_attr) + 16UL;
  *((size_t *)__cil_tmp8) = memconsole_length;
  __cil_tmp9 = (struct bin_attribute  const  *)(& memconsole_bin_attr);
  tmp___1 = (int )sysfs_create_bin_file(firmware_kobj, __cil_tmp9);
  ret = tmp___1;
  return (ret);
}
}
