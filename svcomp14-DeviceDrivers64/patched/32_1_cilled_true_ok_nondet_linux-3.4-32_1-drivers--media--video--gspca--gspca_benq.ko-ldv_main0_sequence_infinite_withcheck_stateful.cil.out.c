...
{ struct usb_device *dev ;
  ...
  if (ret < 0) {
    ...
    __cil_tmp21 = __cil_tmp20 + 3216UL;
    *((int *)__cil_tmp21) = ret;
  }
  return;
}
...
{ struct urb *urb ;
  ...
  while (1) {
    ...
    __cil_tmp7 = (unsigned long )n * 8UL;
    __cil_tmp8 = 1256UL + __cil_tmp7;
    __cil_tmp9 = (unsigned long )gspca_dev;
    ...
    *((void **)__cil_tmp12) = usb_alloc_coherent(__cil_tmp15, __cil_tmp16, 208U, __cil_tmp19);
    ...
    __cil_tmp29 = __cil_tmp28 + 1104UL;
    ...
    *((u32 *)__cil_tmp33) = (u32 )2048;
    ...
    __cil_tmp35 = __cil_tmp34 + 1104UL;
    ...
    *((int *)__cil_tmp47) = 32;
    ...
    while (1) {
      ...
      *((unsigned int *)__cil_tmp52) = 64U;
      __cil_tmp53 = (unsigned long )i * 16UL;
  ...
  __cil_tmp59 = __cil_tmp58 + 3216UL;
...
{ struct gspca_dev *gspca_dev ;
  ...
  __cil_tmp11 = __cil_tmp10 + 3012UL;
  ...
  if (__cil_tmp15 != 0) {
    ...
    __cil_tmp20 = __cil_tmp19 + 3222UL;
    if (*((char *)__cil_tmp20)) {
      return;
    }
  ...
  __cil_tmp24 = 0UL;
  __cil_tmp25 = 1256UL + __cil_tmp24;
  ...
  if (__cil_tmp30 == __cil_tmp29) {
    ...
    __cil_tmp31 = 16UL;
    __cil_tmp32 = 1256UL + __cil_tmp31;
  ...
  __cil_tmp38 = 8UL;
  __cil_tmp39 = 1256UL + __cil_tmp38;
  ...
  while (1) {
    ...
    st = *((int *)__cil_tmp76);
    if (st == 0) {
      __cil_tmp77 = (unsigned long )i * 16UL;
      __cil_tmp78 = __cil_tmp77 + 12UL;
      __cil_tmp79 = 192UL + __cil_tmp78;
    ...
    if (__cil_tmp95 == 128) {
      ...
      if (__cil_tmp108 == 4) {
        ...
        if (__cil_tmp112 == 186) {
          ...
          __cil_tmp117 = __cil_tmp116 + 3010UL;
          *((__u8 *)__cil_tmp117) = (__u8 )0;
          goto __Cont;
        }
      } else {
        __cil_tmp118 = (unsigned long )gspca_dev;
        __cil_tmp119 = __cil_tmp118 + 3010UL;
        *((__u8 *)__cil_tmp119) = (__u8 )0;
        goto __Cont;
      }
    }
    __cil_tmp120 = (unsigned long )i * 16UL;
    __cil_tmp121 = 192UL + __cil_tmp120;
