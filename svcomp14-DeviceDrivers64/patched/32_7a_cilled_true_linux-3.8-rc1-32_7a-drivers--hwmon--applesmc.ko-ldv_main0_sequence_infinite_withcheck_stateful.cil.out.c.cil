...
static struct led_classdev applesmc_backlight  = 
    ...
    0, {0L, {{{0U}}, 0U, 0U, 0, {0, {0, 0}, 0, 0, 0UL}}, {0, 0}, {0, {0, 0}, 0, 0,
                                                                  0UL}}, 0, {0, 0},
    0, (_Bool)0};
static struct applesmc_node_group info_group[8U]  = 
  {      {(char *)"name", (void *)(& applesmc_name_show), 0, 0, 0}, 
...
static struct applesmc_node_group light_sensor_group[2U]  = {      {(char *)"light", (void *)(& applesmc_light_show), 0, 0, 0}, 
        {0, 0, 0, 0, 0}};
static struct applesmc_node_group fan_group[8U]  = 
  {      {(char *)"fan%d_label", (void *)(& applesmc_show_fan_position), 0, 0, 0}, 
...
{ struct applesmc_node_group *grp ;
  ...
  if ((unsigned long )grp->store != (unsigned long )((void *)0)) {
    attr->mode = 420U;
  } else {
    attr->mode = 292U;
  }
...
static struct dmi_system_id applesmc_whitelist[7U]  = {      {& applesmc_dmi_match, "Apple MacBook Air", {{9U, {'A', 'p', 'p', 'l', 'e', '\000'}},
      ...
      0}, 
        {& applesmc_dmi_match, "Apple iMac", {{9U, {'A', 'p', 'p', 'l', 'e', '\000'}},
                                           {5U, {'i', 'M', 'a', 'c', '\000'}}, {(unsigned char)0,
                                                                                {(char)0,
                                                                                 (char)0,
                                                                                 (char)0,
                                                                                 (char)0,
