...
{ struct fujitsu *fujitsu ;
  ...
  *((unsigned long *)__cil_tmp46) = 1UL << 10;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp48);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& fujitsu_drv, & __this_module, "fujitsu_ts");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_fujitsu_drv_serio_driver == 0) {
          ...
          ldv_s_fujitsu_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
