...
{ struct rotary_encoder_platform_data *pdata ;
  ...
  *((struct device **)__cil_tmp42) = (struct device *)__cil_tmp44;
  ...
  tmp___3 = (int )input_register_device(input);
  err = tmp___3;
  if (err) {
  ...
  if (*((bool *)__cil_tmp114)) {
    ...
    __cil_tmp116 = __cil_tmp115 + 34UL;
  ...
  tmp___4 = (int )request_irq(__cil_tmp119, handler, 3UL, "rotary-encoder", __cil_tmp120);
  err = tmp___4;
  if (err) {
  ...
  tmp___5 = (int )request_irq(__cil_tmp130, handler, 3UL, "rotary-encoder", __cil_tmp131);
  err = tmp___5;
  if (err) {
