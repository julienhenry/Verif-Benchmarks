...
{ int err ;
  ...
  *((unsigned long *)__cil_tmp55) = 1UL << 10;
  ...
  tmp___4 = (int )request_irq(__cil_tmp57, & mk712_interrupt, 0UL, "mk712", __cil_tmp58);
  tmp___3 = tmp___4;
  if (tmp___3) {
  ...
  tmp___5 = (int )input_register_device(mk712_dev);
  err = tmp___5;
  if (err) {
    goto fail2;
  }
