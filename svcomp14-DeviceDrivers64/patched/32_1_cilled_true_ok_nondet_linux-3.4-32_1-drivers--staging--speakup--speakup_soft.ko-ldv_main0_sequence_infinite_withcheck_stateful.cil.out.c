...
{ char *cp ;
  ...
  cp = (char *)__cil_tmp10;
  __cil_tmp11 = (unsigned long )(& synth_soft) + 64UL;
...
{ unsigned long flags ;
  ...
  while_break: 
  __cil_tmp9 = (unsigned long )(& synth_soft) + 176UL;
  if (*((int *)__cil_tmp9)) {
  ...
  __cil_tmp12 = (unsigned long )(& synth_soft) + 176UL;
  *((int *)__cil_tmp12) = 1;
...
{ int chars_sent ;
  ...
  *((struct list_head **)__cil_tmp33) = (struct list_head *)__cil_tmp34;
  ...
  while (1) {
    ...
    if (tmp___9) {
      __cil_tmp37 = (unsigned long )(& speakup_info) + 28UL;
      if (*((int *)__cil_tmp37)) {
  ...
  while (1) {
    ...
    __cil_tmp46 = (unsigned long )(& speakup_info) + 28UL;
    if (*((int *)__cil_tmp46)) {
      __cil_tmp47 = (unsigned long )(& speakup_info) + 28UL;
      *((int *)__cil_tmp47) = 0;
      __cil_tmp48 = & ch;
    ...
    tmp = (int )copy_to_user(__cil_tmp53, __cil_tmp54, 1U);
    tmp___14 = tmp;
    if (tmp___14) {
      return ((ssize_t )-14);
    }
...
{ unsigned long supplied_index ;
  ...
  *__cil_tmp7 = 0UL;
  tmp = (int )kstrtoul_from_user(buf___0, count, 0U, & supplied_index);
  converted = tmp;
  if (converted < 0) {
...
{ unsigned long flags ;
  ...
  if (tmp___8) {
    __cil_tmp11 = (unsigned long )(& speakup_info) + 28UL;
    if (*((int *)__cil_tmp11)) {
      ret = 65;
    }
  } else {
...
{ int tmp___7 ;
  ...
  *((int *)__cil_tmp4) = 26;
  __cil_tmp5 = (unsigned long )(& synth_device) + 8UL;
  *((char const   **)__cil_tmp5) = "softsynth";
  __cil_tmp6 = (unsigned long )(& synth_device) + 16UL;
...
{ unsigned long __cil_tmp2 ;
  ...
  {
  __cil_tmp2 = (unsigned long )(& synth_soft) + 176UL;
  if (*((int *)__cil_tmp2)) {
    return (1);
  }
  return (0);
    ...
    if (tmp___8 == 8) {
      ...
      if (0) {
        ...
        if (ldv_s_softsynth_fops_file_operations == 0) {
          ...
          ldv_s_softsynth_fops_file_operations ++;
        }
        goto switch_break;
        case_5: 
