...
{ uint32_t i ;
  ...
  if (bo->mem.mem_type == 2U) {
    (reloc->location)->offset += (uint32 )bo->offset;
...
{ struct vmw_sw_context *sw_context ;
  ...
  tmp___8 = ldv__builtin_expect((unsigned long )cmd == (unsigned long )((void *)0),
                                0L);
  if (tmp___8 != 0L) {
...
{ struct vmw_display_unit *units[8U] ;
  ...
  ldv_39647: 
  i ++;
  clips_ptr += (unsigned long )increment;
  ldv_39661: ;
  if ((unsigned int )i < num_clips) {
    goto ldv_39660;
  }
...
{ uint32_t num_displays ;
  ...
  if (((struct vmw_display_unit *)__mptr___0 + 0xfffffffffffffc50UL)->unit < num_displays && (int )du->pref_active) {
    tmp___0 = 1;
  } else {
    tmp___0 = 2;
  }
...
{ int tmp ;
  ...
  {
  tmp = ttm_bo_create(& dev_priv->bdev, 4096UL, 0, & vmw_vram_sys_placement, 0U, 0UL,
                      0, 0, & dev_priv->dummy_query_bo);
  return (tmp);
}
}
...
static int vmw_probe(struct pci_dev *pdev ,
                     struct pci_device_id  const  *ent ) 
{ int tmp ;
...
{ struct device *var_group1 ;
  ...
  if (ldv_s_vmw_pci_driver_pci_driver == 0) {
    ...
    ldv_s_vmw_pci_driver_pci_driver ++;
  }
  goto ldv_40224;
  case 17: ;
...
{ struct device *device ;
  ...
  if (_min1___1 < _min2___1) {
    initial_width = _min1___1;
  } else {
    initial_width = _min2___1;
  }
  _min1___2 = vmw_priv___0->initial_height;
  _min2___2 = fb_height;
  if (_min1___2 < _min2___2) {
    initial_height = _min1___2;
  } else {
    initial_height = _min2___2;
  }
...
{ struct vmw_private *dev_priv ;
  ...
  tmp___3 = ioread32((void *)(fifo_mem + tmp___4));
...
{ int ret ;
  ...
  {
  ret = vmw_resource_init(dev_priv, res, & dev_priv->context_idr, 256, 0, res_free,
                          0);
  tmp = ldv__builtin_expect(ret != 0, 0L);
  if (tmp != 0L) {
...
{ struct vmw_private *dev_priv ;
  ...
  ttm_ref_object_base_unref(tfile, ctx->base.hash.key, 0);
  out: 
  vmw_resource_unreference(& res);
  return (ret);
}
...
static struct vmw_bpp  const  vmw_sf_bpp[121U]  = 
  {      {0U, 0U}, 
        ...
        {24U, 24U}, 
        {32U, 32U}};
 static uint32_t vmw_surface_dma_size(struct vmw_surface  const  *srf ) 
{ 
 ...
 static uint32_t vmw_surface_define_size(struct vmw_surface  const  *srf ) 
{ 
...
{ uint32_t i ;
  ...
  header->size = 76U;
  body->guest.ptr = *ptr;
  body->guest.ptr.offset += (uint32 )cur_offset->bo_offset;
...
{ struct vmw_resource *res ;
  ...
  if ((unsigned long )srf->backup == (unsigned long )((struct ttm_buffer_object *)0)) {
    ret = ttm_bo_create(& dev_priv->bdev, (unsigned long )srf->backup_size, 0, & vmw_srf_placement,
                        0U, 0UL, 1, 0, & srf->backup);
    tmp___0 = ldv__builtin_expect(ret != 0, 0L);
    if (tmp___0 != 0L) {
      return (ret);
    }
...
{ int ret ;
  ...
  ret = vmw_resource_init(dev_priv, res, & dev_priv->surface_idr, 257, 1, res_free,
...
{ struct ttm_bo_device *bdev ;
  ...
  ret = ttm_bo_init(bdev, & vmw_bo->base, size, 0, placement, 0U, 0UL, (int )interruptible,
...
{ struct vmw_private *dev_priv ;
  ...
  ret = ttm_base_object_init(tmp___6->tfile, & vmw_user_bo->base, 0, 1, & vmw_user_dmabuf_release,
                             0);
  tmp___7 = ldv__builtin_expect(ret != 0, 0L);
  if (! (tmp___7 != 0L)) {
...
{ struct vmw_resource *res ;
  ...
  {
  res = & stream->res;
  ret = vmw_resource_init(dev_priv, res, & dev_priv->stream_idr, 258, 0, res_free,
                          0);
  tmp = ldv__builtin_expect(ret != 0, 0L);
  if (tmp != 0L) {
    if ((unsigned long )res_free == (unsigned long )((void (*)(struct vmw_resource * ))0)) {
...
struct ttm_placement vmw_vram_gmr_placement  =    {0U,
    0U, 2U, (uint32_t const   *)(& vram_gmr_placement_flags), 1U, (uint32_t const   *)(& gmr_placement_flags)};
static uint32_t vram_gmr_ne_placement_flags[2U]  = {      2162692U,      2162696U};
struct ttm_placement vmw_vram_gmr_ne_placement  =    {0U,
    0U, 2U, (uint32_t const   *)(& vram_gmr_ne_placement_flags), 1U, (uint32_t const   *)(& gmr_ne_placement_flags)};
struct ttm_placement vmw_vram_sys_placement  =    {0U,
    0U, 1U, (uint32_t const   *)(& vram_placement_flags), 1U, (uint32_t const   *)(& sys_placement_flags)};
struct ttm_placement vmw_vram_ne_placement  =    {0U,
    0U, 1U, (uint32_t const   *)(& vram_ne_placement_flags), 1U, (uint32_t const   *)(& vram_ne_placement_flags)};
struct ttm_placement vmw_sys_placement  =    {0U,
    0U, 1U, (uint32_t const   *)(& sys_placement_flags), 1U, (uint32_t const   *)(& sys_placement_flags)};
static uint32_t evictable_placement_flags[3U]  = {      65537U,      65540U,      65544U};
struct ttm_placement vmw_evictable_placement  =    {0U,
    0U, 3U, (uint32_t const   *)(& evictable_placement_flags), 1U, (uint32_t const   *)(& sys_placement_flags)};
struct ttm_placement vmw_srf_placement  =    {0U,
    0U, 1U, (uint32_t const   *)(& gmr_placement_flags), 2U, (uint32_t const   *)(& gmr_vram_placement_flags)};
static int vmw_ttm_bind(struct ttm_tt *ttm ,
...
{ int ret ;
  ...
  prepare_to_wait(& dev_priv->fifo_queue, & __wait, tmp___4);
...
{ uint32_t chunk_size ;
  ...
  if ((unsigned long )fifo_state->dynamic_buffer != (unsigned long )((__le32 *)0)) {
    buffer = fifo_state->dynamic_buffer;
  } else {
    buffer = fifo_state->static_buffer;
  }
  if (bytes < chunk_size) {
    chunk_size = bytes;
  }
...
{ struct vmw_fifo_state *fifo_state ;
  ...
  tmp___3 = ldv__builtin_expect((unsigned long )bytes > fifo_state->reserved_size,
                                0L);
  if (tmp___3 != 0L) {
    __asm__  volatile   ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/work/vladimir/UFO/Work/test/work/current--X--drivers/gpu/drm/vmwgfx/vmwgfx.ko--X--defaultlinux-3.5--X--32_7a--X--ufo/linux-3.5/csd_deg_dscv/29/dscv_tempdir/dscv/ri/32_7a/drivers/gpu/drm/vmwgfx/vmwgfx_fifo.c.prepared"),
                         "i" (535), "i" (12UL));
...
{ struct vmw_fifo_state *fifo_state ;
  ...
  tmp___0 = ldv__builtin_expect((unsigned long )fm == (unsigned long )((void *)0),
                                0L);
  if (tmp___0 != 0L) {
...
{ struct vmw_fifo_state *fifo_state ;
  ...
  prepare_to_wait(& dev_priv->fence_queue, & __wait, tmp___6);
...
{ struct vmw_legacy_display *lds ;
  ...
  if (lds->num_active != 0U) {
    tmp___2 = lds->num_active;
  } else {
    tmp___2 = 1U;
  }
  vmw_write(dev_priv, 34U, tmp___2);
  i = 0;
...
{ struct vmw_overlay *overlay ;
  ...
  drm_ut_debug_printk(1U, "drm", "vmw_overlay_update_stream", "   %s: old %p, new %p, %spaused\n",
                      "vmw_overlay_update_stream", stream->buf, buf, tmp___2);
...
void ldv_mutex_lock_495(struct mutex *ldv_func_arg1 ) ;
 static int timespec_compare(struct timespec  const  *lhs , struct timespec  const  *rhs ) 
{ 
...
extern struct timespec ns_to_timespec(s64  ) ;
void vmw_marker_queue_init(struct vmw_marker_queue *queue ) 
{ struct lock_class_key __key ;
...
{ struct vmwgfx_gmrid_man *gman ;
  ...
  if (gman->max_gmr_pages != 0U) {
    gman->used_gmr_pages += (uint32_t )bo->num_pages;
...
{ struct vmwgfx_gmrid_man *gman ;
  ...
  if ((unsigned long )mem->mm_node != (unsigned long )((void *)0)) {
    ...
    gman->used_gmr_pages -= (uint32_t )mem->num_pages;
    spin_unlock(& gman->lock);
    mem->mm_node = 0;
  }
  return;
...
{ struct vmw_fence_action *action ;
  ...
  ldv_39129: 
  list_del_init(& action->head);
  (fman->pending_actions[(unsigned int )action->type]) --;
...
{ struct vmw_private *dev_priv ;
  ...
  if ((unsigned long )fence == (unsigned long )((struct vmw_fence_obj *)0)) {
    ...
    ret = vmw_execbuf_fence_commands(file_priv, dev_priv, & fence, tmp___8);
    tmp___4 = ldv__builtin_expect(ret != 0, 0L);
    if (tmp___4 != 0L) {
