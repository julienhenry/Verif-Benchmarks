...
static struct ida bat_ida  =    {{(struct idr_layer *)((void *)0),
     (struct idr_layer *)((void *)0), 0, 0, {{{{{(__ticketpair_t )0}}, 3735899821U,
                                               4294967295U, (void *)-1L}}}}, (struct ida_bitmap *)((void *)0)};
...
{ int ret ;
  ...
  *((struct device **)__cil_tmp6) = (struct device *)__cil_tmp8;
  ...
  tmp = (int )sysfs_create_bin_file(__cil_tmp12, __cil_tmp13);
  ret = tmp;
  if (ret) {
    goto bin_attr_failed;
  }
...
static int w1_ds2780_init(void)  __attribute__((__section__(".init.text"),
