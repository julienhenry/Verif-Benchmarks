...
extern void init_timer_key(struct timer_list *timer , char *name , struct lock_class_key *key ) ;
 static void setup_timer_key(struct timer_list *timer , char *name , struct lock_class_key *key ,
                                     void (*function)(unsigned long  ) , unsigned long data )  __attribute__((__no_instrument_function__)) ;
 static void setup_timer_key(struct timer_list *timer , char *name , struct lock_class_key *key ,
                                     void (*function)(unsigned long  ) , unsigned long data )  __attribute__((__no_instrument_function__)) ;
 static void setup_timer_key(struct timer_list *timer , char *name , struct lock_class_key *key ,
...
static char __mod_description35[57]  __attribute__((__used__, __unused__, __section__(".modinfo"),
__aligned__(1)))  = 
...
static struct platform_device m2mtest_pdev  = 
     {"m2m-testdev", 0, {(struct device *)0, (struct device_private *)0, {(char *)0,
                       ...
                       (struct device_type *)0, {{0}, {{{{{0U}}, 0U, 0U, (void *)0}}},
                                                 ...
                                                 (struct task_struct *)0, (char *)0,
                                                 (void *)0}, (struct bus_type *)0,
                       (struct device_driver *)0, (void *)0, {{0}, 0U, 0U, (_Bool)0,
                                                              (_Bool)0, (_Bool)0,
                                                              {{{{{0U}}, 0U, 0U, (void *)0}}},
                                                              {(struct list_head *)0,
                                                               (struct list_head *)0},
                                                              ...
                                                              0U, 0U, 0, 0, 0, 0,
                                                              0UL, 0UL, 0UL, 0UL,
                                                              {0LL}, 0LL, (struct dev_pm_qos_request *)0,
                       ...
                       {(void *)0, {(struct list_head *)0, (struct list_head *)0},
                        {{0}}}, (struct class *)0, (struct attribute_group **)0, & m2mtest_dev_release},
    0U, (struct resource *)0, (struct platform_device_id *)0, (struct mfd_cell *)0,
    {}};
...
{ struct m2mtest_fmt *fmt ;
  ...
  while (1) {
    ...
    __cil_tmp7 = (unsigned long )k * 24UL;
  ...
  __cil_tmp21 = (unsigned long )k * 24UL;
...
{ int i ;
  ...
  if (__cil_tmp17 < __cil_tmp16) {
    __cil_tmp18 = (unsigned long )i * 24UL;
...
static int m2mtest_queue_setup(struct vb2_queue *vq ,
                               struct v4l2_format *fmt , unsigned int *nbuffers ,
...
{ struct m2mtest_ctx *ctx ;
  ...
  *((unsigned int *)__cil_tmp13) = 728U;
  __cil_tmp14 = (unsigned long )src_vq;
  __cil_tmp15 = __cil_tmp14 + 16UL;
  *((struct vb2_ops **)__cil_tmp15) = & m2mtest_qops;
  ...
  *((unsigned int *)__cil_tmp24) = 728U;
  __cil_tmp25 = (unsigned long )dst_vq;
  __cil_tmp26 = __cil_tmp25 + 16UL;
  *((struct vb2_ops **)__cil_tmp26) = & m2mtest_qops;
...
{ struct m2mtest_dev *dev ;
  ...
  *((struct v4l2_m2m_ctx **)__cil_tmp19) = v4l2_m2m_ctx_init(__cil_tmp22, __cil_tmp23,
  ...
  if (tmp___10) {
    ...
    tmp___11 = (long )PTR_ERR(__cil_tmp31);
    tmp___9 = tmp___11;
    ret = (int )tmp___9;
...
static struct v4l2_m2m_ops m2m_ops  =    {& device_run,
    & job_ready, & job_abort, & m2mtest_lock, & m2mtest_unlock};
...
{ struct m2mtest_dev *dev ;
  ...
  tmp = (int )v4l2_device_register(__cil_tmp16, __cil_tmp17);
  ret = tmp;
  if (ret) {
    goto free_dev;
  }
  ...
  while_break___1: 
  tmp___10 = (struct video_device *)video_device_alloc();
  vfd = tmp___10;
  if (! vfd) {
    __cil_tmp24 = 0UL;
  ...
  *vfd = *__cil_tmp30;
  ...
  __cil_tmp32 = __cil_tmp31 + 1088UL;
  __cil_tmp33 = (unsigned long )dev;
  __cil_tmp34 = __cil_tmp33 + 232UL;
  *((struct mutex **)__cil_tmp32) = (struct mutex *)__cil_tmp34;
  tmp___11 = (int )video_register_device(vfd, 0, 0);
  ret = tmp___11;
  if (ret) {
    __cil_tmp35 = 0UL;
    __cil_tmp36 = 56UL + __cil_tmp35;
    ...
    if (tmp___8 == 33) {
      ...
      if (0) {
        ...
        if (ldv_s_m2mtest_fops_v4l2_file_operations == 0) {
          ...
          ldv_s_m2mtest_fops_v4l2_file_operations ++;
        }
        goto switch_break;
        case_24: 
        ...
        if (ldv_s_m2mtest_pdrv_platform_driver == 0) {
          ...
          ldv_s_m2mtest_pdrv_platform_driver ++;
        }
        goto switch_break;
        case_33: 
