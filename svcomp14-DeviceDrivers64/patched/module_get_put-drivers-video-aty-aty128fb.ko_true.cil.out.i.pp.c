...
static struct fb_ops aty128fb_ops  = 
 ...
 static u32 _aty_ld_le32(unsigned int volatile   regindex ,
...
static struct backlight_ops  const  aty128_bl_data  =    {0U, & aty128_bl_update_status, & aty128_bl_get_brightness, (int (*)(struct backlight_device * ,
                                                                        struct fb_info * ))0};
static void aty128_bl_set_power(struct fb_info *info ,
                                int power ) 
{ 
