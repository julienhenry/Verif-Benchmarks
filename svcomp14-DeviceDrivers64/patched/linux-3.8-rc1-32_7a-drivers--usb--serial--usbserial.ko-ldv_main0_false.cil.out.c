...
int usb_serial_resume(struct usb_interface *intf ) ;
 static void usb_serial_console_init(int minor ) 
{ 
 ...
 static void usb_serial_console_exit(void) 
{ 
 ...
 static void usb_serial_console_disconnect(struct usb_serial *serial ) 
{ 
...
{ struct usb_serial *serial ;
  ...
  if ((unsigned long )(serial->type)->driver.owner != (unsigned long )((struct module *)0)) {
    ...
    if ((unsigned long )__mod != (unsigned long )((struct module *)0)) {
      tmp___0 = (char *)(& __mod->name);
    } else {
      tmp___0 = (char *)"kernel";
    }
    seq_printf(m, " module:%s", tmp___0);
  }
...
{ struct inode *var_group1 ;
  ...
  if (ldv_s_serial_ops_tty_operations == 0) {
    ...
    ldv_s_serial_ops_tty_operations ++;
  }
  goto ldv_29950;
  case 6: ;
  ...
  if (ldv_s_usb_serial_driver_usb_driver == 0) {
    ...
    ldv_s_usb_serial_driver_usb_driver ++;
  }
  goto ldv_29950;
  case 22: ;
...
{ 
 ...
 static void clear_bit_unlock(unsigned int nr , unsigned long volatile   *addr ) 
{ 
...
extern void tty_flip_buffer_push(struct tty_port * ) ;
 static int tty_insert_flip_char(struct tty_port *port , unsigned char ch ,
                                         char flag ) 
{ struct tty_buffer *tb ;
 ...
 static int tty_insert_flip_string(struct tty_port *port , unsigned char const   *chars ,
                                           size_t size ) 
{ int tmp ;
...
void usb_serial_handle_dcd_change(struct usb_serial_port *usb_port , struct tty_struct *tty ,
                                  unsigned int status ) ;
 static void usb_serial_debug_data(struct device *dev , char const   *function ,
...
{ struct device *var_group1 ;
  ...
  if (ldv_s_usb_serial_bus_type_bus_type == 0) {
    ...
    ldv_s_usb_serial_bus_type_bus_type ++;
  }
  goto ldv_29074;
  case 1: ;
