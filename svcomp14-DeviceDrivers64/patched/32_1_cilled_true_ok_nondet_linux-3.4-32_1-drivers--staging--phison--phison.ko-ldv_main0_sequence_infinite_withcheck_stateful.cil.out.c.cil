  ...
  while (1) {
    ...
    while (1) {
      ...
      if (tmp___7) {
        ...
        __cil_tmp15 = __cil_tmp14 + 12640UL;
...
static int phison_ide_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp___7 ;
  ...
  {
  tmp = (int )__pci_register_driver(& phison_pci_driver, & __this_module, "phison");
  tmp___7 = tmp;
  return (tmp___7);
}
}
