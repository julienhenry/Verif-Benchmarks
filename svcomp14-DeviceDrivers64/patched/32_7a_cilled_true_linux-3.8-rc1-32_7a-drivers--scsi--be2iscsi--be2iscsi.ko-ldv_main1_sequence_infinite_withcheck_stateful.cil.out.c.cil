...
{ 
 ...
 static int nla_ok(struct nlattr  const  *nla , int remaining ) 
{ 
 ...
 static struct nlattr *nla_next(struct nlattr  const  *nla , int *remaining ) 
{ int totlen ;
...
extern unsigned char const   _ctype[] ;
 static int blk_iopoll_sched_prep(struct blk_iopoll *iop ) 
{ int tmp ;
  int tmp___0 ;
...
{ u8 *addr ;
  ...
  tmp = ioremap_nocache(pcidev->resource[2].start, tmp___2);
  addr = (u8 *)tmp;
  ...
  if (pcidev->resource[pcicfg_reg].start != 0ULL || pcidev->resource[pcicfg_reg].end != pcidev->resource[pcicfg_reg].start) {
    tmp___3 = (unsigned long )((pcidev->resource[pcicfg_reg].end - pcidev->resource[pcicfg_reg].start) + 1ULL);
  } else {
    tmp___3 = 0UL;
  }
  tmp___1 = ioremap_nocache(pcidev->resource[pcicfg_reg].start, tmp___3);
  addr = (u8 *)tmp___1;
  if ((unsigned long )addr == (unsigned long )((u8 *)0)) {
    goto pci_map_err;
  }
...
{ uint32_t log_value ;
  ...
  if (1024U > phba->params.num_eq_entries) {
...
{ struct beiscsi_io_task *io_task ;
  ...
  if (((int )(io_task->cmd_bhs)->iscsi_hdr.flags & 64) != 0) {
    conn->rxdata_octets += (uint64_t )resid;
  }
  unmap: 
  scsi_dma_unmap(io_task->scsi_cmnd);
...
{ unsigned int num_cq_pages ;
  ...
  {
  if ((unsigned long )phba->params.num_cq_entries * 16UL > 4095UL) {
    num_cq_pages = (unsigned int )((((unsigned long )phba->params.num_cq_entries + 256UL) * 16UL - 1UL) / 4096UL);
  } else {
    num_cq_pages = 1U;
  }
  if (phba->params.asyncpdus_per_ctrl * phba->params.defpdu_hdr_sz > 4095U) {
    num_async_pdu_buf_pages = (unsigned int )(((unsigned long )(phba->params.asyncpdus_per_ctrl * phba->params.defpdu_hdr_sz) + 4095UL) / 4096UL);
  } else {
    num_async_pdu_buf_pages = 1U;
  }
  if ((unsigned long )phba->params.asyncpdus_per_ctrl * 8UL > 4095UL) {
    num_async_pdu_buf_sgl_pages = (unsigned int )((((unsigned long )phba->params.asyncpdus_per_ctrl + 512UL) * 8UL - 1UL) / 4096UL);
  } else {
    num_async_pdu_buf_sgl_pages = 1U;
  }
  if (phba->params.asyncpdus_per_ctrl * phba->params.defpdu_data_sz > 4095U) {
    num_async_pdu_data_pages = (unsigned int )(((unsigned long )(phba->params.asyncpdus_per_ctrl * phba->params.defpdu_data_sz) + 4095UL) / 4096UL);
  } else {
    num_async_pdu_data_pages = 1U;
  }
  if ((unsigned long )phba->params.asyncpdus_per_ctrl * 8UL > 4095UL) {
    num_async_pdu_data_sgl_pages = (unsigned int )((((unsigned long )phba->params.asyncpdus_per_ctrl + 512UL) * 8UL - 1UL) / 4096UL);
  } else {
    num_async_pdu_data_sgl_pages = 1U;
  }
...
{ struct be_mem_descriptor *mem_descr ;
  ...
  _min2 = alloc_size;
  if (_min1 < _min2) {
    curr_alloc_size = _min1;
  } else {
    curr_alloc_size = _min2;
  }
  ldv_48767: 
  ...
  if ((unsigned long )mem_arr->virtual_address == (unsigned long )((void *)0)) {
    ...
    if (_min1___0 < _min2___0) {
      curr_alloc_size = _min1___0;
    } else {
      curr_alloc_size = _min2___0;
    }
    j ++;
    mem_arr ++;
  }
...
{ unsigned int i ;
  ...
  {
  ret = 0;
  if ((unsigned long )phba->params.num_eq_entries * 4UL > 4095UL) {
    num_eq_pages = (unsigned int )((((unsigned long )phba->params.num_eq_entries + 1024UL) * 4UL - 1UL) / 4096UL);
  } else {
    num_eq_pages = 1U;
  }
  if ((int )phba->msix_enabled) {
...
{ unsigned int wrb_mem_index ;
  ...
  if (num_wrb_rings != 0U) {
    ...
    wrb_vaddr += (unsigned long )(pwrb_arr + (unsigned long )num)->size;
...
{ int num_cpus ;
  ...
  phba->num_cpus = (unsigned int )tmp___0;
  goto ldv_49062;
  case 4U: 
  if (63 < num_cpus) {
    tmp___1 = 63;
  ...
  phba->num_cpus = (unsigned int )tmp___1;
  goto ldv_49062;
  default: 
  phba->num_cpus = 1U;
  }
...
{ struct be_mem_descriptor *mem_descr_sglh ;
  ...
  pfrag += (unsigned long )phba->params.num_sge_per_io;
  tmp___3 = arr_index;
  arr_index ++;
...
{ struct beiscsi_io_task *io_task ;
  ...
  pwrb->dw[0] |= (u32 )(11 << (int )pwrb_typeoffset);
  ...
  if ((task->hdr)->ttt != 4294967295U) {
    ...
    pwrb->dw[0] |= (u32 )(5 << (int )pwrb_typeoffset);
    if ((unsigned int )(phba->pcidev)->device == 1826U) {
      tmp___14 = amap_mask(1U);
  ...
  goto ldv_49311;
  case 2: 
  pwrb->dw[0] |= (u32 )(2 << (int )pwrb_typeoffset);
  hwi_write_buffer(pwrb, task);
  goto ldv_49311;
  case 6: 
  pwrb->dw[0] |= (u32 )(2 << (int )pwrb_typeoffset);
...
{ struct scsi_device *var_group1 ;
  ...
  if (ldv_s_beiscsi_pci_driver_pci_driver == 0) {
    ...
    ldv_s_beiscsi_pci_driver_pci_driver ++;
  }
  goto ldv_49514;
  case 9: ;
...
{ struct be_cmd_set_ip_addr_req *req ;
  ...
  if ((unsigned int )ip_param->param == 7U) {
    ip_type = 16U;
  } else {
    ip_type = 1U;
  }
...
extern void iscsi_session_failure(struct iscsi_session * , enum iscsi_err  ) ;
 static bool beiscsi_error(struct beiscsi_hba *phba ) 
{ 
...
{ u16 compl_status ;
  ...
  ctrl->mcc_numtag[(int )tag] |= compl->tag0 & 16711680U;
  ctrl->mcc_numtag[(int )tag] |= (unsigned int )((int )extd_status << 8) & 65535U;
  ctrl->mcc_numtag[(int )tag] |= (unsigned int )compl_status & 255U;
...
{ 
  ...
  if ((int )embedded) {
    ...
    wrb->embedded |= (u32 )((int )sge_cnt << 3) & 255U;
  }
