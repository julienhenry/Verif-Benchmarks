...
{ struct skbd *skbd ;
  ...
  *((unsigned int *)__cil_tmp82) = (unsigned int )__cil_tmp84;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp107);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
static int skbd_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& skbd_drv, & __this_module, "stowaway");
  tmp = tmp___0;
  return (tmp);
}
}
