...
static struct completion set_timeout_wait  =    {0U,
    {{{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                        {(struct lock_class *)0,
                                                                         (struct lock_class *)0},
  ...
  if (tmp___0 == 25) {
    ...
    if (0) {
      ...
      if (ldv_s_ipmi_wdog_fops_file_operations == 0) {
        ...
        ldv_s_ipmi_wdog_fops_file_operations ++;
      }
      goto ldv_22748;
      case_13: ;
