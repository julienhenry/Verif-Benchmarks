...
{ struct bios_args *bios_return ;
  ...
  *((void **)__cil_tmp23) = (void *)(& args);
  ...
  __cil_tmp27 = (unsigned long )(& output) + 8UL;
...
static int dell_led_init(void)  __attribute__((__section__(".init.text"),
