...
static struct iscsi_boot_attr iscsi_boot_attr_tgt_flags  =    {{"flags",
     (umode_t )292}, 1, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_ip  =    {{"ip-addr", (umode_t )292}, 2, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_port  =    {{"port",
     (umode_t )292}, 3, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_lun  =    {{"lun", (umode_t )292}, 4, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_chap  =    {{"chap-type",
     (umode_t )292}, 5, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_nic  =    {{"nic-assoc", (umode_t )292}, 6, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_tgt_name  =    {{"target-name",
     (umode_t )292}, 7, (ssize_t (*)(void *data , int type , char *buf ))0};
...
static struct iscsi_boot_attr iscsi_boot_attr_tgt_chap_secret  =    {{"chap-secret",
     (umode_t )292}, 9, (ssize_t (*)(void *data , int type , char *buf ))0};
...
static struct iscsi_boot_attr iscsi_boot_attr_tgt_chap_rev_secret  =    {{"rev-chap-name-secret",
     (umode_t )292}, 11, (ssize_t (*)(void *data , int type , char *buf ))0};
            ...
            if (__cil_tmp76 == __cil_tmp75) {
              ...
              if (__cil_tmp86 == __cil_tmp85) {
                ...
                if (__cil_tmp96 == __cil_tmp95) {
                  ...
                  __cil_tmp101 = __cil_tmp100 + 88UL;
                  ...
                  if (__cil_tmp106 == __cil_tmp105) {
                    ...
                    __cil_tmp111 = __cil_tmp110 + 88UL;
                    ...
                    if (__cil_tmp116 == __cil_tmp115) {
                      ...
                      __cil_tmp121 = __cil_tmp120 + 88UL;
...
static struct iscsi_boot_attr iscsi_boot_attr_ini_flags  =    {{"flags",
     (umode_t )292}, 1, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_ini_isns  =    {{"isns-server", (umode_t )292}, 2, (ssize_t (*)(void *data , int type , char *buf ))0};
static struct iscsi_boot_attr iscsi_boot_attr_ini_slp  =    {{"slp-server",
     (umode_t )292}, 3, (ssize_t (*)(void *data , int type , char *buf ))0};
...
{ struct iscsi_boot_kobj *boot_kobj ;
  ...
  *((struct kset **)__cil_tmp19) = *((struct kset **)__cil_tmp21);
  ...
  tmp___2 = (int )kobject_init_and_add(__cil_tmp22, & iscsi_boot_ktype, __cil_tmp24,
                                       name, index);
  tmp___0 = tmp___2;
  if (tmp___0) {
  ...
  *((void (**)(void *data ))__cil_tmp34) = release;
  ...
  tmp___3 = (int )sysfs_create_group(__cil_tmp35, __cil_tmp36);
  tmp___1 = tmp___3;
  if (tmp___1) {
    __cil_tmp37 = (unsigned long )boot_kobj;
...
{ struct iscsi_boot_kset *boot_kset ;
  ...
  tmp___0 = (struct kset *)kset_create_and_add(set_name, __cil_tmp8, firmware_kobj);
  *((struct kset **)__cil_tmp6) = tmp___0;
