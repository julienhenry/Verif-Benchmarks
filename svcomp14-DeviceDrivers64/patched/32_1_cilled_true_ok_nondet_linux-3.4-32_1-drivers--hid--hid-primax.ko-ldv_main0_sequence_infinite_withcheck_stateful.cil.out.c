...
static int px_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__hid_register_driver(& px_driver, & __this_module, "hid_primax");
  tmp = tmp___0;
  return (tmp);
}
}
