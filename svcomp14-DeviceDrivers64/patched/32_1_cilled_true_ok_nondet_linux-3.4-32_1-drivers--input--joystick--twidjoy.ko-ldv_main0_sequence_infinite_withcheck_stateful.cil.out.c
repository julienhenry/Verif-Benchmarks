...
{ struct input_dev *dev ;
  ...
  while (1) {
    ...
    while (1) {
      ...
      __cil_tmp37 = (unsigned long )i * 4UL;
...
{ struct twidjoy_button_spec *bp ;
  ...
  *((unsigned long *)__cil_tmp44) = __cil_tmp46 | __cil_tmp45;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp67);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& twidjoy_drv, & __this_module, "twidjoy");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_twidjoy_drv_serio_driver == 0) {
          ...
          ldv_s_twidjoy_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
