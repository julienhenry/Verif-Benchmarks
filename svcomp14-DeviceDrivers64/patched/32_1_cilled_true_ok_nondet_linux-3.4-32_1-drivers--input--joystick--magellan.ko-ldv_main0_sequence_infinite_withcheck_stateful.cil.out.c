...
{ struct input_dev *dev ;
  ...
  if (0) {
    ...
    while (1) {
      ...
      __cil_tmp23 = (unsigned long )i * 4UL;
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& magellan_drv, & __this_module, "magellan");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_magellan_drv_serio_driver == 0) {
          ...
          ldv_s_magellan_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
