...
{ void *tmp ;
 ...
 static int libipw_is_valid_mode(struct libipw_device *ieee , int mode ) 
{ 
...
{ 
 ...
 static void ipw_set_scan_type(struct ipw_scan_request_ext *scan , u8 index ,
                                       u8 scan_type ) 
{ 
...
static struct libipw_qos_parameters def_qos_parameters_CCK  =    {{31U, 31U, 15U, 7U}, {1023U, 1023U, 31U, 15U}, {1U, 5U, 0U, 0U}, {0U, 0U, 0U,
                                                                      0U}, {0U, 0U,
                                                                            6016U,
                                                                            3264U}};
static struct libipw_qos_parameters def_parameters_OFDM  =    {{15U,
     15U, 15U, 15U}, {1023U, 1023U, 1023U, 1023U}, {0U, 0U, 0U, 0U}, {0U, 0U, 0U,
                                                                      0U}, {0U, 0U,
                                                                            0U, 0U}};
static struct libipw_qos_parameters def_parameters_CCK  =    {{31U,
     31U, 31U, 31U}, {1023U, 1023U, 1023U, 1023U}, {0U, 0U, 0U, 0U}, {0U, 0U, 0U,
                                                                      0U}, {0U, 0U,
                                                                            0U, 0U}};
...
{ size_t out ;
  ...
  tmp = snprint_line((char *)output, size, data + (unsigned long )ofs, (u32 )tmp___0,
                     ofs);
  out = (size_t )tmp;
  ofs += 16U;
  output += out;
...
static void _ipw_write_reg8(struct ipw_priv *priv , u32 reg , u8 value ) ;
 static void ipw_write_reg8(struct ipw_priv *a , u32 b , u8 c ) 
...
static void _ipw_write_reg16(struct ipw_priv *priv , u32 reg , u16 value ) ;
 static void ipw_write_reg16(struct ipw_priv *a , u32 b , u16 c ) 
{ struct thread_info *tmp ;
  int tmp___0 ;
...
static void _ipw_write_reg32(struct ipw_priv *priv , u32 reg , u32 value ) ;
 static void ipw_write_reg32(struct ipw_priv *a , u32 b , u32 c ) 
{ struct thread_info *tmp ;
  int tmp___0 ;
 ...
 static void _ipw_write8(struct ipw_priv *ipw , unsigned long ofs , u8 val ) 
{ 
 ...
 static void _ipw_write16(struct ipw_priv *ipw , unsigned long ofs , u16 val ) 
{ 
 ...
 static void _ipw_write32(struct ipw_priv *ipw , unsigned long ofs , u32 val ) 
{ 
 ...
 static u8 _ipw_read8(struct ipw_priv *ipw , unsigned long ofs ) 
{ unsigned char tmp ;
 ...
 static u32 _ipw_read32(struct ipw_priv *ipw , unsigned long ofs ) 
{ unsigned int tmp ;
...
{ struct thread_info *tmp ;
 ...
 static void __ipw_enable_interrupts(struct ipw_priv *priv ) 
{ struct thread_info *tmp ;
  int tmp___0 ;
 ...
 static void __ipw_disable_interrupts(struct ipw_priv *priv ) 
{ struct thread_info *tmp ;
  int tmp___0 ;
...
{ unsigned long flags ;
 ...
 static void ipw_disable_interrupts(struct ipw_priv *priv ) 
{ unsigned long flags ;
  raw_spinlock_t *tmp ;
...
{ u32 i ;
 ...
 static int ipw_is_init(struct ipw_priv *priv ) 
{ 
  ...
  *len = total_len;
  ...
  if ((ipw_debug_level & 1048576U) != 0U) {
    ...
    printk("\017ipw2200: %c %s addr = 0x%08x, total_len = %i, field_info = 0x%08x\n",
           tmp___23, "ipw_get_ordinal", addr, total_len, field_info);
  }
  if ((ipw_debug_level & 134217728U) != 0U) {
...
static struct driver_attribute driver_attr_debug_level  =    {{"debug_level", 420U, (_Bool)0, 0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
 ...
 static u32 ipw_get_event_log_len(struct ipw_priv *priv ) 
{ struct thread_info *tmp ;
  u32 tmp___0 ;
  u32 tmp___1 ;
  int tmp___2 ;
...
{ struct ipw_priv *priv ;
  ...
  if ((ipw_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2200: %c %s Setting rtap filter to %c%c%c%c-%c%c%c%c:%c%c%c%c-%c%c%c%c\n",
           tmp___18, "store_rtap_filter", tmp___17, tmp___16, tmp___15, tmp___14,
           tmp___13, tmp___12, tmp___11, tmp___10, tmp___9, tmp___8, tmp___7, tmp___6,
...
{ struct ipw_priv *priv ;
  ...
  priv = (struct ipw_priv *)tmp;
  if ((unsigned long )priv->prom_priv != (unsigned long )((struct ipw_prom_priv *)0)) {
    tmp___1 = (unsigned int )(priv->prom_priv)->filter;
  } else {
    tmp___1 = 0U;
  }
  tmp___0 = sprintf(buf, "0x%04X", tmp___1);
  return ((ssize_t )tmp___0);
}
}
...
{ struct ipw_priv *priv ;
  ...
  if ((int )geo->bg[i].flags & 1) {
    tmp___5 = (char *)"passive only";
  } else {
    tmp___5 = (char *)"active/passive";
  }
  ...
  if ((int )geo->a[i].flags & 1) {
    tmp___8 = (char *)"passive only";
  } else {
    tmp___8 = (char *)"active/passive";
  }
...
{ int _min1 ;
  ...
  tmp = ipw_send_cmd_pdu(priv, 8, (int )((u8 )tmp___0), (void *)ssid);
  return (tmp);
}
}
  ...
  if ((priv->status & 2097152U) != 0U) {
    if ((ipw_debug_level & 2048U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Scan completion watchdog aborting scan after (%dms).\n",
             tmp___4, "ipw_scan_check", tmp___1);
    }
    ipw_abort_scan(priv);
...
{ struct libipw_geo  const  *geo ;
  ...
  if ((priv->ieee)->abg_true != 0) {
    ...
    if ((int )max_power != 0) {
      ...
      tx_power.channels_tx_power[i].tx_power = (s8 )tmp___4;
    } else {
      tx_power.channels_tx_power[i].tx_power = priv->tx_power;
    }
    i ++;
...
{ 
 ...
 static void eeprom_write_bit(struct ipw_priv *p , u8 bit ) 
{ int d ;
...
{ u32 tmp ;
 ...
 static void ipw_fw_dma_reset_command_blocks(struct ipw_priv *priv ) 
{ 
...
{ u32 address ;
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s >> :\n", tmp___2, "ipw_fw_dma_write_command_block");
  }
  if ((ipw_debug_level & 134217728U) != 0U) {
    tmp___0 = current_thread_info();
    if (((unsigned long )tmp___0->preempt_count & 134217472UL) != 0UL) {
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s << :\n", tmp___4, "ipw_fw_dma_write_command_block");
  }
  return (0);
}
}
...
{ u32 address ;
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s >> :\n", tmp___7, "ipw_fw_dma_dump_command_block");
  }
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s >> :\n", tmp___14, "ipw_fw_dma_dump_command_block");
  }
  return;
}
}
...
{ u32 current_cb_address ;
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s << :\n", tmp___2, "ipw_fw_dma_command_block_index");
  }
  ...
  if ((ipw_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2200: %c %s >> :\n", tmp___4, "ipw_fw_dma_command_block_index");
  }
...
{ int s ;
 ...
 static int ipw_tx_queue_space(struct clx2_queue  const  *q ) 
{ int s ;
 ...
 static int ipw_queue_inc_wrap(int index , int n_bd ) 
{ int tmp ;
...
{ int i ;
 ...
 static void average_init(struct average *avg ) 
{ 
...
{ struct thread_info *tmp ;
  ...
  if ((priv->status & 2097152U) != 0U && missed_count > 3) {
    if ((ipw_debug_level & 1092U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Aborting scan with missed beacon.\n", tmp___9, "ipw_handle_missed_beacon");
    }
    schedule_work(& priv->abort_scan);
  }
...
{ char ssid[129U] ;
  ...
  if ((ipw_debug_level & 5184U) != 0U) {
    ...
    printk("\017ipw2200: %c %s authenticated: \'%s\' %pM\n", tmp___43, "ipw_rx_notification",
           tmp___7, (u8 *)(& priv->bssid));
  }
  goto ldv_47084;
  case 0: ;
  if ((priv->status & 64U) != 0U) {
    ...
    if ((ipw_debug_level & 5184U) != 0U) {
      ...
      printk("\017ipw2200: %c %s association failed (0x%04X): %s\n", tmp___44, "ipw_rx_notification",
             (int )resp->status, tmp___9);
    }
  }
  if ((ipw_debug_level & 5184U) != 0U) {
  ...
  if ((ipw_debug_level & 1088U) != 0U) {
    ...
    printk("\017ipw2200: %c %s authenticated: \'%s\' %pM\n", tmp___46, "ipw_rx_notification",
           tmp___13, (u8 *)(& priv->bssid));
  }
  priv->status |= 64U;
  goto ldv_47095;
  case 0: ;
  ...
  if ((ipw_debug_level & 5184U) != 0U) {
    ...
    printk("\017ipw2200: %c %s AUTH_SEQ_2\n", tmp___50, "ipw_rx_notification");
  }
  goto ldv_47095;
  case 3: ;
  if ((ipw_debug_level & 5184U) != 0U) {
    tmp___21 = current_thread_info();
    if (((unsigned long )tmp___21->preempt_count & 134217472UL) != 0UL) {
      tmp___51 = 73;
    } else {
      tmp___51 = 85;
    }
  ...
  if ((ipw_debug_level & 5184U) != 0U) {
    ...
    printk("\017ipw2200: %c %s AUT_SEQ_2_FAIL\n", tmp___56, "ipw_rx_notification");
  }
  goto ldv_47095;
  case 10: ;
  if ((ipw_debug_level & 5184U) != 0U) {
    tmp___27 = current_thread_info();
    if (((unsigned long )tmp___27->preempt_count & 134217472UL) != 0UL) {
      tmp___57 = 73;
    } else {
      tmp___57 = 85;
    }
  ...
  if ((unsigned int )size == 46U) {
    if ((ipw_debug_level & 2048U) != 0U) {
      ...
      if (((unsigned long )tmp___31->preempt_count & 134217472UL) != 0UL) {
        tmp___61 = 73;
      } else {
        tmp___61 = 85;
      }
      printk("\017ipw2200: %c %s Scan result for channel %d\n", tmp___61, "ipw_rx_notification",
             (int )x->channel_num);
    } else
    if ((ipw_debug_level & 2048U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Scan result of wrong size %d (should be %zd)\n",
             tmp___62, "ipw_rx_notification", (int )size, 46UL);
    }
  }
  goto ldv_47091;
  case 13: 
  ...
  if ((unsigned int )size == 4U) {
    if ((ipw_debug_level & 2048U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Scan completed: type %d, %d channels, %d status\n",
             tmp___63, "ipw_rx_notification", (int )x___0->scan_type, (int )x___0->num_channels,
             (int )x___0->status);
    } else {
  ...
  if ((ipw_debug_level & 1024U) != 0U) {
    ...
    if (((unsigned long )tmp___37->preempt_count & 134217472UL) != 0UL) {
      tmp___66 = 73;
    } else {
      tmp___66 = 85;
    }
    printk("\017ipw2200: %c %s Unknown notification: subtype=%d,flags=0x%2x,size=%d\n",
           tmp___66, "ipw_rx_notification", (int )notif->subtype, (int )notif->flags,
           (int )size);
  }
  }
  ldv_47091: ;
...
{ int num_rates ;
  ...
  if ((int )_min1___0 < (int )_min2___0) {
    num_rates = (int )_min1___0;
  } else {
    num_rates = (int )_min2___0;
  }
  i = 0;
  goto ldv_47269;
  ldv_47268: 
...
{ struct ipw_supported_rates rates ;
  ...
  if ((priv->ieee)->iw_mode == 1 && ((int )network->capability & 2) == 0) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded due to capability mismatch.\n",
             tmp___33, "ipw_find_adhoc_network", tmp, (u8 *)(& network->bssid));
    }
    return (0);
  }
      ...
      if (tmp___7 != 0) {
        ...
        if ((ipw_debug_level & 1073741824U) != 0U) {
          ...
          printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of non-network ESSID.\n",
                 tmp___34, "ipw_find_adhoc_network", tmp___1, (u8 *)(& network->bssid));
        }
        return (0);
      } else
          ...
          if (tmp___6 != 0) {
            ...
            if ((ipw_debug_level & 1073741824U) != 0U) {
              ...
              printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of ESSID mismatch: \'%s\'.\n",
                     tmp___36, "ipw_find_adhoc_network", (char *)(& escaped), (u8 *)(& network->bssid),
                     tmp___4);
            }
            return (0);
          }
  ...
  if (network->time_stamp[0] < (match->network)->time_stamp[0]) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s excluded because newer than current network.\n",
             tmp___37, "ipw_find_adhoc_network", tmp___9);
    }
    return (0);
  } else
  if (network->time_stamp[1] < (match->network)->time_stamp[1]) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s excluded because newer than current network.\n",
             tmp___38, "ipw_find_adhoc_network", tmp___11);
    }
    return (0);
  }
  if ((priv->ieee)->scan_age != 0 && (long )(network->last_scanned + (unsigned long )(priv->ieee)->scan_age) - (long )jiffies < 0L) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of age: %ums.\n",
             tmp___39, "ipw_find_adhoc_network", tmp___14, (u8 *)(& network->bssid),
             tmp___13);
    }
    return (0);
  }
  if ((int )priv->config & 1 && (int )network->channel != (int )priv->channel) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of channel mismatch: %d != %d.\n",
             tmp___40, "ipw_find_adhoc_network", tmp___16, (u8 *)(& network->bssid),
  ...
  if (((priv->capability & 2U) != 0U) ^ (((int )network->capability & 16) != 0)) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of privacy mismatch: %s != %s.\n",
             tmp___43, "ipw_find_adhoc_network", tmp___18, (u8 *)(& network->bssid),
             tmp___42, tmp___41);
    }
    return (0);
  }
  ...
  if (tmp___22 == 0) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of the same BSSID match: %pM.\n",
             tmp___44, "ipw_find_adhoc_network", tmp___20, (u8 *)(& network->bssid),
             (u8 *)(& priv->bssid));
    }
    return (0);
  }
  ...
  if (tmp___25 == 0) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of invalid frequency/mode combination.\n",
             tmp___45, "ipw_find_adhoc_network", tmp___23, (u8 *)(& network->bssid));
    }
    return (0);
  }
  ...
  if (tmp___28 == 0) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because configured rate mask excludes AP mandatory rate.\n",
             tmp___46, "ipw_find_adhoc_network", tmp___26, (u8 *)(& network->bssid));
    }
    return (0);
  }
  if ((unsigned int )rates.num_rates == 0U) {
    if ((ipw_debug_level & 1073741824U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of no compatible rates.\n",
             tmp___47, "ipw_find_adhoc_network", tmp___29, (u8 *)(& network->bssid));
    }
    return (0);
  }
    ...
    if ((unsigned long )match.network == (unsigned long )priv->assoc_network) {
      if ((ipw_debug_level & 1073741824U) != 0U) {
        ...
        printk("\017ipw2200: %c %s No better ADHOC in this network to merge to.\n",
               tmp___3, "ipw_merge_adhoc_network");
      }
      return;
    }
...
{ struct ipw_supported_rates rates ;
  ...
  if (((priv->ieee)->iw_mode == 2 && ((int )network->capability & 1) == 0) || ((priv->ieee)->iw_mode == 1 && ((int )network->capability & 2) == 0)) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded due to capability mismatch.\n",
             tmp___38, "ipw_best_network", tmp, (u8 *)(& network->bssid));
    }
    return (0);
  }
  tmp___8 = ldv__builtin_expect(roaming___0 != 0, 0L);
    ...
    if ((int )network->ssid_len != (int )(match->network)->ssid_len) {
      ...
      if (tmp___7 != 0) {
        ...
        if ((ipw_debug_level & 4100U) != 0U) {
          ...
          printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of non-network ESSID.\n",
                 tmp___39, "ipw_best_network", tmp___1, (u8 *)(& network->bssid));
        }
        return (0);
      } else
      if ((priv->config & 2U) != 0U) {
        if ((int )network->ssid_len != (int )priv->essid_len) {
          ...
          if (tmp___6 != 0) {
            ...
            if ((ipw_debug_level & 4100U) != 0U) {
              ...
              printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of ESSID mismatch: \'%s\'.\n",
                     tmp___41, "ipw_best_network", (char *)(& escaped), (u8 *)(& network->bssid),
                     tmp___4);
            }
            return (0);
          }
  ...
  if ((unsigned long )match->network != (unsigned long )((struct libipw_network *)0) && (int )(match->network)->stats.rssi > (int )network->stats.rssi) {
    ...
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because \'%s (%pM)\' has a stronger signal.\n",
             tmp___42, "ipw_best_network", (char *)(& escaped___0), (u8 *)(& network->bssid),
  ...
  if (network->last_associate != 0U && (long )jiffies - (long )((unsigned long )network->last_associate + 750UL) < 0L) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of storming (%ums since last assoc attempt).\n",
             tmp___43, "ipw_best_network", tmp___13, (u8 *)(& network->bssid), tmp___12);
    }
    return (0);
  }
  if ((priv->ieee)->scan_age != 0 && (long )(network->last_scanned + (unsigned long )(priv->ieee)->scan_age) - (long )jiffies < 0L) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of age: %ums.\n",
             tmp___44, "ipw_best_network", tmp___16, (u8 *)(& network->bssid), tmp___15);
    }
    return (0);
  }
  if ((int )priv->config & 1 && (int )network->channel != (int )priv->channel) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of channel mismatch: %d != %d.\n",
             tmp___45, "ipw_best_network", tmp___18, (u8 *)(& network->bssid), (int )network->channel,
             (int )priv->channel);
    }
    return (0);
  }
  if (((priv->capability & 2U) != 0U) ^ (((int )network->capability & 16) != 0)) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of privacy mismatch: %s != %s.\n",
             tmp___48, "ipw_best_network", tmp___20, (u8 *)(& network->bssid), tmp___47,
             tmp___46);
    }
    return (0);
  }
    ...
    if (tmp___24 != 0) {
      if ((ipw_debug_level & 4100U) != 0U) {
        ...
        printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of BSSID mismatch: %pM.\n",
               tmp___49, "ipw_best_network", tmp___22, (u8 *)(& network->bssid), (u8 *)(& priv->bssid));
      }
      return (0);
    }
  }
  ...
  if (tmp___27 == 0) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of invalid frequency/mode combination.\n",
             tmp___50, "ipw_best_network", tmp___25, (u8 *)(& network->bssid));
    }
    return (0);
  }
  ...
  if (tmp___30 == 0) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of invalid channel in current GEO\n",
             tmp___51, "ipw_best_network", tmp___28, (u8 *)(& network->bssid));
    }
    return (0);
  }
  ...
  if (tmp___33 == 0) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because configured rate mask excludes AP mandatory rate.\n",
             tmp___52, "ipw_best_network", tmp___31, (u8 *)(& network->bssid));
    }
    return (0);
  }
  if ((unsigned int )rates.num_rates == 0U) {
    if ((ipw_debug_level & 4100U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Network \'%s (%pM)\' excluded because of no compatible rates.\n",
             tmp___53, "ipw_best_network", tmp___34, (u8 *)(& network->bssid));
    }
    return (0);
  }
  ipw_copy_rates(& match->rates, (struct ipw_supported_rates  const  *)(& rates));
...
{ char ssid[129U] ;
  ...
  if ((ipw_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2200: %c %s Scan completed, no valid APs matched [CFG 0x%08X]\n",
           tmp___10, "ipw_debug_config", priv->config);
  }
  ...
  if ((priv->ieee)->freq_band & 1) {
    ...
    if ((priv->config & 2048U) != 0U) {
      ...
      if ((int )geo->bg[i].flags & 1) {
        ...
        tmp___2 = (int )((u8 )scan_type);
      }
      ipw_set_scan_type(scan, (int )((u8 )channel_index), tmp___2);
      ldv_47489: 
      i ++;
      ldv_47491: ;
      if ((int )geo->bg_channels > i) {
  ...
  if (direct != 0 && (unsigned int )priv->direct_scan_ssid_len == 0U) {
    if ((ipw_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Direct scan requested but no SSID to scan for\n",
             tmp___11, "ipw_request_scan_helper");
    }
...
{ int err ;
  ...
  if ((ipw_debug_level & 4100U) != 0U) {
    ...
    if ((priv->capability & 2U) != 0U) {
      tmp___11 = (int )(priv->ieee)->sec.active_key + 49;
    } else {
      tmp___11 = 46;
    }
    if ((priv->capability & 2U) != 0U) {
    ...
    printk("\017ipw2200: %c %s %ssociation attempt: \'%s\', channel %d, 802.11%c [%d], %s[:%s], enc=%s%s%s%c%c\n",
           tmp___19, "ipw_associate_network", tmp___18, tmp, (int )network->channel,
           (int )ipw_modes[(int )priv->assoc_request.ieee_mode], (int )rates->num_rates,
           tmp___17, tmp___16, tmp___15, tmp___14, tmp___12, tmp___11, tmp___10);
  }
...
{ struct net_device *dev ;
    ...
    if (tmp___3 != 0L) {
      ...
      if ((ipw_debug_level & 8192U) != 0U) {
        ...
        printk("\017ipw2200: %c %s Dropping packet while interface is not up.\n",
               tmp___10, "ipw_handle_data_packet");
      }
      return;
    }
  }
  ...
  if ((priv->ieee)->iw_mode != 6) {
    ...
    if ((int )tmp___7) {
      tmp___12 = (priv->ieee)->host_mc_decrypt == 0;
    } else {
      tmp___12 = (priv->ieee)->host_decrypt == 0;
    }
    if (tmp___12) {
...
{ struct net_device *dev ;
  ...
  if (tmp___5 != 0L) {
    ...
    if ((ipw_debug_level & 8192U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Corruption detected! Oh no!\n", tmp___9, "ipw_handle_data_packet_monitor");
    }
    return;
  } else {
    tmp___1 = netif_running((struct net_device  const  *)priv->net_dev);
    ...
    if (tmp___3 != 0L) {
      ...
      if ((ipw_debug_level & 8192U) != 0U) {
        ...
        printk("\017ipw2200: %c %s Dropping packet while interface is not up.\n",
               tmp___10, "ipw_handle_data_packet_monitor");
      }
      return;
    }
  }
  ...
  if ((unsigned int )received_channel <= 14U) {
    if ((unsigned int )received_channel != 14U) {
      tmp___12 = (unsigned int )received_channel * 5U + 2407U;
    } else {
      tmp___12 = 2484U;
    }
    ipw_rt->rt_channel = tmp___12;
  } else {
  ...
  if ((ipw_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2200: %c %s Rx packet of %d bytes.\n", tmp___13, "ipw_handle_data_packet_monitor",
           (rxb->skb)->len);
  }
  tmp___8 = libipw_rx(priv->ieee, rxb->skb, stats);
  if (tmp___8 == 0) {
...
{ struct net_device *dev ;
  ...
  tmp___1 = ldv__builtin_expect((unsigned int )len + 28U > (unsigned int )tmp___0,
                                0L);
  if (tmp___1 != 0L) {
    (dev->stats.rx_errors) ++;
    if ((ipw_debug_level & 8192U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Corruption detected! Oh no!\n", tmp___10, "ipw_handle_promiscuous_rx");
    }
    return;
  }
  ...
  if ((unsigned int )channel <= 14U) {
    if ((unsigned int )channel != 14U) {
      tmp___13 = (unsigned int )channel * 5U + 2407U;
    } else {
      tmp___13 = 2484U;
    }
  ...
  if ((ipw_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2200: %c %s Rx packet of %d bytes.\n", tmp___14, "ipw_handle_promiscuous_rx",
           skb->len);
  }
...
{ struct sk_buff *skb ;
  ...
  if ((priv->config & 4096U) != 0U) {
    ...
    if (__len > 63UL) {
      ...
      __ret = __memcpy((void *)tmp___1, (void const   *)stats, __len);
    } else {
...
{ struct ipw_rx_mem_buffer *rxb ;
  ...
  if ((ipw_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2200: %c %s Frame: len=%u\n", tmp___20, "ipw_rx", (int )pkt->u.frame.length);
  }
  ...
  if ((int )priv->channel == (int )channel) {
    if ((ipw_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2200: %c %s Request to set channel to current value (%d)\n",
             tmp___10, "ipw_set_channel", (int )channel);
    }
    return (0);
  }
  if ((ipw_debug_level & 4U) != 0U) {
...
{ struct ipw_priv *priv ;
  ...
  range->num_bitrates = (__u8 )tmp___2;
  i = 0;
  goto ldv_48181;
  ldv_48180: 
...
{ struct libipw_hdr_3addrqos *hdr ;
  ...
  *(txq->txb + (unsigned long )q->first_empty) = txb;
  ...
  tfd->u.data.num_chunks = (unsigned int )tmp___16;
...
{ struct libipw_rx_stats dummystats ;
  ...
  if ((unsigned int )priv->channel <= 14U) {
    if ((unsigned int )priv->channel != 14U) {
      tmp___6 = (unsigned int )((unsigned short )priv->channel) * 5U + 2407U;
    } else {
      tmp___6 = 2484U;
    }
    *((__le16 *)tmp___0) = tmp___6;
  } else {
...
{ int i ;
  ...
  if ((unsigned int )((unsigned char )geo->a_channels) != 0U) {
    ...
    if (((int )geo->a[i].flags & 8) != 0) {
      (a_band->channels + (unsigned long )i)->flags |= 4U;
    }
    if (((int )geo->a[i].flags & 32) != 0) {
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_ipw_prom_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_ipw_prom_netdev_ops_net_device_ops ++;
  }
  goto ldv_49272;
  case 7: ;
  ...
  if (ldv_s_ipw_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_ipw_netdev_ops_net_device_ops ++;
  }
  goto ldv_49272;
  case 10: ;
