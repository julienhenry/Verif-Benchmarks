...
{ int i ;
  ...
  *((unsigned long *)__cil_tmp27) = (unsigned long )__cil_tmp33;
  __cil_tmp34 = (unsigned long )(& icard) + 4UL;
    ...
    teles_ids, {(char const   *)0, (struct bus_type *)0, (struct module *)0, (char const   *)0,
                ...
                (struct driver_private *)0}, {{{0}, {{{{{0U}}, 0U, 0U, (void *)0}}},
                                               ...
                                               (void *)0}, {(struct list_head *)0,
                                                            (struct list_head *)0}}};
static int init_teles_cs(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
