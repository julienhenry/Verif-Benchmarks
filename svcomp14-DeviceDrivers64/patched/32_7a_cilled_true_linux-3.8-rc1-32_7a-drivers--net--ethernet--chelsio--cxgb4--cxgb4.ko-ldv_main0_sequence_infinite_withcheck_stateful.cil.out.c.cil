...
extern int _dev_info(struct device  const  * , char const   *  , ...) ;
 static int is_vmalloc_addr(void const   *x ) 
{ unsigned long addr ;
...
extern u32 ethtool_op_get_link(struct net_device * ) ;
 static u32 ethtool_rxfh_indir_default(u32 index , u32 n_rx_rings ) 
{ 
...
extern struct net_device *vlan_dev_real_dev(struct net_device  const  * ) ;
 static bool mdio_phy_id_is_c45(int phy_id ) 
{ 
 ...
 static __u16 mdio_phy_id_prtad(int phy_id ) 
{ 
 ...
 static __u16 mdio_phy_id_devad(int phy_id ) 
{ 
...
extern int pcie_capability_clear_and_set_word(struct pci_dev * , int  , u16  , u16  ) ;
 static int pcie_capability_set_word(struct pci_dev *dev , int pos , u16 set ) 
{ int tmp ;
...
{ 
 ...
 static struct port_info *netdev2pinfo(struct net_device  const  *dev ) 
{ void *tmp ;
...
{ void *tmp ;
 ...
 static struct adapter *netdev2adap(struct net_device  const  *dev ) 
...
int t4_wr_mbox_meat(struct adapter *adap , int mbox , void const   *cmd , int size ,
 ...
 static int t4_wr_mbox(struct adapter *adap , int mbox , void const   *cmd ,
                               int size , void *rpl ) 
{ int tmp ;
...
{ struct filter_entry *f ;
  ...
  if ((unsigned long )f->l2t != (unsigned long )((struct l2t_entry *)0)) {
    tmp___17 = (int )(f->l2t)->idx;
  } else {
    tmp___17 = 0;
  }
  tmp___2 = __fswab32((__u32 )(((((((((((((((int )f->fs.rpttid << 25) | tmp___15) | ((int )f->fs.dirsteer << 23)) | ((int )f->fs.maskhash << 22)) | ((int )f->fs.dirsteerhash << 21)) | tmp___16) | ((int )f->fs.newdmac << 19)) | ((int )f->fs.newsmac << 18)) | (((unsigned int )*((unsigned short *)f + 9UL) == 256U || (unsigned int )*((unsigned short *)f + 9UL) == 384U) << 17)) | (((unsigned int )*((unsigned short *)f + 9UL) == 128U || (unsigned int )*((unsigned short *)f + 9UL) == 384U) << 16)) | ((int )f->fs.hitcnts << 15)) | ((int )f->fs.eport << 13)) | ((int )f->fs.prio << 12)) | tmp___17));
...
{ struct filter_entry *f ;
 ...
 static int is_offload(struct adapter  const  *adap ) 
{ 
...
{ struct port_info *pi ;
 ...
 static unsigned int mk_adap_vers(struct adapter  const  *ap ) 
{ 
...
{ int err ;
  ...
  if ((adap->flags & 4U) != 0U) {
    ...
    err = request_irq((adap->pdev)->irq, tmp, tmp___0, (char const   *)(& (adap->port[0])->name),
                      (void *)adap);
    if (err != 0) {
      goto irq_err;
    }
...
{ unsigned int start ;
  ...
  if (adap->vres.ocq.size != 0U) {
    ...
    if ((adap->pdev)->resource[2].start != 0ULL || (adap->pdev)->resource[2].end != (adap->pdev)->resource[2].start) {
      tmp___2 = ((unsigned int )(adap->pdev)->resource[2].end - (unsigned int )(adap->pdev)->resource[2].start) + 1U;
    } else {
      tmp___2 = 0U;
    }
    start = (unsigned int )(adap->pdev)->resource[2].start + (tmp___2 - (unsigned int )tmp);
...
{ struct sge *s ;
  ...
  ret = t4_config_glbl_rss(adapter, (int )adapter->mbox, 1U, tmp___1);
  if (ret < 0) {
    goto bye;
  }
...
{ int ret ;
  ...
  ret = t4_fw_hello(adap, adap->mbox, adap->fn, tmp___3, & state);
  if (ret < 0) {
  ...
  if ((unsigned int )caps_cmd.ofldcaps != 0U) {
    ...
    _min2 = 8192U;
    if (_min1 < _min2) {
      adap->tids.natids = _min1;
    } else {
      adap->tids.natids = _min2;
    }
...
static struct pci_error_handlers  const  cxgb4_eeh  =    {(pci_ers_result_t (*)(struct pci_dev * , enum pci_channel_state  ))(& eeh_err_detected),
 ...
 static bool is_10g_port(struct link_config  const  *lc ) 
{ 
 ...
 static void init_rspq(struct sge_rspq *q , u8 timer_idx , u8 pkt_cnt_idx ,
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_cxgb4_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_cxgb4_netdev_ops_net_device_ops ++;
  }
  goto ldv_46498;
  case 31: ;
...
extern void kfree_skb(struct sk_buff * ) ;
 static unsigned char *__skb_put___0(struct sk_buff *skb , unsigned int len ) 
{ unsigned char *tmp ;
  unsigned char *tmp___0 ;
  bool tmp___1 ;
  long tmp___2 ;
...
struct l2t_entry *cxgb4_l2t_get(struct l2t_data *d , struct neighbour *neigh , struct net_device  const  *physdev ,
 ...
 static unsigned int vlan_prio(struct l2t_entry  const  *e ) 
{ 
...
{ int tmp ;
 ...
 static unsigned int arp_hash(u32 const   *key , int ifindex ) 
{ u32 tmp ;
 ...
 static unsigned int ipv6_hash(u32 const   *key , int ifindex ) 
{ u32 xor ;
  u32 tmp ;
...
{ struct sk_buff *skb ;
  ...
  tmp___0 = __fswab32((__u32 )((((int )e->idx | tmp___4) | ((int )adap->sge.fw_evtq.abs_id << 14)) | 301989888));
  req->ot.opcode_tid = tmp___0;
  if (sync == 0) {
    tmp___5 = -32768;
  } else {
  ...
  tmp___1 = __fswab16((int )((__u16 )((int )((short )((int )e->lport << 8)) | tmp___5)));
  req->params = tmp___1;
...
{ unsigned int tid ;
  ...
  tid = tmp & 16777215U;
  idx = tid & 4095U;
  tmp___0 = ldv__builtin_expect((unsigned int )((unsigned char )rpl->status) != 0U,
                                0L);
  if (tmp___0 != 0L) {
 ...
 static void arpq_enqueue(struct l2t_entry *e , struct sk_buff *skb ) 
{ 
...
{ int i ;
 ...
 static void *l2t_get_idx(struct seq_file *seq , loff_t pos ) 
...
{ int tmp ;
 ...
 static u16 pci_vpd_lrdt_size(u8 const   *lrdt ) 
{ 
 ...
 static u8 pci_vpd_info_field_size(u8 const   *info_field ) 
{ 
...
{ u32 val ;
 ...
 static int t4_wait_op_done(struct adapter *adapter , int reg , u32 mask ,
  ...
  if ((v & 2U) != 0U) {
    ...
    if (tmp___2 != 0) {
      ...
      dev_warn((struct device  const  *)adapter->pdev_dev, "%u %s correctable ECC data error%s\n",
               cnt, (char const   *)(& name) + (unsigned long )idx, tmp___3);
    }
  }
  if ((v & 4U) != 0U) {
...
{ int ret ;
  ...
  tmp = __fswab32((((unsigned int )(tmp___3 | tmp___4) | tmp___5) | (evt_mbox << 20)) | 65536U);
...
{ unsigned char *tmp ;
 ...
 static u32 skb_network_header_len(struct sk_buff  const  *skb ) 
{ 
...
{ struct sk_buff *tmp ;
 ...
 static struct page *__skb_alloc_pages(gfp_t gfp_mask , struct sk_buff *skb ,
                                               unsigned int order ) 
{ struct page *page ;
 ...
 static struct page *__skb_alloc_page(gfp_t gfp_mask , struct sk_buff *skb ) 
{ struct page *tmp ;
...
{ bool tmp ;
 ...
 static bool napi_reschedule(struct napi_struct *napi ) 
{ bool tmp ;
...
extern void napi_complete(struct napi_struct * ) ;
 static int netdev_queue_numa_node_read(struct netdev_queue  const  *q ) 
{ 
...
extern void netif_napi_del(struct napi_struct * ) ;
 static void netif_tx_stop_queue___0(struct netdev_queue *dev_queue ) 
{ int __ret_warn_on ;
  long tmp ;
  long tmp___0 ;
...
struct sk_buff *cxgb4_pktgl_to_skb(struct pkt_gl  const  *gl , unsigned int skb_len ,
 ...
 static unsigned int core_ticks_per_usec(struct adapter  const  *adap ) 
{ 
 ...
 static unsigned int us_to_core_ticks(struct adapter  const  *adap , unsigned int us ) 
{ 
 ...
 static unsigned int core_ticks_to_us(struct adapter  const  *adapter , unsigned int ticks ) 
{ 
 ...
 static unsigned int fl_mtu_bufsize(struct adapter *adapter , unsigned int mtu ) 
{ struct sge *s ;
 ...
 static dma_addr_t get_buf_addr(struct rx_sw_desc  const  *d ) 
{ 
 ...
 static bool is_buf_mapped(struct rx_sw_desc  const  *d ) 
{ 
 ...
 static unsigned int txq_avail(struct sge_txq  const  *q ) 
{ 
 ...
 static unsigned int fl_cap(struct sge_fl  const  *fl ) 
{ 
 ...
 static bool fl_starving(struct sge_fl  const  *fl ) 
{ 
...
{ struct tx_sw_desc *d ;
 ...
 static int reclaimable(struct sge_txq  const  *q ) 
{ int hw_cidx ;
  __u16 tmp ;
  int tmp___0 ;
 ...
 static void reclaim_completed_tx(struct adapter *adap , struct sge_txq *q ,
                                          bool unmap ) 
{ int avail ;
  int tmp ;
 ...
 static int get_buf_size(struct adapter *adapter , struct rx_sw_desc  const  *d ) 
{ struct sge *s ;
...
{ struct rx_sw_desc *d ;
 ...
 static void ring_fl_db(struct adapter *adap , struct sge_fl *q ) 
{ 
 ...
 static void set_rx_sw_desc(struct rx_sw_desc *sd , struct page *pg , dma_addr_t mapping ) 
{ 
...
{ struct sge *s ;
 ...
 static void __refill_fl(struct adapter *adap , struct sge_fl *fl ) 
{ unsigned int _min1 ;
  unsigned int _min2 ;
  unsigned int tmp ;
  unsigned int tmp___0 ;
...
{ long tmp ;
 ...
 static int is_eth_imm(struct sk_buff  const  *skb ) 
{ 
 ...
 static unsigned int calc_tx_flits(struct sk_buff  const  *skb ) 
{ unsigned int flits ;
  int tmp ;
  unsigned char *tmp___0 ;
  unsigned int tmp___1 ;
...
{ unsigned int i ;
 ...
 static void ring_tx_db(struct adapter *adap , struct sge_txq *q , int n ) 
{ 
...
{ u32 wr_mid ;
  ...
  if ((unsigned int )((unsigned short )ssi->gso_size) != 0U) {
    ...
    if ((int )v6) {
      tmp___23 = 10995116277760ULL;
    } else {
      tmp___23 = 8796093022208ULL;
    }
    cntrl = (tmp___23 | ((unsigned long long )l3hdr_len << 20)) | ((unsigned long long )eth_xtra_len << 34);
    (q->tso) ++;
 ...
 static void reclaim_completed_tx_imm(struct sge_txq *q ) 
{ int hw_cidx ;
  __u16 tmp ;
  int reclaim ;
 ...
 static int is_imm(struct sk_buff  const  *skb ) 
{ 
...
{ int ret ;
 ...
 static int is_ofld_imm(struct sk_buff  const  *skb ) 
{ 
 ...
 static unsigned int calc_tx_flits_ofld(struct sk_buff  const  *skb ) 
{ unsigned int flits ;
  unsigned int cnt ;
  int tmp ;
  int tmp___0 ;
...
{ struct sge_ofld_txq *q ;
 ...
 static unsigned int skb_txq(struct sk_buff  const  *skb ) 
{ 
 ...
 static unsigned int is_ctrl_pkt(struct sk_buff  const  *skb ) 
{ 
 ...
 static int ofld_send(struct adapter *adap , struct sk_buff *skb ) 
{ unsigned int idx ;
  unsigned int tmp ;
  int tmp___0 ;
  unsigned int tmp___1 ;
...
{ struct adapter *tmp ;
 ...
 static void copy_frags(struct sk_buff *skb , struct pkt_gl  const  *gl ,
                                unsigned int offset ) 
{ int i ;
  unsigned char *tmp ;
...
{ struct adapter *adapter ;
  ...
  tmp___1 = ldv__builtin_expect((unsigned int )*((unsigned char *)pkt + 9UL) != 0U,
                                0L);
  if (tmp___1 != 0L) {
...
{ bool csum_ok ;
  ...
  tmp___3 = ldv__builtin_expect((unsigned int )*((unsigned char *)pkt + 9UL) != 0U,
                                0L);
  if (tmp___3 != 0L) {
...
{ struct rx_sw_desc *d ;
 ...
 static bool is_new_response(struct rsp_ctrl  const  *r , struct sge_rspq  const  *q ) 
{ 
 ...
 static void rspq_next(struct sge_rspq *q ) 
{ long tmp ;

  {
  q->cur_desc += (unsigned long )q->iqe_len;
  (q->cidx) ++;
...
{ int ret ;
  ...
  tmp___2 = __fswab32((__u32 )((((((int )fwevtq << 28) | ((int )pi->viid << 16)) | tmp___18) | 4096) | tmp___19));
