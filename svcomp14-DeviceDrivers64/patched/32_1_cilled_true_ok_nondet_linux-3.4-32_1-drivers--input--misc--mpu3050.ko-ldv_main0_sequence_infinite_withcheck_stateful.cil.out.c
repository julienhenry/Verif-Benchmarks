...
{ struct mpu3050_sensor *sensor ;
  ...
  __cil_tmp15 = (unsigned long )(& axis) + 2UL;
  ...
  __cil_tmp21 = (unsigned long )(& axis) + 4UL;
...
{ struct mpu3050_sensor *sensor ;
  ...
  *((void (**)(struct input_dev *dev ))__cil_tmp42) = & mpu3050_input_close;
  ...
  if (error) {
    ...
    __cil_tmp65 = __cil_tmp64 + 808UL;
    __cil_tmp66 = *((int *)__cil_tmp65);
    dev_err(__cil_tmp63, "can\'t get IRQ %d, error %d\n", __cil_tmp66, error);
    goto err_pm_set_suspended;
  }
  tmp___8 = (int )input_register_device(idev);
  error = tmp___8;
  if (error) {
...
static struct i2c_device_id  const  mpu3050_ids[1]  = {      {{(char )'m',
       (char )'p', (char )'u', (char )'3', (char )'0', (char )'5', (char )'0', (char )'\000',
