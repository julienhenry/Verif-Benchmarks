...
{ CommandList_struct *c ;
  ...
  blk_end_request_all(rq, tmp___1);
  tmp___0 = spinlock_check(& h->lock);
  flags = _raw_spin_lock_irqsave(tmp___0);
  cmd_free(h, c);
...
{ size_t cmd_sz ;
  ...
  if (pdev->resource[0].start != 0ULL || pdev->resource[0].end != pdev->resource[0].start) {
    tmp___0 = (unsigned long )((pdev->resource[0].end - pdev->resource[0].start) + 1ULL);
  } else {
    tmp___0 = 0UL;
  }
  vaddr = ioremap_nocache(pdev->resource[0].start, tmp___0);
...
{ struct block_device *var_group1 ;
  ...
  if (ldv_s_cciss_fops_block_device_operations == 0) {
    ...
    ldv_s_cciss_fops_block_device_operations ++;
  }
  goto ldv_38093;
  case 1: ;
  ...
  if (ldv_s_cciss_proc_fops_file_operations == 0) {
    ...
    ldv_s_cciss_proc_fops_file_operations ++;
  }
  goto ldv_38093;
  case 11: ;
  ...
  if (ldv_s_cciss_pci_driver_pci_driver == 0) {
    ...
    ldv_s_cciss_pci_driver_pci_driver ++;
  }
  goto ldv_38093;
  case 15: ;
