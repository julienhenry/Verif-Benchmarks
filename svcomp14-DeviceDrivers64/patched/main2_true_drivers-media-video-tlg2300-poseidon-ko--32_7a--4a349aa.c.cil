...
static struct poseidon_tvnorm  const  poseidon_tvnorms[18U]  = 
  {      {32ULL, {'P', 'A', 'L', '-', 'D', '\000', (char)0, (char)0, (char)0, (char)0,
              (char)0, (char)0}, 32U}, 
        {1ULL, {'P', 'A', 'L', '-', 'B', '\000', (char)0, (char)0, (char)0, (char)0,
             (char)0, (char)0}, 16U}, 
        {4ULL, {'P', 'A', 'L', '-', 'G', '\000', (char)0, (char)0, (char)0, (char)0,
             (char)0, (char)0}, 64U}, 
        {8ULL, {'P', 'A', 'L', '-', 'H', '\000', (char)0, (char)0, (char)0, (char)0,
             (char)0, (char)0}, 128U}, 
        {16ULL, {'P', 'A', 'L', '-', 'I', '\000', (char)0, (char)0, (char)0, (char)0,
              (char)0, (char)0}, 256U}, 
        {256ULL, {'P', 'A', 'L', '-', 'M', '\000', (char)0, (char)0, (char)0, (char)0,
               (char)0, (char)0}, 512U}, 
        {512ULL, {'P', 'A', 'L', '-', 'N', '\000', (char)0, (char)0, (char)0, (char)0,
               (char)0, (char)0}, 1048576U}, 
        {1024ULL, {'P', 'A', 'L', '-', 'N', 'c', '\000', (char)0, (char)0, (char)0, (char)0,
                (char)0}, 1048576U}, 
        {4096ULL, {'N', 'T', 'S', 'C', '-', 'M', '\000', (char)0, (char)0, (char)0, (char)0,
                (char)0}, 1U}, 
        {8192ULL, {'N', 'T', 'S', 'C', '-', 'J', 'P', '\000', (char)0, (char)0, (char)0,
                (char)0}, 2U}, 
        {65536ULL, {'S', 'E', 'C', 'A', 'M', '-', 'B', '\000', (char)0, (char)0, (char)0,
                 (char)0}, 4096U}, 
        {131072ULL, {'S', 'E', 'C', 'A', 'M', '-', 'D', '\000', (char)0, (char)0, (char)0,
                  (char)0}, 8192U}, 
        {262144ULL, {'S', 'E', 'C', 'A', 'M', '-', 'G', '\000', (char)0, (char)0, (char)0,
                  (char)0}, 16384U}, 
        {524288ULL, {'S', 'E', 'C', 'A', 'M', '-', 'H', '\000', (char)0, (char)0, (char)0,
                  (char)0}, 32768U}, 
        {1048576ULL, {'S', 'E', 'C', 'A', 'M', '-', 'K', '\000', (char)0, (char)0, (char)0,
                   (char)0}, 65536U}, 
        {2097152ULL, {'S', 'E', 'C', 'A', 'M', '-', 'K', '1', '\000', (char)0, (char)0,
                   (char)0}, 131072U}, 
        {4194304ULL, {'S', 'E', 'C', 'A', 'M', '-', 'L', '\000', (char)0, (char)0, (char)0,
                   (char)0}, 262144U}, 
        {8388608ULL, {'S', 'E', 'C', 'A', 'M', '-', 'L', 'C', '\000', (char)0, (char)0,
                   (char)0}, 524288U}};
...
{ size_t __len ;
  ...
  if (video->prev_left != 0) {
    ...
    video->dst += (unsigned long )(video->prev_left + video->lines_size);
    src += (unsigned long )video->prev_left;
    count -= (unsigned int )video->prev_left;
    video->prev_left = 0;
    goto ldv_28845;
  }
  (video->lines_copied) ++;
  ...
  video->dst += (unsigned long )(video->lines_size + video->lines_size);
  src += (unsigned long )video->lines_size;
  count -= (unsigned int )video->lines_size;
  ldv_28845: ;
...
{ struct vbi_data *vbi ;
 ...
 static void copy_vbi_data(struct vbi_data *vbi , char *src , unsigned int count ) 
{ struct front_face *front ;
  char *buf ;
  void *tmp ;
  size_t __len ;
  ...
  if ((unsigned long )front != (unsigned long )((struct front_face *)0)) {
    ...
    if ((int )tmp___0) {
      ...
      if ((vbi->video)->field_count != 0) {
        buf += (unsigned long )(vbi->vbi_size / 2U);
      }
      __len = (size_t )count;
 ...
 static void copy_vbi_video_data(struct video_data *video , char *src , unsigned int count ) 
{ struct vbi_data *vbi ;
...
{ s32 ret ;
  ...
  ret = usb_set_interface(pd->udev, 0, tmp___12);
  if (ret < 0) {
    goto error;
  }
...
{ struct videobuf_queue *var_group1 ;
  ...
  if (ldv_s_pd_video_fops_v4l2_file_operations == 0) {
    ...
    ldv_s_pd_video_fops_v4l2_file_operations ++;
  }
  goto ldv_29508;
  case 5: ;
...
{ 
 ...
 static struct snd_interval *hw_param_interval(struct snd_pcm_hw_params *params ,
...
{ 
 ...
 static void handle_audio_data(struct urb *urb , int *period_elapsed ) 
{ struct poseidon_audio *pa ;
  struct snd_pcm_runtime *runtime ;
  int stride ;
  int len ;
  ...
  pa->rcv_position += (unsigned int )len;
  if ((snd_pcm_uframes_t )pa->rcv_position >= runtime->buffer_size) {
    pa->rcv_position -= (unsigned int )runtime->buffer_size;
  }
  pa->copied_position += (unsigned int )len;
  if ((snd_pcm_uframes_t )pa->copied_position >= runtime->period_size) {
    pa->copied_position -= (unsigned int )runtime->period_size;
    *period_elapsed = 1;
  }
...
{ struct snd_pcm_substream *var_group1 ;
  ...
  if (ldv_s_pcm_capture_ops_snd_pcm_ops == 0) {
    ...
    ldv_s_pcm_capture_ops_snd_pcm_ops ++;
  }
  goto ldv_30603;
  case 1: ;
...
static int tlg_fm_vidioc_g_tuner(struct file *file ,
                                 void *priv , struct v4l2_tuner *vt ) 
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_poseidon_fm_fops_v4l2_file_operations == 0) {
    ...
    ldv_s_poseidon_fm_fops_v4l2_file_operations ++;
  }
  goto ldv_28794;
  case 1: ;
...
{ int ret ;
  ...
  ret = usb_bulk_msg(udev, tmp | 3221225472U, fwbuf + offset, (int )tmp___0, & actual_length,
                     2500);
  if (ret != 0) {
    goto ldv_29408;
  }
 ...
 static struct poseidon *get_pd(struct usb_interface *intf ) 
{ void *tmp ;
 ...
 static void set_map_flags(struct poseidon *pd , struct usb_device *udev ) 
{ 
 ...
 static int get_autopm_ref(struct poseidon *pd ) 
{ int tmp ;
 ...
 static struct poseidon *fixup(struct poseidon *pd ) 
{ int count ;
  int tmp ;
  int tmp___0 ;
...
{ struct poseidon *pd ;
 ...
 static int is_working(struct poseidon *pd ) 
{ int tmp ;
...
{ struct notifier_block *var_group1 ;
  ...
  if (ldv_s_poseidon_driver_usb_driver == 0) {
    ...
    ldv_s_poseidon_driver_usb_driver ++;
  }
  goto ldv_29539;
  case 2: ;
