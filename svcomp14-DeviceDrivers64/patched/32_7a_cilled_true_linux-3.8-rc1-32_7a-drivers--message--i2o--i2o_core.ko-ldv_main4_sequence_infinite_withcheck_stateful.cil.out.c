...
u32 i2o_cntxt_list_get_ptr(struct i2o_controller *c , void *ptr ) ;
 static u32 i2o_dma_low(dma_addr_t dma_addr ) 
{ 
 ...
 static u32 i2o_dma_high(dma_addr_t dma_addr ) 
{ 
...
{ struct i2o_msg_mfa *mmsg ;
 ...
 static void i2o_flush_reply(struct i2o_controller *c , u32 m ) 
{ 
...
struct i2o_controller *i2o_iop_alloc(void) ;
 static void i2o_iop_free(struct i2o_controller *c ) 
{ 
...
{ struct i2o_controller *c ;
 ...
 static void i2o_iop_enable_all(void) 
{ struct i2o_controller *c ;
  struct i2o_controller *tmp ;
  struct list_head  const  *__mptr ;
  struct list_head  const  *__mptr___0 ;
...
void i2o_driver_unregister(struct i2o_driver *drv ) ;
 static void i2o_driver_notify_controller_add(struct i2o_driver *drv , struct i2o_controller *c ) 
{ 
 ...
 static void i2o_driver_notify_controller_remove(struct i2o_driver *drv ,
                                                         struct i2o_controller *c ) 
{ 
 ...
 static void i2o_driver_notify_device_add(struct i2o_driver *drv , struct i2o_device *i2o_dev ) 
{ 
 ...
 static void i2o_driver_notify_device_remove(struct i2o_driver *drv , struct i2o_device *i2o_dev ) 
{ 
...
void i2o_driver_notify_device_remove_all(struct i2o_device *i2o_dev ) ;
 static struct i2o_message *i2o_msg_out_to_virt(struct i2o_controller *c ,
                                                        u32 m ) 
{ long tmp ;
  long tmp___0 ;
  ...
  if ((pdev->resource[i].flags & 256UL) == 0UL) {
    if (c->base.phys == 0UL) {
      ...
      if (pdev->resource[i].start != 0ULL || pdev->resource[i].end != pdev->resource[i].start) {
        c->base.len = (unsigned long )((pdev->resource[i].end - pdev->resource[i].start) + 1ULL);
      } else {
        c->base.len = 0UL;
      }
      ...
      if (pdev->resource[i].start != 0ULL || pdev->resource[i].end != pdev->resource[i].start) {
        c->in_queue.len = (unsigned long )((pdev->resource[i].end - pdev->resource[i].start) + 1ULL);
      } else {
        c->in_queue.len = 0UL;
      }
      goto ldv_23129;
...
{ struct pci_dev *var_group1 ;
  ...
  if (ldv_s_i2o_pci_driver_pci_driver == 0) {
    ...
    ldv_s_i2o_pci_driver_pci_driver ++;
  }
  goto ldv_23197;
  case 1: ;
