...
static u16 const   atl1c_rrd_addr_lo_regs[4U]  = {      (u16 const   )5480U,      (u16 const   )5484U,      (u16 const   )5488U,      (u16 const   )5492U};
 static void atl1c_irq_enable(struct atl1c_adapter *adapter ) 
{ int tmp ;
  long tmp___0 ;
...
{ struct pci_dev *pdev ;
 ...
 static void atl1c_clean_buffer(struct pci_dev *pdev , struct atl1c_buffer *buffer_info ,
                                        int in_irq ) 
{ u16 pci_driection ;
...
{ u32 pm_ctrl_data ;
  ...
  pm_ctrl_data &= 4294967231U;
  pm_ctrl_data &= 4293984255U;
  pm_ctrl_data &= 4043309055U;
  pm_ctrl_data |= 201326592U;
  if ((unsigned int )hw->nic_type == 2U) {
    goto _L;
  } else
  ...
  if ((unsigned int )hw->nic_type == 5U) {
    ...
    pm_ctrl_data |= 32768U;
    pm_ctrl_data &= 4279238655U;
    pm_ctrl_data |= 12582912U;
    pm_ctrl_data &= 3758096383U;
    pm_ctrl_data &= 2147483647U;
    pm_ctrl_data |= 65536U;
    pm_ctrl_data |= 64U;
  }
  pm_ctrl_data |= 1073741824U;
  if ((int )linkup) {
    pm_ctrl_data &= 4294967287U;
    pm_ctrl_data &= 4294963199U;
    ...
    if ((unsigned int )hw->nic_type == 5U) {
      ...
      pm_ctrl_data &= 4294967279U;
      pm_ctrl_data &= 4294967263U;
      pm_ctrl_data &= 4294967167U;
      pm_ctrl_data |= 8192U;
...
{ struct atl1c_hw *hw ;
  ...
  mac_ctrl_data |= 268435456U;
  if ((unsigned int )hw->nic_type == 4U) {
    mac_ctrl_data |= 1073741824U;
    mac_ctrl_data |= 536870912U;
  } else
  if ((unsigned int )hw->nic_type == 3U) {
    mac_ctrl_data |= 1073741824U;
    mac_ctrl_data |= 536870912U;
...
{ struct atl1c_hw *hw ;
 ...
 static void atl1c_clear_phy_int(struct atl1c_adapter *adapter ) 
{ u16 phy_data ;
