...
static struct attribute_group  const  dac7512_attr_group  =    {(char const   *)0,
    (umode_t (*)(struct kobject * , struct attribute * , int  ))0, dac7512_attributes};
...
{ int ret ;
  ...
  __cil_tmp5 = __cil_tmp4 + 782UL;
  *((u8 *)__cil_tmp5) = (u8 )8;
  __cil_tmp6 = (unsigned long )spi;
  __cil_tmp7 = __cil_tmp6 + 781UL;
  *((u8 *)__cil_tmp7) = (u8 )0;
  ret = spi_setup(spi);
  if (ret < 0) {
    return (ret);
  ...
  tmp = (int )sysfs_create_group(__cil_tmp11, & dac7512_attr_group);
  tmp___7 = tmp;
  return (tmp___7);
}
}
