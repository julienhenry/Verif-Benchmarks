...
{ struct find_interface_arg *arg ;
  ...
  intf = (struct usb_interface *)__mptr + 1152921504606846928UL;
...
{ struct find_interface_arg argb ;
  ...
  if ((unsigned long )dev != (unsigned long )((struct device *)0)) {
    __mptr = (struct device  const  *)dev;
    tmp = (struct usb_interface *)__mptr + 1152921504606846928UL;
  } else {
...
{ struct usb_device *udev ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  udev = (struct usb_device *)__mptr + 1152921504606846840UL;
...
{ struct usb_device *usb_dev ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  usb_dev = (struct usb_device *)__mptr + 1152921504606846840UL;
...
{ struct device  const  *__mptr ;
  ...
  return ((struct usb_device *)__mptr + 1152921504606846840UL);
}
}
...
static spinlock_t device_state_lock  =    {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                      {(struct lock_class *)0,
                                                                       (struct lock_class *)0},
                                                                      "device_state_lock",
                                                                      0, 0UL}}}};
static spinlock_t hub_event_lock  =    {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                      {(struct lock_class *)0,
                                                                       (struct lock_class *)0},
                                                                      "hub_event_lock",
                                                                      0, 0UL}}}};
static struct list_head hub_event_list  =    {& hub_event_list, & hub_event_list};
static wait_queue_head_t khubd_wait  =    {{{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                       {(struct lock_class *)0,
                                                                        (struct lock_class *)0},
                                                                       "khubd_wait.lock",
                                                                       0, 0UL}}}},
...
struct rw_semaphore ehci_cf_port_reset_rwsem  =    {0L, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                           {(struct lock_class *)0,
                                                                            (struct lock_class *)0},
...
{ struct usb_hub *hub ;
  ...
  hub = (struct usb_hub *)__mptr + 1152921504606846472UL;
  hdev = hub->hdev;
  changed = 0U;
  cursor = -1;
...
{ unsigned long flags ;
  ...
  if ((unsigned int )*((unsigned char *)hub + 468UL) == 0U) {
    ...
    if (tmp___0 != 0) {
      ...
      usb_autopm_get_interface_no_resume((struct usb_interface *)__mptr + 1152921504606846928UL);
...
{ struct usb_hub *hub ;
  ...
  {
  __mptr = (struct work_struct  const  *)work;
  hub = (struct usb_hub *)__mptr + 1152921504606846592UL;
  limit = 100;
...
{ struct usb_device *hdev ;
  ...
  if ((unsigned int )type <= 2U) {
    ...
    usb_autopm_put_interface_async((struct usb_interface *)__mptr___0 + 1152921504606846928UL);
  }
  return;
}
}
...
{ struct usb_hub *hub ;
  ...
  hub = (struct usb_hub *)__mptr + 1152921504606846264UL;
...
{ struct usb_hub *hub ;
  ...
  hub = (struct usb_hub *)__mptr + 1152921504606846960UL;
  __mptr___0 = (struct device  const  *)hub->intfdev;
  usb_put_intf((struct usb_interface *)__mptr___0 + 1152921504606846928UL);
...
{ struct usb_hub *hub ;
  ...
  hub = hdev_to_hub(udev->parent);
  return ((bool )((unsigned long )*(hub->port_owners + ((unsigned long )udev->portnum + 1152921504606846975UL)) != (unsigned long )((void *)0)));
}
}
...
{ struct mutex usb_address0_mutex ;
  ...
  usb_address0_mutex.wait_lock.ldv_6060.rlock.owner = (void *)1152921504606846975UL;
...
{ struct usb_device *hdev ;
  ...
  if ((unsigned long )udev != (unsigned long )((struct usb_device *)0)) {
    usb_disconnect((struct usb_device **)(& hdev->children) + ((unsigned long )port1 + 1152921504606846975UL));
  }
  clear_bit(port1, (unsigned long volatile   *)(& hub->change_bits));
  if (((int )portstatus & 1) == 0) {
    clear_bit(port1, (unsigned long volatile   *)(& hub->removed_bits));
...
{ struct list_head *tmp ;
  ...
  hub = (struct usb_hub *)__mptr + 1152921504606846752UL;
  kref_get(& hub->kref);
  spin_unlock_irq(& hub_event_lock);
  hdev = hub->hdev;
  hub_dev = hub->intfdev;
  __mptr___0 = (struct device  const  *)hub_dev;
  intf = (struct usb_interface *)__mptr___0 + 1152921504606846928UL;
  if ((unsigned long )hub->descriptor != (unsigned long )((struct usb_hub_descriptor *)0)) {
...
{ int ret ;
  ...
  if ((unsigned long )config != (unsigned long )((struct usb_host_config *)0)) {
    ...
    if ((unsigned long )cintf->dev.driver != (unsigned long )((struct device_driver *)0)) {
      ...
      drv = (struct usb_driver *)__mptr + 1152921504606846808UL;
  ...
  if ((unsigned long )config != (unsigned long )((struct usb_host_config *)0)) {
    ...
    if (rebind == 0) {
      if ((unsigned long )cintf___0->dev.driver != (unsigned long )((struct device_driver *)0)) {
        ...
        drv___0 = (struct usb_driver *)__mptr___0 + 1152921504606846808UL;
...
{ long tmp ;
  ...
  return ((struct page *)(sg->page_link & 1152921504606846972UL));
}
}
...
{ struct dma_map_ops *ops ;
  ...
  addr = (*(ops->map_page))(dev, (struct page *)(1152897315351035904UL + (tmp___2 >> 12)),
                            (unsigned long )ptr & 4095UL, size, dir, attrs);
  tmp___3 = __phys_addr((unsigned long )ptr);
  debug_dma_map_page(dev, (struct page *)(1152897315351035904UL + (tmp___3 >> 12)),
...
struct mutex usb_bus_list_lock  =    {{1}, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                            {(struct lock_class *)0,
                                                                             (struct lock_class *)0},
...
static spinlock_t hcd_root_hub_lock  =    {{{{0U},
      3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                {(struct lock_class *)0,
                                                                 (struct lock_class *)0},
                                                                "hcd_root_hub_lock",
                                                                0, 0UL}}}};
static spinlock_t hcd_urb_list_lock  =    {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                      {(struct lock_class *)0,
                                                                       (struct lock_class *)0},
                                                                      "hcd_urb_list_lock",
                                                                      0, 0UL}}}};
static spinlock_t hcd_urb_unlink_lock  =    {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                      {(struct lock_class *)0,
                                                                       (struct lock_class *)0},
                                                                      "hcd_urb_unlink_lock",
                                                                      0, 0UL}}}};
wait_queue_head_t usb_kill_urb_queue  =    {{{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                       {(struct lock_class *)0,
                                                                        (struct lock_class *)0},
...
{ struct usb_device *rh_usb_dev ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  rh_usb_dev = (struct usb_device *)__mptr + 1152921504606846840UL;
...
{ struct usb_hcd *hcd ;
  ...
  urb = (struct urb *)__mptr + 1152921504606846944UL;
  goto ldv_28029;
  ldv_28028: ;
  if (urb->unlinked != 0) {
    goto ldv_28020;
  ...
  urb = (struct urb *)__mptr___0 + 1152921504606846944UL;
  ldv_28029: ;
  ...
  if (tmp___2 == 0) {
    ...
    urb = (struct urb *)__mptr___1 + 1152921504606846944UL;
    usb_get_urb(urb);
  }
  spin_unlock_irq(& hcd_urb_list_lock);
  if ((unsigned long )urb != (unsigned long )((struct urb *)0)) {
...
{ struct usb_hcd *hcd ;
  ...
  {
  __mptr = (struct work_struct  const  *)work;
  hcd = (struct usb_hcd *)__mptr + 1152921504606846664UL;
...
{ struct usb_hcd *hcd ;
  ...
  {
  __mptr = (struct kref  const  *)kref;
  hcd = (struct usb_hcd *)__mptr + 1152921504606846848UL;
...
{ int retval ;
  ...
  if ((unsigned long )(hcd->driver)->irq != (unsigned long )((irqreturn_t (* const  )(struct usb_hcd * ))0)) {
    if ((irqflags & 128UL) != 0UL) {
      irqflags &= 1152921504606846943UL;
    }
...
{ struct urb *victim ;
  ...
  victim = (struct urb *)__mptr + 1152921504606846928UL;
  usb_get_urb(victim);
...
{ unsigned long flags ;
  ...
  lazarus = (struct urb *)__mptr + 1152921504606846928UL;
  goto ldv_24285;
  ldv_24284: 
  usb_unpoison_urb(lazarus);
  __mptr___0 = (struct list_head  const  *)lazarus->anchor_list.next;
  lazarus = (struct urb *)__mptr___0 + 1152921504606846928UL;
  ldv_24285: ;
...
{ struct usb_interface *intf ;
  ...
  intfc = (struct usb_interface_cache *)__mptr___0 + 1152921504606846968UL;
...
{ int rc ;
  ...
  {
  __mptr = (struct work_struct  const  *)ws;
  iface = (struct usb_interface *)__mptr + 1152921504606845800UL;
...
static spinlock_t set_config_lock  =    {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                      {(struct lock_class *)0,
                                                                       (struct lock_class *)0},
                                                                      "set_config_lock",
                                                                      0, 0UL}}}};
...
{ struct set_config_request *req ;
  ...
  {
  __mptr = (struct work_struct  const  *)work;
  req = (struct set_config_request *)__mptr + 1152921504606846960UL;
  udev = req->udev;
  device_lock(& udev->dev);
...
{ struct set_config_request *req ;
  ...
  req = (struct set_config_request *)__mptr + 1152921504606846880UL;
  goto ldv_29258;
  ldv_29257: ;
  ...
  req = (struct set_config_request *)__mptr___0 + 1152921504606846880UL;
  ldv_29258: ;
...
{ struct usb_driver *usb_drv ;
  ...
  usb_drv = (struct usb_driver *)__mptr + 1152921504606846808UL;
...
{ struct usb_dynid *dynid ;
  ...
  {
  __mptr = (struct device_driver  const  *)driver;
  usb_driver = (struct usb_driver *)__mptr + 1152921504606846808UL;
  idVendor = 0U;
  idProduct = 0U;
  fields = 0;
  retval = 0;
...
{ struct usb_device_driver *udriver ;
  ...
  udriver = (struct usb_device_driver *)__mptr + 1152921504606846936UL;
  __mptr___0 = (struct device  const  *)dev;
  udev = (struct usb_device *)__mptr___0 + 1152921504606846840UL;
  error = 0;
...
{ struct usb_device *udev ;
  ...
  udriver = (struct usb_device_driver *)__mptr___0 + 1152921504606846936UL;
...
{ struct usb_driver *driver ;
  ...
  {
  __mptr = (struct device_driver  const  *)dev->driver;
  driver = (struct usb_driver *)__mptr + 1152921504606846808UL;
  __mptr___0 = (struct device  const  *)dev;
  intf = (struct usb_interface *)__mptr___0 + 1152921504606846928UL;
  tmp = interface_to_usbdev(intf);
  udev = tmp;
...
{ int tmp ;
  ...
  if (tmp___2 != 0) {
    ...
    if (tmp___1 != 0) {
      ...
      usb_drv = (struct usb_driver *)__mptr___0 + 1152921504606846808UL;
...
{ unsigned char *buffer0 ;
  ...
  if (tmp___0 != 0) {
    ...
    if ((int )((unsigned int )((struct usb_device *)__mptr + 1152921504606846840UL)->speed) == 5) {
      goto case_5;
    } else
    if ((int )((unsigned int )((struct usb_device *)__mptr + 1152921504606846840UL)->speed) == 3) {
      goto case_3;
    } else {
      goto switch_default;
      if (0) {
    ...
    if (tmp != 0) {
      ...
      if ((int )((unsigned int )((struct usb_device *)__mptr___0 + 1152921504606846840UL)->speed) == 3) {
        goto case_3___0;
      } else {
        goto switch_default___0;
        if (0) {
  ...
  if ((unsigned int )((struct usb_device *)__mptr___1 + 1152921504606846840UL)->speed == 1U) {
  ...
  if ((unsigned int )((struct usb_device *)__mptr___2 + 1152921504606846840UL)->speed == 3U) {
  ...
  if ((unsigned int )((struct usb_device *)__mptr___3 + 1152921504606846840UL)->speed == 5U) {
...
{ struct usb_interface_cache *intfc ;
  ...
  intfc = (struct usb_interface_cache *)__mptr + 1152921504606846972UL;
  j = 0;
  goto ldv_24304;
  ldv_24303: 
...
static struct rw_semaphore minor_rwsem  =    {0L, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                           {(struct lock_class *)0,
                                                                            (struct lock_class *)0},
...
static struct device_attribute dev_attr_devnum  =    {{"devnum", 292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0},
    ...
    (ssize_t (*)(struct device * , struct device_attribute * , char const   * , size_t  ))0};
static ssize_t show_devpath(struct device *dev ,
                            struct device_attribute *attr , char *buf ) 
{ struct usb_device *udev ;
  struct device  const  *__mptr ;
  int tmp ;
...
static struct device_attribute dev_attr_quirks  =    {{"quirks", 292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0},
    ...
    (ssize_t (*)(struct device * , struct device_attribute * , char const   * , size_t  ))0};
static ssize_t show_avoid_reset_quirk(struct device *dev ,
                                      struct device_attribute *attr , char *buf ) 
{ struct usb_device *udev ;
  struct device  const  *__mptr ;
  int tmp ;
...
{ struct device *dev ;
  ...
  dev = (struct device *)__mptr + 1152921504606846960UL;
  __mptr___0 = (struct device  const  *)dev;
  udev = (struct usb_device *)__mptr___0 + 1152921504606846840UL;
...
{ struct usb_interface *intf ;
  ...
  if ((unsigned long )intf->dev.driver == (unsigned long )((struct device_driver *)0)) {
    ...
    if ((unsigned int )*((unsigned char *)((struct usb_driver *)__mptr___0 + 1152921504606846808UL) + 288UL) != 0U) {
      ret = sprintf(buf, "%u\n", 1);
    } else {
      ret = sprintf(buf, "%u\n", 0);
    }
...
{ struct ep_device *ep ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  ep = (struct ep_device *)__mptr + 1152921504606846960UL;
  tmp = sprintf(buf, "%02x\n", (int )(ep->desc)->bLength);
  return ((ssize_t )tmp);
}
}
...
{ struct ep_device *ep_dev ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  ep_dev = (struct ep_device *)__mptr + 1152921504606846960UL;
...
struct mutex usbfs_mutex  =    {{1}, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                            {(struct lock_class *)0,
                                                                             (struct lock_class *)0},
...
static int claimintf(struct dev_state *ps ,
                     unsigned int ifnum ) 
{ struct usb_device *dev ;
  struct usb_interface *intf ;
  int err ;
    ...
    if ((unsigned long )intf == (unsigned long )((struct usb_interface *)0)) {
      ...
      if (ctl->ioctl_code == 21783) {
        ...
        if (0) {
          ...
          if ((unsigned long )intf->dev.driver != (unsigned long )((struct device_driver *)0)) {
            __mptr___0 = (struct device_driver  const  *)intf->dev.driver;
            driver = (struct usb_driver *)__mptr___0 + 1152921504606846808UL;
          }
...
static struct blocking_notifier_head usb_notifier_list  =    {{0L, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                            {(struct lock_class *)0,
                                                                             (struct lock_class *)0},
...
static char const   format_endpt[51U]  = 
  {      (char const   )'E',      (char const   )':',      (char const   )' ',      (char const   )' ', 
        ...
        (char const   )'s',      (char const   )'\n',      (char const   )'\000'};
static struct device_connect_event device_event  =    {{1}, {{{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                             {(struct lock_class *)0,
                                                                              (struct lock_class *)0},
...
{ struct usb_bus *bus ;
  ...
  bus = (struct usb_bus *)__mptr + 1152921504606846904UL;
  goto ldv_27804;
  ldv_27803: ;
  ...
  bus = (struct usb_bus *)__mptr___0 + 1152921504606846904UL;
  ldv_27804: ;
...
struct file_operations  const  usbfs_devices_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
 static int constant_test_bit(unsigned int nr ,
...
static struct mutex companions_mutex  =    {{1}, {{{{0U}, 3735899821U, 4294967295U, (void *)1152921504606846975UL, {(struct lock_class_key *)0,
                                                                            {(struct lock_class *)0,
                                                                             (struct lock_class *)0},
...
static void companion_common(struct pci_dev *pdev ,
                             struct usb_hcd *hcd , enum companion_action action ) 
...
{ struct pci_dev *pci_dev ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  pci_dev = (struct pci_dev *)__mptr + 1152921504606846832UL;
...
{ int retval ;
  ...
  if (retval == 0) {
    __mptr = (struct device  const  *)dev;
    powermac_set_asic((struct pci_dev *)__mptr + 1152921504606846832UL, 0);
  }
...
{ int retval ;
  ...
  {
  __mptr = (struct device  const  *)dev;
  powermac_set_asic((struct pci_dev *)__mptr + 1152921504606846832UL, 1);
...
{ struct dentry *dev ;
  ...
  dev = (struct dentry *)__mptr + 1152921504606846760UL;
  goto ldv_28791;
  ldv_28790: ;
  ...
  dev = (struct dentry *)__mptr___0 + 1152921504606846760UL;
  ldv_28791: ;
...
{ struct dentry *root ;
  ...
  bus = (struct dentry *)__mptr + 1152921504606846760UL;
  goto ldv_28807;
  ldv_28806: ;
  ...
  bus = (struct dentry *)__mptr___0 + 1152921504606846760UL;
  ldv_28807: ;
...
{ struct list_head *list ;
  ...
  de = (struct dentry *)__mptr + 1152921504606846760UL;
