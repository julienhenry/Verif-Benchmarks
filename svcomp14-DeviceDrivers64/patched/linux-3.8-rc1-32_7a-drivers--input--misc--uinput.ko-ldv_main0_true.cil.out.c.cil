...
{ __s32 tmp ;
  ...
  if ((unsigned long )dev->absinfo != (unsigned long )((struct input_absinfo *)0)) {
    tmp = (dev->absinfo + (unsigned long )axis)->minimum;
  } else {
    tmp = 0;
  }
  return (tmp);
 ...
 static void input_abs_set_min(struct input_dev *dev , unsigned int axis ,
                                       int val ) 
{ 
...
{ __s32 tmp ;
  ...
  {
  if ((unsigned long )dev->absinfo != (unsigned long )((struct input_absinfo *)0)) {
    tmp = (dev->absinfo + (unsigned long )axis)->maximum;
  } else {
    tmp = 0;
  }
  return (tmp);
 ...
 static void input_abs_set_max(struct input_dev *dev , unsigned int axis ,
                                       int val ) 
{ 
 ...
 static void input_abs_set_fuzz(struct input_dev *dev , unsigned int axis ,
                                        int val ) 
{ 
 ...
 static int input_abs_get_flat(struct input_dev *dev , unsigned int axis ) 
{ __s32 tmp ;

  {
  if ((unsigned long )dev->absinfo != (unsigned long )((struct input_absinfo *)0)) {
    tmp = (dev->absinfo + (unsigned long )axis)->flat;
  } else {
    tmp = 0;
  }
  return (tmp);
 ...
 static void input_abs_set_flat(struct input_dev *dev , unsigned int axis ,
                                        int val ) 
{ 
