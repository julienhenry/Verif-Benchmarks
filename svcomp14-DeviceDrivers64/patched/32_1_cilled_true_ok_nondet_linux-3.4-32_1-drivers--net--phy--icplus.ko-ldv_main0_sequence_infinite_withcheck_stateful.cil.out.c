...
{ unsigned long __cil_tmp2 ;
  ...
  __cil_tmp3 = __cil_tmp2 + 800UL;
  __cil_tmp4 = *((int *)__cil_tmp3);
  if (__cil_tmp4 == 4) {
    genphy_read_status(phydev);
  } else {
    __cil_tmp5 = (unsigned long )phydev;
    __cil_tmp6 = __cil_tmp5 + 844UL;
    *((int *)__cil_tmp6) = -2;
  }
  return (0);
}
...
static struct phy_driver ip101a_g_driver  = 
    ...
    (void (*)(struct phy_device *dev , struct sk_buff *skb , int type ))0, {(char const   *)0,
                                                                            ...
                                                                            (struct dev_pm_ops  const  *)0,
                                                                            (struct driver_private *)0}};
static int icplus_init(void)  __attribute__((__section__(".init.text"),
