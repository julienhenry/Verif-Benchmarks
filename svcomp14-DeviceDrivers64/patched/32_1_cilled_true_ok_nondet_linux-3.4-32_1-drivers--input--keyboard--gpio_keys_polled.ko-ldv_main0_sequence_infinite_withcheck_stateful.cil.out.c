...
{ int tmp ;
 ...
 static int gpio_cansleep(unsigned int gpio )  __attribute__((__no_instrument_function__)) ;
 static int gpio_cansleep(unsigned int gpio )  __attribute__((__no_instrument_function__)) ;
...
{ struct gpio_keys_platform_data *pdata ;
  ...
  *((__u16 *)__cil_tmp65) = (__u16 )256;
  ...
  while (1) {
    ...
    __cil_tmp70 = (unsigned long )i * 16UL;
  ...
  *((struct gpio_keys_platform_data **)__cil_tmp109) = pdata;
  ...
  while (1) {
    ...
    __cil_tmp117 = (unsigned long )i * 16UL;
