...
{ int tmp ;
 ...
 static struct sk_buff *bt_skb_alloc(unsigned int len , gfp_t how ) 
{ struct sk_buff *skb ;
...
static struct file_operations  const  btmrvl_hscfgcmd_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_psmode_write(struct file *file ,
                                   char const   *ubuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  long result ;
  long ret ;
...
static struct file_operations  const  btmrvl_psmode_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_pscmd_write(struct file *file ,
                                  char const   *ubuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  long result ;
...
static struct file_operations  const  btmrvl_pscmd_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_gpiogap_write(struct file *file ,
                                    char const   *ubuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  long result ;
...
static struct file_operations  const  btmrvl_gpiogap_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_hscmd_write(struct file *file ,
                                  char const   *ubuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  long result ;
...
static struct file_operations  const  btmrvl_hscmd_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_hsmode_write(struct file *file ,
                                   char const   *ubuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  long result ;
...
static struct file_operations  const  btmrvl_hsmode_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_curpsmode_read(struct file *file ,
...
static struct file_operations  const  btmrvl_curpsmode_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_psstate_read(struct file *file ,
                                   char *userbuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  int ret ;
...
static struct file_operations  const  btmrvl_psstate_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_hsstate_read(struct file *file ,
                                   char *userbuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  int ret ;
...
static struct file_operations  const  btmrvl_hsstate_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static ssize_t btmrvl_txdnldready_read(struct file *file ,
                                       char *userbuf , size_t count , loff_t *ppos ) 
{ struct btmrvl_private *priv ;
  char buf[16U] ;
  int ret ;
  ...
  if (tmp == 25) {
    ...
    if (0) {
      ...
      if (ldv_s_btmrvl_hscfgcmd_fops_file_operations == 0) {
        ...
        ldv_s_btmrvl_hscfgcmd_fops_file_operations ++;
      }
      goto ldv_40025;
      case_1: ;
      ...
      if (ldv_s_btmrvl_psmode_fops_file_operations == 0) {
        ...
        ldv_s_btmrvl_psmode_fops_file_operations ++;
      }
      goto ldv_40025;
      case_4: ;
      ...
      if (ldv_s_btmrvl_psstate_fops_file_operations == 0) {
        ...
        ldv_s_btmrvl_psstate_fops_file_operations ++;
      }
      goto ldv_40025;
      case_21: ;
      ...
      if (ldv_s_btmrvl_hsstate_fops_file_operations == 0) {
        ...
        ldv_s_btmrvl_hsstate_fops_file_operations ++;
      }
      goto ldv_40025;
      case_23: ;
