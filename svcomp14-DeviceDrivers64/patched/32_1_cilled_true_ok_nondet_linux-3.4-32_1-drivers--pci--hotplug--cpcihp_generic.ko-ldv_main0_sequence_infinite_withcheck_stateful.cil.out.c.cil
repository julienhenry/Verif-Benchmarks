...
{ char *str ;
  ...
  while (1) {
    ...
    if (*__cil_tmp104) {
      __cil_tmp105 = 0UL;
      __cil_tmp106 = 24UL + __cil_tmp105;
  ...
  if (__cil_tmp112 > 7U) {
    __cil_tmp113 = 0UL;
    __cil_tmp114 = 24UL + __cil_tmp113;
...
{ int status ;
  ...
  *((int (**)(void))__cil_tmp41) = & query_enum;
  __cil_tmp42 = (unsigned long )(& generic_hpc) + 40UL;
  *((struct cpci_hp_controller_ops **)__cil_tmp42) = & generic_hpc_ops;
  status = cpci_hp_register_controller(& generic_hpc);
  if (status != 0) {
    __cil_tmp43 = 0UL;
    __cil_tmp44 = 24UL + __cil_tmp43;
