...
extern int autoremove_wake_function(wait_queue_t * , unsigned int  , int  , void * ) ;
 static int wait_on_bit(void *word , int bit , int (*action)(void * ) , unsigned int mode ) 
{ int tmp ;
  int tmp___0 ;
...
{ 
 ...
 static struct bio *bio_list_get(struct bio_list *bl ) 
{ struct bio *bio ;
  struct bio *tmp ;
...
extern void dm_put_device(struct dm_target * , struct dm_dev * ) ;
 static void *dm_per_bio_data(struct bio *bio , size_t data_size ) 
{ 
 ...
 static unsigned int dm_bio_get_target_request_nr(struct bio  const  *bio ) 
...
{ 
 ...
 static unsigned int dm_consecutive_chunk_count(struct dm_exception *e ) 
{ 
...
{ loff_t tmp ;
 ...
 static chunk_t sector_to_chunk(struct dm_exception_store *store , sector_t sector ) 
{ 
...
static spinlock_t _pending_exceptions_done_spinlock  =    {{{{{0U}},
      3735899821U, 4294967295U, 0xffffffffffffffffUL, {0, {0, 0}, "_pending_exceptions_done_spinlock",
                                                       0, 0UL}}}};
...
{ struct transient_c *tc ;
  ...
  tc->next_free += (sector_t )store->chunk_size;
  return (0);
}
}
...
{ int r ;
  ...
  ps->current_committed -= (uint32_t )nr_merged;
