...
{ unsigned char status ;
  ...
  {
  __cil_tmp5 = (void *)0;
  tmp___0 = (int )request_irq(12U, & ct82c710_interrupt, 0UL, "ct82c710", __cil_tmp5);
  err = tmp___0;
  if (err) {
    return (err);
  }
