...
enum xp_retval (*xp_remote_memcpy)(unsigned long dst_gpa , unsigned long src_gpa ,
                                   size_t len )  ;
...
{ struct xpc_interface *__cil_tmp7 ;
  ...
  *((void (**)(int  ))__cil_tmp7) = connect;
  __cil_tmp8 = (unsigned long )(& xpc_interface) + 8UL;
  *((void (**)(int  ))__cil_tmp8) = disconnect;
  __cil_tmp9 = (unsigned long )(& xpc_interface) + 16UL;
  *((enum xp_retval (**)(short  , int  , u32  , void * , u16  ))__cil_tmp9) = send;
  __cil_tmp10 = (unsigned long )(& xpc_interface) + 24UL;
  *((enum xp_retval (**)(short  , int  , u32  , void * , u16  , void (*)(enum xp_retval reason ,
                                                                         short partid ,
                                                                         int ch_number ,
                                                                         void *key ) ,
                         void * ))__cil_tmp10) = send_notify;
  __cil_tmp11 = (unsigned long )(& xpc_interface) + 32UL;
  *((void (**)(short  , int  , void * ))__cil_tmp11) = received;
  __cil_tmp12 = (unsigned long )(& xpc_interface) + 40UL;
...
{ struct xpc_interface *__cil_tmp1 ;
  ...
  *((void (**)(int  ))__cil_tmp1) = (void (*)(int  ))(& xpc_notloaded);
  __cil_tmp2 = (unsigned long )(& xpc_interface) + 8UL;
  *((void (**)(int  ))__cil_tmp2) = (void (*)(int  ))(& xpc_notloaded);
  __cil_tmp3 = (unsigned long )(& xpc_interface) + 16UL;
  *((enum xp_retval (**)(short  , int  , u32  , void * , u16  ))__cil_tmp3) = (enum xp_retval (*)(short  ,
                                                                                                  int  ,
                                                                                                  u32  ,
                                                                                                  void * ,
                                                                                                  u16  ))(& xpc_notloaded);
  __cil_tmp4 = (unsigned long )(& xpc_interface) + 24UL;
  *((enum xp_retval (**)(short  , int  , u32  , void * , u16  , void (*)(enum xp_retval reason ,
                                                                         short partid ,
                                                                         int ch_number ,
                                                                         void *key ) ,
                         void * ))__cil_tmp4) = (enum xp_retval (*)(short  , int  ,
                                                                    ...
                                                                    u16  , void (*)(enum xp_retval reason ,
                                                                                    ...
                                                                                    void *key ) ,
                                                                    void * ))(& xpc_notloaded);
  __cil_tmp5 = (unsigned long )(& xpc_interface) + 32UL;
  *((void (**)(short  , int  , void * ))__cil_tmp5) = (void (*)(short  , int  , void * ))(& xpc_notloaded);
  __cil_tmp6 = (unsigned long )(& xpc_interface) + 40UL;
...
{ struct xpc_registration *registration ;
  ...
  __cil_tmp29 = (unsigned long )ch_number * 128UL;
  ...
  tmp = (int )mutex_lock_interruptible(__cil_tmp31);
  tmp___5 = tmp;
  if (tmp___5 != 0) {
...
{ struct xpc_registration *registration ;
  ...
  {
  __cil_tmp3 = (unsigned long )ch_number * 128UL;
...
{ enum xp_retval ret ;
  ...
  while (1) {
    ...
    while (1) {
      __cil_tmp4 = (unsigned long )ch_number * 128UL;
...
extern struct uv_hub_info_s __uv_hub_info  __attribute__((__section__(".data..percpu"))) ;
 static unsigned long uv_soc_phys_ram_to_gpa(unsigned long paddr )  __attribute__((__no_instrument_function__)) ;
 static unsigned long uv_soc_phys_ram_to_gpa(unsigned long paddr )  __attribute__((__no_instrument_function__)) ;
...
{ unsigned long tcp_ptr__ ;
 ...
 static unsigned long uv_gpa(void *v )  __attribute__((__no_instrument_function__)) ;
 static unsigned long uv_gpa(void *v )  __attribute__((__no_instrument_function__)) ;
...
{ unsigned long tmp ;
 ...
 static int uv_gpa_in_mmr_space(unsigned long gpa )  __attribute__((__no_instrument_function__)) ;
 static int uv_gpa_in_mmr_space(unsigned long gpa )  __attribute__((__no_instrument_function__)) ;
...
{ unsigned long __cil_tmp2 ;
 ...
 static unsigned long uv_gpa_to_soc_phys_ram(unsigned long gpa )  __attribute__((__no_instrument_function__)) ;
 static unsigned long uv_gpa_to_soc_phys_ram(unsigned long gpa )  __attribute__((__no_instrument_function__)) ;
...
extern short *uv_cpu_to_blade ;
 static int uv_cpu_to_blade_id(int cpu )  __attribute__((__no_instrument_function__)) ;
 static int uv_cpu_to_blade_id(int cpu )  __attribute__((__no_instrument_function__)) ;
...
{ short *__cil_tmp2 ;
 ...
 static int uv_cpu_to_pnode(int cpu )  __attribute__((__no_instrument_function__)) ;
 static int uv_cpu_to_pnode(int cpu )  __attribute__((__no_instrument_function__)) ;
...
static enum xp_retval xp_remote_mmr_read(unsigned long dst_gpa , unsigned long src_gpa ,
                                         size_t len ) 
{ int ret ;
...
static enum xp_retval xp_remote_memcpy_uv(unsigned long dst_gpa , unsigned long src_gpa ,
                                          size_t len ) 
{ int ret ;
  enum xp_retval tmp ;
  int tmp___0 ;
...
{ int tmp ;
  ...
  enum xp_retval (**__cil_tmp10)(unsigned long dst_gpa , unsigned long src_gpa , size_t len ) ;
