...
{ struct pcap_rtc *pcap_rtc ;
  ...
  *((struct rtc_device **)__cil_tmp16) = rtc_device_register("pcap", __cil_tmp19,
  ...
  tmp___3 = (long )IS_ERR(__cil_tmp23);
  tmp___2 = tmp___3;
  if (tmp___2) {
    ...
    tmp___4 = (long )PTR_ERR(__cil_tmp27);
    tmp___1 = tmp___4;
    err = (int )tmp___1;
    goto fail_rtc;
  }
  ...
  tmp___5 = (int )request_irq(__cil_tmp30, & pcap_rtc_irq, 0UL, "RTC Timer", __cil_tmp31);
  err = tmp___5;
  if (err) {
    goto fail_timer;
  }
  ...
  tmp___6 = (int )request_irq(__cil_tmp32, & pcap_rtc_irq, 0UL, "RTC Alarm", __cil_tmp33);
  err = tmp___6;
  if (err) {
    goto fail_alarm;
  }
