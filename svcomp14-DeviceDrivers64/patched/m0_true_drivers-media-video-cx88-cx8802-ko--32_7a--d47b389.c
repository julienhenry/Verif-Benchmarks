...
extern void pci_unregister_driver(struct pci_driver * ) ;
 static int pci_dma_supported(struct pci_dev *hwdev , u64 mask ) 
{ int tmp ;
  ...
  tmp = dma_supported(tmp___0, mask);
  return (tmp);
}
}
...
{ struct cx8802_dev *dev ;
  ...
  {
  i = 0;
  if ((unsigned int )drv->hw_access == 1U) {
    tmp___0 = (char *)"shared";
  } else {
    tmp___0 = (char *)"exclusive";
  }
  if ((unsigned int )drv->type_id == 1U) {
    tmp___1 = (char *)"dvb";
  } else {
    tmp___1 = (char *)"blackbird";
  }
...
{ struct pci_dev *var_group1 ;
  ...
  if (ldv_s_cx8802_pci_driver_pci_driver == 0) {
    ...
    ldv_s_cx8802_pci_driver_pci_driver ++;
  }
  goto ldv_39468;
  case 1: ;
