...
extern struct bio *bio_map_kern(struct request_queue * , void * , unsigned int  ,
                                gfp_t  ) ;
 static unsigned short req_get_ioprio(struct request *req ) 
{ 
...
extern int virtqueue_add_buf_gfp(struct virtqueue * , struct scatterlist * , unsigned int  ,
 ...
 static int virtqueue_add_buf(struct virtqueue *vq , struct scatterlist *sg ,
...
extern void virtio_check_driver_offered_feature(struct virtio_device  const  * , unsigned int  ) ;
 static bool virtio_has_feature(struct virtio_device  const  *vdev , unsigned int fbit ) 
{ int tmp ;
 ...
 static int virtio_config_buf(struct virtio_device *vdev , unsigned int fbit ,
...
{ long tmp ;
 ...
 static long ( __attribute__((__warn_unused_result__)) IS_ERR___0)(void const   *ptr ) 
{ long tmp ;
