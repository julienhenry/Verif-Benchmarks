...
{ struct dma_map_ops *ops ;
 ...
 static void dma_sync_single_range_for_cpu(struct device *dev , dma_addr_t addr ,
...
{ 
 ...
 static void dma_sync_single_range_for_device(struct device *dev , dma_addr_t addr ,
                                                      unsigned long offset , size_t size ,
                                                      enum dma_data_direction dir ) 
{ 
...
extern void unregister_netdev(struct net_device * ) ;
 static char const   *netdev_name(struct net_device  const  *dev ) 
{ 
...
{ char const   *tmp ;
 ...
 static void ssb_set_drvdata(struct ssb_device *dev , void *data ) 
{ 
 ...
 static void *ssb_get_drvdata(struct ssb_device *dev ) 
{ 
...
extern int __ssb_driver_register(struct ssb_driver * , struct module * ) ;
 static int ssb_driver_register(struct ssb_driver *drv ) 
{ int tmp ;
...
extern void ssb_device_disable(struct ssb_device * , u32  ) ;
 static u32 ssb_read32(struct ssb_device *dev , u16 offset ) 
{ u32 tmp ;
 ...
 static void ssb_write32(struct ssb_device *dev , u16 offset , u32 value ) 
{ 
...
extern void ssb_dma_free_consistent(struct ssb_device * , size_t  , void * , dma_addr_t  ,
                                    gfp_t  ) ;
 static void __ssb_dma_not_implemented(struct ssb_device *dev ) 
{ 
 ...
 static int ssb_dma_mapping_error(struct ssb_device *dev , dma_addr_t addr ) 
{ int tmp ;
  int tmp___0 ;
 ...
 static dma_addr_t ssb_dma_map_single(struct ssb_device *dev , void *p , size_t size ,
                                              enum dma_data_direction dir ) 
{ dma_addr_t tmp ;
  dma_addr_t tmp___0 ;
 ...
 static void ssb_dma_unmap_single(struct ssb_device *dev , dma_addr_t dma_addr ,
                                          size_t size , enum dma_data_direction dir ) 
{ 
 ...
 static void ssb_dma_sync_single_for_cpu(struct ssb_device *dev , dma_addr_t dma_addr ,
                                                 size_t size , enum dma_data_direction dir ) 
{ 
 ...
 static void ssb_dma_sync_single_for_device(struct ssb_device *dev , dma_addr_t dma_addr ,
                                                    size_t size , enum dma_data_direction dir ) 
{ 
 ...
 static void ssb_dma_sync_single_range_for_cpu(struct ssb_device *dev , dma_addr_t dma_addr ,
                                                       unsigned long offset , size_t size ,
                                                       enum dma_data_direction dir ) 
{ 
 ...
 static void ssb_dma_sync_single_range_for_device(struct ssb_device *dev ,
...
extern int ssb_pcihost_register(struct pci_driver * ) ;
 static void ssb_pcihost_unregister(struct pci_driver *driver ) 
{ 
 ...
 static void ssb_pcihost_set_power_state(struct ssb_device *sdev , pci_power_t state ) 
{ 
...
static char const   b44_gstrings[47U][32U]  = 
  { {        't',        'x',        '_',        'g', 
   ...
   {        'r',        'x',        '_',        'n', 
            ...
            (char)0,        (char)0,        (char)0,        (char)0, 
            (char)0,        (char)0,        (char)0,        (char)0}};
 static void b44_sync_dma_desc_for_device(struct ssb_device *sdev , dma_addr_t dma_base ,
...
{ 
 ...
 static void b44_sync_dma_desc_for_cpu(struct ssb_device *sdev , dma_addr_t dma_base ,
                                               unsigned long offset , enum dma_data_direction dir ) 
{ 
 ...
 static unsigned long br32(struct b44  const  *bp , unsigned long reg ) 
{ u32 tmp ;
 ...
 static void bw32(struct b44  const  *bp , unsigned long reg , unsigned long val ) 
{ 
  ...
  if (i == timeout) {
    ...
    if (tmp___3 != 0) {
      ...
      printk("<3>%s %s: %s: BUG!  Timeout waiting for bit %08x of register %lx to %s\n",
             tmp___2, tmp___1, tmp___0, bit, reg, tmp___4);
    }
    return (-19);
  }
  return (0);
...
{ u32 val ;
 ...
 static void __b44_disable_ints(struct b44 *bp ) 
{ 
...
{ u32 cur ;
  ...
  if (tmp___1 != 0) {
    if (bp->tx_cons <= bp->tx_prod) {
      tmp___2 = (bp->tx_cons + bp->tx_pending) - bp->tx_prod > 128U;
    } else {
      tmp___2 = ((bp->tx_cons - bp->tx_prod) + bp->tx_pending) - 512U > 128U;
    }
    if (tmp___2) {
...
{ struct b44 *bp ;
  ...
  if (bp->tx_cons <= bp->tx_prod) {
    tmp___10 = bp->tx_cons + bp->tx_pending == bp->tx_prod;
  } else {
    tmp___10 = (bp->tx_cons - bp->tx_prod) + bp->tx_pending == 512U;
  }
  tmp___4 = ldv__builtin_expect(tmp___10, 0L);
  if (tmp___4 != 0L) {
  ...
  if (bp->tx_cons <= bp->tx_prod) {
    tmp___11 = bp->tx_cons + bp->tx_pending == bp->tx_prod;
  } else {
    tmp___11 = (bp->tx_cons - bp->tx_prod) + bp->tx_pending == 512U;
  }
  if (tmp___11) {
    netif_stop_queue(dev);
  }
...
{ unsigned int dma_desc_align_size ;
  ...
  dma_desc_sync_size = (int )tmp___0;
  err = b44_pci_init();
  if (err != 0) {
    return (err);
  }
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_b44_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_b44_netdev_ops_net_device_ops ++;
  }
  goto ldv_30529;
  case 16: ;
  ...
  if (ldv_s_b44_ssb_driver_ssb_driver == 0) {
    ...
    ldv_s_b44_ssb_driver_ssb_driver ++;
  }
  goto ldv_30529;
  case 26: ;
