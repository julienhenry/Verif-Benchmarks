...
static struct kernel_param  const  __param_debug  __attribute__((__used__,
__unused__, __section__("__param"), __aligned__(sizeof(void *))))  =    {__param_str_debug, (struct kernel_param_ops  const  *)(& param_ops_bool), (u16 )420,
    (u16 )0, {(void *)(& debug)}};
...
{ struct iowarrior *dev ;
  ...
  while (1) {
    ...
    tmp___12 = (int )copy_to_user((void *)buffer, (void const   *)(dev->read_queue + offset),
                                  (unsigned int )count);
    tmp = tmp___12;
    tmp___10 = tmp;
    if (tmp___10) {
...
{ struct iowarrior *dev ;
  ...
  if ((int )dev->product_id == 5379) {
    ...
    if (0) {
      ...
      tmp___20 = (unsigned long )copy_from_user((void *)buf, (void const   *)user_buffer,
                                                count);
      tmp = tmp___20;
      tmp___8 = tmp;
      if (tmp___8) {
      ...
      tmp___21 = (unsigned long )copy_from_user((void *)buf, (void const   *)user_buffer,
                                                count);
      tmp___19 = tmp___21;
      tmp___17 = tmp___19;
      if (tmp___17) {
  ...
  if ((unsigned long )((int )cmd) == ((unsigned long )(((2U << 30) | (unsigned int )(192 << 8)) | 3U) | (sizeof(struct iowarrior_info ) << 16))) {
    ...
    if (0) {
      ...
      if ((int )dev->product_id == 5376) {
        ...
        tmp___11 = (unsigned long )copy_from_user((void *)buffer, (void const   *)user_buffer,
                                                  (unsigned long )dev->report_size);
        tmp = tmp___11;
        tmp___8 = tmp;
        io_res = (int )tmp___8;
      ...
      if (io_res < 0) {
        ...
        tmp___12 = (int )copy_to_user((void *)user_buffer, (void const   *)buffer,
      ...
      tmp___13 = (int )copy_to_user((void *)((struct iowarrior_info *)arg), (void const   *)(& info),
...
static struct file_operations  const  iowarrior_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file *file ,
                                                                        ...
                                                                        loff_t offset ,
                                                                        loff_t len ))0};
static char *iowarrior_devnode(struct device *dev ,
                               mode_t *mode ) 
{ char const   *tmp___7 ;
  char *tmp___8 ;
    ...
    if (tmp___8 == 8) {
      ...
      if (0) {
        ...
        if (ldv_s_iowarrior_fops_file_operations == 0) {
          ...
          ldv_s_iowarrior_fops_file_operations ++;
        }
        goto switch_break;
        case_1: 
        ...
        if (ldv_s_iowarrior_driver_usb_driver == 0) {
          ...
          ldv_s_iowarrior_driver_usb_driver ++;
        }
        goto switch_break;
        case_8: 
