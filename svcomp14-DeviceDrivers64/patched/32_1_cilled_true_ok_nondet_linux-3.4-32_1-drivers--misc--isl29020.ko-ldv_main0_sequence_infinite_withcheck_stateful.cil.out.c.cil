...
static struct device_attribute dev_attr_lux0_input  =    {{"lux0_input",
     (umode_t )292}, & als_lux_input_data_show, (ssize_t (*)(struct device *dev ,
...
static struct attribute_group m_als_gr  =    {"isl29020",
    (umode_t (*)(struct kobject * , struct attribute * , int  ))0, mid_att_als};
...
{ int res ;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp7, __cil_tmp8);
  res = tmp;
  if (res) {
    ...
    if (tmp___7 == 3) {
      ...
      if (0) {
        ...
        if (ldv_s_isl29020_driver_i2c_driver == 0) {
          ...
          ldv_s_isl29020_driver_i2c_driver ++;
        }
        goto switch_break;
        case_3: 
