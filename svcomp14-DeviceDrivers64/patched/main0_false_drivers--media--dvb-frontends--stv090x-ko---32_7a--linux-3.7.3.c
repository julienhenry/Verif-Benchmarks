...
static struct stv090x_short_frame_crloop stv090x_s2_short_crl_cut30[4U]  = {      {0, 44U, 43U, 11U, 11U, 58U}, 
 ...
 static s32 comp2(s32 __x , s32 __width ) 
{ s32 tmp ;
...
{ u32 sym ;
  ...
  if (srate > 60000000U) {
    sym = srate << 4;
    sym /= (u32 )((state->internal)->mclk >> 12);
  } else
  if (srate > 6000000U) {
    sym = srate << 6;
    sym /= (u32 )((state->internal)->mclk >> 10);
  } else {
    sym = srate << 9;
    sym /= (u32 )((state->internal)->mclk >> 7);
  }
  if ((unsigned int )state->demod == 2U) {
...
{ u32 reg ;
  ...
  if ((state->internal)->dev_ver <= 32U) {
    ...
    if ((unsigned int )state->algo == 2U) {
      freq_abs = 65536000U;
      freq_abs /= (u32 )((state->internal)->mclk / 1000);
      freq = (short )freq_abs;
    } else {
...
{ u32 srate_coarse ;
  ...
  if (state->srate > sym) {
    ...
    if (srate_coarse > 3000000U) {
      ...
      sym /= (u32 )((state->internal)->mclk / 1000);
      if ((unsigned int )state->demod == 2U) {
      ...
      sym = (srate_coarse / 10U) * 13U;
      sym = (sym / 100U) * 65536U;
      sym /= (u32 )((state->internal)->mclk / 100);
      if ((unsigned int )state->demod == 2U) {
...
{ struct dvb_frontend *fe ;
  ...
  state->frequency += (u32 )offst_freq;
...
{ struct stv090x_state *state ;
  ...
  reg = (u32 )tmp___1;
  if ((int )(state->config)->diseqc_envelope_mode) {
    tmp___26 = 4U;
  } else {
    tmp___26 = 2U;
  }
  reg = (reg & 4294967288U) | tmp___26;
  reg |= 64U;
  if ((unsigned int )state->demod == 2U) {
    tmp___2 = stv090x_write_reg(state, 61840U, (int )((u8 )reg));
    tmp___4 = tmp___2 < 0;
...
{ struct stv090x_state *state ;
  ...
  if (verbose != 0U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___22 = (char *)"STV0900";
    } else {
      tmp___22 = (char *)"STV0903";
    }
    printk("\v%s: Set %s(%d) to sleep\n", "stv090x_sleep", tmp___22, (unsigned int )state->demod);
  } else
  if (verbose > 1U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___23 = (char *)"STV0900";
    } else {
      tmp___23 = (char *)"STV0903";
    }
    printk("\r%s: Set %s(%d) to sleep\n", "stv090x_sleep", tmp___23, (unsigned int )state->demod);
  } else
  if (verbose > 2U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___24 = (char *)"STV0900";
    } else {
      tmp___24 = (char *)"STV0903";
    }
    printk("\016%s: Set %s(%d) to sleep\n", "stv090x_sleep", tmp___24, (unsigned int )state->demod);
  } else
  if (verbose > 3U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___25 = (char *)"STV0900";
    } else {
      tmp___25 = (char *)"STV0903";
    }
    printk("\017%s: Set %s(%d) to sleep\n", "stv090x_sleep", tmp___25, (unsigned int )state->demod);
  } else
  if (verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___26 = (char *)"STV0900";
    } else {
      tmp___26 = (char *)"STV0903";
    }
    printk("Set %s(%d) to sleep", tmp___26, (unsigned int )state->demod);
  }
...
{ struct stv090x_state *state ;
  ...
  if (verbose != 0U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___17 = (char *)"STV0900";
    } else {
      tmp___17 = (char *)"STV0903";
    }
    printk("\v%s: Wake %s(%d) from standby\n", "stv090x_wakeup", tmp___17, (unsigned int )state->demod);
  } else
  if (verbose > 1U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___18 = (char *)"STV0900";
    } else {
      tmp___18 = (char *)"STV0903";
    }
    printk("\r%s: Wake %s(%d) from standby\n", "stv090x_wakeup", tmp___18, (unsigned int )state->demod);
  } else
  if (verbose > 2U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___19 = (char *)"STV0900";
    } else {
      tmp___19 = (char *)"STV0903";
    }
    printk("\016%s: Wake %s(%d) from standby\n", "stv090x_wakeup", tmp___19, (unsigned int )state->demod);
  } else
  if (verbose > 3U && verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___20 = (char *)"STV0900";
    } else {
      tmp___20 = (char *)"STV0903";
    }
    printk("\017%s: Wake %s(%d) from standby\n", "stv090x_wakeup", tmp___20, (unsigned int )state->demod);
  } else
  if (verbose > 3U) {
    if ((unsigned int )state->device == 1U) {
      tmp___21 = (char *)"STV0900";
    } else {
      tmp___21 = (char *)"STV0903";
    }
    printk("Wake %s(%d) from standby", tmp___21, (unsigned int )state->demod);
  }
...
{ struct stv090x_state *state ;
  ...
  if ((state->internal)->dev_ver <= 31U) {
    if (verbose != 0U && verbose != 0U) {
      printk("\v%s: NON_ERROR: __VERIFIER_error(); Unsupported Cut: 0x%02x!\n", "stv090x_setup", (state->internal)->dev_ver);
    } else
    if (verbose > 1U && verbose != 0U) {
      printk("\r%s: NON_ERROR: __VERIFIER_error(); Unsupported Cut: 0x%02x!\n", "stv090x_setup", (state->internal)->dev_ver);
    } else
    if (verbose > 2U && verbose != 0U) {
      printk("\016%s: NON_ERROR: __VERIFIER_error(); Unsupported Cut: 0x%02x!\n", "stv090x_setup", (state->internal)->dev_ver);
    } else
    if (verbose > 3U && verbose != 0U) {
      printk("\017%s: NON_ERROR: __VERIFIER_error(); Unsupported Cut: 0x%02x!\n", "stv090x_setup", (state->internal)->dev_ver);
    } else
    if (verbose != 0U) {
      printk("NON_ERROR: __VERIFIER_error(); Unsupported Cut: 0x%02x!", (state->internal)->dev_ver);
    }
    goto err;
  } else
...
static struct dvb_frontend_ops stv090x_ops  = 
     ...
     0U, 0U, 268436993}, {5U, 6U, 4U, (unsigned char)0, (unsigned char)0, (unsigned char)0,
                          (unsigned char)0, (unsigned char)0}, & stv090x_release,
    0, & stv090x_init, & stv090x_sleep, 0, 0, & stv090x_frontend_algo, 0, 0, 0, & stv090x_read_status,
    & stv090x_read_per, & stv090x_read_signal_strength, & stv090x_read_cnr, 0, 0,
    & stv090x_send_diseqc_msg, & stv090x_recv_slave_reply, & stv090x_send_diseqc_burst,
    & stv090x_set_tone, 0, 0, 0, 0, 0, 0, & stv090x_search, {{{(char)0, (char)0, (char)0,
...
{ struct stv090x_state *state ;
  ...
  if (verbose != 0U && verbose != 0U) {
    if ((unsigned int )state->device == 1U) {
      tmp___2 = (char *)"STV0900";
    } else {
      tmp___2 = (char *)"STV0903";
    }
    printk("\v%s: Attaching %s demodulator(%d) Cut=0x%02x\n", "stv090x_attach", tmp___2,
           (unsigned int )demod, (state->internal)->dev_ver);
  } else
  if (verbose > 1U && verbose != 0U) {
    if ((unsigned int )state->device == 1U) {
      tmp___3 = (char *)"STV0900";
    } else {
      tmp___3 = (char *)"STV0903";
    }
    printk("\r%s: Attaching %s demodulator(%d) Cut=0x%02x\n", "stv090x_attach", tmp___3,
           (unsigned int )demod, (state->internal)->dev_ver);
  } else
  if (verbose > 2U && verbose != 0U) {
    if ((unsigned int )state->device == 1U) {
      tmp___4 = (char *)"STV0900";
    } else {
      tmp___4 = (char *)"STV0903";
    }
    printk("\016%s: Attaching %s demodulator(%d) Cut=0x%02x\n", "stv090x_attach",
           tmp___4, (unsigned int )demod, (state->internal)->dev_ver);
  } else
  if (verbose > 3U && verbose != 0U) {
    if ((unsigned int )state->device == 1U) {
      tmp___5 = (char *)"STV0900";
    } else {
      tmp___5 = (char *)"STV0903";
    }
    printk("\017%s: Attaching %s demodulator(%d) Cut=0x%02x\n", "stv090x_attach",
           tmp___5, (unsigned int )demod, (state->internal)->dev_ver);
  } else
  if (verbose != 0U) {
    if ((unsigned int )state->device == 1U) {
      tmp___6 = (char *)"STV0900";
    } else {
      tmp___6 = (char *)"STV0903";
    }
    printk("Attaching %s demodulator(%d) Cut=0x%02x", tmp___6, (unsigned int )demod,
           (state->internal)->dev_ver);
  }
