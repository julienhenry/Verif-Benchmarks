...
{ struct ftl_zone *zone ;
  ...
  if (! zone->initialized) {
    ...
    if (error) {
      tmp___9 = (void *)ERR_PTR((long )error);
      tmp = tmp___9;
      tmp___8 = tmp;
...
{ struct sm_ftl *ftl ;
  ...
  tmp___12 = (long )IS_ERR((void const   *)zone);
  tmp = tmp___12;
  tmp___8 = tmp;
  if (tmp___8) {
    tmp___13 = (long )PTR_ERR((void const   *)zone);
    tmp___11 = tmp___13;
    tmp___7 = tmp___11;
    error = (int )tmp___7;
    goto unlock;
...
{ int error ;
  ...
  tmp___11 = (long )IS_ERR((void const   *)cache_flush_workqueue);
  tmp = tmp___11;
  tmp___9 = tmp;
  if (tmp___9) {
    tmp___12 = (long )PTR_ERR((void const   *)cache_flush_workqueue);
    tmp___10 = tmp___12;
    tmp___8 = tmp___10;
    return ((int )tmp___8);
  }
