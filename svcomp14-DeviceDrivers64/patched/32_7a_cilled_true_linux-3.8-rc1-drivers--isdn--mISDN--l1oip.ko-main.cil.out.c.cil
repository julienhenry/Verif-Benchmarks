...
{ 
 ...
 static void set_channelmap(u_int nr , u_char *map ) 
{ 
...
{ struct sk_buff *skb ;
 ...
 static struct sk_buff *_alloc_mISDN_skb(u_int prim , u_int id___0 , u_int len ,
...
{ struct sk_buff *skb ;
 ...
 static void _queue_data(struct mISDNchannel *ch , u_int prim , u_int id___0 ,
...
{ struct bchannel *bch ;
  ...
  if ((unsigned long )tmp == (unsigned long )((void *)0)) {
    ...
    hc->chan[bch->slot].tx_counter += (u32 )l;
    skb_trim(skb, 0U);
    queue_ch_frame(ch, 24578U, (int )hh->id, skb);
    return (0);
  }
  ...
  l1oip_socket_send(hc, (int )((u8 )hc->codec), (int )((u8 )bch->slot), 0U, (int )((u16 )hc->chan[bch->slot].tx_counter),
                    p, ll);
  hc->chan[bch->slot].tx_counter += (u32 )ll;
  p += (unsigned long )ll;
  l -= ll;
  ldv_41777: ;
  if (l != 0) {
