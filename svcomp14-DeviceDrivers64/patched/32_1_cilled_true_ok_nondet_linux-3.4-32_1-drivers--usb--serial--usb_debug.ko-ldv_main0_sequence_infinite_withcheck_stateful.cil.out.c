...
static char USB_DEBUG_BRK[8]  = 
  {      (char)0,      (char)255,      (char)1,      (char)254, 
        (char)0,      (char)254,      (char)1,      (char)255};
...
static int debug_driver_init(void)  __attribute__((__section__(".init.text"),
