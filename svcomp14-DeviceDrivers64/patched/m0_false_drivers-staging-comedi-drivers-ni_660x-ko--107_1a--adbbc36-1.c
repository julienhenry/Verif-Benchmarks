...
{ 
 ...
 static void comedi_set_hw_dev(struct comedi_device *dev , struct device *hw_dev ) 
{ long tmp ;
...
extern void pci_unregister_driver(struct pci_driver * ) ;
 static struct mite_dma_descriptor_ring *mite_alloc_ring(struct mite_struct *mite ) 
{ struct mite_dma_descriptor_ring *ring ;
  void *tmp ;
 ...
 static void mite_free_ring(struct mite_dma_descriptor_ring *ring ) 
{ 
...
struct pci_device_id  const  __mod_pci_device_table  ;
 static struct ni_660x_private *private(struct comedi_device *dev ) 
{ 
 ...
 static struct ni_660x_board  const  *board(struct comedi_device *dev ) 
{ 
...
{ unsigned long flags ;
  ...
  tmp___1->dma_configuration_soft_copies[counter->chip_index] &= ~ tmp___2;
  tmp___3 = private(dev);
  tmp___4 = dma_selection_counter(counter->counter_index);
  tmp___5 = dma_select_bits(mite_channel, tmp___4);
  tmp___3->dma_configuration_soft_copies[counter->chip_index] |= tmp___5;
  tmp___6 = private(dev);
...
{ unsigned long flags ;
  ...
  tmp___3->dma_configuration_soft_copies[counter->chip_index] |= tmp___4;
  tmp___5 = private(dev);
...
{ unsigned int i ;
  ...
  tmp___0->dma_configuration_soft_copies[chipset] |= tmp___1 & tmp___2;
  i ++;
  ldv_21503: ;
  if (i <= 3U) {
    goto ldv_21502;
