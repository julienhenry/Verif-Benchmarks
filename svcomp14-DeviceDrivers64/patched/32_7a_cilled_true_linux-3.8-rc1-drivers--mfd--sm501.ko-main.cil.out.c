...
{ 
 ...
 static void sm501_mdelay(struct sm501_devdata *sm , unsigned int delay ) 
{ unsigned long __ms ;
  unsigned long tmp ;
...
{ struct platform_device *pdev ;
 ...
 static struct sm501_gpio_chip *to_sm501_gpio(struct gpio_chip *gc ) 
{ struct gpio_chip  const  *__mptr ;
 ...
 static struct sm501_devdata *sm501_gpio_to_dev(struct sm501_gpio *gpio ) 
...
{ struct sm501_gpio *gpio ;
 ...
 static int sm501_gpio_isregistered(struct sm501_devdata *sm ) 
{ 
...
static struct device_attribute dev_attr_dbg_regs  =    {{"dbg_regs", 438U, (_Bool)0, 0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
    ...
    & sm501_dbg_regs, 0};
 static void sm501_init_reg(struct sm501_devdata *sm , unsigned long reg ,
