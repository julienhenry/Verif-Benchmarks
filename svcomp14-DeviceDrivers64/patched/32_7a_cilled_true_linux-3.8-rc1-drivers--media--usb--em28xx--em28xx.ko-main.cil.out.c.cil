...
static struct v4l2_queryctrl ac97_qctrl[2U]  = {      {9963781U, 1U, {'V', 'o', 'l', 'u', 'm', 'e', '\000'}, 0, 31, 1, 31, 32U, {0U,
 ...
 static void buffer_filled(struct em28xx *dev , struct em28xx_dmaqueue *dma_q ,
...
{ 
 ...
 static void vbi_buffer_filled(struct em28xx *dev , struct em28xx_dmaqueue *dma_q ,
                                       struct em28xx_buffer *buf ) 
{ 
...
{ void *startwrite ;
  ...
  offset = dma_q->pos;
  if (buf->top_field == 0) {
    startwrite += (unsigned long )(dev->vbi_height * (unsigned int )bytesperline);
...
{ char *errmsg ;
 ...
 static void get_next_buf(struct em28xx_dmaqueue *dma_q , struct em28xx_buffer **buf ) 
{ struct em28xx *dev ;
 ...
 static void vbi_get_next_buf(struct em28xx_dmaqueue *dma_q , struct em28xx_buffer **buf ) 
{ struct em28xx *dev ;
  struct em28xx_dmaqueue  const  *__mptr ;
  char *outp ;
  int tmp ;
 ...
 static int em28xx_isoc_copy(struct em28xx *dev , struct urb *urb ) 
{ struct em28xx_buffer *buf ;
 ...
 static int em28xx_isoc_copy_vbi(struct em28xx *dev , struct urb *urb ) 
{ struct em28xx_buffer *buf ;
  struct em28xx_buffer *vbi_buf ;
  struct em28xx_dmaqueue *dma_q ;
...
{ struct em28xx *dev ;
  ...
  err: ;
  if (i2c_debug > 1U) {
    printk("\017%s at %s:  ERROR: __VERIFIER_error(); %i\n", (char *)(& dev->name), "em28xx_i2c_xfer",
           rc);
  }
  return (rc);
}
