...
extern void schedule(void) ;
 static void flowi4_init_output(struct flowi4 *fl4 , int oif , __u32 mark ,
...
{ 
 ...
 static struct flowi *flowi4_to_flowi(struct flowi4 *fl4 ) 
...
extern struct net_device *__ip_dev_find(struct net * , __be32  , bool  ) ;
 static struct net_device *ip_dev_find(struct net *net , __be32 addr ) 
...
extern void dst_release(struct dst_entry * ) ;
 static void dst_confirm(struct dst_entry *dst ) 
{ 
...
{ 
 ...
 static __u8 inet_sk_flowi_flags(struct sock  const  *sk ) 
{ __u8 flags ;
...
extern struct rtable *ip_route_output_flow(struct net * , struct flowi4 * , struct sock * ) ;
 static struct rtable *ip_route_output_ports(struct net *net , struct flowi4 *fl4 ,
...
{ __u8 tmp ;
  ...
  flowi4_init_output(fl4, oif, tmp___3, (int )tos, 0, (int )proto, tmp___0, daddr,
 ...
 static void set_arp_failure_handler(struct sk_buff *skb , void (*hnd)(struct t3cdev * ,
                                                                               struct sk_buff * ) ) 
{ 
...
extern int cxgb3_ofld_send(struct t3cdev * , struct sk_buff * ) ;
 static int l2t_send(struct t3cdev *dev , struct sk_buff *skb , struct l2t_entry *e ) 
{ int tmp ;
  long tmp___0 ;
  int tmp___1 ;
...
{ int mpalen ;
  ...
  mpa->flags = (u8 )(tmp___10 | tmp___11);
...
int cxio_poll_cq(struct t3_wq *wq , struct t3_cq *cq , struct t3_cqe *cqe , u8 *cqe_flushed ,
 ...
 static int t3a_device(struct iwch_dev  const  *rhp ) 
{ 
...
{ 
 ...
 static void ring_doorbell(void *doorbell , u32 qpid ) 
{ 
...
{ struct iwch_dev *rhp ;
 ...
 static void build_term_codes(struct respQ_msg_t *rsp_msg , u8 *layer_type ,
                                      u8 *ecode ) 
{ int status ;
  int tagged ;
  int opcode ;
...
{ int ret ;
  ...
  if (tmp != 0L) {
    if ((int )mask & 1) {
      tmp___25 = attrs->next_state;
    } else {
      tmp___25 = 4294967295U;
    }
...
void cxio_hal_pblpool_free(struct cxio_rdev *rdev_p , u32 addr , int size ) ;
 static int insert_handle(struct iwch_dev *rhp , struct idr *idr , void *handle ,
                                  u32 id ) 
{ int ret ;
  int newid ;
  int tmp ;
...
{ u64 mask ;
  ...
  *total_size += (buffer_list + (unsigned long )i)->size;
  if (i > 0) {
...
{ int tmp ;
 ...
 static struct in_device *__in_dev_get_rcu(struct net_device  const  *dev ) 
{ struct in_device *_________p1 ;
 ...
 static struct in_device *in_dev_get(struct net_device  const  *dev ) 
...
extern void in_dev_finish_destroy(struct in_device * ) ;
 static void in_dev_put(struct in_device *idev ) 
{ int tmp ;
...
void cxio_hal_put_pdid(struct cxio_hal_resource *rscp , u32 pdid ) ;
 static int insert_handle___0(struct iwch_dev *rhp , struct idr *idr , void *handle ,
                                      u32 id ) 
{ int ret ;
  int newid ;
  int tmp ;
...
{ struct list_head *pos ;
 ...
 static void insert_mmap(struct iwch_ucontext *ucontext , struct iwch_mm_entry *mm ) 
{ struct _ddebug descriptor ;
  long tmp ;
...
{ int len ;
  ...
  if ((unsigned long long )rdev_p->rnic_info.udbell_physbase <= addr && (unsigned long long )(rdev_p->rnic_info.udbell_physbase + (unsigned long )rdev_p->rnic_info.udbell_len) > addr) {
    ...
    vma->vm_flags |= 393216UL;
    vma->vm_flags &= 0xffffffffffffffefUL;
...
{ struct iwch_dev *rhp ;
  ...
  if ((unsigned long )ucontext != (unsigned long )((struct iwch_ucontext *)0)) {
    tmp___5 = & ucontext->uctx;
  } else {
    tmp___5 = & rhp->rdev.uctx;
  }
  cxio_destroy_qp(& rhp->rdev, & qhp->wq, tmp___5);
  descriptor.modname = "iw_cxgb3";
...
{ struct iwch_dev *rhp ;
  ...
  struct _ddebug descriptor___1 ;
  long tmp___27 ;
  struct cxio_ucontext *tmp___28 ;
  struct cxio_ucontext *tmp___29 ;
  ...
  if ((unsigned long )ucontext != (unsigned long )((struct iwch_ucontext *)0)) {
    tmp___28 = & ucontext->uctx;
  } else {
    tmp___28 = & rhp->rdev.uctx;
  }
  ...
  if (tmp___20 != 0) {
    if ((unsigned long )ucontext != (unsigned long )((struct iwch_ucontext *)0)) {
      tmp___29 = & ucontext->uctx;
    } else {
      tmp___29 = & rhp->rdev.uctx;
    }
    cxio_destroy_qp(& rhp->rdev, & qhp->wq, tmp___29);
    kfree((void const   *)qhp);
...
{ struct iwch_dev *rhp ;
  ...
  mask = (enum iwch_qp_attr_mask )(tmp___3 | (unsigned int )mask);
...
{ 
  ...
  {
  (wq->queue)->wq_in_err.err &= 0xfffffffffffffffdULL;
  return;
}
}
...
extern struct net_device *dev_get_by_name(struct net * , char const   * ) ;
 static void dev_put___0(struct net_device *dev ) 
{ void const   *__vpp_verify ;
  int pao_ID__ ;
  int pao_ID_____0 ;
  int pao_ID_____1 ;
...
{ struct t3_cqe cqe ;
  ...
  tmp___0 = __fswab32(((wq->qpid << 12) | tmp___1) | 2435U);
  cqe.header = tmp___0;
...
{ struct t3_cqe cqe ;
  ...
  tmp___0 = __fswab32((((u32 )sqp->opcode | (wq->qpid << 12)) | tmp___1) | 2448U);
  cqe.header = tmp___0;
...
{ int err ;
  ...
  if (reset_tpt_entry != 0U) {
    ...
    tmp___3 = __fswab32(((((unsigned int )perm << 28) | tmp___12) | tmp___13) | (unsigned int )((int )page_size << 20));
