...
static int vmic_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__pci_register_driver(& vmic_driver, & __this_module, "vme_vmivme7805");
  tmp = tmp___0;
  return (tmp);
}
}
...
{ int retval ;
  ...
  {
  tmp___1 = (int )pci_enable_device(pdev);
  retval = tmp___1;
  if (retval) {
  ...
  tmp___2 = (int )pci_request_regions(pdev, __cil_tmp13);
  retval = tmp___2;
  if (retval) {
