...
{ int err ;
  ...
  tmp___0 = (int )pci_request_regions(pdev, "orinoco_pci");
  err = tmp___0;
  if (err) {
  ...
  tmp___1 = (int )request_irq(__cil_tmp19, & orinoco_interrupt, 128UL, "orinoco_pci",
                              __cil_tmp20);
  err = tmp___1;
  if (err) {
...
{ int tmp___7 ;
  ...
  printk("<7>%s\n", __cil_tmp4);
  tmp = (int )__pci_register_driver(& orinoco_pci_driver, & __this_module, "orinoco_pci");
  tmp___7 = tmp;
  return (tmp___7);
}
}
