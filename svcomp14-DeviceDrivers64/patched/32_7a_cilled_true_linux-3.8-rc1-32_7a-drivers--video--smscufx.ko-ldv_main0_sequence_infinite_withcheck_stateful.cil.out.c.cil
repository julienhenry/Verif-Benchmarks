...
static struct fb_fix_screeninfo ufx_fix  = 
     {{'s', 'm', 's', 'c', 'u', 'f', 'x', '\000', (char)0, (char)0, (char)0, (char)0,
     (char)0, (char)0, (char)0, (char)0}, 0UL, 0U, 0U, 0U, 2U, 0U, 0U, 0U, 0U, 0UL,
...
static void ufx_calc_pll_values(u32 clk_pixel_pll , struct pll_values *asic_pll ) 
{ u32 ref_clk ;
  u32 div_r0 ;
  u32 div_f0 ;
  u32 div_q0 ;
  ...
  __x___0 = (int )(pllout_freq1 - clk_pixel_pll);
  if (__x___0 < 0) {
    tmp = - __x___0;
  } else {
    tmp = __x___0;
