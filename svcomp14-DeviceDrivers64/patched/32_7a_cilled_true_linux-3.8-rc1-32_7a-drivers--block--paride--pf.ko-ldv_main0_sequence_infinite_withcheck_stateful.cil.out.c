...
extern void put_disk(struct gendisk * ) ;
 static unsigned int bio_cur_bytes(struct bio *bio ) 
{ 
...
{ unsigned int tmp ;
 ...
 static unsigned int blk_rq_cur_sectors(struct request  const  *rq ) 
{ int tmp ;
...
{ 
 ...
 static int status_reg(struct pf_unit *pf ) 
{ int tmp ;
 ...
 static int read_reg(struct pf_unit *pf , int reg ) 
{ int tmp ;
 ...
 static void write_reg(struct pf_unit *pf , int reg , int val ) 
{ 
...
{ unsigned long saved_flags ;
 ...
 static void next_request(int err ) 
{ unsigned long saved_flags ;
  raw_spinlock_t *tmp ;
...
{ struct block_device *var_group1 ;
  ...
  if (ldv_s_pf_fops_block_device_operations == 0) {
    ...
    ldv_s_pf_fops_block_device_operations ++;
  }
  goto ldv_30338;
  case 1: ;
