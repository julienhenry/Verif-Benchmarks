...
{ struct stinger *stinger ;
  ...
  *((unsigned long *)__cil_tmp48) = __cil_tmp66 | __cil_tmp49;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp68);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& stinger_drv, & __this_module, "stinger");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_stinger_drv_serio_driver == 0) {
          ...
          ldv_s_stinger_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
