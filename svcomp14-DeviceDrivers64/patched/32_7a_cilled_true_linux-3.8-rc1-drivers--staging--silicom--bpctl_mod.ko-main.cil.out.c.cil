...
{ int tmp ;
 ...
 static int ldv_register_chrdev_8(unsigned int major , char const   *name ,
...
{ 
 ...
 static void ldv_unregister_chrdev_9(unsigned int major , char const   *name ) ;
...
{ int tmp ;
 ...
 static unsigned int _kc_jiffies_to_msecs(unsigned long j ) 
{ 
...
{ u_int32_t ctrl_ext ;
  ...
  if (tmp___2 != 0) {
    ...
    if (pbpctl_dev->bp_ext_ver == 0) {
      pbpctl_dev->bp_caps |= 64639U;
    } else
    if (pbpctl_dev->bp_ext_ver > 0) {
      pbpctl_dev->bp_caps |= 57352U;
      cap_reg = get_bp_prod_caps(pbpctl_dev);
      if ((cap_reg & 4) != 0) {
        pbpctl_dev->bp_caps |= 67108864U;
      } else {
        pbpctl_dev->bp_caps |= 64U;
      }
      ...
      if (cap_reg & 1) {
        pbpctl_dev->bp_caps |= 7223U;
        if (pbpctl_dev->bp_ext_ver > 5) {
          pbpctl_dev->bp_caps |= 896U;
        }
      }
      if ((cap_reg & 2) != 0) {
        pbpctl_dev->bp_caps |= 66846720U;
      }
      if (pbpctl_dev->bp_ext_ver > 7) {
        if ((cap_reg & 8) != 0) {
          pbpctl_dev->bp_caps |= 1879048192U;
        }
        if ((cap_reg & 16) != 0) {
          pbpctl_dev->bp_caps_ex |= 1U;
          pbpctl_dev->bp_caps |= 134217728U;
      ...
      if (pbpctl_dev->bp_ext_ver > 8) {
        if ((cap_reg & 32) != 0) {
          pbpctl_dev->bp_caps_ex |= 2U;
          pbpctl_dev->bp_caps |= 196608U;
        }
      }
    }
    if (pbpctl_dev->bp_ext_ver >= 0) {
  ...
  if (((pbpctl_dev->subdevice == 321U || pbpctl_dev->subdevice == 322U) || pbpctl_dev->subdevice == 323U) || pbpctl_dev->subdevice == 320U) {
    pbpctl_dev->bp_caps &= 4294770687U;
  }
  pbpctl_dev_m = get_master_port_fn(pbpctl_dev);
  if ((unsigned long )pbpctl_dev_m != (unsigned long )((bpctl_dev_t *)0)) {
    cap_reg___0 = 0;
