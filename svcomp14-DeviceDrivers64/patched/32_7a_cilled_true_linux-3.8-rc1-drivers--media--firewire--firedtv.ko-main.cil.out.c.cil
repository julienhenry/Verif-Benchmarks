...
void fdtv_handle_rc(struct firedtv *fdtv , unsigned int code ) ;
 static void clear_operands(struct avc_command_frame *c , int from , int to ) 
{ 
...
{ int ret ;
 ...
 static u32 get_opcr(__be32 opcr , u32 mask , u32 shift ) 
{ __u32 tmp ;
 ...
 static void set_opcr(__be32 *opcr , u32 value , u32 mask , u32 shift ) 
{ __u32 tmp ;
  __u32 tmp___0 ;
...
{ int i ;
 ...
 static void dealloc_channel(struct firedtv *fdtv , int i ) 
{ 
...
extern struct bus_type fw_bus_type ;
 static struct fw_device *fw_device(struct device *dev ) 
{ struct device  const  *__mptr ;
 ...
 static struct fw_unit *fw_unit(struct device *dev ) 
{ struct device  const  *__mptr ;
...
static spinlock_t node_list_lock  =    {{{{{0U}}, 3735899821U, 4294967295U, 0xffffffffffffffffUL, {0, {0, 0}, "node_list_lock",
                                                               0, 0UL}}}};
 static struct fw_device *device_of(struct firedtv *fdtv ) 
