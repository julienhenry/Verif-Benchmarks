...
static struct device_attribute dev_attr_yoffset  =    {{"yoffset", (umode_t )292}, & show_yoffset, (ssize_t (*)(struct device *dev ,
                                                             struct device_attribute *attr ,
                                                             char const   *buf , size_t count ))((void *)0)};
static ssize_t show_image(struct file *file ,
...
static struct attribute_group bgrt_attribute_group  =    {(char const   *)0,
    (umode_t (*)(struct kobject * , struct attribute * , int  ))0, bgrt_attributes};
static int bgrt_init(void)  __attribute__((__section__(".init.text"),
...
{ acpi_status status ;
  ...
  *((void **)__cil_tmp18) = ioremap(__cil_tmp23, __cil_tmp25);
  ...
  tmp___0 = (int )sysfs_create_group(bgrt_kobj, __cil_tmp28);
  ret = tmp___0;
  if (ret) {
    goto out_kobject;
  }
  __cil_tmp29 = (struct bin_attribute  const  *)(& image_attr);
  tmp___1 = (int )sysfs_create_bin_file(bgrt_kobj, __cil_tmp29);
  ret = tmp___1;
  if (ret) {
    goto out_group;
  }
  ...
  out_iounmap: 
  __cil_tmp31 = (unsigned long )(& image_attr) + 24UL;
...
{ unsigned long __cil_tmp1 ;
  ...
  {
  __cil_tmp1 = (unsigned long )(& image_attr) + 24UL;
