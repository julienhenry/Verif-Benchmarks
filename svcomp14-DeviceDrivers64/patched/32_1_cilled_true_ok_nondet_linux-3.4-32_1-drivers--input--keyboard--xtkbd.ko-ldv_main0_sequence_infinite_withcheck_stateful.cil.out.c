...
{ struct xtkbd *xtkbd ;
  ...
  *((unsigned int *)__cil_tmp82) = (unsigned int )__cil_tmp84;
  ...
  __cil_tmp105 = __cil_tmp104 + 256UL;
  __cil_tmp106 = *((struct input_dev **)__cil_tmp105);
  tmp___0 = (int )input_register_device(__cil_tmp106);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
static int xtkbd_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& xtkbd_drv, & __this_module, "xtkbd");
  tmp = tmp___0;
  return (tmp);
}
}
