...
static struct sensor_device_attribute sensor_dev_attr_in0_input  =    {{{"in0_input",
      (umode_t )292}, & show_adc, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                               char const   *buf , size_t count ))((void *)0)},
    0};
...
{ struct max1111_data *data ;
  ...
  *((struct spi_device **)data) = spi;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp23, & max1111_attr_group);
  err = tmp;
  if (err) {
  ...
  *((struct device **)__cil_tmp27) = hwmon_device_register(__cil_tmp28);
  ...
  if (tmp___9) {
    ...
    tmp___11 = (long )PTR_ERR(__cil_tmp38);
    tmp___8 = tmp___11;
    err = (int )tmp___8;
    goto err_remove;
  }
