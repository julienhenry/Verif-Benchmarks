...
extern struct module __this_module ;
 static void ldv___module_get_3(struct module *module ) ;
...
extern void mempool_kfree(void * , void * ) ;
 static mempool_t *mempool_create_kmalloc_pool(int min_nr , size_t size ) 
{ mempool_t *tmp ;
...
{ 
 ...
 static struct bio *bio_list_peek(struct bio_list *bl ) 
{ 
...
static struct attribute kobj_pkt_attr_st2  =    {"packets_started", 292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0},
                                                           {(char)0}, {(char)0}, {(char)0},
                                                           {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_st3  =    {"packets_finished",
    292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_st4  =    {"kb_written",
    292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_st5  =    {"kb_read",
    292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_st6  =    {"kb_read_gather",
    292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
...
static struct attribute kobj_pkt_attr_wq1  =    {"size",
    292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_wq2  =    {"congestion_off",
    420U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
static struct attribute kobj_pkt_attr_wq3  =    {"congestion_on",
    420U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0}, {(char)0},
                                        {(char)0}, {(char)0}, {(char)0}, {(char)0}}}};
...
static struct kobj_type kobj_pkt_type_wqueue  =    {& pkt_kobj_release,
    & kobj_pkt_ops, (struct attribute **)(& kobj_pkt_attrs_wqueue), (struct kobj_ns_type_operations  const  *(*)(struct kobject * ))0,
...
{ struct packet_data *pkt ;
 ...
 static struct pkt_rb_node *pkt_rbtree_next(struct pkt_rb_node *node ) 
{ struct rb_node *n ;
  struct rb_node *tmp ;
...
{ int frames_read ;
  ...
  pd->stats.secs_w += (unsigned long )(num_frames * 4);
  ...
  out_account: 
  (pd->stats.pkt_started) ++;
  pd->stats.secs_rg += (unsigned long )(frames_read * 4);
  return;
}
}
...
{ 
 ...
 static void pkt_set_state(struct packet_data *pkt , enum packet_data_state state ) 
{ 
...
{ struct packet_data *pkt ;
  ...
  *(states + (unsigned long )i) = 0;
  ...
  goto ldv_31038;
  ldv_31037: 
  (*(states + (unsigned long )pkt->state)) ++;
  __mptr___0 = (struct list_head  const  *)pkt->list.next;
  pkt = (struct packet_data *)__mptr___0;
  ldv_31038: ;
  if ((unsigned long )(& pkt->list) != (unsigned long )(& pd->cdrw.pkt_active_list)) {
...
{ struct pktcdvd_device *pd ;
  ...
  pkt->sleep_time += residue - min_sleep_time;
  if (pkt->sleep_time <= 0L) {
    pkt->sleep_time = 0L;
    atomic_inc(& pkt->run_sm);
  }
...
{ struct pktcdvd_device *pd ;
  ...
  if ((bio->bi_rw & 1UL) == 0UL) {
    ...
    pd->stats.secs_r += (unsigned long )(bio->bi_size >> 9);
...
static struct file_operations  const  pkt_proc_fops  = 
    ...
    (int (*)(struct file * , long  , struct file_lock ** ))0, (long (*)(struct file * ,
                                                                        int  , loff_t  ,
                                                                        loff_t  ))0};
static int pkt_new_dev(struct pktcdvd_device *pd ,
                       dev_t dev ) 
{ int i ;
  int ret ;
  char b[32U] ;
  ...
  if (tmp___0 == 11) {
    ...
    if (0) {
      ...
      if (ldv_s_pktcdvd_ops_block_device_operations == 0) {
        ...
        ldv_s_pktcdvd_ops_block_device_operations ++;
      }
      goto ldv_31505;
      case_7: ;
