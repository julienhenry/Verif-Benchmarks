    ...
    if (__cil_tmp35 == 5194) {
      ...
      if (__cil_tmp39 == 29746) {
        ...
        *((int *)__cil_tmp99) = 32;
        ...
        __cil_tmp101 = __cil_tmp100 + 92UL;
        ...
        *((int *)__cil_tmp105) = -1;
        ...
        __cil_tmp107 = __cil_tmp106 + 128UL;
...
{ int retval ;
  ...
  *((char const   **)__cil_tmp3) = (char const   *)__cil_tmp6;
  tmp___0 = (int )__pci_register_driver(& driver_adl_pci7432_pci_driver, & __this_module,
                                        "adl_pci7432");
  tmp = tmp___0;
  return (tmp);
}
