...
extern int misc_deregister(struct miscdevice * ) ;
 static unsigned int scsi_varlen_cdb_length(void const   *hdr ) 
{ 
...
extern unsigned char const   scsi_command_size_tbl[8U] ;
 static unsigned int scsi_command_size(unsigned char const   *cmnd ) 
{ unsigned int tmp ;
