...
extern void fb_dealloc_cmap(struct fb_cmap * ) ;
 static void _radeon_msleep(struct radeonfb_info *rinfo , unsigned long ms ) 
{ unsigned long __ms ;
  unsigned long tmp ;
 ...
 static void _OUTREGP(struct radeonfb_info *rinfo , u32 addr , u32 val , u32 mask ) 
{ unsigned long flags ;
  unsigned int tmp ;
...
{ u32 save ;
 ...
 static u32 __INPLL(struct radeonfb_info *rinfo , u32 addr ) 
{ u32 data ;
 ...
 static void __OUTPLL(struct radeonfb_info *rinfo , unsigned int index , u32 val ) 
{ 
 ...
 static void __OUTPLLP(struct radeonfb_info *rinfo , unsigned int index ,
                               u32 val , u32 mask ) 
{ unsigned int tmp ;
...
{ 
 ...
 static int var_to_depth(struct fb_var_screeninfo  const  *var ) 
{ int tmp ;
...
{ int i ;
 ...
 static void radeon_engine_flush(struct radeonfb_info *rinfo ) 
{ int i ;
  unsigned int tmp ;
 ...
 static void _radeon_engine_idle(struct radeonfb_info *rinfo ) 
{ int i ;
  unsigned int tmp ;
...
{ unsigned char ppll_div_sel ;
  ...
  vclk /= (unsigned long long )__base;
  xtal = (long )vclk;
...
{ u32 val ;
  ...
  if (unblank != 0) {
    ...
    if (val != target_val) {
      ...
      rinfo->init_state.lvds_gen_cntl &= 4294377724U;
      rinfo->init_state.lvds_gen_cntl |= target_val & 589571U;
      if (mode_switch != 0) {
    ...
    rinfo->init_state.lvds_gen_cntl &= 4294377724U;
    rinfo->init_state.lvds_gen_cntl |= val & 589571U;
    if (rinfo->is_mobility != 0 || rinfo->is_IGP != 0) {
...
{ struct radeonfb_info *rinfo ;
  ...
  newmode->crtc_more_cntl &= 4294967280U;
  if (primary_mon == 3 || primary_mon == 2) {
    newmode->crtc_ext_cntl = 72U;
    if ((int )mirror) {
      newmode->crtc_ext_cntl |= 32768U;
    }
    newmode->crtc_gen_cntl &= 4294967292U;
  } else {
  ...
  if (primary_mon == 3 || primary_mon == 2) {
    ...
    if (mode->xres != (__u32 )rinfo->panel_info.xres) {
      ...
      newmode->fp_horz_stretch |= 100663296U;
      use_rmx = 1;
    }
    newmode->fp_horz_stretch &= 4160749567U;
    if (mode->yres != (__u32 )rinfo->panel_info.yres) {
      ...
      newmode->fp_vert_stretch |= 100663296U;
      use_rmx = 1;
    }
    newmode->fp_vert_stretch &= 4160749567U;
    newmode->fp_gen_cntl = rinfo->init_state.fp_gen_cntl & 4195082239U;
    newmode->fp_gen_cntl |= 196616U;
    if ((((((((unsigned int )rinfo->family == 11U || (unsigned int )rinfo->family == 13U) || (unsigned int )rinfo->family == 12U) || (unsigned int )rinfo->family == 14U) || (unsigned int )rinfo->family == 15U) || (unsigned int )rinfo->family == 16U) || (unsigned int )rinfo->family == 18U) || (unsigned int )rinfo->family == 7U) {
      newmode->fp_gen_cntl &= 4294964223U;
      if (use_rmx != 0) {
        newmode->fp_gen_cntl |= 2048U;
      } else {
    ...
    if (primary_mon == 2) {
      newmode->lvds_gen_cntl |= 524289U;
      newmode->fp_gen_cntl &= 4294967290U;
    } else {
      newmode->fp_gen_cntl |= 5U;
      newmode->tmds_transmitter_cntl &= 4294967293U;
      if (((((((((unsigned int )rinfo->family == 11U || (unsigned int )rinfo->family == 13U) || (unsigned int )rinfo->family == 12U) || (unsigned int )rinfo->family == 14U) || (unsigned int )rinfo->family == 15U) || (unsigned int )rinfo->family == 16U) || (unsigned int )rinfo->family == 18U) || (unsigned int )rinfo->family == 7U) || rinfo->has_CRTC2 == 0) {
        newmode->tmds_transmitter_cntl &= 4294967294U;
      } else {
        newmode->tmds_transmitter_cntl |= 1U;
      }
      newmode->crtc_ext_cntl &= 4294934527U;
    }
...
{ u32 tmp ;
  ...
  if (tmp___4 != 0L) {
    ...
    __dynamic_pr_debug(& descriptor, "radeonfb (%s): Found %ldk of %s %d bits wide videoram\n",
                       tmp___3, rinfo->video_ram / 1024UL, tmp___5, rinfo->vram_width);
  }
  return;
}
}
...
{ struct fb_info *info ;
  ...
  if (__min1 < __min2) {
    rinfo->mapped_vram = __min1;
  } else {
    rinfo->mapped_vram = __min2;
  }
  ldv_33734: 
  ...
  if (default_dynclk < -1) {
    ...
    radeonfb_pm_init(rinfo, tmp___17, (int )ignore_devlist, (int )force_sleep);
  } else {
...
{ struct fb_var_screeninfo *var_group1 ;
  ...
  if (ldv_s_radeonfb_driver_pci_driver == 0) {
    ...
    ldv_s_radeonfb_driver_pci_driver ++;
  }
  goto ldv_33969;
  case 10: ;
...
{ u32 sclk_cntl ;
  ...
  clk_pwrmgt_cntl &= 2164230912U;
  clk_pwrmgt_cntl |= 1049600U;
  __OUTPLL(rinfo, 20U, clk_pwrmgt_cntl);
  clk_pin_cntl = __INPLL(rinfo, 1U);
  clk_pin_cntl &= 4294959103U;
...
{ struct radeon_bl_privdata *pdata ;
  ...
  if (level > 0) {
    ...
    rinfo->init_state.lvds_gen_cntl &= 4294377724U;
    rinfo->init_state.lvds_gen_cntl |= rinfo->pending_lvds_gen_cntl & 589571U;
  } else {
    tmpPixclksCntl = __INPLL(rinfo, 45U);
    if (rinfo->is_mobility != 0 || rinfo->is_IGP != 0) {
      __OUTPLLP(rinfo, 45U, 0U, 4294950911U);
    }
    lvds_gen_cntl &= 4294836479U;
    tmp___3 = radeon_bl_get_level_brightness(pdata, 0);
    lvds_gen_cntl = (u32 )(tmp___3 << 8) | lvds_gen_cntl;
    lvds_gen_cntl |= 2U;
    writel(lvds_gen_cntl, (void volatile   *)rinfo->mmio_base + 720U);
    __const_udelay(429500UL);
    lvds_gen_cntl &= 4294967166U;
    writel(lvds_gen_cntl, (void volatile   *)rinfo->mmio_base + 720U);
    lvds_gen_cntl &= 4294705151U;
    rinfo->pending_lvds_gen_cntl = lvds_gen_cntl;
  ...
  rinfo->init_state.lvds_gen_cntl &= 4294377724U;
  rinfo->init_state.lvds_gen_cntl |= lvds_gen_cntl & 589571U;
  return (0);
}
}
