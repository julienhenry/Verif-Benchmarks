...
static struct device_attribute dev_attr_name  =    {{"name",
     (umode_t )420}, & name_show, (ssize_t (*)(struct device *dev , struct device_attribute *attr ,
                                               char const   *buf , size_t count ))((void *)0)};
void switch_set_state(struct switch_dev *sdev ,
                      int state ) 
{ char name_buf[120] ;
  char state_buf[120] ;
  char *prop_buf ;
    ...
    *((int *)__cil_tmp18) = state;
    ...
    if (prop_buf) {
      ...
      if (length > 0) {
        ...
        tmp___1 = env_offset;
        env_offset ++;
        __cil_tmp33 = (unsigned long )tmp___1 * 8UL;
      ...
      if (length > 0) {
        ...
        tmp___3 = env_offset;
        env_offset ++;
        __cil_tmp51 = (unsigned long )tmp___3 * 8UL;
      ...
      __cil_tmp55 = (unsigned long )env_offset * 8UL;
...
{ struct class *tmp ;
  ...
  struct class *tmp___2 ;
  long tmp___3 ;
  long tmp___4 ;

  {
  if (! switch_class) {
    tmp___2 = (struct class *)__class_create(& __this_module, "switch", & __key___3);
    tmp = tmp___2;
    switch_class = tmp;
    __cil_tmp4 = (void const   *)switch_class;
    tmp___3 = (long )IS_ERR(__cil_tmp4);
    tmp___1 = tmp___3;
    if (tmp___1) {
      __cil_tmp5 = (void const   *)switch_class;
      tmp___4 = (long )PTR_ERR(__cil_tmp5);
      tmp___0 = tmp___4;
      return ((int )tmp___0);
    }
...
{ int ret ;
  ...
  *((struct device **)__cil_tmp8) = device_create(switch_class, __cil_tmp10, __cil_tmp14,
  ...
  tmp___1 = (long )IS_ERR(__cil_tmp20);
  tmp___0 = tmp___1;
  if (tmp___0) {
    ...
    tmp___2 = (long )PTR_ERR(__cil_tmp24);
    tmp = tmp___2;
    return ((int )tmp);
  }
