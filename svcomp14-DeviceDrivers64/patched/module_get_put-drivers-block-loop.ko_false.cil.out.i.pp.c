...
{ 
  ...
  {
  m->flags = (m->flags & 1152921504598458368UL) | (unsigned long )mask;
  return;
}
}
...
{ struct loop_device *l ;
  ...
  l = (struct loop_device *)__mptr + 1152921504606846320UL;
  goto ldv_30632;
  ldv_30631: ;
  ...
  l = (struct loop_device *)__mptr___0 + 1152921504606846320UL;
  ldv_30632: ;
...
static ssize_t loop_attr_do_show_sizelimit(struct device *d ,
...
static struct device_attribute loop_attr_sizelimit  =    {{"sizelimit", 292U, (struct lock_class_key *)0, {{{(char)0}, {(char)0}, {(char)0},
    ...
    (ssize_t (*)(struct device * , struct device_attribute * , char const   * , size_t  ))0};
static ssize_t loop_attr_do_show_autoclear(struct device *d ,
                                           struct device_attribute *attr , char *b ) 
{ ssize_t tmp ;
...
static struct attribute *loop_attrs[5U]  = {      & loop_attr_backing_file.attr,      & loop_attr_offset.attr,      & loop_attr_sizelimit.attr,      & loop_attr_autoclear.attr, 
        (struct attribute *)0};
static struct attribute_group loop_attribute_group  =    {"loop",
    (mode_t (*)(struct kobject * , struct attribute * , int  ))0, (struct attribute **)(& loop_attrs)};
...
{ unsigned int n ;
  ...
  __mptr = (struct list_head  const  *)loop_devices.next;
  lo = (struct loop_device *)__mptr + 1152921504606846320UL;
  goto ldv_30981;
  ldv_30980: 
  mutex_lock_nested(& lo->lo_ctl_mutex, 0U);
  ...
  lo = (struct loop_device *)__mptr___0 + 1152921504606846320UL;
  ldv_30981: ;
...
{ int i ;
  ...
  lo = (struct loop_device *)__mptr___1 + 1152921504606846320UL;
  __mptr___2 = (struct list_head  const  *)lo->lo_list.next;
  next = (struct loop_device *)__mptr___2 + 1152921504606846320UL;
  goto ldv_31056;
  ldv_31055: 
  loop_free(lo);
  lo = next;
  __mptr___3 = (struct list_head  const  *)next->lo_list.next;
  next = (struct loop_device *)__mptr___3 + 1152921504606846320UL;
  ldv_31056: ;
  if ((unsigned long )(& lo->lo_list) != (unsigned long )(& loop_devices)) {
    goto ldv_31055;
  }
...
{ unsigned long range ;
  ...
  lo = (struct loop_device *)__mptr + 1152921504606846320UL;
  __mptr___0 = (struct list_head  const  *)lo->lo_list.next;
  next = (struct loop_device *)__mptr___0 + 1152921504606846320UL;
  goto ldv_31071;
  ldv_31070: 
  loop_del_one(lo);
  lo = next;
  __mptr___1 = (struct list_head  const  *)next->lo_list.next;
  next = (struct loop_device *)__mptr___1 + 1152921504606846320UL;
  ldv_31071: ;
  if ((unsigned long )(& lo->lo_list) != (unsigned long )(& loop_devices)) {
    goto ldv_31070;
  }
  ...
  if (tmp___0 == 6) {
    ...
    if (0) {
      ...
      if (ldv_s_lo_fops_block_device_operations == 0) {
        ...
        ldv_s_lo_fops_block_device_operations ++;
      }
      goto ldv_31125;
      case_4: ;
