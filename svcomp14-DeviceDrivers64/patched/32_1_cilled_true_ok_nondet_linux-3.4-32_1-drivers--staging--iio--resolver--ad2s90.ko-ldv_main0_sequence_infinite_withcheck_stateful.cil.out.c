...
extern int spi_sync(struct spi_device *spi , struct spi_message *message ) ;
 static int spi_read(struct spi_device *spi , void *buf , size_t len )  __attribute__((__no_instrument_function__)) ;
 static int spi_read(struct spi_device *spi , void *buf , size_t len )  __attribute__((__no_instrument_function__)) ;
