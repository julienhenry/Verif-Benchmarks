...
static int gyration_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__hid_register_driver(& gyration_driver, & __this_module, "hid_gyration");
  tmp = tmp___0;
  return (tmp);
}
}
