...
extern void dev_kfree_skb_irq(struct sk_buff * ) ;
 static struct atm_vcc *atm_sk(struct sock *sk ) 
{ 
...
{ struct eni_dev *eni_dev ;
  ...
  if (eff == 0UL) {
    ...
    if ((words & 1152921504606846960UL) != 0UL) {
      tmp___2 = j;
      j ++;
      ...
      paddr = (unsigned long long )((words & 1152921504606846960UL) << 2) + paddr;
      words &= 15UL;
    }
    if ((words & 1152921504606846968UL) != 0UL) {
      tmp___4 = j;
      j ++;
      ...
      paddr = (unsigned long long )((words & 1152921504606846968UL) << 2) + paddr;
      words &= 7UL;
    }
    if ((words & 1152921504606846972UL) != 0UL) {
      tmp___6 = j;
      j ++;
      ...
      paddr = (unsigned long long )((words & 1152921504606846972UL) << 2) + paddr;
      words &= 3UL;
    }
    if ((words & 1152921504606846974UL) != 0UL) {
      tmp___8 = j;
      j ++;
      ...
      paddr = (unsigned long long )((words & 1152921504606846974UL) << 2) + paddr;
      words &= 1UL;
    }
    if (words != 0UL) {
      tmp___10 = j;
...
{ struct eni_vcc *eni_vcc ;
 ...
 static int rx_vcc(struct atm_vcc *vcc ) 
{ void *vci_dsc ;
  unsigned long tmp ;
  struct eni_vcc *eni_vcc ;
  int tmp___0 ;
...
{ struct eni_dev *eni_dev ;
  ...
  __asm__  volatile   ("": : : "memory");
  (((struct eni_vcc *)curr->dev_data)->servicing) --;
  ldv_40214: 
  curr = eni_dev->fast;
...
{ struct eni_dev *eni_dev ;
  ...
  putting ++;
  (((struct eni_vcc *)vcc->dev_data)->servicing) ++;
  ldv_40225: 
...
{ struct eni_dev *eni_dev ;
 ...
 static void put_dma(int chan , u32 *dma , int *j , dma_addr_t paddr , u32 size ) 
{ u32 init ;
  u32 words ;
  int tmp ;
  int tmp___0 ;
...
{ struct eni_dev *eni_dev ;
  ...
  ((struct eni_vcc *)vcc->dev_data)->txing -= ((struct eni_skb_prv *)(& skb->cb))->size;
  pci_unmap_single(eni_dev->pci_dev, ((struct eni_skb_prv *)(& skb->cb))->paddr, (size_t )skb->len,
                   1);
...
{ struct atm_dev *dev ;
  ...
  if ((int )reason & 1) {
    ...
    eni_dev->lost += (unsigned long )tmp & 65535UL;
  }
  if ((reason & 2U) != 0U) {
    EVENT("SUNI int\n", 0UL, 0UL);
...
{ struct hlist_node *node ;
  ...
  *(page + (unsigned long )length) = (char)10;
  ...
  if ((unsigned long )node != (unsigned long )((struct hlist_node *)0)) {
    ...
    s = (struct sock *)__mptr + 1152921504606846920UL;
    goto ldv_40672;
  }
  ldv_40674: 
  i ++;
  ...
  tmp___9 = sprintf(page, "free      %p-%p (%6d bytes)\n", fe->start + - offset, fe->start + (((unsigned long )(1 << fe->order) - offset) + 1152921504606846975UL),
                    1 << fe->order);
  return (tmp___9);
  ldv_40680: 
  i ++;
