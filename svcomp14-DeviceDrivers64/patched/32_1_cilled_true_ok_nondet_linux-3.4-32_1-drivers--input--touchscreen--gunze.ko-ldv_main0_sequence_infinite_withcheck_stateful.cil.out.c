...
{ struct gunze *gunze ;
  ...
  *((unsigned long *)__cil_tmp50) = 1UL << 10;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp52);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
static int gunze_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& gunze_drv, & __this_module, "gunze");
  tmp = tmp___0;
  return (tmp);
}
}
