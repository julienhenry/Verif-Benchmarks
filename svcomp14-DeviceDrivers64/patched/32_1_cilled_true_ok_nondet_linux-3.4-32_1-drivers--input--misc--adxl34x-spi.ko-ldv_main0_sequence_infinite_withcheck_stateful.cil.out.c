...
{ struct adxl34x *ac ;
  ...
  if (tmp___8) {
    ...
    tmp___9 = (long )PTR_ERR(__cil_tmp23);
    tmp___7 = tmp___9;
    return ((int )tmp___7);
  }
  __cil_tmp24 = (void *)ac;
...
static int adxl34x_driver_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
