...
{ struct tdo24m *lcd ;
  ...
  __cil_tmp20 = __cil_tmp19 + 1166UL;
  *((u8 *)__cil_tmp20) = (u8 )8U;
  __cil_tmp21 = (unsigned long )spi;
  __cil_tmp22 = __cil_tmp21 + 1165UL;
