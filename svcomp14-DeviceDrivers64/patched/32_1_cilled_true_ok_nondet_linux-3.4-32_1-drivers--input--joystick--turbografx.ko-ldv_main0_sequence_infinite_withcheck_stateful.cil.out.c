...
{ struct tgfx *tgfx ;
  ...
  __cil_tmp7 = __cil_tmp6 + 824UL;
  __cil_tmp8 = (struct mutex *)__cil_tmp7;
  tmp___1 = (int )mutex_lock_interruptible(__cil_tmp8);
  err = tmp___1;
  if (err) {
    return (err);
  }
  __cil_tmp9 = (unsigned long )tgfx;
  __cil_tmp10 = __cil_tmp9 + 820UL;
  tmp___0 = *((int *)__cil_tmp10);
  __cil_tmp11 = (unsigned long )tgfx;
  __cil_tmp12 = __cil_tmp11 + 820UL;
  __cil_tmp13 = (unsigned long )tgfx;
  __cil_tmp14 = __cil_tmp13 + 820UL;
...
{ struct tgfx *tgfx ;
  ...
  *((void (**)(unsigned long  ))__cil_tmp37) = & tgfx_timer;
  ...
  while (1) {
    ...
    __cil_tmp44 = (unsigned long )i * 8UL;
    __cil_tmp45 = 88UL + __cil_tmp44;
    ...
    *((int *)__cil_tmp49) = __cil_tmp53 | __cil_tmp50;
    __cil_tmp54 = 0UL;
    __cil_tmp55 = (unsigned long )i * 64UL;
    __cil_tmp56 = __cil_tmp55 + __cil_tmp54;
    __cil_tmp57 = 144UL + __cil_tmp56;
    ...
    __cil_tmp63 = 0UL;
    __cil_tmp64 = (unsigned long )i * 32UL;
    __cil_tmp65 = __cil_tmp64 + __cil_tmp63;
    __cil_tmp66 = 592UL + __cil_tmp65;
    ...
    __cil_tmp77 = 0UL;
    __cil_tmp78 = (unsigned long )i * 64UL;
    __cil_tmp79 = __cil_tmp78 + __cil_tmp77;
    __cil_tmp80 = 144UL + __cil_tmp79;
    ...
    *((char const   **)input_dev) = (char const   *)__cil_tmp83;
    ...
    __cil_tmp86 = 0UL;
    __cil_tmp87 = (unsigned long )i * 32UL;
    __cil_tmp88 = __cil_tmp87 + __cil_tmp86;
    __cil_tmp89 = 592UL + __cil_tmp88;
    ...
    *((__u16 *)__cil_tmp105) = (__u16 )256;
    ...
    __cil_tmp108 = __cil_tmp107 + 504UL;
    ...
    *((void (**)(struct input_dev *dev ))__cil_tmp110) = & tgfx_close;
    __cil_tmp111 = 0UL;
    __cil_tmp112 = 40UL + __cil_tmp111;
    ...
    *((unsigned long *)__cil_tmp114) = __cil_tmp116 | __cil_tmp115;
    ...
    while (1) {
      ...
      __cil_tmp119 = (unsigned long )j * 4UL;
  ...
  __cil_tmp135 = __cil_tmp134 + 816UL;
  ...
  __cil_tmp138 = 88UL + __cil_tmp137;
  ...
  while (1) {
    ...
    __cil_tmp142 = (unsigned long )i * 8UL;
    __cil_tmp143 = 88UL + __cil_tmp142;
    __cil_tmp144 = (unsigned long )tgfx;
    __cil_tmp145 = __cil_tmp144 + __cil_tmp143;
    if (*((struct input_dev **)__cil_tmp145)) {
      __cil_tmp146 = (unsigned long )i * 8UL;
      __cil_tmp147 = 88UL + __cil_tmp146;
  ...
  tmp___2 = (void *)ERR_PTR(__cil_tmp152);
  tmp___0 = tmp___2;
...
{ int i ;
  ...
  while (1) {
    ...
    __cil_tmp7 = (unsigned long )i * 36UL;
    ...
    if (__cil_tmp10 == 0U) {
      ...
      __cil_tmp13 = (unsigned long )i * 36UL;
    ...
    __cil_tmp17 = (unsigned long )i * 36UL;
    ...
    *((struct tgfx **)__cil_tmp22) = tgfx_probe(__cil_tmp28, __cil_tmp35, __cil_tmp41);
    ...
    tmp___2 = (long )IS_ERR(__cil_tmp45);
    tmp___0 = tmp___2;
    if (tmp___0) {
      ...
      tmp___3 = (long )PTR_ERR(__cil_tmp49);
      tmp = tmp___3;
      err = (int )tmp;
      goto while_break;
    }
  ...
  if (err) {
    while (1) {
      ...
      __cil_tmp50 = (unsigned long )i * 8UL;
...
{ int i ;
  ...
  while (1) {
    ...
    __cil_tmp2 = (unsigned long )i * 8UL;
