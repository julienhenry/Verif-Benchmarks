...
{ struct stmpe *stmpe ;
  ...
  *((struct device **)__cil_tmp23) = (struct device *)__cil_tmp25;
  ...
  __cil_tmp87 = (void *)ts;
  tmp = (int )request_threaded_irq(__cil_tmp84, __cil_tmp86, & stmpe_ts_handler, 8192UL,
  ...
  *((unsigned long *)__cil_tmp97) = __cil_tmp99 | __cil_tmp98;
  __cil_tmp100 = 40UL;
  __cil_tmp101 = 48UL + __cil_tmp100;
  ...
  *((void (**)(struct input_dev *dev ))__cil_tmp107) = & stmpe_ts_close;
  ...
  tmp___9 = (int )input_register_device(idev);
  ret = tmp___9;
  if (ret) {
