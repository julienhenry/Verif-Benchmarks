...
{ struct wm831x *wm831x ;
  ...
  *((struct device **)__cil_tmp64) = (struct device *)__cil_tmp66;
  ...
  tmp___3 = (int )request_threaded_irq(__cil_tmp67, __cil_tmp69, & wm831x_on_irq,
                                       1UL, "wm831x_on", __cil_tmp70);
  ret = tmp___3;
  if (ret < 0) {
  ...
  tmp___4 = (int )input_register_device(__cil_tmp75);
  ret = tmp___4;
  if (ret) {
    while (1) {
