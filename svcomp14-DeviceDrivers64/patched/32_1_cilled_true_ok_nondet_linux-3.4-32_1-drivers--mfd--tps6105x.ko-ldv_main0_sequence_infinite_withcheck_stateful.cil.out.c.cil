...
{ int ret ;
  ...
  tmp = (int )mutex_lock_interruptible(__cil_tmp7);
  ret = tmp;
  if (ret) {
    return (ret);
  }
...
{ int ret ;
  ...
  tmp = (int )mutex_lock_interruptible(__cil_tmp9);
  ret = tmp;
  if (ret) {
    return (ret);
  }
