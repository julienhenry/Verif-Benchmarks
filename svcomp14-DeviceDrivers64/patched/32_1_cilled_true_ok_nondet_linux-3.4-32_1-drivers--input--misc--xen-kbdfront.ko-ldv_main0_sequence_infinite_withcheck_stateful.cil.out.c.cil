...
extern int xenbus_scanf(u32 tid , char const   *dir , char const   *node , char const   *fmt 
                        , ...) ;
extern int xenbus_printf(u32 tid , char const   *dir , char const   *node , char const   *fmt 
                         , ...) ;
...
extern void xenbus_dev_fatal(struct xenbus_device *dev , int err , char const   *fmt 
                             , ...) ;
...
{ int ret ;
  ...
  *((__u16 *)__cil_tmp60) = (__u16 )65535;
  ...
  while_break___0: 
  tmp___2 = (int )input_register_device(kbd);
  ret = tmp___2;
  if (ret) {
  ...
  *((__u16 *)__cil_tmp93) = (__u16 )65534;
  ...
  __cil_tmp101 = 0UL;
  __cil_tmp102 = 40UL + __cil_tmp101;
  ...
  while (1) {
    ...
    __cil_tmp107 = 0UL;
    __cil_tmp108 = 48UL + __cil_tmp107;
  ...
  while_break___1: 
  tmp___3 = (int )input_register_device(ptr);
  ret = tmp___3;
  if (ret) {
...
static int xenkbd_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
...
{ int tmp ;
  ...
  tmp___0 = (int )xenbus_register_frontend(& xenkbd_driver);
  tmp = tmp___0;
  return (tmp);
}
}
