...
int pccard_read_tuple(struct pcmcia_socket *s , unsigned int function , cisdata_t code ,
                      void *parse ) ;
int pcmcia_replace_cis(struct pcmcia_socket *s , u8 const   *data , size_t len ) ;
...
{ struct pcmcia_device *p_dev ;
  ...
  if (tmp___0 != 0L) {
    if ((unsigned long )leftover != (unsigned long )((struct pcmcia_device *)0)) {
      tmp___2 = leftover->devname;
    } else {
      tmp___2 = (char *)"";
    }
    if ((unsigned long )leftover != (unsigned long )((struct pcmcia_device *)0)) {
      tmp___3 = & leftover->dev;
    } else {
      tmp___3 = & s->dev;
    }
    __dynamic_dev_dbg(& descriptor, (struct device  const  *)tmp___3, "pcmcia_card_remove(%d) %s\n",
                      s->sock, tmp___2);
  }
...
{ struct pcmcia_socket *s ;
 ...
 static int pcmcia_devmatch(struct pcmcia_device *dev , struct pcmcia_device_id  const  *did ) 
{ int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
{ struct pcmcia_device *p_dev ;
  ...
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___3 = (int )p_dev->func_id;
  } else {
    tmp___3 = 0;
  }
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___4 = (int )p_dev->card_id;
  } else {
    tmp___4 = 0;
  }
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___5 = (int )p_dev->manf_id;
  } else {
    tmp___5 = 0;
  }
  tmp___2 = add_uevent_var(env, "MODALIAS=pcmcia:m%04Xc%04Xf%02Xfn%02Xpfn%02Xpa%08Xpb%08Xpc%08Xpd%08X",
                           tmp___5, tmp___4, tmp___3, (int )p_dev->func, (int )p_dev->device_no,
...
{ struct pcmcia_device *p_dev ;
  ...
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___1 = (int )p_dev->func_id;
  } else {
    tmp___1 = 0;
  }
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___2 = (int )p_dev->card_id;
  } else {
    tmp___2 = 0;
  }
  if ((unsigned int )*((unsigned char *)p_dev + 137UL) != 0U) {
    tmp___3 = (int )p_dev->manf_id;
  } else {
    tmp___3 = 0;
  }
  tmp___0 = sprintf(buf, "pcmcia:m%04Xc%04Xf%02Xfn%02Xpfn%02Xpa%08Xpb%08Xpc%08Xpd%08X\n",
                    tmp___3, tmp___2, tmp___1, (int )p_dev->func, (int )p_dev->device_no,
                    hash[0], hash[1], hash[2], hash[3]);
  return ((ssize_t )tmp___0);
}
}
...
{ struct pcmcia_socket *var_group1 ;
  ...
  if (ldv_s_pcmcia_bus_type_bus_type == 0) {
    ...
    ldv_s_pcmcia_bus_type_bus_type ++;
  }
  goto ldv_26983;
  case 7: ;
...
{ unsigned int align ;
  ...
  if (base != 0U) {
    if (lines != 0U) {
      tmp___4 = (unsigned int )(1 << (int )lines);
    } else {
      tmp___4 = 0U;
    }
    align = tmp___4;
...
{ struct pcmcia_socket *s ;
  ...
  if ((s->features & 4U) != 0U) {
    align = (u_long )res->end;
  } else {
    align = (u_long )s->map_size;
  }
  ...
  res->flags &= 0xffffffffffffffe3UL;
  res->flags |= (unsigned long )(((int )win->map << 2) | 512);
  res->parent = win->res;
  if ((unsigned long )win->res != (unsigned long )((struct resource *)0)) {
...
{ void *sys ;
  ...
  if ((attr & 8) != 0) {
    ...
    *buf = readb((void const volatile   *)sys + 8U);
    ...
    sys += (unsigned long )((s->map_size - 1U) & addr);
    goto ldv_24667;
    ldv_24666: ;
...
{ u_int len ;
  ...
  ret = read_cis_cache(s, (int )((tuple_flags *)(& tuple->Flags))->space, tuple->CISOffset + (u_int )tuple->TupleOffset,
                       (size_t )tmp, (void *)tuple->TupleData);
  if (ret != 0) {
    return (-1);
  }
  return (0);
...
{ int i ;
  ...
  *(ofs + (unsigned long )i) = (u_char )j;
  ...
  j ++;
  if ((unsigned int )*p != 255U) {
    *(s + (unsigned long )tmp) = (char )*p;
  } else {
    *(s + (unsigned long )tmp) = 0;
  }
...
{ int rasz ;
  ...
  goto ldv_24927;
  ldv_24926: 
  config->base += (u_int )((int )*(p + (unsigned long )i) << i * 8);
  i ++;
  ldv_24927: ;
  if (i <= rasz) {
    goto ldv_24926;
  }
  p += (unsigned long )rasz + 1UL;
  i = 0;
  goto ldv_24930;
  ldv_24929: 
  config->rmask[i] = 0U;
  ...
  goto ldv_24933;
  ldv_24932: 
  config->rmask[i >> 2] += (u_int )((int )*(p + (unsigned long )i) << (i % 4) * 8);
  i ++;
  ldv_24933: ;
  if (i <= rmsz) {
    goto ldv_24932;
...
{ int i ;
  ...
  if (((int )pwr->present >> i) & 1) {
    ...
    if (((int )*p & 127) <= 99) {
      pwr->param[i] += (((u_int )*p & 127U) * scale) / 100U;
    } else
...
{ struct pcmcia_cfg_mem *cfg_mem ;
  ...
  if ((flags & 1024U) != 0U && ((int )cfg->flags & 2048) != 0) {
    p_dev->config_flags |= 2U;
  }
  if ((flags & 2048U) != 0U) {
    if ((unsigned int )cfg->io.nwin != 0U) {
      io = & cfg->io;
    } else {
      io = & dflt->io;
    }
    ...
    (p_dev->resource[0])->flags &= 0xffffffffffffffe7UL;
    tmp___2 = pcmcia_io_cfg_data_width((unsigned int )io->flags);
    (p_dev->resource[0])->flags |= (unsigned long )tmp___2;
  ...
  if ((flags & 4096U) != 0U) {
    if ((unsigned int )cfg->mem.nwin != 0U) {
      mem = & cfg->mem;
    } else {
      mem = & dflt->mem;
    }
