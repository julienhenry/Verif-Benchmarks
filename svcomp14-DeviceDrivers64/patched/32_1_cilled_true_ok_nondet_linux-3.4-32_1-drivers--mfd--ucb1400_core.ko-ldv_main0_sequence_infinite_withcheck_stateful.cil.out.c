...
{ int err ;
  ...
  __cil_tmp25 = (unsigned long )(& ucb_ts) + 8UL;
  *((int *)__cil_tmp25) = (int )tmp___8;
  __cil_tmp26 = (unsigned long )(& ucb_ts) + 8UL;
  __cil_tmp27 = *((int *)__cil_tmp26);
  if (__cil_tmp27 != 17156) {
    err = -19;
    goto err0;
  }
  __cil_tmp28 = (unsigned long )(& ucb_gpio) + 120UL;
  ...
  *((struct platform_device **)__cil_tmp30) = platform_device_alloc("ucb1400_gpio",
  ...
  __cil_tmp41 = (unsigned long )(& ucb_ts) + 16UL;
  *((struct snd_ac97 **)__cil_tmp41) = ac97;
  ...
  if (__cil_tmp44 != __cil_tmp43) {
    ...
    if (__cil_tmp45 >= 0) {
      __cil_tmp46 = (unsigned long )(& ucb_ts) + 12UL;
      *((int *)__cil_tmp46) = *((int *)pdata);
    } else {
      __cil_tmp47 = (unsigned long )(& ucb_ts) + 12UL;
      *((int *)__cil_tmp47) = -1;
    }
  } else {
    __cil_tmp48 = (unsigned long )(& ucb_ts) + 12UL;
    *((int *)__cil_tmp48) = -1;
  }
...
{ int tmp___7 ;
  ...
  {
  tmp = (int )driver_register(& ucb1400_core_driver);
  tmp___7 = tmp;
  return (tmp___7);
}
}
