...
static struct completion xpc_discovery_exited  =    {0U,
    {{{{{{0U}}, 3735899821U, 4294967295U, 0xffffffffffffffffUL, {0, {0, 0}, "(xpc_discovery_exited).wait.lock",
...
{ int l ;
  ...
  *remote_rp_pa = xpc_get_rsvd_page_pa(nasid);
  ...
  if ((unsigned long )discovered_nasids != (unsigned long )((unsigned long *)0)) {
    ...
    goto ldv_21008;
    ldv_21007: 
    *(discovered_nasids + (unsigned long )l) |= *(remote_part_nasids + (unsigned long )l);
    l ++;
    ldv_21008: ;
...
void ldv_mutex_unlock_cached_activate_gru_mq_desc_mutex(struct mutex *lock ) ;
 static int __first_node(nodemask_t const   *srcp ) 
{ int __min1 ;
  int __min2 ;
  unsigned long tmp ;
  int tmp___0 ;
 ...
 static int __next_node(int n , nodemask_t const   *srcp ) 
{ int __min1 ;
  int __min2 ;
  unsigned long tmp ;
  int tmp___0 ;
...
{ struct xpc_send_msg_slot_uv *msg_slot ;
  ...
  tmp = ldv__builtin_expect(msg_slot->msg_slot_number != msg->hdr.msg_slot_number,
                            0L);
  if (tmp != 0L) {
    __asm__  volatile   ("1:\tud2\n.pushsection __bug_table,\"a\"\n2:\t.long 1b - 2b, %c0 - 2b\n\t.word %c1, 0\n\t.org 2b+%c2\n.popsection": : "i" ((char *)"/home/mikhail/launches/cpachecker-regression2/launcher-working-dir/ldv-manager-work-dir/work/current--X--drivers/misc/sgi-xp/xpc.ko--X--regression-testlinux-3.8-rc1--X--32_7a--X--cpachecker/linux-3.8-rc1/csd_deg_dscv/17/dscv_tempdir/dscv/ri/32_7a/drivers/misc/sgi-xp/xpc_uv.c.prepared"),
                         "i" (1436), "i" (12UL));
  ...
  msg_slot->msg_slot_number += (unsigned int )ch->local_nentries;
