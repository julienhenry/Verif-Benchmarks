...
static struct v4l2_subdev_audio_ops  const  msp_audio_ops  =    {(int (*)(struct v4l2_subdev *sd ,
             u32 freq ))0, & msp_s_i2s_clock_freq, & msp_s_routing, (int (*)(struct v4l2_subdev *sd ,
                                                                             int enable ))0};
...
{ struct msp_state *state ;
  ...
  if (thread_func) {
    ...
    __k = tmp___25;
    tmp___30 = (long )IS_ERR((void const   *)__k);
    tmp = tmp___30;
    tmp___26 = tmp;
    if (! tmp___26) {
      wake_up_process(__k);
    ...
    state->kthread = __k;
    tmp___31 = (long )IS_ERR((void const   *)state->kthread);
    tmp___29 = tmp___31;
    tmp___28 = tmp___29;
    if (tmp___28) {
...
static struct msp3400c_carrier_detect msp3400c_carrier_detect_55[2]  = {      {(int )((float )(5.7421875 / 18.432) * (float )(1 << 24)),
      (char *)"5.742 PAL B/G FM-stereo"}, 
        {(int )((float )(5.85 / 18.432) * (float )(1 << 24)), (char *)"5.85  PAL B/G NICAM"}};
static struct msp3400c_carrier_detect msp3400c_carrier_detect_65[6]  = {      {(int )((float )(5.85 / 18.432) * (float )(1 << 24)),
      (char *)"5.85  PAL D/K + SECAM NICAM"}, 
        {(int )((float )(6.2578125 / 18.432) * (float )(1 << 24)), (char *)"6.25  PAL D/K1 FM-stereo"}, 
        {(int )((float )(6.7421875 / 18.432) * (float )(1 << 24)),
      (char *)"6.74  PAL D/K2 FM-stereo"}, 
        {(int )((float )(7.02 / 18.432) * (float )(1 << 24)), (char *)"7.02  PAL SAT FM-stereo s/b"}, 
        {(int )((float )(7.20 / 18.432) * (float )(1 << 24)),
      (char *)"7.20  PAL SAT FM-stereo s"}, 
        {(int )((float )(7.38 / 18.432) * (float )(1 << 24)), (char *)"7.38  PAL SAT FM-stereo b"}};
char const   *msp_standard_std_name(int std ) 
{ int i ;
