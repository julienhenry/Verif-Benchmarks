...
{ struct ab8500 *ab8500 ;
  ...
  *((struct device **)__cil_tmp29) = (struct device *)__cil_tmp31;
  ...
  tmp___1 = (int )request_any_context_irq(__cil_tmp35, & ab8500_ponkey_handler, 0UL,
  ...
  tmp___2 = (int )request_any_context_irq(__cil_tmp45, & ab8500_ponkey_handler, 0UL,
  ...
  tmp___3 = (int )input_register_device(__cil_tmp52);
  error = tmp___3;
  if (error) {
