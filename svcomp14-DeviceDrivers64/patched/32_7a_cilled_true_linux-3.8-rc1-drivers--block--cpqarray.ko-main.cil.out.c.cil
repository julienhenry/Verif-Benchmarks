...
static void start_io(ctlr_info_t *h ) ;
 static void addQ(cmdlist_t **Qptr , cmdlist_t *c ) ;
 static cmdlist_t *removeQ(cmdlist_t **Qptr , cmdlist_t *c ) ;
 static void complete_command(cmdlist_t *cmd , int timeout ) ;
...
static void ida_procinit(int i ) ;
 static drv_info_t *get_drv(struct gendisk *disk ) 
{ 
...
{ id_log_drv_t *id_ldrive ;
  ...
  if ((unsigned int )id_lstatus_buf->status != 2U) {
    ...
    if (ret_code != 1) {
      ...
      info_p->log_drv_map |= (__u32 )(1 << (int )log_unit);
      ...
      info_p->drv_assign_map |= sense_config_buf->drv_asgn_map;
      info_p->drv_assign_map |= sense_config_buf->spare_asgn_map;
      info_p->drv_spare_map |= sense_config_buf->spare_asgn_map;
    }
    log_index ++;
  }
  log_unit ++;
