...
{ struct ar7_bin_rec header ;
  ...
  *((uint32_t *)__cil_tmp43) = (uint32_t )0;
  ...
  if ((unsigned int )((int )__cil_tmp76) == 4277008962U) {
    goto case_4277008962;
  } else
  if ((unsigned int )((int )__cil_tmp76) == 4276949633U) {
    ...
    if (0) {
      case_4277008962: 
      while (1) {
        __cil_tmp77 = (unsigned long )(& header) + 4UL;
        if (! *((unsigned int *)__cil_tmp77)) {
          goto while_break___0;
        }
        __cil_tmp78 = (unsigned long )(& header) + 4UL;
      ...
      case_4276949633: 
      while (1) {
        __cil_tmp89 = (unsigned long )(& header) + 4UL;
        if (! *((unsigned int *)__cil_tmp89)) {
          goto while_break___1;
        }
        __cil_tmp90 = (unsigned long )(& header) + 4UL;
