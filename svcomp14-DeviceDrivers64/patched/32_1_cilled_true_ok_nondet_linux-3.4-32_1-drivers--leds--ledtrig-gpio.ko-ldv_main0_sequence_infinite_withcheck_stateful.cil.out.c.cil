...
{ struct led_classdev *led ;
  ...
  __cil_tmp13 = *((void **)__cil_tmp12);
  gpio_data = (struct gpio_trig_data *)__cil_tmp13;
  tmp___0 = (int )kstrtoul(buf, 10U, & inverted);
  ret = tmp___0;
  if (ret < 0) {
    return ((ssize_t )ret);
  }
...
{ struct led_classdev *led ;
  ...
  tmp___4 = (int )request_irq(__cil_tmp41, & gpio_trig_irq, 131UL, "ledtrig-gpio",
                              __cil_tmp42);
  ret = tmp___4;
  if (ret) {
...
static int gpio_trig_init(void)  __attribute__((__section__(".init.text"),
