...
{ struct file *var_group1 ;
  ...
  if (ldv_s_synth_fops_file_operations == 0) {
    ...
    ldv_s_synth_fops_file_operations ++;
  }
  goto ldv_23987;
  case 1: ;
...
static struct msg_group_t all_groups[7U]  = {      {(char *)"ctl_keys",
      52, 60}, 
        {(char *)"colors", 61, 69}, 
...
int set_mask_bits(char const   *input , int which , int how ) ;
...
{ 
  ...
  ((speakup_console[(int )vc->vc_num])->reading_x) --;
  (speakup_console[(int )vc->vc_num])->reading_pos -= 2UL;
  say_char(vc);
  return;
}
}
...
{ u_char temp ;
  ...
  if ((speakup_console[(int )vc->vc_num])->reading_x == 0UL) {
    ...
    ((speakup_console[(int )vc->vc_num])->reading_y) --;
...
{ 
  ...
  ((speakup_console[(int )vc->vc_num])->reading_y) --;
  (speakup_console[(int )vc->vc_num])->reading_pos -= (u_long )vc->vc_size_row;
  say_line(vc);
  return;
}
}
...
{ 
  ...
  {
  (speakup_console[(int )vc->vc_num])->parked = (char )((int )((signed char )(speakup_console[(int )vc->vc_num])->parked) | 1);
  (speakup_console[(int )vc->vc_num])->reading_pos += (((u_long )vc->vc_rows - (speakup_console[(int )vc->vc_num])->reading_y) - 1UL) * (u_long )vc->vc_size_row;
...
{ 
  ...
  {
  (speakup_console[(int )vc->vc_num])->parked = (char )((int )((signed char )(speakup_console[(int )vc->vc_num])->parked) | 1);
  (speakup_console[(int )vc->vc_num])->reading_pos -= (speakup_console[(int )vc->vc_num])->reading_x * 2UL;
  (speakup_console[(int )vc->vc_num])->reading_x = 0UL;
  say_char(vc);
  return;
}
...
{ int i ;
  ...
  ldv_29633: 
  ch = (u_char )buf[i];
  (speakup_console[(int )vc->vc_num])->reading_pos -= ((speakup_console[(int )vc->vc_num])->reading_x - (u_long )i) * 2UL;
...
{ int len ;
  ...
  len --;
  ch = (u_char )buf[len];
  (speakup_console[(int )vc->vc_num])->reading_pos -= ((speakup_console[(int )vc->vc_num])->reading_x - (u_long )len) * 2UL;
...
{ int i ;
  ...
  start += (unsigned long )vc->vc_size_row;
  i ++;
  ldv_29869: ;
...
{ u_char goto_buf[8U] ;
  ...
  if ((int )((signed char )*cp) == 120) {
    if ((unsigned int )*((u_char *)(& goto_buf)) <= 47U) {
      (speakup_console[(int )vc->vc_num])->go_pos += (speakup_console[(int )vc->vc_num])->reading_x;
    } else {
      ((speakup_console[(int )vc->vc_num])->go_pos) --;
    }
    ...
    if ((unsigned int )*((u_char *)(& goto_buf)) <= 47U) {
      (speakup_console[(int )vc->vc_num])->go_pos += (speakup_console[(int )vc->vc_num])->reading_y;
    } else {
      ((speakup_console[(int )vc->vc_num])->go_pos) --;
    }
  ...
  if ((speakup_console[(int )vc->vc_num])->go_x != 0UL) {
    ...
    (speakup_console[(int )vc->vc_num])->reading_pos += (speakup_console[(int )vc->vc_num])->go_pos * 2UL;
    say_word(vc);
  } else {
...
{ size_t bufsize ;
  ...
  *buf_pointer = 0;
  ...
  buf_pointer += (unsigned long )printed;
  bufsize -= (size_t )printed;
...
static int atedge(int p , int size_row ) 
{ 

  {
  return (p % size_row == 0 || (p + 2) % size_row == 0);
}
}
static unsigned short limit(unsigned short v , unsigned short u ) 
{ int tmp ;
