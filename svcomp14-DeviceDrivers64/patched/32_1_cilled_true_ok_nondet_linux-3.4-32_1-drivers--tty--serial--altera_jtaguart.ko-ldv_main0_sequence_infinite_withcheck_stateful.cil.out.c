...
{ struct altera_jtaguart *pp ;
  ...
  tmp = (int )request_irq(__cil_tmp16, & altera_jtaguart_interrupt, 0UL, "altera_jtaguart",
                          __cil_tmp17);
  ret = tmp;
  if (ret) {
    __cil_tmp18 = (unsigned long )port;
    __cil_tmp19 = __cil_tmp18 + 220UL;
...
{ struct altera_jtaguart_platform_uart *platp ;
  ...
  __cil_tmp14 = (unsigned long )i * 272UL;
...
{ struct uart_port *port ;
  ...
  __cil_tmp6 = (unsigned long )i * 272UL;
