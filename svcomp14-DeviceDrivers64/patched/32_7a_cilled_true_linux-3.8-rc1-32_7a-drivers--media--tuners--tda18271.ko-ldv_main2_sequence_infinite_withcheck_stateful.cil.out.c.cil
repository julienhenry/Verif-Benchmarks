...
{ struct tda18271_priv *priv ;
  ...
  if (ret != 2) {
    _tda_printk(priv, "\v", "tda18271_read_regs", "ERROR: __VERIFIER_error(); i2c_transfer returned: %d\n",
                ret);
  }
  if ((tda18271_debug & 4) != 0) {
...
{ struct tda18271_priv *priv ;
  ...
  tda18271_i2c_gate_ctrl(fe, 0);
  if (ret != 2) {
    _tda_printk(priv, "\v", "tda18271_read_extended", "ERROR: __VERIFIER_error(); i2c_transfer returned: %d\n",
                ret);
  }
  i = 0;
  goto ldv_23966;
...
{ struct tda18271_priv *priv ;
  ...
  if (ret != 1) {
    _tda_printk(priv, "\v", "__tda18271_write_regs", "ERROR: __VERIFIER_error(); idx = 0x%x, len = %d, i2c_transfer returned: %d\n",
                idx, max, ret);
  }
  if (ret != 1) {
    tmp___1 = ret;
...
{ struct tda18271_priv *priv ;
  ...
  *(regs + 5UL) = (unsigned char )((int )((signed char )*(regs + 5UL)) | ((tmp___0 | tmp___1) | tmp___2));
...
{ struct tda18271_priv *priv ;
  ...
  if (tda18271_debug & 1) {
    if ((int )priv->output_opt & 1) {
      tmp___0 = (char *)"off";
    } else {
      tmp___0 = (char *)"on";
    }
    if (((unsigned int )priv->output_opt & 2U) != 0U) {
      tmp___1 = (char *)"off";
    } else {
      tmp___1 = (char *)"on";
    }
    if (standby != 0) {
      tmp___2 = (char *)"standby";
    } else {
      tmp___2 = (char *)"active";
    }
 ...
 static int charge_pump_source(struct dvb_frontend *fe , int force ) 
{ struct tda18271_priv *priv ;
  int tmp ;
 ...
 static void tda18271_set_if_notch(struct dvb_frontend *fe ) 
{ struct tda18271_priv *priv ;
  unsigned char *regs ;
...
{ struct tda18271_priv *priv ;
  ...
  freq = ((params->frequency * tmp) * 125U) / 2U;
  priv->mode = 0;
  if (params->mode == 1U) {
...
{ struct tda18271_priv *priv ;
 ...
 static int tda18271_need_cal_on_startup(struct tda18271_config *cfg ) 
{ int tmp ;

  {
  if (tda18271_cal_on_startup == -1) {
    tmp = (unsigned long )cfg != (unsigned long )((struct tda18271_config *)0) && (unsigned int )*((unsigned char *)cfg + 24UL) != 0U;
  } else {
    tmp = tda18271_cal_on_startup != 0;
  }
  return (tmp);
}
}
