  ...
  if (tmp == 1) {
    ...
    if (0) {
      ...
      if (ldv_s_regulator_userspace_consumer_driver_platform_driver == 0) {
        ...
        ldv_s_regulator_userspace_consumer_driver_platform_driver ++;
      }
      goto ldv_15450;
      case_1: ;
