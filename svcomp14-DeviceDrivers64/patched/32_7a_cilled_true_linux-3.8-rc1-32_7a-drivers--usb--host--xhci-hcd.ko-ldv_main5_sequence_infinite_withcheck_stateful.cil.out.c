...
{ 
 ...
 static int usb_endpoint_interrupt_type(struct usb_endpoint_descriptor  const  *epd ) 
{ 
 ...
 static int usb_ss_max_streams(struct usb_ss_ep_comp_descriptor  const  *comp ) 
{ int max_streams ;
...
{ 
 ...
 static unsigned int xhci_readl(struct xhci_hcd  const  *xhci , __le32 *regs ) 
{ unsigned int tmp ;
 ...
 static void xhci_writel(struct xhci_hcd *xhci , unsigned int val , __le32 *regs ) 
{ 
 ...
 static u64 xhci_read_64(struct xhci_hcd  const  *xhci , __le64 *regs ) 
{ __u32 *ptr ;
  u64 val_lo ;
  unsigned int tmp ;
  u64 val_hi ;
 ...
 static void xhci_write_64(struct xhci_hcd *xhci , u64 val , __le64 *regs ) 
{ __u32 *ptr ;
  u32 val_lo ;
  u32 val_hi ;
...
{ struct xhci_ring *ring ;
  ...
  (seg->trbs + 63UL)->link.control &= 4294967294U;
  seg = seg->next;
...
{ unsigned int index ;
  ...
  if (tmp___2 != 0) {
    ...
    index = ((unsigned int )(tmp___0 * 2) + tmp___3) - 1U;
  }
  return (index);
}
}
...
{ struct xhci_container_ctx *in_ctx ;
  ...
  if (hw_max_packet_size != max_packet_size) {
    ...
    ep_ctx->ep_info2 &= 65535U;
    ep_ctx->ep_info2 |= (__le32 )(max_packet_size << 16);
...
{ struct xhci_hcd *xhci ;
  ...
  if ((slot_ctx->dev_info & 4160749568U) > last_ctx << 27) {
    slot_ctx->dev_info &= 134217727U;
    slot_ctx->dev_info |= last_ctx << 27;
  }
...
{ int ret ;
  ...
  goto ldv_31511;
  case 5U: 
  dev_warn((struct device  const  *)(& udev->dev), "ERROR: __VERIFIER_error(); Endpoint drop flag = 0, add flag = 1, and endpoint is not disabled.\n");
  ret = -22;
  goto ldv_31511;
  case 22U: 
  dev_warn((struct device  const  *)(& udev->dev), "ERROR: __VERIFIER_error(); Incompatible device for endpoint configure command.\n");
  ret = -19;
  goto ldv_31511;
  case 1U: 
  descriptor.modname = "xhci_hcd";
  ...
  default: 
  tmp___0 = xhci_to_hcd(xhci);
  dev_err((struct device  const  *)tmp___0->self.controller, "ERROR: __VERIFIER_error(); unexpected command completion code 0x%x.\n",
          *cmd_status);
  ret = -22;
  goto ldv_31511;
  }
...
{ int ret ;
  ...
  goto ldv_31528;
  case 22U: 
  dev_warn((struct device  const  *)(& udev->dev), "ERROR: __VERIFIER_error(); Incompatible device for evaluate context command.\n");
  ret = -19;
  goto ldv_31528;
  case 29U: 
...
{ struct xhci_interval_bw *interval_bw ;
  ...
  if ((unsigned int )udev->speed == 5U) {
    ...
    if ((int )tmp___2) {
      ...
      ((xhci->devs[udev->slot_id])->bw_table)->ss_bw_in -= tmp___0;
    } else {
      tmp___1 = xhci_get_ss_bw_consumed(ep_bw);
      ((xhci->devs[udev->slot_id])->bw_table)->ss_bw_out -= tmp___1;
    }
    return;
  }
...
{ struct xhci_root_port_bw_info *rh_bw_info ;
  ...
  if (old_active_eps == 0 && (virt_dev->tt_info)->active_eps != 0) {
    (rh_bw_info->num_active_tts) ++;
    rh_bw_info->bw_table.bw_used += 125U;
  } else
  if (old_active_eps != 0 && (virt_dev->tt_info)->active_eps == 0) {
    (rh_bw_info->num_active_tts) --;
    rh_bw_info->bw_table.bw_used -= 125U;
...
{ int ret ;
  ...
  if (timeleft <= 0) {
    tmp___7 = xhci_to_hcd(xhci);
    if (! ctx_change) {
      tmp___9 = (char *)"configure endpoint";
    } else {
      tmp___9 = (char *)"evaluate context";
    }
    if (timeleft == 0) {
      tmp___10 = (char *)"Timeout";
    } else {
      tmp___10 = (char *)"Signal";
    }
...
{ int i ;
  ...
  ctrl_ctx = xhci_get_input_control_ctx(xhci, virt_dev->in_ctx);
  ctrl_ctx->add_flags |= 1U;
  ctrl_ctx->add_flags &= 4294967293U;
  ctrl_ctx->drop_flags &= 4294967292U;
...
{ int i ;
  ...
  ldv_31906: 
  ep_index = xhci_get_endpoint_index(& (*(eps + (unsigned long )i))->desc);
  vdev->eps[ep_index].ep_state &= 4294967287U;
  descriptor___2.modname = "xhci_hcd";
  ...
  vdev->eps[ep_index].ep_state |= 16U;
  i ++;
  ldv_31907: ;
  if ((unsigned int )i < num_eps) {
    goto ldv_31906;
  ...
  vdev->eps[ep_index].ep_state &= 4294967287U;
  vdev->eps[ep_index].ep_state &= 4294967279U;
...
{ int i ;
  ...
  (xhci->devs[udev->slot_id])->eps[ep_index].ep_state |= 32U;
  ...
  xhci_free_stream_info(xhci, vdev->eps[ep_index].stream_info);
  vdev->eps[ep_index].stream_info = 0;
  vdev->eps[ep_index].ep_state &= 4294967263U;
  vdev->eps[ep_index].ep_state &= 4294967279U;
  i ++;
  ldv_31938: ;
  if ((unsigned int )i < num_eps) {
...
{ int ret ;
  ...
  if (timeleft <= 0) {
    tmp___11 = xhci_to_hcd(xhci);
    if (timeleft == 0) {
      tmp___24 = (char *)"Timeout";
    } else {
      tmp___24 = (char *)"Signal";
    }
...
{ struct xhci_hcd *xhci ;
  ...
  goto ldv_32007;
  ldv_32006: 
  virt_dev->eps[i].ep_state &= 4294967291U;
...
{ struct xhci_hcd *xhci ;
  ...
  if (timeleft <= 0) {
    tmp___4 = xhci_to_hcd(xhci);
    if (timeleft == 0) {
      tmp___13 = (char *)"Timeout";
    } else {
      tmp___13 = (char *)"Signal";
    }
...
{ unsigned long flags ;
  ...
  if (timeleft <= 0) {
    tmp___11 = xhci_to_hcd(xhci);
    if (timeleft == 0) {
      tmp___30 = (char *)"Timeout";
    } else {
      tmp___30 = (char *)"Signal";
    }
  ...
  case 11U: 
  tmp___12 = xhci_to_hcd(xhci);
  dev_err((struct device  const  *)tmp___12->self.controller, "Setup ERROR: __VERIFIER_error(); address device command for slot %d.\n",
          udev->slot_id);
  ret = -22;
  goto ldv_32064;
  case 4U: 
  ...
  goto ldv_32064;
  case 22U: 
  dev_warn((struct device  const  *)(& udev->dev), "ERROR: __VERIFIER_error(); Incompatible device for address device command.\n");
  ret = -19;
  goto ldv_32064;
  case 1U: 
  descriptor___2.modname = "xhci_hcd";
  ...
  default: 
  tmp___15 = xhci_to_hcd(xhci);
  dev_err((struct device  const  *)tmp___15->self.controller, "ERROR: __VERIFIER_error(); unexpected command completion code 0x%x.\n",
          virt_dev->cmd_status);
  descriptor___3.modname = "xhci_hcd";
...
{ unsigned long long timeout_ns ;
  ...
  _tmp___0 /= (unsigned long long )__base___0;
  timeout_ns = _tmp___0;
  if (timeout_ns == 0ULL) {
    timeout_ns ++;
  }
...
{ struct xhci_virt_device *virt_dev ;
  ...
  slot_ctx->dev_info2 &= 4294901760U;
  slot_ctx->dev_info2 |= (__le32 )max_exit_latency;
  descriptor.modname = "xhci_hcd";
...
{ struct xhci_hcd *xhci ;
  ...
  slot_ctx->dev_info |= 67108864U;
  if (tt->multi != 0) {
    slot_ctx->dev_info |= 33554432U;
  }
  ...
  if (tmp___12 != 0L) {
    tmp___11 = xhci_to_hcd(xhci);
    if ((unsigned int )xhci->hci_version > 149U) {
      tmp___17 = (char *)"configure endpoint";
    } else {
      tmp___17 = (char *)"evaluate context";
    }
    __dynamic_dev_dbg(& descriptor___3, (struct device  const  *)tmp___11->self.controller,
...
{ struct xhci_segment *seg ;
  ...
  if (cycle_state == 0U) {
    ...
    goto ldv_30104;
    ldv_30103: 
    (seg->trbs + (unsigned long )i)->link.control |= 1U;
    i ++;
    ldv_30104: ;
    if (i <= 63) {
      goto ldv_30103;
...
{ struct xhci_segment *next ;
  ...
  ring->num_trbs_free += num_segs * 63U;
  if ((unsigned int )ring->type != 6U && (unsigned long )ring->enq_seg == (unsigned long )ring->last_seg) {
    ((ring->last_seg)->trbs + 63UL)->link.control &= 4294967293U;
    (last->trbs + 63UL)->link.control |= 2U;
    ring->last_seg = last;
  }
  return;
}
...
{ struct xhci_ring *ring ;
  ...
  if ((unsigned int )type != 6U) {
    ((ring->last_seg)->trbs + 63UL)->link.control |= 2U;
  }
...
{ int rings_cached ;
  ...
  if (rings_cached <= 30) {
    *(virt_dev->ring_cache + (unsigned long )rings_cached) = virt_dev->eps[ep_index].ring;
    ...
    if (tmp___0 != 0L) {
      tmp = xhci_to_hcd(xhci);
      if (virt_dev->num_rings_cached > 1) {
        tmp___3 = (char *)"s";
      } else {
        tmp___3 = (char *)"";
      }
...
{ struct xhci_segment *first ;
  ...
  if (num_segs_needed > ring->num_segs) {
    num_segs = num_segs_needed;
  } else {
    num_segs = ring->num_segs;
  }
...
{ unsigned long tmp ;
  ...
  return ((struct xhci_slot_ctx *)(ctx->bytes + tmp));
}
}
struct xhci_ep_ctx *xhci_get_ep_ctx(struct xhci_hcd *xhci , struct xhci_container_ctx *ctx ,
                                    unsigned int ep_index ) 
{ unsigned int tmp ;
  ...
  return ((struct xhci_ep_ctx *)ctx->bytes + (unsigned long )(tmp * ep_index));
}
}
...
{ struct xhci_virt_device *dev ;
  ...
  switch ((unsigned int )udev->speed) {
  case 5U: 
  slot_ctx->dev_info |= 4194304U;
  goto ldv_30433;
  case 3U: 
  slot_ctx->dev_info |= 3145728U;
  goto ldv_30433;
  case 2U: 
  slot_ctx->dev_info |= 1048576U;
  goto ldv_30433;
  case 1U: 
  slot_ctx->dev_info |= 2097152U;
  goto ldv_30433;
  case 4U: 
  descriptor.modname = "xhci_hcd";
  ...
  slot_ctx->dev_info2 |= (port_num & 255U) << 16;
  top_dev = udev;
  goto ldv_30443;
  ldv_30442: 
  top_dev = top_dev->parent;
  ...
  switch ((unsigned int )udev->speed) {
  case 5U: 
  ep0_ctx->ep_info2 |= 33554432U;
  goto ldv_30460;
  case 3U: ;
  case 2U: 
  ep0_ctx->ep_info2 |= 4194304U;
  goto ldv_30460;
  case 1U: 
  ep0_ctx->ep_info2 |= 524288U;
  goto ldv_30460;
  case 4U: 
  descriptor___4.modname = "xhci_hcd";
...
{ unsigned int interval ;
  ...
  __val = (__u8 )tmp;
  if ((int )__max < (int )__val) {
    tmp___0 = __max;
  } else {
    tmp___0 = __val;
  }
  interval = (unsigned int )(tmp___0 + -1);
  if ((unsigned int )((int )ep->desc.bInterval + -1) != interval) {
    ...
    dev_warn((struct device  const  *)(& udev->dev), "ep %#x - rounding interval to %d %sframes\n",
             (int )ep->desc.bEndpointAddress, 1 << (int )interval, tmp___1);
  }
  if ((unsigned int )udev->speed == 2U) {
    interval += 3U;
  }
...
{ unsigned int ep_index ;
  ...
  if (tmp___6 != 0) {
    ...
    ep_ctx->ep_info2 |= (max_burst << 8) & 65535U;
  } else {
  ...
  if (tmp___9 != 0 && (unsigned int )xhci->hci_version == 256U) {
    ...
    ep_ctx->tx_info |= max_esit_payload & 65535U;
  }
  return (0);
}
}
...
{ u32 chain ;
  ...
  if ((unsigned int )ring->type != 6U) {
    ...
    if ((unsigned int )ring->type != 1U || (xhci->quirks & 512U) == 0U) {
      ...
      if (tmp___0 == 0) {
        next->link.control &= 4294967279U;
        next->link.control |= chain;
      }
    }
    __asm__  volatile   ("sfence": : : "memory");
    next->link.control ^= 1U;
...
{ struct xhci_segment *cur_seg ;
  ...
  if ((cur_trb->generic.field[3] & 64512U) == 6144U) {
    cur_trb->generic.field[3] &= 4294967279U;
    if ((int )flip_cycle) {
      cur_trb->generic.field[3] ^= 1U;
    }
    descriptor.modname = "xhci_hcd";
...
{ unsigned int slot_id ;
  ...
  if ((unsigned long )ep_ring == (unsigned long )((struct xhci_ring *)0)) {
    ...
    dev_warn((struct device  const  *)tmp->self.controller, "WARN Set TR deq ptr command for freed stream ID %u\n",
             stream_id);
    dev->eps[ep_index].ep_state &= 4294967294U;
    return;
  }
  ep_ctx = xhci_get_ep_ctx(xhci, dev->out_ctx, ep_index);
...
{ int slot_id ;
  ...
  if ((xhci->quirks & 2U) != 0U) {
    ...
    (xhci->devs[slot_id])->eps[ep_index].ep_state &= 4294967293U;
...
{ int slot_id ;
  ...
  if (cmd_dequeue_dma == 0ULL) {
    xhci->error_bitmask |= 16;
    return;
  }
  if (cmd_dma != cmd_dequeue_dma) {
    xhci->error_bitmask |= 32;
    return;
  }
...
{ struct usb_hcd *hcd ;
  ...
  if ((temp & 4194304U) != 0U && (temp & 480U) == 480U) {
    ...
    if ((temp & 15360U) == 4096U) {
      ...
      bus_state->port_remote_wakeup |= (u32 )(1 << (int )faked_port_index);
...
{ struct xhci_virt_device *xdev ;
  ...
  if (trb_comp_code == 27U || trb_comp_code == 26U) {
    ...
    if (urb_priv->td_cnt == urb_priv->length) {
      ...
      if (urb->pipe >> 30 == 0U) {
        tmp___2 = xhci_to_hcd(xhci);
        (tmp___2->self.bandwidth_isoc_reqs) --;
        tmp___3 = xhci_to_hcd(xhci);
...
{ struct xhci_ring *ep_ring ;
  ...
  if ((unsigned long )td->last_trb == (unsigned long )event_trb) {
    ...
    ldv_28527: ;
    if ((cur_trb->generic.field[3] & 64512U) != 8192U && (cur_trb->generic.field[3] & 64512U) != 6144U) {
      (td->urb)->actual_length += cur_trb->generic.field[2] & 131071U;
    }
    next_trb(xhci, ep_ring, & cur_seg, & cur_trb);
    ldv_28528: ;
    if ((unsigned long )cur_trb != (unsigned long )event_trb) {
    ...
    if (trb_comp_code != 27U) {
      (td->urb)->actual_length += (cur_trb->generic.field[2] & 131071U) - (event->transfer_len & 131071U);
    }
  }
...
{ 
  ...
  __asm__  volatile   ("sfence": : : "memory");
  if (start_cycle != 0) {
    start_trb->field[3] |= (__le32 )start_cycle;
  } else {
    start_trb->field[3] &= 4294967294U;
  }
    ...
    if (tmp___1 != 0) {
      ...
      if (tmp___0 != 0L) {
        ...
        __dynamic_dev_dbg(& descriptor, (struct device  const  *)(& (urb->dev)->dev),
                          ...
                          ep_interval, tmp___4, xhci_interval, tmp___3);
      }
    }
...
{ struct xhci_ring *ep_ring ;
  ...
  if (__min1___0 < __min2___0) {
    trb_buff_len = __min1___0;
  } else {
    trb_buff_len = __min2___0;
  }
...
{ struct xhci_ring *ep_ring ;
  ...
  tmp___6 = xhci_to_hcd(xhci);
  (tmp___6->self.bandwidth_isoc_reqs) ++;
  giveback_first_trb(xhci, slot_id, ep_index, urb->stream_id, start_cycle, start_trb);
  return (0);
  cleanup: 
  i --;
  ...
  if (xhci_interval != ep_interval) {
    ...
    if (tmp___2 != 0) {
      ...
      if (tmp___1 != 0L) {
        ...
        __dynamic_dev_dbg(& descriptor, (struct device  const  *)(& (urb->dev)->dev),
                          "Driver uses different interval (%d microframe%s) than xHCI (%d microframe%s)\n",
                          ep_interval, tmp___5, xhci_interval, tmp___4);
      }
    }
    urb->interval = xhci_interval;
    if ((unsigned int )(urb->dev)->speed == 1U || (unsigned int )(urb->dev)->speed == 2U) {
...
{ u32 all_ports_seen_u0 ;
  ...
  if (xhci->port_status_u0 != all_ports_seen_u0 && (int )port_in_u0) {
    xhci->port_status_u0 |= (u32 )(1 << (int )wIndex);
  ...
  *(buf + 12UL) = (char )temp;
  ...
  if ((temp & 480U) == 480U && (temp & 15360U) != 4096U) {
    ...
    if ((long )jiffies - (long )bus_state->resume_done[(int )wIndex] >= 0L) {
      ...
      xhci_ring_device(xhci, slot_id);
      bus_state->port_c_suspend |= (u32 )(1 << (int )wIndex);
      bus_state->suspended_ports &= (u32 )(~ (1 << (int )wIndex));
    } else {
      status |= 4U;
    }
  }
...
{ struct xhci_hcd *xhci ;
  ...
  if ((temp___0 & 15360U) == 4096U) {
    temp___0 &= 4043440125U;
  } else {
    temp___0 &= 4051828733U;
  }
...
{ u32 temp ;
  ...
  if (tmp___2 != 0L) {
    tmp___1 = xhci_to_hcd(xhci);
    if ((int )temp & 1) {
      tmp___11 = (char *)"running";
    } else {
      tmp___11 = (char *)"being stopped";
    }
    __dynamic_dev_dbg(& descriptor___0, (struct device  const  *)tmp___1->self.controller,
                      "  HC is %s\n", tmp___11);
  }
...
extern struct module __this_module ;
 static struct usb_bus *hcd_to_bus(struct usb_hcd *hcd ) 
{ 
...
{ struct usb_hcd *var_group1 ;
  ...
  if (ldv_s_xhci_pci_driver_pci_driver == 0) {
    ...
    ldv_s_xhci_pci_driver_pci_driver ++;
  }
  goto ldv_31021;
  case 4: ;
...
{ struct usb_hcd *var_group1 ;
  ...
  if (ldv_s_usb_xhci_driver_platform_driver == 0) {
    ...
    ldv_s_usb_xhci_driver_platform_driver ++;
  }
  goto ldv_26324;
  case 2: ;
