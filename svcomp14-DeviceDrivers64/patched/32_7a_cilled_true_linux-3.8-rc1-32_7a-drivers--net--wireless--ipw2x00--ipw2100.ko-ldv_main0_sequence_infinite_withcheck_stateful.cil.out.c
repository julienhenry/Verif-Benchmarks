...
static struct iw_handler_def ipw2100_wx_handler_def ;
 static void read_register(struct net_device *dev , u32 reg , u32 *val ) 
{ struct ipw2100_priv *priv ;
  ...
  *val = ioread32(priv->ioaddr + (unsigned long )reg);
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "read_register");
    printk("r: 0x%08X => 0x%08X\n", reg, *val);
  }
  return;
}
}
 static void write_register(struct net_device *dev , u32 reg , u32 val ) 
{ struct ipw2100_priv *priv ;
  void *tmp ;
  struct thread_info *tmp___0 ;
  int tmp___1 ;
  ...
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "write_register");
    printk("w: 0x%08X <= 0x%08X\n", reg, val);
  }
  return;
}
}
 static void read_register_word(struct net_device *dev , u32 reg , u16 *val ) 
{ struct ipw2100_priv *priv ;
  void *tmp ;
  ...
  *val = (u16 )tmp___0;
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "read_register_word");
    printk("r: 0x%08X => %04X\n", reg, (int )*val);
  }
  return;
}
}
 static void read_register_byte(struct net_device *dev , u32 reg , u8 *val ) 
{ struct ipw2100_priv *priv ;
  void *tmp ;
  unsigned int tmp___0 ;
  struct thread_info *tmp___1 ;
  ...
  *val = (u8 )tmp___0;
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "read_register_byte");
    printk("r: 0x%08X => %02X\n", reg, (int )*val);
  }
  return;
}
}
 static void write_register_word(struct net_device *dev , u32 reg , u16 val ) 
{ struct ipw2100_priv *priv ;
  void *tmp ;
  struct thread_info *tmp___0 ;
  int tmp___1 ;
  ...
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "write_register_word");
    printk("w: 0x%08X <= %04X\n", reg, (int )val);
  }
  return;
}
}
 static void write_register_byte(struct net_device *dev , u32 reg , u8 val ) 
{ struct ipw2100_priv *priv ;
  void *tmp ;
  struct thread_info *tmp___0 ;
  int tmp___1 ;
  ...
  if ((ipw2100_debug_level & 67108864U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "write_register_byte");
    printk("w: 0x%08X =< %02X\n", reg, (int )val);
  }
  return;
}
}
 static void read_nic_dword(struct net_device *dev , u32 addr , u32 *val ) 
{ 
 ...
 static void write_nic_dword(struct net_device *dev , u32 addr , u32 val ) 
{ 
 ...
 static void read_nic_word(struct net_device *dev , u32 addr , u16 *val ) 
{ 
 ...
 static void write_nic_word(struct net_device *dev , u32 addr , u16 val ) 
{ 
 ...
 static void read_nic_byte(struct net_device *dev , u32 addr , u8 *val ) 
{ 
 ...
 static void write_nic_byte(struct net_device *dev , u32 addr , u8 val ) 
{ 
...
{ struct ipw2100_ordinals *ordinals ;
    ...
    if (*len != 4U) {
      *len = 4U;
      if ((ipw2100_debug_level & 4U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_ordinal");
        printk("wrong size\n");
      }
      return (-22);
    }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_ordinal");
    printk("wrong table\n");
  }
  if (ord > 999U && ordinals->table2_size + 1000U > ord) {
    return (-22);
...
{ char line[81U] ;
  ...
  tmp = snprint_line((char *)(& line), 81UL, data + (unsigned long )ofs, tmp___0,
                     ofs);
  printk("\017%s\n", tmp);
  ofs += 16U;
  _min1___0 = len;
...
{ unsigned long now ;
  ...
  if ((priv->status & 536870912UL) == 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "schedule_reset");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "schedule_reset");
...
{ struct list_head *element ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___11, "ipw2100_hw_send_command");
  ...
  if (priv->fatal_error != 0U) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___12, "ipw2100_hw_send_command");
  ...
  if ((priv->status & 4UL) == 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___13, "ipw2100_hw_send_command");
  ...
  if ((priv->status & 2UL) != 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___14, "ipw2100_hw_send_command");
  ...
  if (tmp___5 != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___15, "ipw2100_hw_send_command");
  ...
  if (err == 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___16, "ipw2100_hw_send_command");
      printk("Command completion failed out after %dms.\n", 2000);
    }
    priv->fatal_error = 285212672U;
    priv->status &= 0xfffffffffffffffdUL;
    schedule_reset(priv);
    return (-5);
  }
  if (priv->fatal_error != 0U) {
...
{ int i ;
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wait_for_card_state");
  ...
  if ((u32 )state == card_state || ((priv->status & 8UL) == 0UL) == state) {
    if (state == 0) {
      ...
      priv->status &= 0xfffffffffffffff7UL;
    }
    return (0);
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wait_for_card_state");
    if (state != 0) {
...
{ u32 address ;
 ...
 static void ipw2100_enable_interrupts(struct ipw2100_priv *priv ) 
{ 
 ...
 static void ipw2100_disable_interrupts(struct ipw2100_priv *priv ) 
{ 
  ...
  priv->status &= 0xfffffffffffff7ffUL;
...
{ struct ipw2100_ordinals *ord ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_initialize_ordinals");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_initialize_ordinals");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_initialize_ordinals");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_initialize_ordinals");
    printk("exit\n");
  }
  return;
}
}
 static void ipw2100_hw_set_gpio(struct ipw2100_priv *priv ) 
{ u32 reg ;
...
{ unsigned short value ;
  ...
  if ((priv->hw_features & 1UL) == 0UL) {
    ...
    priv->status &= 0xffffffffffffefffUL;
    return (0);
  }
  i = 0;
  goto ldv_52332;
...
{ u32 addr ;
  ...
  if (tmp___0 != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_get_hw_features");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_get_hw_features");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_get_hw_features");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_get_hw_features");
    if ((int )priv->hw_features & 1) {
      tmp___8 = (char *)"";
    } else {
      tmp___8 = (char *)"not ";
    }
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_start_adapter");
    printk("enter\n");
  }
  if ((priv->status & 4UL) != 0UL) {
    return (0);
  ...
  if ((ipw2100_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_start_adapter");
  ...
  if ((ipw2100_debug_level & 65536U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_start_adapter");
    if (i != 0) {
      tmp___8 = (char *)"SUCCESS";
    } else {
      tmp___8 = (char *)"FAILED";
    }
  ...
  priv->status |= 4UL;
  priv->status &= 0xfffffffffffff9ffUL;
  if ((ipw2100_debug_level & 4U) != 0U) {
    tmp___4 = current_thread_info();
    if (((unsigned long )tmp___4->preempt_count & 134217472UL) != 0UL) {
      tmp___9 = 73;
    ...
    printk("\017ipw2100: %c %s ", tmp___9, "ipw2100_start_adapter");
    printk("exit\n");
  }
  return (0);
}
}
 static void ipw2100_reset_fatalerror(struct ipw2100_priv *priv ) 
{ u32 tmp ;
...
{ u32 reg ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_power_cycle_adapter");
  ...
  ldv_52360: 
  priv->status &= 0xffffffffdfffffffUL;
  if (i == 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      tmp___0 = current_thread_info();
      if (((unsigned long )tmp___0->preempt_count & 134217472UL) != 0UL) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_power_cycle_adapter");
  ...
  priv->status &= 0xfffffffffffff9f3UL;
  return (0);
}
}
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_hw_phy_off");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_enable_adapter");
  ...
  if (tmp___1 != 0) {
    if ((ipw2100_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_enable_adapter");
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_enable_adapter");
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_enable_adapter");
...
{ struct host_command cmd ;
  ...
  if (priv->fatal_error == 0U) {
    ...
    if ((ipw2100_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_hw_stop_adapter");
  ...
  write_register(priv->net_dev, 32U, 128U);
  priv->status &= 0xffffffffffffffebUL;
  return (0);
}
}
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_disable_adapter");
    printk("CARD_DISABLE\n");
  }
  if ((priv->status & 8UL) == 0UL) {
    return (0);
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_disable_adapter");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_scan_options");
    printk("enter\n");
  }
  if ((ipw2100_debug_level & 2048U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_set_scan_options");
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_set_scan_options");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_start_scan");
    printk("START_SCAN\n");
  }
  cmd.host_command_parameters[0] = 0U;
  ...
  if ((priv->status & 16777216UL) != 0UL) {
    if ((ipw2100_debug_level & 2048U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_start_scan");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_start_scan");
    printk("enter\n");
  }
  if ((ipw2100_debug_level & 2048U) != 0U) {
    tmp___2 = current_thread_info();
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_start_scan");
    printk("starting scan\n");
  }
  priv->status |= 16777216UL;
  err = ipw2100_hw_send_command(priv, & cmd);
  if (err != 0) {
    priv->status &= 0xfffffffffeffffffUL;
  }
  if ((ipw2100_debug_level & 4U) != 0U) {
    tmp___3 = current_thread_info();
    if (((unsigned long )tmp___3->preempt_count & 134217472UL) != 0UL) {
    ...
    printk("\017ipw2100: %c %s ", tmp___8, "ipw2100_start_scan");
    printk("exit\n");
  }
  return (err);
}
...
{ unsigned long flags ;
  ...
  if ((priv->status & 8192UL) != 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___9, "ipw2100_up");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((unsigned int )((unsigned char )geo->bg_channels) != 0U) {
    ...
    if (((int )geo->bg[i].flags & 8) != 0) {
      (bg_band->channels + (unsigned long )i)->flags |= 4U;
    }
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_reset_adapter");
...
{ int ret ;
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "isr_indicate_associated");
      printk("failed querying ordinals at line %d\n", 2070);
    }
    return;
  }
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "isr_indicate_associated");
      printk("failed querying ordinals at line %d\n", 2078);
    }
    return;
  }
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___8, "isr_indicate_associated");
      printk("failed querying ordinals at line %d\n", 2086);
    }
    return;
  }
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___9, "isr_indicate_associated");
      printk("failed querying ordinals at line %d\n", 2094);
    }
    return;
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___10, "isr_indicate_associated");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___11, "isr_indicate_associated");
...
{ int ssid_len ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_essid");
...
{ char ssid[129U] ;
  ...
  if ((ipw2100_debug_level & 5184U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "isr_indicate_association_lost");
  ...
  if ((priv->status & 16UL) != 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "isr_indicate_association_lost");
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "isr_indicate_rf_kill");
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 2048U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "isr_scan_complete");
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 2048U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "isr_indicate_scanning");
    printk("Scanning...\n");
  }
  priv->status |= 16777216UL;
  return;
...
{ int i ;
  ...
  if ((status == 2048 && (priv->status & 1024UL) != 0UL) && (priv->status & 16777216UL) == 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "isr_status_change");
  ...
  if ((int )status_handlers[i].status == status) {
    if ((ipw2100_debug_level & 1024U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "isr_status_change");
  ...
  if ((ipw2100_debug_level & 1024U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "isr_status_change");
...
{ struct thread_info *tmp ;
  ...
  if (cmd->host_command_reg <= 69U) {
    if ((ipw2100_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___0, "isr_rx_complete_command");
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_corruption_detected");
...
{ struct net_device *dev ;
  ...
  if ((ipw2100_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___16, "isr_rx");
    printk("Handler...\n");
  }
  ...
  if (tmp___3 != 0L) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___17, "isr_rx");
  ...
  if (tmp___7 != 0L) {
    ...
    if ((ipw2100_debug_level & 8192U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___18, "isr_rx");
  ...
  if (tmp___9 != 0L) {
    ...
    if (tmp___10 != 0L) {
      if ((ipw2100_debug_level & 8192U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___19, "isr_rx");
  ...
  if (tmp___12 == 0) {
    if ((ipw2100_debug_level & 8192U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___21, "isr_rx");
  ...
  if (tmp___15 != 0L) {
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___22, "isr_rx");
...
{ struct net_device *dev ;
  ...
  if ((ipw2100_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___15, "isr_rx_monitor");
    printk("Handler...\n");
  }
  tmp___2 = skb_tailroom((struct sk_buff  const  *)packet->skb);
  ...
  if (tmp___3 != 0L) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___16, "isr_rx_monitor");
      tmp___1 = skb_tailroom((struct sk_buff  const  *)packet->skb);
      printk("%s: frame_size (%u) > skb_tailroom (%u)!  Dropping.\n", (char *)(& dev->name),
             status->frame_size, tmp___1);
    }
  ...
  if (tmp___7 != 0L) {
    ...
    if ((ipw2100_debug_level & 8192U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___17, "isr_rx_monitor");
      printk("Dropping packet while interface is not up.\n");
    }
    return;
  }
  ...
  if (tmp___9 != 0L) {
    ...
    if (tmp___10 != 0L) {
      if ((ipw2100_debug_level & 16777216U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___18, "isr_rx_monitor");
  ...
  if (tmp___14 != 0L) {
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___19, "isr_rx_monitor");
      printk("TODO: Shutdown adapter...\n");
    }
  }
  (priv->rx_queue.drv + (unsigned long )i)->host_addr = (u32 )packet->dma_addr;
...
{ struct ipw2100_bd_queue *rxq ;
  ...
  if (rxq->entries <= r) {
    if ((ipw2100_debug_level & 16777216U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "__ipw2100_rx_process");
  ...
  if ((ipw2100_debug_level & 16777216U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "__ipw2100_rx_process");
...
{ struct ipw2100_bd_queue *txq ;
  ...
  if ((r > w || ((u32 )e >= r && (u32 )e < w)) && ((u32 )e >= r || (u32 )e < w)) {
    if ((ipw2100_debug_level & 8388608U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "__ipw2100_tx_process");
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___8, "__ipw2100_tx_process");
  ...
  if (packet->type == 51967) {
    ...
    if ((ipw2100_debug_level & 8388608U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___9, "__ipw2100_tx_process");
      printk("TX%d V=%p P=%04X T=%04X L=%d\n", i, txq->drv + (unsigned long )i, (unsigned int )txq->nic + (unsigned int )((unsigned long )i) * 16U,
             (txq->drv + (unsigned long )i)->host_addr, (txq->drv + (unsigned long )i)->buf_length);
    }
  }
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___10, "__ipw2100_tx_process");
  ...
  if ((packet->info.c_struct.cmd)->host_command_reg <= 69U) {
    if ((ipw2100_debug_level & 8388608U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___11, "__ipw2100_tx_process");
  ...
  txq->available += (u32 )descriptors_used;
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___12, "__ipw2100_tx_process");
 ...
 static void __ipw2100_tx_complete(struct ipw2100_priv *priv ) 
{ int i ;
  int tmp ;
...
{ struct list_head *element ;
  ...
  if (txq->available <= 3U) {
    if ((ipw2100_debug_level & 8388608U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_tx_send_commands");
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_tx_send_commands");
...
{ struct list_head *element ;
  ...
  if (tmp___0 != 0L) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_tx_send_data");
  ...
  if (txq->available <= (u32 )((int )(packet->info.d_struct.txb)->nr_frags + 3)) {
    if ((ipw2100_debug_level & 8388608U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___8, "ipw2100_tx_send_data");
      printk("no room in tx_queue\n");
    }
    goto ldv_52729;
  }
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___9, "ipw2100_tx_send_data");
  ...
  if ((unsigned int )(packet->info.d_struct.txb)->nr_frags > 1U) {
    if ((ipw2100_debug_level & 2097152U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___10, "ipw2100_tx_send_data");
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___11, "ipw2100_tx_send_data");
  ...
  txq->available += (u32 )(~ ((int )(packet->info.d_struct.txb)->nr_frags));
  priv->txq_stat.value = (int )txq->available;
  if (priv->txq_stat.value > priv->txq_stat.hi) {
    priv->txq_stat.hi = priv->txq_stat.value;
  }
...
{ struct net_device *dev ;
  ...
  if ((ipw2100_debug_level & 33554432U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___12, "ipw2100_irq_tasklet");
  ...
  if ((ipw2100_debug_level & 33554432U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___13, "ipw2100_irq_tasklet");
    printk("INTA: 0x%08lX\n", (unsigned long )inta & 3238068243UL);
  }
  if ((inta & 1073741824U) != 0U) {
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___14, "ipw2100_irq_tasklet");
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___15, "ipw2100_irq_tasklet");
  ...
  if ((inta & 2U) != 0U) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___16, "ipw2100_irq_tasklet");
      printk("RX interrupt\n");
    }
    (priv->rx_interrupts) ++;
  ...
  if ((int )inta & 1) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___17, "ipw2100_irq_tasklet");
      printk("TX interrupt\n");
    }
    (priv->tx_interrupts) ++;
  ...
  if ((inta & 4U) != 0U) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___18, "ipw2100_irq_tasklet");
      printk("TX complete\n");
    }
    (priv->inta_other) ++;
  ...
  if ((inta & 16777216U) != 0U) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___19, "ipw2100_irq_tasklet");
  ...
  if ((inta & 16U) != 0U) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___20, "ipw2100_irq_tasklet");
  ...
  if ((inta & 65536U) != 0U) {
    if ((ipw2100_debug_level & 33554432U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___21, "ipw2100_irq_tasklet");
  ...
  if ((ipw2100_debug_level & 33554432U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___22, "ipw2100_irq_tasklet");
    printk("exit\n");
  }
  return;
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((priv->status & 1024UL) == 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_tx");
  ...
  if ((ipw2100_debug_level & 8388608U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_tx");
...
{ struct ipw2100_priv *priv ;
  ...
  tmp___2 = sprintf(out, "%30s [%08X] : %04X\n", nic_data[i].name, nic_data[i].addr,
                    (int )tmp16);
  out += (unsigned long )tmp___2;
  goto ldv_52895;
  case 4UL: 
  read_nic_dword(dev, nic_data[i].addr, & tmp32);
  tmp___3 = sprintf(out, "%30s [%08X] : %08X\n", nic_data[i].name, nic_data[i].addr,
                    tmp32);
  out += (unsigned long )tmp___3;
  goto ldv_52895;
  }
  ldv_52895: 
  i ++;
    ...
    if ((unsigned int )tmp___7 == 111U) {
      ...
      if ((unsigned int )tmp___8 == 110U) {
        ...
        if ((ipw2100_debug_level & 4U) != 0U) {
          ...
          printk("\017ipw2100: %c %s ", tmp___9, "store_memory");
  ...
  if (count > 1UL) {
    ...
    if ((unsigned int )tmp___5 == 111U) {
      ...
      if ((unsigned int )tmp___6 == 102U) {
        ...
        if ((ipw2100_debug_level & 4U) != 0U) {
          ...
          printk("\017ipw2100: %c %s ", tmp___10, "store_memory");
    ...
    if ((unsigned int )tmp___4 == 114U) {
      if ((ipw2100_debug_level & 4U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___11, "store_memory");
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___12, "store_memory");
...
{ struct ipw2100_priv *priv ;
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "show_bssinfo");
      printk("failed querying ordinals at line %d\n", 4198);
    }
  }
  length = 6U;
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "show_bssinfo");
      printk("failed querying ordinals at line %d\n", 4205);
    }
  }
  length = 4U;
  ...
  if (ret != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___8, "show_bssinfo");
      printk("failed querying ordinals at line %d\n", 4211);
    }
  }
  ...
  out += (unsigned long )tmp___4;
  tmp___5 = sprintf(out, "Channel: %d\n", chan);
  out += (unsigned long )tmp___5;
  return ((long )out - (long )buf);
}
}
...
{ char *p ;
  ...
  if ((unsigned long )((char const   *)p) == (unsigned long )buf) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "store_debug_level");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "store_scan_age");
    printk("enter\n");
  }
  ...
  if ((unsigned long )((char *)(& buffer)) == (unsigned long )p) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___5, "store_scan_age");
      ...
      if ((ipw2100_debug_level & 4U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___6, "store_scan_age");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "store_scan_age");
    printk("exit\n");
  }
  return ((ssize_t )len);
}
...
{ struct ipw2100_priv *priv ;
  ...
  val = ((priv->status & 8192UL) != 0UL) | tmp___2;
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 131072U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw_radio_kill_sw");
    if (disable_radio != 0) {
      tmp___4 = (char *)"OFF";
    } else {
      tmp___4 = (char *)"ON";
  ...
  if (disable_radio != 0) {
    ...
    priv->status &= 0xffffffffffffdfffUL;
    ...
    if (tmp___2 != 0) {
      if ((ipw2100_debug_level & 131072U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___5, "ipw_radio_kill_sw");
...
{ struct ipw2100_status_queue *q ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "status_queue_allocate");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "status_queue_allocate");
    printk("exit\n");
  }
  return (0);
}
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "status_queue_free");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "status_queue_free");
    printk("exit\n");
  }
  return;
}
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "bd_queue_allocate");
    printk("enter\n");
  }
  ...
  if ((unsigned long )q->drv == (unsigned long )((struct ipw2100_bd *)0)) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___4, "bd_queue_allocate");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "bd_queue_allocate");
    printk("exit\n");
  }
  return (0);
}
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "bd_queue_free");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "bd_queue_free");
    printk("exit\n");
  }
  return;
}
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "bd_queue_initialize");
    printk("enter\n");
  }
  if ((ipw2100_debug_level & 4U) != 0U) {
    tmp___0 = current_thread_info();
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "bd_queue_initialize");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "bd_queue_initialize");
    printk("exit\n");
  }
  return;
}
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_tx_allocate");
    printk("enter\n");
  }
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_tx_initialize");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_tx_initialize");
    printk("exit\n");
  }
  return;
}
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_tx_free");
    printk("enter\n");
  }
  bd_queue_free(priv, & priv->tx_queue);
  if ((unsigned long )priv->tx_buffers == (unsigned long )((struct ipw2100_tx_packet *)0)) {
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_tx_free");
    printk("exit\n");
  }
  return;
}
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_rx_allocate");
    printk("enter\n");
  }
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_rx_allocate");
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_rx_allocate");
  ...
  if ((unsigned long )priv->rx_buffers == (unsigned long )((struct ipw2100_rx_packet *)0)) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___8, "ipw2100_rx_allocate");
...
{ struct thread_info *tmp ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_rx_initialize");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_rx_initialize");
    printk("exit\n");
  }
  return;
}
...
{ int i ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_rx_free");
    printk("enter\n");
  }
  bd_queue_free(priv, & priv->rx_queue);
  status_queue_free(priv);
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_rx_free");
    printk("exit\n");
  }
  return;
}
...
{ u32 length ;
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_read_mac_address");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_read_mac_address");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_mac_address");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_set_mac_address");
    printk("enter\n");
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_set_mac_address");
    printk("exit\n");
  }
  return (err);
}
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_set_port_type");
    if (port_type == 3U) {
      tmp___1 = (char *)"Ad-Hoc";
    } else {
      tmp___1 = (char *)"Managed";
    }
    printk("PORT_TYPE: %s\n", tmp___1);
  }
  if (batch_mode == 0) {
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_channel");
    printk("CHANNEL: %d\n", channel___0);
  }
  if ((priv->ieee)->iw_mode == 2) {
    return (0);
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_channel");
  ...
  if (channel___0 != 0U) {
    ...
    priv->config &= 0xfffffffffffffffeUL;
  }
...
{ struct host_command cmd ;
  ...
  if ((unsigned long )bssid != (unsigned long )((u8 *)0)) {
    if ((ipw2100_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_mandatory_bssid");
    ...
    if ((ipw2100_debug_level & 32U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_mandatory_bssid");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_disassociate_bssid");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_wpa_ie");
    printk("SET_WPA_IE\n");
  }
  if (batch_mode == 0) {
    err = ipw2100_disable_adapter(priv);
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_set_security_information");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_ibss_beacon_interval");
    printk("enter\n");
  }
  if ((priv->ieee)->iw_mode == 1) {
    if (batch_mode == 0) {
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_set_ibss_beacon_interval");
    printk("exit\n");
  }
  return (0);
}
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___0, "ipw2100_set_wep_flags");
...
{ int keylen ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_set_key");
  ...
  if (keylen == 0) {
    if ((ipw2100_debug_level & 4194304U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_set_key");
    ...
    if (keylen == 5) {
      if ((ipw2100_debug_level & 4194304U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_set_key");
      ...
      if ((ipw2100_debug_level & 4194304U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___8, "ipw2100_set_key");
...
{ struct host_command cmd ;
  ...
  if ((ipw2100_debug_level & 32U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_set_key_index");
...
{ int i ;
  ...
  priv->status &= 0xffffffffbfffffffUL;
  exit: ;
  if (batch_mode == 0) {
    ipw2100_enable_adapter(priv);
  }
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4194304U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "shim__set_security");
    if ((int )(priv->ieee)->sec.flags & 1) {
      tmp___2 = 49;
    } else {
      tmp___2 = 48;
    }
...
{ int err ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_adapter_setup");
    printk("enter\n");
  }
  err = ipw2100_disable_adapter(priv);
  if (err != 0) {
  ...
  if ((priv->ieee)->iw_mode == 6) {
    ...
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_adapter_setup");
      printk("exit\n");
    }
    return (0);
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_adapter_setup");
    printk("exit\n");
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_open");
    printk("dev->open\n");
  }
  tmp___1 = spinlock_check(& priv->low_lock);
  flags = _raw_spin_lock_irqsave(tmp___1);
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_close");
    printk("enter\n");
  }
  tmp___1 = spinlock_check(& priv->low_lock);
  flags = _raw_spin_lock_irqsave(tmp___1);
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_close");
    printk("exit\n");
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_tx_timeout");
...
{ struct ipw2100_priv *priv ;
  ...
  if (priv->fatal_error != 0U) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_hang_check");
    ...
    if (tmp___2 != 0 || priv->last_rtc == rtc) {
      if ((ipw2100_debug_level & 4U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_hang_check");
...
{ struct ipw2100_priv *priv ;
  ...
  if (tmp___2 != 0) {
    if ((ipw2100_debug_level & 131072U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_rf_kill");
  ...
  if ((priv->status & 12288UL) == 0UL) {
    if ((ipw2100_debug_level & 131072U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_rf_kill");
  ...
  if ((ipw2100_debug_level & 131072U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_rf_kill");
...
{ void *ioaddr ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___10, "ipw2100_pci_init_one");
    printk("enter\n");
  }
  if ((pci_dev->resource[0].flags & 512UL) == 0UL) {
    if ((ipw2100_debug_level & 4U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___11, "ipw2100_pci_init_one");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___12, "ipw2100_pci_init_one");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___13, "ipw2100_pci_init_one");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___14, "ipw2100_pci_init_one");
    printk("exit\n");
  }
  priv->status |= 32UL;
...
{ struct ipw2100_priv *priv ;
  ...
  priv->status &= 0xffffffffffffffdfUL;
  sysfs_remove_group(& pci_dev->dev.kobj, (struct attribute_group  const  *)(& ipw2100_attribute_group));
  if (ipw2100_firmware.version != 0) {
    ipw2100_release_firmware(priv, & ipw2100_firmware);
  }
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_pci_remove_one");
    printk("exit\n");
  }
  return;
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_suspend");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_resume");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_name");
    printk("Name: %s\n", (char *)(& wrqu->name));
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((int )fwrq->e > 0 || fwrq->m > 1000) {
    ...
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_set_freq");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_freq");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_set_mode");
    printk("SET Mode -> %d\n", wrqu->mode);
  }
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_mode");
    printk("GET Mode -> %d\n", wrqu->mode);
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_range");
    printk("GET Range\n");
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((int )tmp___1) {
    ...
    if ((int )tmp___2) {
      ...
      if ((ipw2100_debug_level & 8U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_wx_set_wap");
        printk("exit - disable mandatory BSSID\n");
      }
      priv->config &= 0xfffffffffffffffbUL;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_wx_set_wap");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_wap");
...
{ struct ipw2100_priv *priv ;
  ...
  if (length == 0) {
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_wx_set_essid");
      printk("Setting ESSID to ANY\n");
    }
    priv->config &= 0xfffffffffffffffdUL;
  ...
  if ((int )priv->essid_len == length) {
    ...
    if (tmp___2 == 0) {
      if ((ipw2100_debug_level & 8U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___6, "ipw2100_wx_set_essid");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___7, "ipw2100_wx_set_essid");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((priv->config & 2UL) != 0UL || (priv->status & 1024UL) != 0UL) {
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_wx_get_essid");
    ...
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_wx_get_essid");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wx_set_nick");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wx_get_nick");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_set_rate");
    printk("SET Rate -> %04X\n", rate);
  }
  done: 
...
{ struct ipw2100_priv *priv ;
  ...
  if (err != 0) {
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wx_get_rate");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_wx_get_rate");
    printk("GET Rate -> %d\n", wrqu->bitrate.value);
  }
  done: 
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_set_rts");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_rts");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wx_set_txpow");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_txpow");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_set_frag");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_frag");
...
{ struct ipw2100_priv *priv ;
  ...
  if (((int )wrqu->retry.flags & 16) != 0) {
    ...
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_wx_set_retry");
  ...
  if (((int )wrqu->retry.flags & 32) != 0) {
    ...
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_wx_set_retry");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_wx_set_retry");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_retry");
    printk("GET Retry -> %d\n", wrqu->retry.value);
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_wx_set_scan");
  ...
  if (tmp___2 != 0) {
    ...
    if (tmp___3 != 0) {
      ...
      if ((ipw2100_debug_level & 8U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_wx_set_scan");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((unsigned int )wrqu->power.disabled != 0U) {
    ...
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_wx_set_power");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___4, "ipw2100_wx_set_power");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___5, "ipw2100_wx_set_power");
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_wx_get_power");
...
{ struct ipw2100_priv *priv ;
  ...
  if (mode == 0) {
    priv->config &= 0xffffffffffffffefUL;
  } else {
    err = -22;
    goto done;
  }
...
{ struct ipw2100_priv *priv ;
  ...
  if (mode == 0) {
    priv->config &= 0xfffffffffffff7ffUL;
  } else {
    err = -22;
    goto done;
  }
...
static struct iw_priv_args  const  ipw2100_private_args[8U]  = 
  {      {35808U, 18434U, 0U, {'m', 'o', 'n', 'i', 't', 'o', 'r', '\000', (char)0, (char)0,
                           (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}}, 
        {35809U,
      18432U, 0U, {'r', 'e', 's', 'e', 't', '\000', (char)0, (char)0, (char)0, (char)0,
                   (char)0, (char)0, (char)0, (char)0, (char)0, (char)0}}, 
        {35810U, 18433U, 0U, {'s', 'e', 't', '_', 'p', 'o', 'w', 'e', 'r', '\000', (char)0,
                           (char)0, (char)0, (char)0, (char)0, (char)0}}, 
        {35811U, 0U, 10320U, {'g', 'e', 't', '_', 'p', 'o', 'w', 'e', 'r', '\000', (char)0,
                           (char)0, (char)0, (char)0, (char)0, (char)0}}, 
        {35812U, 18433U, 0U, {'s', 'e', 't', '_', 'p', 'r', 'e', 'a', 'm', 'b', 'l',
                           'e', '\000', (char)0, (char)0, (char)0}}, 
        {35813U, 0U, 10256U, {'g', 'e', 't', '_', 'p', 'r', 'e', 'a', 'm', 'b', 'l',
                           'e', '\000', (char)0, (char)0, (char)0}}, 
        {35814U, 18433U, 0U, {'s', 'e', 't', '_', 'c', 'r', 'c', '_', 'c', 'h', 'e',
                           'c', 'k', '\000', (char)0, (char)0}}, 
...
{ int rssi_qual ;
  ...
  if ((priv->status & 1024UL) == 0UL) {
    ...
    if (beacon_qual == quality) {
      if ((ipw2100_debug_level & 8U) != 0U) {
        ...
        printk("\017ipw2100: %c %s ", tmp___9, "ipw2100_wx_wireless_stats");
      ...
      if (tx_qual == quality) {
        if ((ipw2100_debug_level & 8U) != 0U) {
          ...
          printk("\017ipw2100: %c %s ", tmp___10, "ipw2100_wx_wireless_stats");
        ...
        if (quality != 100) {
          if ((ipw2100_debug_level & 8U) != 0U) {
            ...
            printk("\017ipw2100: %c %s ", tmp___11, "ipw2100_wx_wireless_stats");
          ...
          if ((ipw2100_debug_level & 8U) != 0U) {
            ...
            printk("\017ipw2100: %c %s ", tmp___12, "ipw2100_wx_wireless_stats");
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___13, "ipw2100_wx_wireless_stats");
    printk("failed querying ordinals.\n");
  }
  return (0);
}
...
{ struct ipw2100_priv *priv ;
  ...
  if ((ipw2100_debug_level & 8U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_wx_event_work");
    printk("enter\n");
  }
  ...
  if ((priv->status & 1536UL) == 0UL || (priv->status & 12288UL) != 0UL) {
    ...
    if (tmp___0 != 0) {
      ...
      priv->status &= 0xfffffffffffffdffUL;
      priv->status |= 1024UL;
  ...
  if ((priv->status & 1024UL) == 0UL) {
    if ((ipw2100_debug_level & 8U) != 0U) {
      ...
      printk("\017ipw2100: %c %s ", tmp___3, "ipw2100_wx_event_work");
...
{ char *fw_name ;
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___1, "ipw2100_get_firmware");
  ...
  if ((ipw2100_debug_level & 4U) != 0U) {
    ...
    printk("\017ipw2100: %c %s ", tmp___2, "ipw2100_get_firmware");
...
{ unsigned int addr ;
  ...
  firmware_data += 4UL;
  firmware_data_left -= 4U;
  len = *((u16 *)firmware_data);
  firmware_data += 2UL;
  firmware_data_left -= 2U;
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_ipw2100_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_ipw2100_netdev_ops_net_device_ops ++;
  }
  goto ldv_54278;
  case 3: ;
  ...
  if (ldv_s_ipw2100_pci_driver_pci_driver == 0) {
    ...
    ldv_s_ipw2100_pci_driver_pci_driver ++;
  }
  goto ldv_54278;
  case 7: ;
