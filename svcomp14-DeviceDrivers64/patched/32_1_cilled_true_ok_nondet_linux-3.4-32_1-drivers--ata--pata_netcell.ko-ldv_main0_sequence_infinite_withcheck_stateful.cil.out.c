...
{ struct ata_port_info  const  *port_info[2] ;
  ...
  *((struct ata_port_info  const  **)__cil_tmp9) = (struct ata_port_info  const  *)__cil_tmp10;
  ...
  tmp = (int )pcim_enable_device(pdev);
  rc = tmp;
  if (rc) {
    return (rc);
  }
...
static int netcell_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp___7 ;
  ...
  {
  tmp = (int )__pci_register_driver(& netcell_pci_driver, & __this_module, "pata_netcell");
  tmp___7 = tmp;
  return (tmp___7);
}
}
