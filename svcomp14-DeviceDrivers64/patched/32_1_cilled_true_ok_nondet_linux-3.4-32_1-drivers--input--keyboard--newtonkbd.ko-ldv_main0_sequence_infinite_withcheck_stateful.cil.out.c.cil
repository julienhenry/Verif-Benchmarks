...
static int nkbd_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& nkbd_drv, & __this_module, "newtonkbd");
  tmp = tmp___0;
  return (tmp);
}
}
