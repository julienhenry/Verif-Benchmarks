...
static int tekram_sir_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp___7 ;
  ...
  while (1) {
    ...
    if (irda_debug >= 1U) {
      __cil_tmp8 = (unsigned long )(& tekram) + 8UL;
