...
{ struct max11801_data *data ;
  ...
  *((struct device **)__cil_tmp20) = (struct device *)__cil_tmp22;
  ...
  tmp = (int )request_threaded_irq(__cil_tmp45, __cil_tmp47, & max11801_ts_interrupt,
  ...
  tmp___8 = (int )input_register_device(__cil_tmp55);
  error = tmp___8;
  if (error) {
    goto err_free_irq;
  }
