...
{ int res ;
  ...
  *((unsigned long *)__cil_tmp20) = (unsigned long )__cil_tmp22;
  ...
  tmp = (int )sysfs_create_group(__cil_tmp26, & m_thermal_gr);
  res = tmp;
  if (res) {
  ...
  *((struct device **)data) = hwmon_device_register(__cil_tmp33);
  ...
  tmp___10 = (long )IS_ERR(__cil_tmp35);
  tmp___9 = tmp___10;
  if (tmp___9) {
    __cil_tmp36 = *((struct device **)data);
    __cil_tmp37 = (void const   *)__cil_tmp36;
    tmp___11 = (long )PTR_ERR(__cil_tmp37);
    tmp___8 = tmp___11;
    res = (int )tmp___8;
...
static struct i2c_driver sensor_emc1403  = 
    ...
    emc1403_idtable, & emc1403_detect, emc1403_address_list, {(struct list_head *)0,
                                                              (struct list_head *)0}};
static int sensor_emc1403_init(void)  __attribute__((__section__(".init.text"),
    ...
    if (tmp___7 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_sensor_emc1403_i2c_driver == 0) {
          ...
          ldv_s_sensor_emc1403_i2c_driver ++;
        }
        goto switch_break;
        case_1: 
