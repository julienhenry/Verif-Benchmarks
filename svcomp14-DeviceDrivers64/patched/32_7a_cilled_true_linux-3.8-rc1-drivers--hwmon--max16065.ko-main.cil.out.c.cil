...
static int const   max16065_csp_adc_range[2U]  = {      7000,      14000};
 static int ADC_TO_MV(int adc , int range ) 
{ 
 ...
 static int LIMIT_TO_MV(int limit , int range ) 
{ 
 ...
 static int MV_TO_LIMIT(int mv , int range ) 
{ int __x ;
  int __d ;
  int tmp ;
  int tmp___0 ;
 ...
 static int ADC_TO_CURR(int adc , int gain ) 
{ 
