...
{ 
 ...
 static void *skb_frag_address(skb_frag_t const   *frag ) 
{ struct page *tmp ;
  void *tmp___0 ;
...
{ bool tmp ;
 ...
 static void eisa_set_drvdata(struct eisa_device *edev , void *data ) 
{ 
...
{ struct vortex_private *vp ;
  ...
  dev->stats.tx_carrier_errors += (unsigned long )tmp___0;
  tmp___1 = window_read8(vp, 6, 1);
  dev->stats.tx_heartbeat_errors += (unsigned long )tmp___1;
  tmp___2 = window_read8(vp, 6, 4);
  dev->stats.tx_window_errors += (unsigned long )tmp___2;
  tmp___3 = window_read8(vp, 6, 5);
  dev->stats.rx_fifo_errors += (unsigned long )tmp___3;
  tmp___4 = window_read8(vp, 6, 6);
  dev->stats.tx_packets += (unsigned long )tmp___4;
  tmp___5 = window_read8(vp, 6, 9);
  dev->stats.tx_packets += (unsigned long )(((int )tmp___5 & 48) << 4);
  window_read8(vp, 6, 7);
  tmp___6 = window_read16(vp, 6, 10);
  dev->stats.rx_bytes += (unsigned long )tmp___6;
  tmp___7 = window_read16(vp, 6, 12);
  dev->stats.tx_bytes += (unsigned long )tmp___7;
  tmp___8 = window_read8(vp, 6, 2);
  vp->xstats.tx_multiple_collisions += (unsigned long )tmp___8;
  tmp___9 = window_read8(vp, 6, 3);
  vp->xstats.tx_single_collisions += (unsigned long )tmp___9;
  tmp___10 = window_read8(vp, 6, 8);
  vp->xstats.tx_deferred += (unsigned long )tmp___10;
  tmp___11 = window_read8(vp, 4, 12);
  vp->xstats.rx_bad_ssd += (unsigned long )tmp___11;
  ...
  up___0 = tmp___12;
  dev->stats.rx_bytes += (unsigned long )(((int )up___0 & 15) << 16);
  dev->stats.tx_bytes += (unsigned long )(((int )up___0 & 240) << 12);
  return;
}
}
