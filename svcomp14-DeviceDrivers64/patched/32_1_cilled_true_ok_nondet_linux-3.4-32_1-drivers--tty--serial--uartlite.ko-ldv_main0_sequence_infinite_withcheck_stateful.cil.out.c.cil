...
{ int ret ;
  ...
  tmp = (int )request_irq(__cil_tmp5, & ulite_isr, 192UL, "uartlite", __cil_tmp6);
  ret = tmp;
  if (ret) {
    return (ret);
  }
...
{ struct uart_port *port ;
  ...
  if (id < 0) {
    ...
    while (1) {
      ...
      __cil_tmp7 = (unsigned long )id * 256UL;
  ...
  __cil_tmp13 = (unsigned long )id * 256UL;
  ...
  if (*((resource_size_t *)__cil_tmp15)) {
    ...
    __cil_tmp17 = (unsigned long )id * 256UL;
  ...
  __cil_tmp22 = (unsigned long )id * 256UL;
