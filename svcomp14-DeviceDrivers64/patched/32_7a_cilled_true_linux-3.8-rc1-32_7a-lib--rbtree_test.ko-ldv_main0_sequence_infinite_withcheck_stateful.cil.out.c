...
extern void warn_slowpath_null(char const   * , int  ) ;
 static u64 paravirt_read_tsc(void) 
{ u64 __ret ;
  unsigned long __edi ;
  unsigned long __esi ;
  unsigned long __edx ;
...
extern void __rb_insert_augmented(struct rb_node * , struct rb_root * , void (*)(struct rb_node * ,
                                                                                 struct rb_node * ) ) ;
 static void rb_insert_augmented(struct rb_node *node , struct rb_root *root___0 ,
...
{ 
 ...
 static void rb_set_parent_color(struct rb_node *rb , struct rb_node *p ,
                                         int color ) 
{ 
 ...
 static void __rb_change_child(struct rb_node *old , struct rb_node *new ,
...
extern void __rb_erase_color(struct rb_node * , struct rb_root * , void (*)(struct rb_node * ,
                                                                            struct rb_node * ) ) ;
 static void rb_erase_augmented(struct rb_node *node , struct rb_root *root___0 ,
                                        struct rb_augment_callbacks  const  *augment ) 
...
{ u32 tmp ;
 ...
 static void prandom_seed_state(struct rnd_state *state , u64 seed ) 
{ u32 i ;
...
{ struct rb_node **new ;
 ...
 static void erase(struct test_node *node , struct rb_root *root___0 ) 
{ 
 ...
 static u32 augment_recompute(struct test_node *node ) 
{ u32 max ;
  u32 child_augmented ;
  struct rb_node  const  *__mptr ;
 ...
 static void augment_callbacks_propagate(struct rb_node *rb , struct rb_node *stop ) 
{ struct test_node *node ;
 ...
 static void augment_callbacks_copy(struct rb_node *rb_old , struct rb_node *rb_new ) 
