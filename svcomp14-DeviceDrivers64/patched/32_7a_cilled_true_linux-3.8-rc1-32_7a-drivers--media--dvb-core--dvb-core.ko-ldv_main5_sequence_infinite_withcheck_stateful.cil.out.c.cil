...
{ struct dvb_ringbuffer *buf ;
 ...
 static void dvb_dmxdev_filter_state_set(struct dmxdev_filter *dmxdevfilter ,
                                                 int state ) 
{ 
...
{ struct dmxdev_feed *feed ;
 ...
 static int dvb_dmxdev_filter_reset(struct dmxdev_filter *dmxdevfilter ) 
{ 
...
{ void *mem ;
 ...
 static void invert_mode(dmx_filter_t *filter ) 
{ int i ;
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_dvb_demux_fops_file_operations == 0) {
    ...
    ldv_s_dvb_demux_fops_file_operations ++;
  }
  goto ldv_22791;
  case 1: ;
  ...
  if (ldv_s_dvb_dvr_fops_file_operations == 0) {
    ...
    ldv_s_dvb_dvr_fops_file_operations ++;
  }
  goto ldv_22791;
  case 6: ;
...
extern struct timespec current_kernel_time(void) ;
 static s64 timespec_to_ns(struct timespec  const  *ts ) 
{ 
...
static int dvb_demux_feed_err_pkts  =    1;
 static u16 section_length(u8 const   *buf ) 
{ 
 ...
 static u16 ts_pid(u8 const   *buf ) 
{ 
 ...
 static u8 payload(u8 const   *tsp ) 
{ 
...
{ size_t __len ;
 ...
 static int dvb_dmx_swfilter_payload(struct dvb_demux_feed *feed , u8 const   *buf ) 
{ int count ;
  u8 tmp ;
  int p ;
  int tmp___0 ;
...
{ u8 neq ;
 ...
 static int dvb_dmx_swfilter_section_feed(struct dvb_demux_feed *feed ) 
{ struct dvb_demux *demux ;
...
{ struct dvb_demux *demux ;
  ...
  sec->secbuf += (unsigned long )seclen;
  n = (u16 )((int )n + 1);
  ldv_22352: ;
...
{ u8 p ;
 ...
 static void dvb_dmx_swfilter_packet_type(struct dvb_demux_feed *feed , u8 const   *buf ) 
{ u16 tmp ;
  int tmp___0 ;
...
{ size_t tmp ;
 ...
 static int find_next_packet(u8 const   *buf , int pos , size_t count , int pktsize ) 
{ int start ;
  int lost ;
  int backtrack ;
  ...
  goto ldv_22421;
  ldv_22420: ;
  if ((unsigned int )((unsigned char )*(buf + (unsigned long )pos)) == 71U || (pktsize == 204 && (unsigned int )((unsigned char )*(buf + (unsigned long )pos)) == 184U)) {
    goto ldv_22419;
  }
  pos ++;
  ldv_22421: ;
  ...
  lost = pos - start;
  if (lost != 0) {
    backtrack = pos - pktsize;
    if (backtrack >= 0 && ((unsigned int )((unsigned char )*(buf + (unsigned long )backtrack)) == 71U || (pktsize == 204 && (unsigned int )((unsigned char )*(buf + (unsigned long )backtrack)) == 184U))) {
      return (backtrack);
    }
  }
  return (pos);
 ...
 static void _dvb_dmx_swfilter(struct dvb_demux *demux , u8 const   *buf ,
                                       size_t count , int pktsize ) 
{ int p ;
  int i ;
  int j ;
  u8 const   *q ;
  ...
  if (pktsize == 204 && (unsigned int )((unsigned char )*q) == 184U) {
    __len___1 = 188UL;
    if (__len___1 > 63UL) {
  ...
  if (i != 0) {
    ...
    __ret___2 = __builtin_memcpy((void *)(& demux->tsbuf), (void const   *)buf + (unsigned long )p,
                                 __len___2);
    demux->tsbufp = i;
    if (pktsize == 204 && (unsigned int )demux->tsbuf[0] == 184U) {
      demux->tsbuf[0] = 71U;
    }
  }
  bailout: 
...
{ int i ;
  ...
  *(tuple + (unsigned long )i) = (u8 )tmp;
  if (dvb_ca_en50221_debug != 0) {
    if ((unsigned int )*(tuple + (unsigned long )i) > 31U && (unsigned int )*(tuple + (unsigned long )i) <= 126U) {
      tmp___0 = (int )*(tuple + (unsigned long )i);
    } else {
      tmp___0 = 46;
    }
    printk("  0x%02x: 0x%02x %c\n", i, (int )*(tuple + (unsigned long )i), tmp___0);
  }
  i ++;
  ldv_22137: ;
  if (i < _tupleLength) {
...
{ int address ;
  ...
  goto ldv_22156;
  ldv_22155: 
  (ca->slot_info + (unsigned long )slot)->config_base |= (u32 )((int )tuple[i + 2] << i * 8);
  i ++;
  ldv_22156: ;
  if (rasz + 1 > i) {
    goto ldv_22155;
...
{ struct dvb_device *dvbdev ;
  ...
  if ((size_t )(fragpos + fraglen) < count) {
    fragbuf[1] = 128U;
  } else {
    fragbuf[1] = 0U;
  }
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_dvb_ca_fops_file_operations == 0) {
    ...
    ldv_s_dvb_ca_fops_file_operations ++;
  }
  goto ldv_22528;
  case 1: ;
...
{ int autoinversion ;
  ...
  c->frequency += (u32 )fepriv->lnb_drift;
  if (autoinversion != 0) {
...
{ s32 tmp ;
  ...
  if (curtime.tv_usec < lasttime.tv_usec) {
    tmp = (s32 )(((unsigned int )curtime.tv_usec - (unsigned int )lasttime.tv_usec) + 1000000U);
  } else {
    tmp = (s32 )((unsigned int )curtime.tv_usec - (unsigned int )lasttime.tv_usec);
  }
  return (tmp);
}
}
 static void timeval_usec_add(struct timeval *curtime , u32 add_usec ) 
{ 

  {
  curtime->tv_usec += (__kernel_suseconds_t )add_usec;
...
{ struct dvb_device *dvbdev ;
  ...
  if ((file->f_flags & 3U) != 0U) {
    fepriv->tune_mode_flags &= 0xfffffffffffffffeUL;
    fepriv->tone = -1;
    fepriv->voltage = -1;
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_dvb_frontend_fops_file_operations == 0) {
    ...
    ldv_s_dvb_frontend_fops_file_operations ++;
  }
  goto ldv_24890;
  case 1: ;
...
static int dvb_net_debug  ;
 static __u32 iov_crc32(__u32 c , struct kvec *iov , unsigned int cnt ) 
{ unsigned int j ;
...
{ int (*ule_mandatory_ext_handlers[255U])(struct dvb_net_priv * ) ;
  ...
  if ((unsigned int )hlen == 0U) {
    if ((unsigned long )ule_mandatory_ext_handlers[(int )htype] != (unsigned long )((int (*)(struct dvb_net_priv * ))0)) {
      ...
      if (ext_len >= 0) {
        p->ule_next_hdr += (unsigned long )ext_len;
        if ((unsigned int )p->ule_bridged == 0U) {
          tmp___1 = __fswab16((int )*((__be16 *)p->ule_next_hdr));
          p->ule_sndu_type = tmp___1;
          p->ule_next_hdr += 2UL;
        } else {
          if ((unsigned int )p->ule_dbit != 0U) {
            tmp___4 = 12U;
          } else {
            tmp___4 = 18U;
          }
          tmp___2 = __fswab16((int )*((__be16 *)p->ule_next_hdr + tmp___4));
...
{ struct dvb_net_priv *priv ;
  ...
  if ((unsigned int )new_ts != 0U) {
    ...
    if (((int )*(ts + 1UL) & 64) != 0) {
      ...
      if (priv->ule_sndu_remain > 183) {
        ...
        consume_skb(priv->ule_skb);
        reset_ule(priv);
        from_where += (unsigned long )*(ts + 4UL);
  ...
  priv->ule_sndu_remain -= (int )how_much;
  ts_remain = (int )ts_remain - (int )how_much;
  from_where += (unsigned long )how_much;
  if (priv->ule_sndu_remain <= 0) {
    ...
    if (ule_crc != expected_crc) {
      if ((unsigned int )ts_remain > 2U) {
        tmp___11 = (int )*((unsigned short *)from_where);
      } else {
        tmp___11 = 0;
      }
      ...
      dev->stats.rx_bytes += (unsigned long )(priv->ule_skb)->len;
...
{ struct net_device *var_group1 ;
  ...
  if (ldv_s_dvb_netdev_ops_net_device_ops == 0) {
    ...
    ldv_s_dvb_netdev_ops_net_device_ops ++;
  }
  goto ldv_39430;
  case 1: ;
...
{ size_t todo ;
  ...
  {
  todo = len;
  if ((unsigned long )rbuf->pread + len > (unsigned long )rbuf->size) {
    split = (size_t )(rbuf->size - rbuf->pread);
  } else {
    split = 0UL;
  }
  if (split != 0UL) {
...
{ size_t todo ;
  ...
  {
  todo = len;
  if ((unsigned long )rbuf->pwrite + len > (unsigned long )rbuf->size) {
    split = (size_t )(rbuf->size - rbuf->pwrite);
  } else {
    split = 0UL;
  }
  if (split != 0UL) {
...
{ size_t todo ;
  ...
  todo = len;
  if (idx + len > (unsigned long )rbuf->size) {
    split = (unsigned long )rbuf->size - idx;
  } else {
    split = 0UL;
  }
  if (split != 0UL) {
