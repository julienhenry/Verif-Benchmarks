...
extern int regulator_set_voltage(struct regulator *regulator , int min_uV , int max_uV ) ;
 static int led_regulator_get_max_brightness(struct regulator *supply )  __attribute__((__no_instrument_function__)) ;
 static int led_regulator_get_max_brightness(struct regulator *supply )  __attribute__((__no_instrument_function__)) ;
...
{ struct led_regulator_platform_data *pdata ;
  ...
  tmp___3 = (struct regulator *)regulator_get_exclusive(__cil_tmp24, "vled");
  vcc = tmp___3;
  __cil_tmp25 = (void const   *)vcc;
  tmp___4 = (long )IS_ERR(__cil_tmp25);
  tmp___0 = tmp___4;
  if (tmp___0) {
    ...
    tmp___5 = (long )PTR_ERR(__cil_tmp31);
    tmp = tmp___5;
    return ((int )tmp);
  }
  ...
  *((struct regulator **)__cil_tmp72) = vcc;
  ...
  __cil_tmp105 = __cil_tmp104 + 264UL;
