...
{ struct adapter_reply_queue *reply_q ;
  ...
  if ((unsigned int )request_desript_type == 6U || (unsigned int )request_desript_type == 0U) {
    ...
    if (tmp___0 != 0L) {
      tmp___1 = ldv__builtin_expect((unsigned long )mpt_callbacks[(int )cb_idx] != (unsigned long )((u8 (*)(struct MPT3SAS_ADAPTER * ,
                                                                                                            u16  ,
                                                                                                            u8  ,
                                                                                                            u32  ))0),
                                    1L);
  ...
  if ((unsigned int )request_desript_type == 1U) {
    ...
    if ((unsigned int )smid != 0U) {
      ...
      if (tmp___2 != 0L) {
        tmp___3 = ldv__builtin_expect((unsigned long )mpt_callbacks[(int )cb_idx] != (unsigned long )((u8 (*)(struct MPT3SAS_ADAPTER * ,
                                                                                                              u16  ,
                                                                                                              u8  ,
                                                                                                              u32  ))0),
                                      1L);
 ...
 static int _base_is_controller_msix_enabled(struct MPT3SAS_ADAPTER *ioc ) 
{ 
...
{ u8 cb_idx ;
  ...
  goto ldv_38520;
  ldv_38519: ;
  if ((unsigned long )mpt_callbacks[(int )cb_idx] == (unsigned long )((u8 (*)(struct MPT3SAS_ADAPTER * ,
                                                                              u16  ,
                                                                              u8  ,
                                                                              u32  ))0)) {
    goto ldv_38518;
...
{ Mpi2SCSIIORequest_t *mpi_request ;
  ...
  sg_local += (unsigned long )ioc->sge_size_ieee;
  sges_left --;
  sges_in_segment --;
  ldv_38598: ;
...
{ u8 sgl_flags ;
  ...
  if (data_out_sz != 0UL && data_in_sz != 0UL) {
    ...
    psge += (unsigned long )ioc->sge_size_ieee;
...
{ 
 ...
 static u8 _base_get_msix_index(struct MPT3SAS_ADAPTER *ioc ) 
{ int pscr_ret__ ;
...
{ int i ;
  ...
  if ((ioc->facts.IOCCapabilities & 128U) != 0U) {
    ...
    printk("\016%sBIDI Target", tmp___2);
    i ++;
  }
  ...
  if ((ioc->facts.IOCCapabilities & 16U) != 0U) {
    ...
    printk("\016%sSnapshot Buffer", tmp___4);
    i ++;
  }
  if ((ioc->facts.IOCCapabilities & 8U) != 0U) {
    ...
    printk("\016%sDiag Trace Buffer", tmp___5);
    i ++;
  }
  ...
  if ((ioc->facts.IOCCapabilities & 4U) != 0U) {
    ...
    printk("\016%sTask Set Full", tmp___7);
    i ++;
  }
...
{ struct mpt3sas_facts *facts ;
  ...
  if (max_queue_depth != -1 && max_queue_depth != 0) {
    ...
    max_request_credit = (u16 )tmp___11;
  ...
  if (__min1___2 < __min2___2) {
    ioc->chain_depth = __min1___2;
  } else {
    ioc->chain_depth = __min2___2;
  }
...
{ int i ;
 ...
 static void _debug_dump_reply(void *mpi_request , int sz ) 
{ int i ;
  __le32 *mfp ;
 ...
 static void _debug_dump_config(void *mpi_request , int sz ) 
{ int i ;
  __le32 *mfp ;
...
{ u16 smid ;
  ...
  if ((unsigned long )config_page != (unsigned long )((void *)0)) {
    ...
    if ((unsigned int )mpi_request->Action == 2U || (unsigned int )mpi_request->Action == 4U) {
      ...
      memset(mem.page, 0, (size_t )tmp___2);
    }
  }
  retry_config: ;
  ...
  if ((ioc_status == 0U && (unsigned long )config_page != (unsigned long )((void *)0)) && (unsigned int )mpi_request->Action == 1U) {
    ...
    if ((unsigned long )p != (unsigned long )((u8 *)0)) {
      if ((((int )mpi_request->Header.PageType ^ (int )*(p + 3UL)) & 15) != 0) {
        ...
        _debug_dump_config((void *)p, tmp___3 / 4);
      ...
      if (((int )mpi_request->Header.PageType & 15) == 15 && (int )mpi_request->ExtPageType != (int )*(p + 6UL)) {
        ...
        _debug_dump_config((void *)p, tmp___4 / 4);
...
{ 
 ...
 static struct scsi_cmnd *_scsih_scsi_lookup_get_clear(struct MPT3SAS_ADAPTER *ioc ,
                                                               u16 smid ) 
{ unsigned long flags ;
  struct scsi_cmnd *scmd ;
  raw_spinlock_t *tmp ;
...
{ Mpi2SCSIIORequest_t *mpi_request ;
  ...
  if ((unsigned int )sas_device_priv_data->tlr_snoop_check == 0U) {
    ...
    if ((sas_device_priv_data->flags & 2U) != 0U && response_code == 2U) {
      sas_device_priv_data->flags &= 4294967293U;
    }
  }
...
static struct pci_error_handlers _scsih_err_handler  =    {(pci_ers_result_t (*)(struct pci_dev * ,
                          enum pci_channel_state  ))(& _scsih_pci_error_detected),
...
{ struct file *var_group1 ;
  ...
  mpt3sas_ioc_list.next = tmp___1;
  tmp___2 = __VERIFIER_nondet_pointer();
  mpt3sas_ioc_list.prev = tmp___2;
  LDV_IN_INTERRUPT = 1;
  ldv_initialize();
  goto ldv_40262;
  ldv_40261: 
