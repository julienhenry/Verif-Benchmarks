...
{ void *tmp ;
 ...
 static struct clk *clk_get(struct device *dev , char const   *id ) 
{ 
...
{ unsigned long const   (*__mptr)[0U] ;
 ...
 static struct r8a66597_td *r8a66597_get_td(struct r8a66597 *r8a66597 , u16 pipenum ) 
{ int tmp ;
  long tmp___0 ;
...
{ unsigned int tmp ;
 ...
 static void r8a66597_read_fifo(struct r8a66597 *r8a66597 , unsigned long offset ,
                                        u16 *buf , int len ) 
{ void *fifoaddr ;
  unsigned long count ;
  unsigned long tmp ;
 ...
 static void r8a66597_write(struct r8a66597 *r8a66597 , u16 val , unsigned long offset ) 
{ 
 ...
 static void r8a66597_mdfy(struct r8a66597 *r8a66597 , u16 val , u16 pat ,
...
{ u16 tmp ;
 ...
 static void r8a66597_write_fifo(struct r8a66597 *r8a66597 , struct r8a66597_pipe *pipe ,
                                         u16 *buf , int len ) 
{ void *fifoaddr ;
  unsigned long count ;
  unsigned char *pb ;
...
{ unsigned long dvstctr_reg ;
 ...
 static void r8a66597_port_power(struct r8a66597 *r8a66597 , int port , int power ) 
{ unsigned long dvstctr_reg ;
  unsigned long tmp ;
...
{ int idx ;
  ...
  {
  idx = address / 32;
  r8a66597->child_connect_map[idx] |= (unsigned long )(1 << address % 32);
  return;
}
}
...
{ 
 ...
 static unsigned short mbw_value(struct r8a66597 *r8a66597 ) 
{ 
 ...
 static void cfifo_change(struct r8a66597 *r8a66597 , u16 pipenum ) 
{ unsigned short mbw ;
  unsigned short tmp ;
 ...
 static void fifo_change_from_pipe(struct r8a66597 *r8a66597 , struct r8a66597_pipe *pipe ) 
{ unsigned short mbw ;
  unsigned short tmp ;
...
{ int chix ;
  ...
  if ((((unsigned int )udev->state == 7U && (unsigned long )udev->parent != (unsigned long )((struct usb_device *)0)) && (udev->parent)->devnum > 1) && (unsigned int )(udev->parent)->descriptor.bDeviceClass == 9U) {
    *(map + (unsigned long )(udev->devnum / 32)) |= (unsigned long )(1 << udev->devnum % 32);
  }
  chix = 1;
...
{ struct usb_hcd *var_group1 ;
  ...
  if (ldv_s_r8a66597_driver_platform_driver == 0) {
    ...
    ldv_s_r8a66597_driver_platform_driver ++;
  }
  goto ldv_29303;
  case 14: ;
