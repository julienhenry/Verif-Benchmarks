...
void hfs_mark_mdb_dirty(struct super_block *sb ) ;
 static void hfs_bitmap_dirty(struct super_block *sb ) 
{ 
...
extern int autoremove_wake_function(wait_queue_t * , unsigned int  , int  , void * ) ;
 static int PageError(struct page  const  *page ) 
{ int tmp ;
...
{ struct hfs_btree *tree ;
 ...
 static int hfs_bnode_hash(u32 num ) 
{ 
...
{ struct hfs_bnode *node ;
  ...
  memset(tmp___3 + (unsigned long )node->page_offset, 0, (size_t )tmp___5);
...
{ struct hfs_btree *tree ;
  ...
  if (fd->record + 1 < num_recs) {
    ...
    fd->bnode = new_node;
    fd->record -= num_recs;
    fd->keyoffset += 14 - data_start;
    fd->entryoffset += 14 - data_start;
  }
...
{ struct hfs_find_data fd ;
  ...
  entry_size = hfs_cat_build_thread(sb, & entry, tmp___2, (u32 )dir->i_ino, str);
...
{ struct super_block *sb ;
  ...
  entry_size = hfs_cat_build_thread(sb, & entry, tmp___3, (u32 )dst_dir->i_ino, dst_name);
  err = hfs_brec_find(& dst_fd);
  if (err != -2) {
    if (err == 0) {
      err = -17;
...
extern void inode_add_bytes(struct inode * , loff_t  ) ;
 static void set_buffer_mapped(struct buffer_head *bh ) 
{ 
...
{ int res ;
  ...
  if ((((struct hfs_inode_info *)__mptr___5 + 0xfffffffffffffed0UL)->flags & 4U) != 0U) {
    ...
    ((struct hfs_inode_info *)__mptr___2 + 0xfffffffffffffed0UL)->flags &= 4294967289U;
  } else {
    if (res != 0) {
      return;
    }
    ...
    ((struct hfs_inode_info *)__mptr___4 + 0xfffffffffffffed0UL)->flags &= 4294967293U;
  }
  return;
}
}
...
{ struct hfs_find_data fd ;
 ...
 static int __hfs_ext_read_extent(struct hfs_find_data *fd , struct hfs_extent *extent ,
...
{ int res ;
 ...
 static int __hfs_ext_cache_extent(struct hfs_find_data *fd , struct inode *inode ,
                                           u32 block ) 
{ int res ;
  struct inode  const  *__mptr ;
  struct inode  const  *__mptr___0 ;
  ...
  if (res == 0) {
    ...
    ((struct hfs_inode_info *)__mptr___7 + 0xfffffffffffffed0UL)->flags &= 4294967289U;
  }
  return (res);
}
}
...
{ struct hfs_find_data fd ;
  ...
  total_blocks /= ((struct hfs_sb_info *)sb->s_fs_info)->alloc_blksz;
  if (total_blocks == 0U) {
    return (0);
  }
  blocks = 0U;
...
{ struct super_block *sb ;
  ...
  if (create != 0) {
    ...
    (((struct hfs_inode_info *)__mptr___11 + 0xfffffffffffffed0UL)->fs_blocks) ++;
...
{ struct super_block *sb ;
  ...
  if ((int )((struct hfs_inode_info *)__mptr___19 + 0xfffffffffffffed0UL)->alloc_blocks == (int )((struct hfs_inode_info *)__mptr___20 + 0xfffffffffffffed0UL)->first_blocks) {
    ...
    if (res == 0) {
      ...
      ((struct hfs_inode_info *)__mptr___17 + 0xfffffffffffffed0UL)->flags |= 2U;
  ...
  ((struct hfs_inode_info *)__mptr___27 + 0xfffffffffffffed0UL)->flags |= 6U;
...
{ struct super_block *sb ;
  ...
  if ((int )blk_cnt > (int )start) {
    __mptr___12 = (struct inode  const  *)inode;
    ((struct hfs_inode_info *)__mptr___12 + 0xfffffffffffffed0UL)->flags |= 2U;
    goto ldv_22381;
  }
  alloc_cnt = start;
  __mptr___13 = (struct inode  const  *)inode;
  ...
  __mptr___15 = (struct inode  const  *)inode;
  ((struct hfs_inode_info *)__mptr___15 + 0xfffffffffffffed0UL)->flags &= 4294967289U;
  hfs_brec_remove(& fd);
  goto ldv_22396;
  ldv_22381: 
  hfs_find_exit(& fd);
...
extern ssize_t __blockdev_direct_IO(int  , struct kiocb * , struct inode * , struct block_device * ,
                                    ...
                                    int  ) ;
 static ssize_t blockdev_direct_IO(int rw , struct kiocb *iocb , struct inode *inode ,
...
{ struct super_block *sb ;
  ...
  (((struct hfs_sb_info *)sb->s_fs_info)->next_id) ++;
  ...
  if (((int )mode & 61440) == 16384) {
    inode->i_size = 2LL;
    (((struct hfs_sb_info *)sb->s_fs_info)->folder_count) ++;
    if (dir->i_ino == 2UL) {
  ...
  if (((int )mode & 61440) == 32768) {
    ...
    (((struct hfs_sb_info *)sb->s_fs_info)->file_count) ++;
    if (dir->i_ino == 2UL) {
...
{ struct hfs_iget_data *idata ;
  ...
  if ((unsigned long )idata->key != (unsigned long )((struct hfs_cat_key *)0)) {
    ...
    __mptr___4 = (struct inode  const  *)inode;
    ((struct hfs_inode_info *)__mptr___4 + 0xfffffffffffffed0UL)->flags |= 1U;
  }
  __mptr___5 = (struct inode  const  *)inode;
...
{ struct inode *inode ;
  ...
  if ((int )attr->ia_valid & 1) {
    ...
    if (((int )inode->i_mode & 61440) == 16384) {
      tmp___7 = ~ ((int )((short )hsb->s_dir_umask));
    } else {
      tmp___7 = ~ ((int )((short )hsb->s_file_umask));
    }
    attr->ia_mode = (umode_t )((int )((short )attr->ia_mode) & tmp___7);
  }
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_hfs_file_operations_file_operations == 0) {
    ...
    ldv_s_hfs_file_operations_file_operations ++;
  }
  goto ldv_26140;
  case 12: ;
...
{ int oldbit ;
 ...
 static void be32_add_cpu(__be32 *var , u32 val ) 
{ __u32 tmp ;
  __u32 tmp___0 ;
...
{ struct hfs_mdb *mdb ;
  ...
  if (tmp___10 != 0) {
    ...
    block >>= (int )sb->s_blocksize_bits + -9;
...
void ldv_mutex_lock_103(struct mutex *ldv_func_arg1 ) ;
 static unsigned long partial_name_hash(unsigned long c , unsigned long prevhash ) 
{ 
...
extern struct user_namespace init_user_ns ;
 static bool uid_valid(kuid_t uid ) 
{ bool tmp ;
  int tmp___0 ;
 ...
 static bool gid_valid(kgid_t gid ) 
{ bool tmp ;
  int tmp___0 ;
...
{ gid_t tmp ;
 ...
 static uid_t from_kuid_munged(struct user_namespace *to , kuid_t kuid ) 
{ uid_t uid ;
  uid_t tmp ;
 ...
 static gid_t from_kgid_munged(struct user_namespace *to , kgid_t kgid ) 
{ gid_t gid ;
  gid_t tmp ;
...
struct dentry_operations  const  hfs_dentry_operations ;
 static char const   *hfs_mdb_name(struct super_block *sb ) 
{ 
...
{ struct hfs_inode_info *i ;
  ...
  if ((unsigned long )i != (unsigned long )((struct hfs_inode_info *)0)) {
    tmp___0 = & i->vfs_inode;
  } else {
    tmp___0 = 0;
  }
...
static struct match_token  const  tokens[13U]  = 
  {      {0, "uid=%u"}, 
        ...
        {11, "iocharset=%s"}, 
        {12, 0}};
 static int match_fourchar(substring_t *arg , u32 *result ) 
{ size_t __len ;
  void *__ret ;
...
{ struct inode *inode ;
  ...
  if (diff != 0) {
    inode->i_ctime.tv_sec += (__kernel_time_t )diff;
    inode->i_atime.tv_sec += (__kernel_time_t )diff;
    inode->i_mtime.tv_sec += (__kernel_time_t )diff;
    __mptr___0 = (struct inode  const  *)inode;
    ((struct hfs_inode_info *)__mptr___0 + 0xfffffffffffffed0UL)->tz_secondswest += diff;
  }
  return (1);
}
}
