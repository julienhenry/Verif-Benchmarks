...
{ struct uio_pci_generic_dev *gdev ;
  ...
  {
  tmp___2 = (int )pci_enable_device(pdev);
  err = tmp___2;
  if (err) {
  ...
  *((struct pci_dev **)__cil_tmp38) = pdev;
  ...
  tmp___3 = (int )__uio_register_device(& __this_module, __cil_tmp41, __cil_tmp42);
  tmp___1 = tmp___3;
  if (tmp___1) {
    goto err_register;
  }
...
{ int tmp ;
  ...
  tmp___0 = (int )__pci_register_driver(& driver, & __this_module, "uio_pci_generic");
  tmp = tmp___0;
  return (tmp);
}
}
