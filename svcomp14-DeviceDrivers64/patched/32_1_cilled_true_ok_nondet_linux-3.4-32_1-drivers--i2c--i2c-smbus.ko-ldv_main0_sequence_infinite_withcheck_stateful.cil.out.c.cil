...
{ struct i2c_smbus_alert *alert ;
  ...
  while (1) {
    ...
    __cil_tmp19 = (unsigned long )(& data) + 2UL;
    ...
    while (1) {
      ...
      while (1) {
        ...
        if (tmp___7) {
          ...
          __cil_tmp47 = (unsigned long )(& data) + 2UL;
...
{ struct i2c_smbus_alert_setup *setup ;
  ...
  *((struct i2c_client **)__cil_tmp33) = ara;
  ...
  if (__cil_tmp36 > 0) {
    ...
    tmp = (int )devm_request_irq(__cil_tmp39, __cil_tmp43, & smbalert_irq, 0UL, "smbus_alert",
                                 __cil_tmp44);
    res = tmp;
    if (res) {
...
static int i2c_smbus_init(void)  __attribute__((__section__(".init.text"),
