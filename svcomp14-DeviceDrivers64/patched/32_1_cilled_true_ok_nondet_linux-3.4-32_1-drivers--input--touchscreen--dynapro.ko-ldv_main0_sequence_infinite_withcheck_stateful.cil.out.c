...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& dynapro_drv, & __this_module, "dynapro");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_dynapro_drv_serio_driver == 0) {
          ...
          ldv_s_dynapro_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
