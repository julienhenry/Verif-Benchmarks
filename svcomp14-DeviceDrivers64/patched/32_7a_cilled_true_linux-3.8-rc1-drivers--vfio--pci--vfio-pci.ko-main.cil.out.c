...
{ void *tmp ;
 ...
 static void p_setb(struct perm_bits *p , int off , u8 virt , u8 write ) 
{ 
 ...
 static void p_setw(struct perm_bits *p , int off , u16 virt , u16 write ) 
{ 
 ...
 static void p_setd(struct perm_bits *p , int off , u32 virt , u32 write ) 
{ 
...
{ struct pci_dev *pdev ;
  ...
  if ((int )hidden) {
    *((__le32 *)vdev->vconfig + (unsigned long )epos) &= 4290772992U;
  } else {
    ecaps ++;
  }
