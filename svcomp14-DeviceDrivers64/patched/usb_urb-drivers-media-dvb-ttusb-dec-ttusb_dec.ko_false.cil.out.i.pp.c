...
{ int result ;
  ...
  tmp___8 = (int )mutex_lock_interruptible_nested(& dec->usb_mutex, 0U);
  tmp = tmp___8;
  result = tmp;
  if (result) {
    kfree((void const   *)b);
...
{ int i ;
  ...
  tmp___8 = (int )mutex_lock_interruptible_nested(& dec->iso_mutex, 0U);
  tmp = tmp___8;
  tmp___7 = tmp;
  if (tmp___7) {
    return;
    ...
    if (tmp___8 == 1) {
      ...
      if (0) {
        ...
        if (ldv_s_ttusb_dec_driver_usb_driver == 0) {
          ...
          ldv_s_ttusb_dec_driver_usb_driver ++;
        }
        goto switch_break;
        case_1: 
