...
{ u8 get_tuner_1[8U] ;
  ...
  if ((unsigned int )state->board_info[0] == 188U) {
    if ((unsigned int )state->dst_type != 3U) {
      ...
      state->type_flags |= 1024U;
    }
    if ((unsigned int )state->board_info[1] == 1U) {
      state->dst_hw_cap |= 2048U;
      if (verbose != 0U && verbose != 0U) {
...
{ struct dst_state *state ;
  ...
  if ((unsigned int )state->dst_type == 0U) {
    __len = 10UL;
    if (__len > 63UL) {
      if ((state->type_flags & 4096U) != 0U) {
        tmp = & sat_tuna_188;
      } else {
        tmp = & sat_tuna_204;
      }
      __ret = __memcpy((void *)(& state->tx_tuna), (void const   *)tmp, __len);
    } else {
      if ((state->type_flags & 4096U) != 0U) {
        tmp___0 = & sat_tuna_188;
      } else {
        tmp___0 = & sat_tuna_204;
      }
      __ret = __builtin_memcpy((void *)(& state->tx_tuna), (void const   *)tmp___0,
                               __len);
    }
  } else
  if ((unsigned int )state->dst_type == 1U) {
    ...
    if (__len___0 > 63UL) {
      if ((state->type_flags & 4096U) != 0U) {
        tmp___1 = & ter_tuna_188;
      } else {
        tmp___1 = & ter_tuna_204;
      }
      __ret___0 = __memcpy((void *)(& state->tx_tuna), (void const   *)tmp___1, __len___0);
    } else {
      if ((state->type_flags & 4096U) != 0U) {
        tmp___2 = & ter_tuna_188;
      } else {
        tmp___2 = & ter_tuna_204;
      }
      __ret___0 = __builtin_memcpy((void *)(& state->tx_tuna), (void const   *)tmp___2,
                                   __len___0);
    }
  } else
  if ((unsigned int )state->dst_type == 2U) {
    ...
    if (__len___1 > 63UL) {
      if ((state->type_flags & 4096U) != 0U) {
        tmp___3 = & cab_tuna_188;
      } else {
        tmp___3 = & cab_tuna_204;
      }
      __ret___1 = __memcpy((void *)(& state->tx_tuna), (void const   *)tmp___3, __len___1);
    } else {
      if ((state->type_flags & 4096U) != 0U) {
        tmp___4 = & cab_tuna_188;
      } else {
        tmp___4 = & cab_tuna_204;
      }
      __ret___1 = __builtin_memcpy((void *)(& state->tx_tuna), (void const   *)tmp___4,
                                   __len___1);
    }
  } else
  if ((unsigned int )state->dst_type == 3U) {
...
static struct dvb_frontend_ops dst_dvbt_ops  = 
     ...
     166667U, 0U, 0U, 0U, 0U, 0U, 784896}, {3U, (unsigned char)0, (unsigned char)0,
                                            (unsigned char)0, (unsigned char)0, (unsigned char)0,
                                            (unsigned char)0, (unsigned char)0}, & dst_release,
    0, & dst_init, 0, 0, & dst_tune_frontend, (enum dvbfe_algo (*)(struct dvb_frontend * ))(& dst_get_tuning_algo),
...
static struct dvb_frontend_ops dst_dvbs_ops  = 
     ...
     1000U, 29500U, 1000000U, 45000000U, 0U, 0U, 1536}, {5U, (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0}, & dst_release,
    0, & dst_init, 0, 0, & dst_tune_frontend, (enum dvbfe_algo (*)(struct dvb_frontend * ))(& dst_get_tuning_algo),
    & dst_set_frontend, 0, & dst_get_frontend, & dst_read_status, 0, & dst_read_signal_strength,
...
static struct dvb_frontend_ops dst_dvbc_ops  = 
     ...
     62500U, 0U, 1000000U, 45000000U, 0U, 0U, 129536}, {1U, (unsigned char)0, (unsigned char)0,
                                                        (unsigned char)0, (unsigned char)0,
                                                        (unsigned char)0, (unsigned char)0,
                                                        (unsigned char)0}, & dst_release,
    0, & dst_init, 0, 0, & dst_tune_frontend, (enum dvbfe_algo (*)(struct dvb_frontend * ))(& dst_get_tuning_algo),
...
static struct dvb_frontend_ops dst_atsc_ops  = 
     ...
     62500U, 0U, 1000000U, 45000000U, 0U, 0U, 2204160}, {11U, (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0, (unsigned char)0,
                                                         (unsigned char)0}, & dst_release,
    0, & dst_init, 0, 0, & dst_tune_frontend, (enum dvbfe_algo (*)(struct dvb_frontend * ))(& dst_get_tuning_algo),
