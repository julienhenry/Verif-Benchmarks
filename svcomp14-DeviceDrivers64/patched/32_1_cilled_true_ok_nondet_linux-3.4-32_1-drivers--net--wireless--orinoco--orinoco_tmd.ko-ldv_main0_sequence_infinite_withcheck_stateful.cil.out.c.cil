...
{ int err ;
  ...
  tmp___0 = (int )pci_request_regions(pdev, "orinoco_tmd");
  err = tmp___0;
  if (err) {
  ...
  *((void **)card) = bridge_io;
  ...
  tmp___1 = (int )request_irq(__cil_tmp20, & orinoco_interrupt, 128UL, "orinoco_tmd",
                              __cil_tmp21);
  err = tmp___1;
  if (err) {
...
{ struct orinoco_private *priv ;
  ...
  __cil_tmp12 = __cil_tmp11 + 1080UL;
...
{ int tmp___7 ;
  ...
  printk("<7>%s\n", __cil_tmp4);
  tmp = (int )__pci_register_driver(& orinoco_tmd_driver, & __this_module, "orinoco_tmd");
  tmp___7 = tmp;
  return (tmp___7);
}
}
