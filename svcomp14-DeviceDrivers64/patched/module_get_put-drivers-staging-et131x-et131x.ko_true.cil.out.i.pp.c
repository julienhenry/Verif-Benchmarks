...
{ u32 Carry1 ;
  ...
  if ((Carry1 & 16384U) != 0U) {
    etdev->Stats.code_violations += 65536U;
  }
  if ((Carry1 & 256U) != 0U) {
    etdev->Stats.alignment_err += 4096U;
  }
  if ((Carry1 & 128U) != 0U) {
    etdev->Stats.length_err += 65536U;
  }
  if ((Carry1 & 4U) != 0U) {
    etdev->Stats.other_errors += 65536U;
  }
  if ((Carry1 & 64U) != 0U) {
    etdev->Stats.crc_err += 65536U;
  }
  if ((Carry1 & 8U) != 0U) {
    etdev->Stats.rx_ov_flow += 65536U;
  }
  if ((int )Carry1 & 1) {
    etdev->Stats.norcvbuf += 65536U;
  }
  if ((Carry2 & 65536U) != 0U) {
    etdev->Stats.max_pkt_error += 4096U;
  }
  if ((Carry2 & 32768U) != 0U) {
    etdev->Stats.tx_uflo += 4096U;
  }
  if ((Carry2 & 64U) != 0U) {
    etdev->Stats.first_collision += 4096U;
  }
  if ((Carry2 & 256U) != 0U) {
    etdev->Stats.tx_deferred += 4096U;
  }
  if ((Carry2 & 32U) != 0U) {
    etdev->Stats.excessive_collisions += 4096U;
  }
  if ((Carry2 & 16U) != 0U) {
    etdev->Stats.late_collisions += 4096U;
  }
  if ((Carry2 & 4U) != 0U) {
    etdev->Stats.collisions += 4096U;
  }
  return;
}
}
...
{ u32 i ;
  ...
  et131x_align_allocated_memory(adapter, & rx_ring->Fbr1Realpa, & rx_ring->Fbr1offset,
                                4095ULL);
  rx_ring->pFbr1RingVa += (unsigned long )rx_ring->Fbr1offset;
  ...
  et131x_align_allocated_memory(adapter, & rx_ring->Fbr0Realpa, & rx_ring->Fbr0offset,
                                4095ULL);
  rx_ring->pFbr0RingVa += (unsigned long )rx_ring->Fbr0offset;
  i = 0U;
  goto ldv_35677;
  ldv_35676: ;
  ...
  (rx_ring->fbr[1])->buffer2[index] = (rx_ring->fbr[1])->virt[index] + 1152921504606846972UL;
  j ++;
  ldv_35674: ;
  if (j <= 31U) {
    goto ldv_35673;
  ...
  (rx_ring->fbr[0])->buffer2[index___0] = (rx_ring->fbr[0])->virt[index___0] + 1152921504606846972UL;
  j ++;
  ldv_35683: ;
  if (j <= 31U) {
    goto ldv_35682;
...
{ struct rx_ring *rx_local ;
  ...
  if (len != 0U) {
    ...
    etdev->net_stats.rx_bytes += (unsigned long )rfd->len;
...
{ void *tmp ;
  ...
  {
  if (size != 0UL) {
    if (1152921504606846975UL / size < n) {
      return ((void *)0);
    }
  }
...
{ u32 i ;
  ...
  if ((etdev->tx_ring.send_idx & 1023U) == 0U) {
    etdev->tx_ring.send_idx &= 4294966272U;
    etdev->tx_ring.send_idx ^= 1024U;
  } else
...
{ struct et131x_adapter *etdev ;
  ...
  etdev = (struct et131x_adapter *)__mptr + 1152921504606846960UL;
...
{ struct et131x_adapter *adapter ;
  ...
  PacketFilter &= 4294967293U;
  if ((netdev->flags & 256U) != 0U) {
    adapter->PacketFilter |= 8U;
  } else {
    adapter->PacketFilter &= 4294967287U;
  }
  if ((netdev->flags & 512U) != 0U) {
    adapter->PacketFilter |= 16U;
  }
  if (netdev->mc.count > 128) {
    adapter->PacketFilter |= 16U;
  }
  if (netdev->mc.count <= 0) {
    adapter->PacketFilter &= 4294967279U;
    adapter->PacketFilter &= 4294967293U;
  } else {
    adapter->PacketFilter |= 2U;
  }
  i = 0;
