...
{ struct aic7xxx_scb *scbp ;
  ...
  if ((int )(p->scb_data)->numscbs < (int )(p->scb_data)->maxscbs) {
    ...
    scb_count = (unsigned long )tmp___2;
...
{ struct aic7xxx_scb *scb ;
  ...
  if (((unsigned int )scb->flags & 8U) == 0U) {
    if ((unsigned int )lastphase == 64U) {
      tmp___84 = (char *)"Data-In";
    } else {
      tmp___84 = (char *)"Data-Out";
    }
    printk("\f(scsi%d:%d:%d:%d) Data overrun detected in %s phase, tag %d;\n", p->host_no,
           ((int )(scb->hscb)->target_channel_lun >> 3) & 1, ((int )(scb->hscb)->target_channel_lun >> 4) & 15,
           (int )(scb->hscb)->target_channel_lun & 7, tmp___84, (int )(scb->hscb)->tag);
    tmp___40 = aic_inb(p, 54L);
    if (((int )tmp___40 & 16) != 0) {
      tmp___85 = (char *)"Have";
    } else {
      tmp___85 = (char *)"Haven\'t";
    }
    printk("\f  %s seen Data Phase. Length=%d, NumSGs=%d.\n", tmp___85, scb->sg_length,
           (int )scb->sg_count);
  ...
  if ((unsigned int )resid_sgcnt != 0U) {
    tmp___86 = resid_sgcnt;
  } else {
    tmp___86 = 1U;
  }
  index = (unsigned int )scb->sg_count - tmp___86;
  ...
  if ((unsigned int )tmp___57 == 1U) {
    tmp___87 = 2;
  } else {
    tmp___87 = 0;
  }
  aic_outb(p, (int )((unsigned char )((int )((signed char )((int )tmp___57 << 2)) | tmp___87)),
           252L);
    ...
    if (((unsigned int )scb->flags & 1536U) != 1536U) {
      if (((int )aic_dev->flags & 16) == 0) {
        ...
        if ((unsigned int )p->user[(int )tindex].offset != 0U) {
          ...
          aic_dev->goal.period = (unsigned char )tmp___11;
          if (((unsigned int )p->features & 2U) != 0U) {
            aic_dev->goal.offset = 127U;
          } else {
            aic_dev->goal.offset = 15U;
      ...
      if (__max1___0 > __max2___0) {
        new_period = __max1___0;
      } else {
        new_period = __max2___0;
      }
      __min1 = offset;
      ...
      if (((int )aic_dev->flags & 16) == 0) {
        ...
        if ((unsigned int )p->user[(int )tindex].offset != 0U) {
          ...
          if ((int )__max1___1 > (int )__max2___1) {
            tmp___12 = (int )__max1___1;
          } else {
            tmp___12 = (int )__max2___1;
          }
          aic_dev->goal.period = (unsigned char )tmp___12;
          if (((unsigned int )p->features & 2U) != 0U) {
            aic_dev->goal.offset = 127U;
          } else
          if ((unsigned int )aic_dev->goal.width != 0U) {
    ...
    if ((unsigned int )lastphase == 160U) {
      ...
      if ((unsigned int )message == 6U || (unsigned int )message == 13U) {
        ...
        if ((unsigned int )message != 6U) {
          tmp___26 = (int )(scb->hscb)->tag;
        } else {
          tmp___26 = 255;
        }
        aic7xxx_reset_device(p, (int )target, channel___0, -1, tmp___26);
        aic7xxx_run_done_queue(p, 1);
        scb = 0;
        printerror = 0;
      } else
  ...
  if (((int )aic_dev->flags & 16) == 0) {
    ...
    if ((unsigned int )*((unsigned char *)sdpnt + 293UL) != 0U && (unsigned int )p->user[(int )tindex].offset != 0U) {
      ...
      if (((unsigned int )*((unsigned char *)sdpnt + 293UL) != 0U && (unsigned int )p->user[(int )tindex].period <= 9U) && (unsigned int )p->user[(int )tindex].options != 0U) {
        ...
        aic_dev->goal.period = (unsigned char )tmp___6;
        aic_dev->goal.options = 0U;
      }
    } else {
      tmp___5 = 0U;
  ...
  if (tmp___0 != 0) {
    ...
    if (((unsigned int )p->features & 1024U) != 0U) {
      ...
      if ((int )p->adapter_control & 1) {
        ...
        printk("\016(scsi%d) Cables present (Int-50 %s, Int-68 %s, Ext-68 %s)\n",
               p->host_no, (char *)"Don\'t Care", tmp___2, tmp___1);
        if ((aic7xxx_verbose & 16) != 0) {
          if (eprom_present != 0) {
            tmp___3 = (char *)"is";
          } else {
    ...
    if ((int )p->adapter_control & 1) {
      ...
      if ((unsigned int )max_target > 8U) {
        ...
        printk("\016(scsi%d) Cables present (Int-50 %s, Int-68 %s, Ext-68 %s)\n",
               p->host_no, tmp___6, tmp___5, tmp___4);
      } else {
        if (external_present != 0) {
          tmp___7 = (char *)"YES";
        } else {
...
{ int have_seeprom ;
        ...
        if ((unsigned int )tmp___11 != 0U) {
          ...
          if (((int )tmp___10 & -129) != 0) {
            ...
            if ((int )p->features & 1) {
              ...
              sc->device_flags[i] = (unsigned short )((int )((short )sc->device_flags[i]) | tmp___21);
            }
          }
        }
      }
  ...
  if (((unsigned int )p->features & 512U) != 0U) {
    ...
    if (((int )sc->device_flags[i] & 7) <= 2) {
      ...
      scsirate = (unsigned char )(((int )((signed char )sc->device_flags[i]) & 7) | tmp___22);
      p->user[i].options = 0U;
    }
  ...
  if (((unsigned int )p->features & 2U) != 0U) {
    ...
    scsirate = (unsigned char )(((int )((signed char )sc->device_flags[i]) & 7) | tmp___23);
    p->user[i].options = 0U;
    ...
    if ((int )p->features & 1) {
      ...
      tmp___17 = aic7xxx_find_period(p, (unsigned int )scsirate, tmp___24);
...
{ struct aic7xxx_host *p ;
  ...
  if (((long )p->flags & 16777216L) == 0L) {
    if (((long )p->flags & 4L) != 0L) {
      tmp___56 = (char *)"SEEPROM not found, using defaults.";
    } else {
      tmp___56 = (char *)"SEEPROM not found, using leftover BIOS values.";
    }
    tmp___57 = tmp___56;
  } else {
    tmp___57 = (char *)"SEEPROM found and used.";
  }
  tmp___16 = sprintf(aic7xxx_buffer + (unsigned long )size, " Adapter SEEPROM Config: %s\n",
                     tmp___57);
  size = tmp___16 + size;
  if (((long )p->flags & 8388608L) != 0L) {
    tmp___58 = (char *)"Enabled";
  } else {
    tmp___58 = (char *)"Disabled";
  }
  ...
  if (((unsigned int )p->chip & 512U) != 0U) {
    if (((int )p->pause & 8) != 0) {
      tmp___59 = (char *)"(Level Sensitive)";
    } else {
      tmp___59 = (char *)"(Edge Triggered)";
    }
  ...
  if ((unsigned int )aic_dev->cur.offset != 0U) {
    tmp___61 = (char *)"Sync transfers at ";
  } else {
    tmp___61 = (char *)"Async transfers.\n";
  }
  if ((unsigned int )aic_dev->cur.width == 1U) {
    tmp___62 = (char *)"Wide";
  } else {
    tmp___62 = (char *)"Narrow";
  }
