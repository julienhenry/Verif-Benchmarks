...
static struct ida bat_ida  =    {{(struct idr_layer *)0,
     (struct idr_layer *)0, 0, 0, {{{{{0U}}, 3735899821U, 4294967295U, (void *)0xffffffffffffffffUL,
                                     {(struct lock_class_key *)0, {(struct lock_class *)0,
                                                                   (struct lock_class *)0},
                                      "bat_ida.lock", 0, 0UL}}}}}, (struct ida_bitmap *)0};
