...
{ int ret ;
  ...
  tmp___0 = (int )hid_hw_start(hdev, cmask);
  ret = tmp___0;
  if (ret) {
    __cil_tmp16 = (unsigned long )hdev;
    __cil_tmp17 = __cil_tmp16 + 6328UL;
...
static int samsung_init(void)  __attribute__((__section__(".init.text"),
...
{ int tmp___7 ;
  ...
  {
  tmp = (int )__hid_register_driver(& samsung_driver, & __this_module, "hid_samsung");
  tmp___7 = tmp;
  return (tmp___7);
}
}
