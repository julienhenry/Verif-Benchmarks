...
{ unsigned char *tmp ;
 ...
 static struct sk_buff *skb_unshare(struct sk_buff *skb , gfp_t pri ) 
{ struct sk_buff *nskb ;
  struct sk_buff *tmp ;
  int tmp___0 ;
...
extern void remove_proc_entry(char const   * , struct proc_dir_entry * ) ;
 static struct proc_dir_entry *create_proc_read_entry(char const   *name ,
...
extern void wireless_send_event(struct net_device * , unsigned int  , union iwreq_data * ,
                                char const   * ) ;
 static int iwe_stream_lcp_len(struct iw_request_info *info ) 
{ 
 ...
 static int iwe_stream_point_len(struct iw_request_info *info ) 
{ 
 ...
 static int iwe_stream_event_len_adjust(struct iw_request_info *info , int event_len ) 
{ 
 ...
 static char *iwe_stream_add_event(struct iw_request_info *info , char *stream ,
...
{ int lcp_len ;
  ...
  if (tmp___0 != 0L) {
    ...
    __ret___0 = __builtin_memcpy((void *)stream + (unsigned long )lcp_len, (void const   *)(& iwe->u),
                                 __len___0);
    stream += (unsigned long )event_len;
  }
  return (stream);
}
}
 static char *iwe_stream_add_point(struct iw_request_info *info , char *stream ,
...
{ 
 ...
 static int ieee80211_is_assoc_resp(__le16 fc ) 
{ 
 ...
 static int ieee80211_is_reassoc_resp(__le16 fc ) 
{ 
...
{ char *p ;
  ...
  if (sta->ap != 0) {
    if (sta->u.ap.channel >= 0) {
      ...
      p += (unsigned long )tmp___14;
    }
    tmp___15 = sprintf(p, "ssid=");
    p += (unsigned long )tmp___15;
    i = 0;
    goto ldv_40262;
    ldv_40261: ;
    if ((unsigned int )sta->u.ap.ssid[i] > 31U && (unsigned int )sta->u.ap.ssid[i] <= 126U) {
...
extern int iw_handler_get_thrspy(struct net_device * , struct iw_request_info * ,
                                 union iwreq_data * , char * ) ;
 static char *iwe_stream_add_value(struct iw_request_info *info , char *event ,
...
{ int i ;
 ...
 static int prism2_translate_scan(local_info_t *local , struct iw_request_info *info ,
...
{ struct hfa384x_hostscan_result *scan ;
 ...
 static int prism2_ioctl_giwscan_sta(struct net_device *dev , struct iw_request_info *info ,
                                             struct iw_point *data , char *extra ) 
{ struct hostap_interface *iface ;
  local_info_t *local ;
  int res ;
...
{ __le16 tmp ;
 ...
 static int ieee80211_is_cts(__le16 fc ) 
{ 
