...
{ acpi_handle handle ;
  ...
  *((u32 *)__cil_tmp20) = (u32 )__cil_tmp22;
  ...
  tmp___10 = (int )pci_request_region(dev, 0, __cil_tmp26);
  tmp___8 = tmp___10;
  if (tmp___8) {
    goto exit_disable;
  }
...
static int ioapic_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
...
{ int tmp___7 ;
  ...
  {
  tmp = (int )__pci_register_driver(& ioapic_driver, & __this_module, "ioapic");
  tmp___7 = tmp;
  return (tmp___7);
}
}
