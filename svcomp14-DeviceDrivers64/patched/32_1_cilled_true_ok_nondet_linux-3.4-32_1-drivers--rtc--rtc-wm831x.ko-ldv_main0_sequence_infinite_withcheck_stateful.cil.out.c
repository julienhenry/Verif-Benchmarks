...
{ struct wm831x *wm831x ;
  ...
  *((struct rtc_device **)__cil_tmp33) = rtc_device_register("wm831x", __cil_tmp36,
  ...
  tmp___4 = (long )IS_ERR(__cil_tmp40);
  tmp___3 = tmp___4;
  if (tmp___3) {
    ...
    tmp___5 = (long )PTR_ERR(__cil_tmp44);
    tmp___2 = tmp___5;
    ret = (int )tmp___2;
    goto err;
  }
  ...
  tmp___6 = (int )request_threaded_irq(__cil_tmp45, __cil_tmp47, & wm831x_alm_irq,
                                       1UL, "RTC alarm", __cil_tmp48);
  ret = tmp___6;
  if (ret != 0) {
