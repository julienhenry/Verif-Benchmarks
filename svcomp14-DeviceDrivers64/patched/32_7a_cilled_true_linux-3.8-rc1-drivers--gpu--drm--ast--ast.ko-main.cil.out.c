...
extern void drm_gem_object_free(struct kref * ) ;
 static void drm_gem_object_unreference(struct drm_gem_object *obj ) 
{ 
 ...
 static void drm_gem_object_unreference_unlocked(struct drm_gem_object *obj ) 
{ struct drm_device *dev ;
...
extern void ttm_bo_unref(struct ttm_buffer_object ** ) ;
 static u32 ast_read32(struct ast_private *ast , u32 reg ) 
{ u32 val ;
 ...
 static u8 ast_io_read8(struct ast_private *ast , u32 reg ) 
{ u8 val ;
  unsigned int tmp ;
 ...
 static void ast_write32(struct ast_private *ast , u32 reg , u32 val ) 
{ 
 ...
 static void ast_io_write8(struct ast_private *ast , u32 reg , u8 val ) 
{ 
 ...
 static void ast_io_write16(struct ast_private *ast , u32 reg , u16 val ) 
{ 
 ...
 static void ast_set_index_reg(struct ast_private *ast , uint32_t base , uint8_t index ,
                                       uint8_t val ) 
{ 
...
{ struct ast_bo *ast_bo___0 ;
 ...
 static u64 ast_bo_mmap_offset(struct ast_bo *bo ) 
{ 
...
extern void drm_sysfs_connector_remove(struct drm_connector * ) ;
 static void drm_gem_object_unreference_unlocked___0(struct drm_gem_object *obj ) 
{ struct drm_device *dev ;
...
extern void drm_helper_connector_dpms(struct drm_connector * , int  ) ;
 static void drm_crtc_helper_add(struct drm_crtc *crtc , struct drm_crtc_helper_funcs  const  *funcs ) 
{ 
 ...
 static void drm_encoder_helper_add(struct drm_encoder *encoder , struct drm_encoder_helper_funcs  const  *funcs ) 
{ 
 ...
 static void drm_connector_helper_add(struct drm_connector *connector , struct drm_connector_helper_funcs  const  *funcs ) 
{ 
...
static int ast_cursor_move(struct drm_crtc *crtc , int x , int y ) ;
 static void ast_load_palette_index(struct ast_private *ast , u8 index , u8 red ,
                                            u8 green , u8 blue ) 
{ 
...
{ union __anonunion_srcdata32_206 srcdata32[2U] ;
  ...
  ldv_37681: 
  dstxor += (unsigned long )last_alpha_dst_delta;
  j ++;
  ldv_37683: ;
  if (j < height) {
    goto ldv_37682;
...
{ struct ast_private *ast ;
  ...
  dst += (unsigned long )(ast->next_cursor * 8224);
...
extern void drm_fb_get_bpp_depth(uint32_t  , unsigned int * , int * ) ;
 static void drm_gem_object_unreference_unlocked___1(struct drm_gem_object *obj ) 
{ struct drm_device *dev ;
...
extern struct ttm_mem_type_manager_func  const  ttm_bo_manager_func ;
 static struct ast_bo *ast_bo(struct ttm_buffer_object *bo ) 
...
extern void ttm_pool_unpopulate(struct ttm_tt * ) ;
 static struct ast_private *ast_bdev(struct ttm_bo_device *bd ) 
...
{ struct ast_private *ast ;
 ...
 static u64 ast_bo_gpu_offset(struct ast_bo *bo ) 
{ 
...
{ struct drm_file *file_priv ;
  ...
  {
  tmp___0 = ldv__builtin_expect((unsigned long long )vma->vm_pgoff <= 1048575ULL,
                                0L);
  if (tmp___0 != 0L) {
...
{ struct ast_private *ast ;
 ...
 static u32 mindwm(struct ast_private *ast , u32 r ) 
{ u32 tmp ;
 ...
 static void moutdwm(struct ast_private *ast , u32 r , u32 v ) 
{ 
...
{ u32 trap ;
  ...
  goto ldv_37446;
  case 16777216: 
  param->dram_config |= 4U;
  goto ldv_37446;
  case 33554432: 
  param->dram_config |= 8U;
  goto ldv_37446;
  case 67108864: 
  param->dram_config |= 12U;
  goto ldv_37446;
  }
  ldv_37446: ;
  return;
