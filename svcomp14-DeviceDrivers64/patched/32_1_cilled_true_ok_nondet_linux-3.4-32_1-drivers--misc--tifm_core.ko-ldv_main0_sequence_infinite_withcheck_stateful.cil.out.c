...
extern int add_uevent_var(struct kobj_uevent_env *env , char const   *format  , ...) ;
...
static struct idr tifm_adapter_idr  =    {(struct idr_layer *)((void *)0), (struct idr_layer *)((void *)0), 0, 0, {{{{{(__ticketpair_t )0}},
                                                                               ...
                                                                               4294967295U,
                                                                               (void *)-1L}}}};
static spinlock_t tifm_adapter_lock  =    {{{{{(__ticketpair_t )0}},
      3735899821U, 4294967295U, (void *)-1L}}};
...
{ char const   *card_type_name[3][3] ;
  ...
  *((char const   **)__cil_tmp39) = "sd";
  ...
  __cil_tmp48 = (unsigned long )__cil_tmp47 * 8UL;
  __cil_tmp49 = (unsigned long )nt * 24UL;
...
{ int rc ;
  ...
  tmp___0 = (int )device_add(__cil_tmp17);
  rc = tmp___0;
  if (rc) {
    spin_lock(& tifm_adapter_lock);
...
{ unsigned int cnt ;
  ...
  while (1) {
    ...
    __cil_tmp6 = (unsigned long )cnt * 8UL;
    __cil_tmp7 = 872UL + __cil_tmp6;
    __cil_tmp8 = (unsigned long )fm;
    __cil_tmp9 = __cil_tmp8 + __cil_tmp7;
    if (*((struct tifm_dev **)__cil_tmp9)) {
      __cil_tmp10 = (unsigned long )cnt * 8UL;
      __cil_tmp11 = 872UL + __cil_tmp10;
      __cil_tmp12 = (unsigned long )fm;
      __cil_tmp13 = __cil_tmp12 + __cil_tmp11;
...
{ int tmp ;
  ...
  *((struct bus_type **)__cil_tmp5) = & tifm_bus_type;
  ...
  tmp___0 = (int )driver_register(__cil_tmp8);
  tmp = tmp___0;
  return (tmp);
}
}
...
{ int rc ;
  ...
  tmp___1 = (int )__bus_register(& tifm_bus_type, & __key___4);
  tmp = tmp___1;
  rc = tmp;
  if (rc) {
    goto err_out_wq;
  }
  tmp___2 = (int )__class_register(& tifm_adapter_class, & __key___5);
  tmp___0 = tmp___2;
  rc = tmp___0;
  if (! rc) {
    return (0);
