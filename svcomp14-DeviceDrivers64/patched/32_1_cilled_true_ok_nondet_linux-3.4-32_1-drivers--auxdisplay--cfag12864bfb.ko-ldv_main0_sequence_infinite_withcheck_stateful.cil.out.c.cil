...
{ int ret ;
  ...
  *((struct fb_var_screeninfo *)__cil_tmp19) = cfag12864bfb_var;
  ...
  __cil_tmp21 = __cil_tmp20 + 1136UL;
  *((void **)__cil_tmp21) = (void *)0;
  __cil_tmp22 = (unsigned long )info;
  __cil_tmp23 = __cil_tmp22 + 1160UL;
...
{ int ret ;
  ...
  if (! tmp___7) {
    printk("<3>cfag12864bfb: ERROR: __VERIFIER_error(); cfag12864b is not initialized\n");
    goto none;
  }
  tmp___8 = cfag12864b_enable();
  if (tmp___8) {
    printk("<3>cfag12864bfb: ERROR: __VERIFIER_error(); can\'t enable cfag12864b refreshing (being used)\n");
    return (-19);
  }
