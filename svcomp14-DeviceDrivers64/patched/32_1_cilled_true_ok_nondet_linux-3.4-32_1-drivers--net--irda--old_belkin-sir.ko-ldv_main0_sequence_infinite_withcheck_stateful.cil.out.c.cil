...
static int old_belkin_sir_init(void)  __attribute__((__section__(".init.text"),
    ...
    if (tmp___8 == 3) {
      ...
      if (0) {
        ...
        if (ldv_s_old_belkin_dongle_driver == 0) {
          ...
          ldv_s_old_belkin_dongle_driver ++;
        }
        goto switch_break;
        case_1: 
