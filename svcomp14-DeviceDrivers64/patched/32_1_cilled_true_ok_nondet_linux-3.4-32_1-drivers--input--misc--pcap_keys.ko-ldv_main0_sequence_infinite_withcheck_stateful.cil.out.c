...
{ int err ;
  ...
  *((struct device **)__cil_tmp22) = (struct device *)__cil_tmp24;
  ...
  tmp___4 = (int )input_register_device(input_dev);
  err = tmp___4;
  if (err) {
    goto fail_allocate;
  }
  ...
  tmp___5 = (int )request_irq(__cil_tmp44, & pcap_keys_handler, 0UL, "Power key",
                              __cil_tmp45);
  err = tmp___5;
  if (err) {
    goto fail_register;
  ...
  tmp___6 = (int )request_irq(__cil_tmp47, & pcap_keys_handler, 0UL, "Headphone button",
                              __cil_tmp48);
  err = tmp___6;
  if (err) {
    goto fail_pwrkey;
