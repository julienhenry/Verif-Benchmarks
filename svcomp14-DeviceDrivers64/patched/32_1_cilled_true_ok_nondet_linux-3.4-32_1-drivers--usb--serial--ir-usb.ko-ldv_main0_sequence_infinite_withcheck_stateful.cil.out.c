...
{ int retval ;
  ...
  if (*__cil_tmp2) {
    __cil_tmp3 = (unsigned long )(& ir_device) + 200UL;
    __cil_tmp4 = & buffer_size;
    __cil_tmp5 = *__cil_tmp4;
    *((size_t *)__cil_tmp3) = (size_t )__cil_tmp5;
    __cil_tmp6 = (unsigned long )(& ir_device) + 208UL;
