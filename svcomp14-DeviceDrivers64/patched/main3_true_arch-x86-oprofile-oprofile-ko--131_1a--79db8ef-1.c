...
struct oprofile_operations {
   ...
   int (*sync_start)(void) ;
   int (*sync_stop)(void) ;
   void (*backtrace)(struct pt_regs * , unsigned int  ) ;
...
struct op_x86_model_spec {
   ...
   int (*fill_in_addresses)(struct op_msrs * ) ;
   void (*setup_ctrs)(struct op_x86_model_spec  const  * , struct op_msrs  const  * ) ;
   void (*cpu_down)(void) ;
   int (*check_ctrs)(struct pt_regs * , struct op_msrs  const  * ) ;
   void (*start)(struct op_msrs  const  * ) ;
   void (*stop)(struct op_msrs  const  * ) ;
   void (*shutdown)(struct op_msrs  const  * ) ;
   void (*switch_ctrl)(struct op_x86_model_spec  const  * , struct op_msrs  const  * ) ;
};
...
{ int err ;
  ...
  if ((unsigned long )oprofile_ops.backtrace == (unsigned long )((void (*)(struct pt_regs * ,
                                                                           unsigned int  ))0)) {
    err = -22;
    goto out;
  }
...
void oprofile_add_sample(struct pt_regs *regs , unsigned long event ) ;
void oprofile_add_ext_sample(unsigned long pc , struct pt_regs *regs , unsigned long event ,
                             int is_kernel ) ;
void oprofile_add_pc(unsigned long pc , int is_kernel , unsigned long event ) ;
void oprofile_add_trace(unsigned long pc ) ;
unsigned long oprofile_get_cpu_buffer_size(void) ;
void oprofile_cpu_buffer_inc_smpl_lost(void) ;
void oprofile_write_reserve(struct op_entry *entry , struct pt_regs *regs , unsigned long pc ,
                            int code , int size ) ;
...
unsigned long op_cpu_buffer_entries(int cpu ) ;
 static int op_cpu_buffer_add_data(struct op_entry *entry , unsigned long val ) 
{ 
 ...
 static int op_cpu_buffer_get_size(struct op_entry *entry ) 
{ 
...
{ struct op_entry entry ;
 ...
 static int op_add_sample(struct oprofile_cpu_buffer *cpu_buf , unsigned long pc ,
                                  unsigned long event ) 
{ struct op_entry entry ;
  struct op_sample *sample ;
  int tmp ;
...
{ struct task_struct *tmp ;
 ...
 static void oprofile_begin_trace(struct oprofile_cpu_buffer *cpu_buf ) 
{ 
...
{ 
 ...
 static void __oprofile_add_ext_sample(unsigned long pc , struct pt_regs *regs ,
...
{ struct oprofile_cpu_buffer *cpu_buf ;
 ...
 static int op_cpu_buffer_get_data(struct op_entry *entry , unsigned long *val ) 
{ int size ;
...
{ 
 ...
 static unsigned long fast_get_dcookie(struct path *path ) 
...
{ struct mm_struct *mm ;
 ...
 static int is_code(unsigned long val ) 
{ 
...
{ 
 ...
 static void __clear_bit_unlock(unsigned int nr , unsigned long volatile   *addr ) 
{ 
...
{ struct inode *var_group1 ;
  ...
  if (ldv_s_event_buffer_fops_file_operations == 0) {
    ...
    ldv_s_event_buffer_fops_file_operations ++;
  }
  goto ldv_18187;
  case 1: ;
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_timeout_fops_file_operations == 0) {
    ...
    ldv_s_timeout_fops_file_operations ++;
  }
  goto ldv_13899;
  case 1: ;
  ...
  if (ldv_s_depth_fops_file_operations == 0) {
    ...
    ldv_s_depth_fops_file_operations ++;
  }
  goto ldv_13899;
  case 3: ;
  ...
  if (ldv_s_enable_fops_file_operations == 0) {
    ...
    ldv_s_enable_fops_file_operations ++;
  }
  goto ldv_13899;
  case 7: ;
...
{ struct file *var_group1 ;
  ...
  if (ldv_s_ulong_fops_file_operations == 0) {
    ...
    ldv_s_ulong_fops_file_operations ++;
  }
  goto ldv_19096;
  case 1: ;
  ...
  if (ldv_s_ulong_ro_fops_file_operations == 0) {
    ...
    ldv_s_ulong_ro_fops_file_operations ++;
  }
  goto ldv_19096;
  case 4: ;
  ...
  if (ldv_s_atomic_ro_fops_file_operations == 0) {
    ...
    ldv_s_atomic_ro_fops_file_operations ++;
  }
  goto ldv_19096;
  case 6: ;
...
extern int hrtimer_start(struct hrtimer * , ktime_t  , enum hrtimer_mode  ) ;
int ldv_hrtimer_start_35(struct hrtimer *ldv_func_arg1 , ktime_t ldv_func_arg2 , enum hrtimer_mode ldv_func_arg3 ) ;
extern int hrtimer_cancel(struct hrtimer * ) ;
extern u64 hrtimer_forward(struct hrtimer * , ktime_t  , ktime_t  ) ;
 static u64 hrtimer_forward_now(struct hrtimer *timer___0 , ktime_t interval ) 
{ ktime_t tmp ;
  u64 tmp___0 ;
...
void x86_backtrace(struct pt_regs *regs , unsigned int depth ) ;
int oprofile_arch_init(struct oprofile_operations *ops ) 
{ int ret ;
...
{ int tmp ;
 ...
 static unsigned long kernel_stack_pointer(struct pt_regs *regs ) 
{ 
 ...
 static unsigned long frame_pointer(struct pt_regs *regs ) 
{ 
...
{ unsigned int ret ;
 ...
 static int __copy_from_user_inatomic(void *dst , void const   *src , unsigned int size ) 
{ unsigned long tmp ;
...
extern struct pv_cpu_ops pv_cpu_ops ;
 static u64 paravirt_read_msr(unsigned int msr , int *err ) 
{ u64 __ret ;
  unsigned long __edi ;
  unsigned long __esi ;
  unsigned long __edx ;
 ...
 static int paravirt_write_msr(unsigned int msr , unsigned int low , unsigned int high ) 
{ int __ret ;
  unsigned long __edi ;
  unsigned long __esi ;
  unsigned long __edx ;
...
{ u32 tmp ;
 ...
 static void apic_write(u32 reg , u32 val ) 
{ 
...
{ u64 val ;
  ...
  val |= 1048576ULL;
  if (counter_config___0->user != 0UL) {
    tmp = 65536ULL;
  } else {
    tmp = 0ULL;
  }
  val = tmp | val;
  if (counter_config___0->kernel != 0UL) {
    tmp___0 = 131072ULL;
  } else {
    tmp___0 = 0ULL;
  }
  ...
  if ((unsigned int )((unsigned short )model___0->event_mask) != 0U) {
    tmp___1 = (short )model___0->event_mask;
  } else {
    tmp___1 = 255;
  }
  event = (u16 )(tmp___1 & (int )((short )event));
...
static void nmi_cpu_setup_mux(int cpu , struct op_msrs  const  *msrs ) 
{ int i ;
  struct op_msr *multiplex ;
  int tmp ;
  void const   *__vpp_verify ;
...
{ int tmp ;
  ...
  {
  if (counter_config[model->num_counters].count != 0UL) {
    tmp = 0;
  } else {
    tmp = -22;
  }
...
{ int tmp ;
 ...
 static void mux_init(struct oprofile_operations *ops ) 
{ int tmp ;
...
{ struct notifier_block *var_group1 ;
 ...
 static void __cpuid(unsigned int *eax , unsigned int *ebx , unsigned int *ecx ,
                             unsigned int *edx ) 
{ unsigned long __edi ;
  unsigned long __esi ;
  unsigned long __edx ;
...
extern void release_evntsel_nmi(unsigned int  ) ;
 static void op_x86_warn_in_use(int counter ) 
{ int pfo_ret__ ;
 ...
 static void op_x86_warn_reserved(int counter ) 
{ 
...
{ unsigned int lfsr_value ;
 ...
 static u64 op_amd_randomize_ibs_op(u64 val ) 
{ unsigned int random ;
  unsigned int tmp ;
 ...
 static void op_amd_handle_ibs(struct pt_regs *regs , struct op_msrs  const  *msrs ) 
{ u64 val ;
  u64 ctl ;
  struct op_entry entry ;
  int _err ;
  ...
  if (ibs_config.fetch_enabled != 0UL) {
    ...
    if ((ctl & 562949953421312ULL) != 0ULL) {
      ...
      ctl &= 0xfffdffff0000ffffULL;
      ctl |= 281474976710656ULL;
 ...
 static void op_amd_start_ibs(void) 
{ u64 val ;
  u64 __val ;
  ...
  if (ibs_config.fetch_enabled != 0UL) {
    ...
    if (ibs_config.rand_en != 0UL) {
      tmp = 144115188075855872ULL;
    } else {
      tmp = 0ULL;
    }
    val = tmp | val;
    val |= 281474976710656ULL;
  ...
  if (ibs_config.op_enabled != 0UL) {
    ...
    if (((long long )ibs_caps & 16LL) != 0LL && ibs_config.dispatched_ops != 0UL) {
      ibs_op_ctl |= 524288ULL;
    }
    ibs_op_ctl |= 131072ULL;
...
static void op_mux_switch_ctrl(struct op_x86_model_spec  const  *model___0 , struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int virt ;
  int tmp ;
...
static void op_amd_shutdown(struct op_msrs  const  *msrs ) 
{ int i ;
...
static int op_amd_fill_in_addresses(struct op_msrs *msrs ) 
{ int i ;
  int tmp ;
  int tmp___0 ;
...
static void op_amd_setup_ctrs(struct op_x86_model_spec  const  *model___0 , struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int tmp ;
  int _err ;
...
static int op_amd_check_ctrs(struct pt_regs *regs , struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int virt ;
  int tmp ;
...
static void op_amd_start(struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int tmp ;
  int _err ;
...
static void op_amd_stop(struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int tmp ;
  int _err ;
...
extern struct cpuinfo_x86 cpu_info ;
 static void *kmalloc___0(size_t size , gfp_t flags ) 
{ void *tmp___1 ;
 ...
 static void *kzalloc___0(size_t size , gfp_t flags ) 
{ void *tmp ;
 ...
 static void op_x86_warn_in_use___0(int counter ) 
{ int pfo_ret__ ;
...
static void ppro_shutdown(struct op_msrs  const  *msrs ) 
{ int i ;
...
static int ppro_fill_in_addresses(struct op_msrs *msrs ) 
{ int i ;
  int tmp ;
  int tmp___0 ;
...
static void ppro_setup_ctrs(struct op_x86_model_spec  const  *model___0 , struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  void *tmp ;
...
static int ppro_check_ctrs(struct pt_regs *regs , struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  long tmp ;
  int _err ;
...
static void ppro_start(struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int _err ;
...
static void ppro_stop(struct op_msrs  const  *msrs ) 
{ u64 val ;
  int i ;
  int _err ;
...
extern unsigned long find_first_bit(unsigned long const   * , unsigned long  ) ;
 static unsigned int cpumask_first(struct cpumask  const  *srcp ) 
{ unsigned long tmp ;
...
static void p4_shutdown(struct op_msrs  const  *msrs ) 
{ int i ;
...
static int p4_fill_in_addresses(struct op_msrs *msrs ) 
{ unsigned int i ;
  unsigned int addr ;
...
static void p4_setup_ctrs(struct op_x86_model_spec  const  *model___0 , struct op_msrs  const  *msrs ) 
{ unsigned int i ;
  unsigned int low ;
  unsigned int high ;
  unsigned int stag ;
  ...
  goto ldv_15799;
  ldv_15798: 
  tmp___0 = ldv__builtin_expect((msrs->controls + (unsigned long )i)->addr == 0UL,
                                0L);
  if (tmp___0 != 0L) {
    goto ldv_15795;
  }
  ...
  goto ldv_15803;
  ldv_15802: 
  tmp___2 = ldv__builtin_expect((msrs->controls + (unsigned long )i)->addr == 0UL,
                                0L);
  if (tmp___2 != 0L) {
    goto ldv_15801;
  }
...
static int p4_check_ctrs(struct pt_regs *regs , struct op_msrs  const  *msrs ) 
{ unsigned long ctr ;
  unsigned long low ;
  unsigned long high ;
  unsigned long stag ;
...
static void p4_start(struct op_msrs  const  *msrs ) 
{ unsigned int low ;
  unsigned int high ;
  unsigned int stag ;
  int i ;
...
static void p4_stop(struct op_msrs  const  *msrs ) 
{ unsigned int low ;
  unsigned int high ;
  unsigned int stag ;
  int i ;
