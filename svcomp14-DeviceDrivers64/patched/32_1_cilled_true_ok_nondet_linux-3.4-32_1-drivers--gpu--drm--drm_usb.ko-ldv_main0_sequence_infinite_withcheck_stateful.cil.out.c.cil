...
extern void drm_ut_debug_printk(unsigned int request_level , char const   *prefix ,
                                char const   *function_name , char const   *format 
                                , ...) ;
...
{ struct drm_device *dev ;
  ...
  *((struct device **)__cil_tmp11) = (struct device *)__cil_tmp13;
  ...
  __cil_tmp18 = __cil_tmp17 + 1136UL;
  ...
  __cil_tmp21 = __cil_tmp20 + 1144UL;
  ...
  if (*((int (**)(struct drm_device * , unsigned long flags ))__cil_tmp25)) {
    ...
    __cil_tmp27 = __cil_tmp26 + 1112UL;
