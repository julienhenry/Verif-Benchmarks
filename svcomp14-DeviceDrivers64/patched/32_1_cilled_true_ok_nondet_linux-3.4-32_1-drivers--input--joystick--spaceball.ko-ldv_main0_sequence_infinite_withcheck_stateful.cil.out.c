...
{ struct spaceball *spaceball ;
  ...
  *((struct input_dev **)spaceball) = input_dev;
  ...
  __cil_tmp23 = (unsigned long )id * 8UL;
  ...
  *((unsigned long *)__cil_tmp51) = __cil_tmp53 | __cil_tmp52;
  ...
  tmp___0 = (int )input_register_device(__cil_tmp118);
  err = tmp___0;
  if (err) {
    goto fail3;
  }
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__serio_register_driver(& spaceball_drv, & __this_module, "spaceball");
  tmp = tmp___0;
  return (tmp);
}
}
    ...
    if (tmp___0 == 2) {
      ...
      if (0) {
        ...
        if (ldv_s_spaceball_drv_serio_driver == 0) {
          ...
          ldv_s_spaceball_drv_serio_driver ++;
        }
        goto switch_break;
        case_1: 
