...
{ long tmp___7 ;
  ...
  while (1) {
    ...
    (dev->data.pos) ++;
    dev->data.tester += (u32 )((int )dev->data.buffer[tmp___8] << dev->data.bits_left);
...
static struct _ddebug descriptor___3  __attribute__((__used__,
__section__("__verbose"), __aligned__(8)))  =    {"keyspan_remote", "keyspan_setup", "/anthill/stuff/tacas-comp/work/current--X--drivers/input/misc/keyspan_remote.ko--X--bulklinux-3.0.1--X--68_1/linux-3.0.1/csd_deg_dscv/11/dscv_tempdir/dscv/ri/68_1/drivers/input/misc/keyspan_remote.c.common.c",
...
{ struct usb_device *udev ;
  ...
  (remote->irq_urb)->transfer_flags |= 4U;
  tmp___12 = (int )input_register_device(remote->input);
  tmp = tmp___12;
  error = tmp;
  if (error) {
    goto fail3;
    ...
    if (tmp___8 == 1) {
      ...
      if (0) {
        ...
        if (ldv_s_keyspan_driver_usb_driver == 0) {
          ...
          ldv_s_keyspan_driver_usb_driver ++;
        }
        goto switch_break;
        case_1: 
