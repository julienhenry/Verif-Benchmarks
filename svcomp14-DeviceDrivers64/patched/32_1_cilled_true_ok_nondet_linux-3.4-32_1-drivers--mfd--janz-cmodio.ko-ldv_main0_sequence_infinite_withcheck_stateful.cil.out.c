...
{ struct janz_platform_data *pdata ;
  ...
  __cil_tmp10 = (unsigned long )devno * 96UL;
  __cil_tmp11 = 24UL + __cil_tmp10;
  __cil_tmp12 = (unsigned long )priv;
  __cil_tmp13 = __cil_tmp12 + __cil_tmp11;
  cell = (struct mfd_cell *)__cil_tmp13;
  __cil_tmp14 = devno * 3U;
  __cil_tmp15 = (unsigned long )__cil_tmp14 * 56UL;
  __cil_tmp16 = 408UL + __cil_tmp15;
  __cil_tmp17 = (unsigned long )priv;
  __cil_tmp18 = __cil_tmp17 + __cil_tmp16;
  res = (struct resource *)__cil_tmp18;
  __cil_tmp19 = (unsigned long )devno * 4UL;
  __cil_tmp20 = 1080UL + __cil_tmp19;
...
static struct attribute_group  const  cmodio_sysfs_attr_group  =    {(char const   *)0,
    (umode_t (*)(struct kobject * , struct attribute * , int  ))0, cmodio_sysfs_attrs};
static int cmodio_pci_probe(struct pci_dev *dev ,
                            struct pci_device_id  const  *id )  __attribute__((__section__(".devinit.text"),
__no_instrument_function__)) ;
...
{ struct cmodio_device *priv ;
  ...
  *((struct pci_dev **)priv) = dev;
  tmp___2 = (int )pci_enable_device(dev);
  ret = tmp___2;
  if (ret) {
  ...
  pci_set_master(dev);
  tmp___3 = (int )pci_request_regions(dev, "janz-cmodio");
  ret = tmp___3;
  if (ret) {
  ...
  *((u8 *)__cil_tmp38) = (u8 )tmp___1;
  ...
  tmp___4 = (int )sysfs_create_group(__cil_tmp42, & cmodio_sysfs_attr_group);
  ret = tmp___4;
  if (ret) {
...
static struct pci_driver cmodio_pci_driver  = 
    ...
    {(char const   *)0, (struct bus_type *)0, (struct module *)0, (char const   *)0,
     ...
     (struct driver_private *)0}, {{{{{{0U}}, 0U, 0U, (void *)0}}}, {(struct list_head *)0,
                                                                     (struct list_head *)0}}};
static int cmodio_init(void)  __attribute__((__section__(".init.text"),
__no_instrument_function__)) ;
...
{ int tmp ;
  ...
  {
  tmp___0 = (int )__pci_register_driver(& cmodio_pci_driver, & __this_module, "janz_cmodio");
  tmp = tmp___0;
  return (tmp);
}
}
