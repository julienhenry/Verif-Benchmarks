...
{ 
 ...
 static void list_splice_init_rcu(struct list_head *list , struct list_head *head ,
                                          void (*sync)(void) ) 
...
struct ipmi_smi_msg *ipmi_alloc_smi_msg(void) ;
 static void ipmi_free_smi_msg(struct ipmi_smi_msg *msg ) 
{ 
...
{ unsigned char csum ;
 ...
 static void format_ipmb_msg(struct ipmi_smi_msg *smi_msg , struct kernel_ipmi_msg *msg ,
...
{ int i ;
  ...
  smi_msg->data[smi_msg->data_size + i] = ipmb_checksum((unsigned char *)(& smi_msg->data) + ((unsigned long )i + 6UL),
                                                        smi_msg->data_size + -6);
  smi_msg->data_size += i + 1;
  smi_msg->msgid = msgid;
  return;
}
}
 static void format_lan_msg(struct ipmi_smi_msg *smi_msg , struct kernel_ipmi_msg *msg ,
...
{ struct ipmi_recv_msg *msg ;
  ...
  ent->timeout -= (unsigned long )timeout_period;
  if (ent->timeout != 0UL) {
    return;
  }
